...
`;class _t{constructor(t,e){this.host=t,this._hass=e,this._isRemote=!1,t.addController(this)}hostConnected(){this._refresh()}setHass(t){this._hass=t,this._refresh(),this.host.requestUpdate()}get state(){return{isRemote:this._isRemote,previewFps:this._isRemote?10:20,useBinaryPack:this._isRemote,disableBloom:this._isRemote}}_refresh(){if("undefined"==typeof location)return void(this._isRemote=!1);const t=location.hostname.endsWith(".ui.nabu.casa"),e=this._hass?.config?.external_url,i=!!e&&e.replace(/\/$/,"")===location.origin;this._isRemote=t||i}}const mt=[gt,ft];class vt extends ot{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new _t(this),this._visible=!0,this._inView=!0}static{this.styles=mt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}t([ct({attribute:!1})],vt.prototype,"hass",void 0);const yt=/^[0-9a-fA-F]+$/;function bt(t,e){const i=new Uint8ClampedArray(4*e);for(let s=0;s<e;s++){const e=Math.min(t.count-1,Math.max(0,Math.round(s/t.scale))),n=t.leds_hex[e]??"000000",r=4*s;8===n.length?(i[r]=parseInt(n.slice(0,2),16),i[r+1]=parseInt(n.slice(2,4),16),i[r+2]=parseInt(n.slice(4,6),16),i[r+3]=parseInt(n.slice(6,8),16)):(i[r]=parseInt(n.slice(0,2),16),i[r+1]=parseInt(n.slice(2,4),16),i[r+2]=parseInt(n.slice(4,6),16),i[r+3]=255)}return i}function xt(t,e,i,s){let n,r=!1;const o=async()=>{n?.(),n=void 0,r||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let n=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&yt.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let r=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(r=t)}return{leds_hex:s,n:r,channels:n,scale:r/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:s?.remote??!1}))};o();const a=function(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}(t,()=>{o()});return()=>{r=!0,a(),n?.(),n=void 0}}async function wt(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",n),i(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function St(t){await wt(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,i=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${i}`)}}function Ct(t,e,i=100){let s,n,r;const o=()=>{if(s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,r){const e=r;r=void 0,t(...e)}},a=(...t)=>{r=t,s&&clearTimeout(s),s=setTimeout(o,e),n||(n=setTimeout(o,i))};return a.cancel=()=>{s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,r=void 0},a}async function kt(t,e){await wt(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function Pt(t,e,i,s){await wt(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}async function It(t,e,i){return(await t.sendMessagePromise({type:"wled_studio/effect_meta",schema_version:1,controller_id:e,effect_id:i})).meta??{sliders:{},colors_enabled:!0,palette_enabled:!0,flag:null,defaults:{}}}function Mt(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function At(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function $t(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}function Et(t,e,i){const s=new Set(t),n=(i.length?i:t.map(t=>({id:t}))).map(t=>s.has(t.id)?{...e,id:t.id,sel:!0,on:void 0!==e.on?e.on:!1===t.on||t.on}:{id:t.id,sel:!1});return{seg:n}}function Lt(t,e){const i=new Set(t);return i.has(e)?i.delete(e):i.add(e),[...i].sort((t,e)=>t-e)}function Tt(t,e){const i=t.id,s=e.find(t=>t.wled_segment_id===i||t.segment_index===i||t.entity_id.endsWith(`_segment_${i}`));return`${("string"==typeof t.n&&t.n.trim()?t.n.trim():"")||s?.name?.replace(/^.*\s—\s/,"")||`Seg ${i+1}`} (${t.start??"?"}–${t.stop??"?"})`}function Rt(t){if(t instanceof Error)return t.message;if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t;if("string"==typeof e.message)return"string"==typeof e.code?`${e.code}: ${e.message}`:e.message;const i=e.error;if(i&&"object"==typeof i){const t=i;if("string"==typeof t.message)return"string"==typeof t.code?`${t.code}: ${t.message}`:t.message}if("string"==typeof e.code)return e.code}try{return JSON.stringify(t)}catch{return"Unknown error"}}const Ft={all:"All","1d":"1D","2d":"2D",solid:"Solid",sound:"Sound",palette:"Palette"};function Dt(t){return void 0!==t.Solid?t.Solid:0}const Ot="wled_studio.segment_snapshot",Nt="wled_studio.merge_for_effects",Ut=["start","stop","len","grp","spc","of","on","bri","col","fx","sx","ix","c1","c2","c3","o1","o2","o3","pal","n","rev","mi","sel","awm"];function Gt(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function zt(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function Bt(t){return Boolean(Gt(Nt)[t])}function Vt(t,e){const i=Gt(Nt);e?i[t]=!0:delete i[t],zt(Nt,i)}function Wt(t){return Gt(Ot)[t]??null}function Ht(t){return{seg:t.segments.map(t=>function(t){const e=t,i={id:t.id};for(const t of Ut){const s=e[t];void 0!==s&&(i[t]=s)}return i}(t))}}function jt(t,e){const i=t.find(t=>0===t.id);return i?[0]:t.length?[t[0].id]:[0]}function qt(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:At(t.col),awm:t.awm};return JSON.stringify(e)}function Kt(t,e,i){let s,n=null,r=0;const o=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await kt(t,e)).segments??[]).find(t=>t.id===r);if(!s||!n)return;const o=qt(n);if(o===qt(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(At(t.col))!==JSON.stringify(At(e.col))}(n,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=Ct((s,a)=>{n=a,r=a.id,Pt(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(n={...a,...i,id:a.id}),o()}).catch(t=>{i(a,`Failed to apply state to WLED: ${Rt(t)}`)})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var Yt,Xt,Zt,Jt,Qt,te={},ee=[],ie=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function se(t,e){for(var i in e)t[i]=e[i];return t}function ne(t){var e=t.parentNode;e&&e.removeChild(t)}function re(t,e,i){var s,n,r,o,a=arguments;if(e=se({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return o=e.key,null!=(r=e.ref)&&delete e.ref,null!=o&&delete e.key,oe(t,e,o,r)}function oe(t,e,i,s){var n={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return Yt.vnode&&Yt.vnode(n),n}function ae(t){return t.children}function le(t,e){this.props=t,this.context=e}function he(t,e){if(null==e)return t.__p?he(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?he(t):null}function ce(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return ce(t)}}function de(t){(!t.__d&&(t.__d=!0)&&1===Xt.push(t)||Jt!==Yt.debounceRendering)&&(Jt=Yt.debounceRendering,(Yt.debounceRendering||Zt)(ue))}function ue(){var t,e,i,s,n,r,o,a;for(Xt.sort(function(t,e){return e.__v.__b-t.__v.__b});t=Xt.pop();)t.__d&&(i=void 0,s=void 0,r=(n=(e=t).__v).__e,o=e.__P,a=e.u,e.u=!1,o&&(i=[],s=ve(o,n,se({},n),e.__n,void 0!==o.ownerSVGElement,null,i,a,null==r?he(n):r),ye(i,n),s!=r&&ce(n)))}function pe(t,e,i,s,n,r,o,a,l){var h,c,d,u,p,g,f,_=i&&i.__k||ee,m=_.length;if(a==te&&(a=null!=r?r[0]:m?he(i,0):null),h=0,e.__k=ge(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=_[h])||d&&i.key==d.key&&i.type===d.type)_[h]=void 0;else for(c=0;c<m;c++){if((d=_[c])&&i.key==d.key&&i.type===d.type){_[c]=void 0;break}d=null}if(u=ve(t,i,d=d||te,s,n,r,o,null,a,l),(c=i.ref)&&d.ref!=c&&(f||(f=[])).push(c,i.__c||u,i),null!=u){if(null==g&&(g=u),null!=i.l)u=i.l,i.l=null;else if(r==d||u!=a||null==u.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(u);else{for(p=a,c=0;(p=p.nextSibling)&&c<m;c+=2)if(p==u)break t;t.insertBefore(u,a)}"option"==e.type&&(t.value="")}a=u.nextSibling,"function"==typeof e.type&&(e.l=u)}}return h++,i}),e.__e=g,null!=r&&"function"!=typeof e.type)for(h=r.length;h--;)null!=r[h]&&ne(r[h]);for(h=m;h--;)null!=_[h]&&we(_[h],_[h]);if(f)for(h=0;h<f.length;h++)xe(f[h],f[++h],f[++h])}function ge(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)ge(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return oe(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=oe(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function fe(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===ie.test(e)?i+"px":null==i?"":i}function _e(t,e,i,s,n){var r,o,a,l,h;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(r=t.style,"string"==typeof i)r.cssText=i;else{if("string"==typeof s&&(r.cssText="",s=null),s)for(o in s)i&&o in i||fe(r,o,"");if(i)for(a in i)s&&i[a]===s[a]||fe(r,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),h=e.toLowerCase(),e=(h in t?h:e).slice(2),i?(s||t.addEventListener(e,me,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,me,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function me(t){return this.t[t.type](Yt.event?Yt.event(t):t)}function ve(t,e,i,s,n,r,o,a,l,h){var c,d,u,p,g,f,_,m,v,y,b=e.type;if(void 0!==e.constructor)return null;(c=Yt.__b)&&c(e);try{t:if("function"==typeof b){if(m=e.props,v=(c=b.contextType)&&s[c.__c],y=c?v?v.props.value:c.__p:s,i.__c?_=(d=e.__c=i.__c).__p=d.__E:("prototype"in b&&b.prototype.render?e.__c=d=new b(m,y):(e.__c=d=new le(m,y),d.constructor=b,d.render=Se),v&&v.sub(d),d.props=m,d.state||(d.state={}),d.context=y,d.__n=s,u=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=b.getDerivedStateFromProps&&se(d.__s==d.state?d.__s=se({},d.__s):d.__s,b.getDerivedStateFromProps(m,d.__s)),u)null==b.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&o.push(d);else{if(null==b.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(m,y),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(m,d.__s,y)){for(d.props=m,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,c=0;c<e.__k.length;c++)e.__k[c]&&(e.__k[c].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(m,d.__s,y)}for(p=d.props,g=d.state,d.context=y,d.props=m,d.state=d.__s,(c=Yt.__r)&&c(e),d.__d=!1,d.__v=e,d.__P=t,c=d.render(d.props,d.state,d.context),e.__k=ge(null!=c&&c.type==ae&&null==c.key?c.props.children:c),null!=d.getChildContext&&(s=se(se({},s),d.getChildContext())),u||null==d.getSnapshotBeforeUpdate||(f=d.getSnapshotBeforeUpdate(p,g)),pe(t,e,i,s,n,r,o,l,h),d.base=e.__e;c=d.__h.pop();)d.__s&&(d.state=d.__s),c.call(d);u||null==p||null==d.componentDidUpdate||d.componentDidUpdate(p,g,f),_&&(d.__E=d.__p=null)}else e.__e=be(i.__e,e,i,s,n,r,o,h);(c=Yt.diffed)&&c(e)}catch(t){Yt.__e(t,e,i)}return e.__e}function ye(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){Yt.__e(t,i.__v)}Yt.__c&&Yt.__c(e)}function be(t,e,i,s,n,r,o,a){var l,h,c,d,u=i.props,p=e.props;if(n="svg"===e.type||n,null==t&&null!=r)for(l=0;l<r.length;l++)if(null!=(h=r[l])&&(null===e.type?3===h.nodeType:h.localName===e.type)){t=h,r[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(p);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),r=null}return null===e.type?u!==p&&(null!=r&&(r[r.indexOf(t)]=null),t.data=p):e!==i&&(null!=r&&(r=ee.slice.call(t.childNodes)),c=(u=i.props||te).dangerouslySetInnerHTML,d=p.dangerouslySetInnerHTML,a||(d||c)&&(d&&c&&d.__html==c.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,n){var r;for(r in i)r in e||_e(t,r,null,i[r],s);for(r in e)n&&"function"!=typeof e[r]||"value"===r||"checked"===r||i[r]===e[r]||_e(t,r,e[r],i[r],s)}(t,p,u,n,a),e.__k=e.props.children,d||pe(t,e,i,s,"foreignObject"!==e.type&&n,r,o,te,a),a||("value"in p&&void 0!==p.value&&p.value!==t.value&&(t.value=null==p.value?"":p.value),"checked"in p&&void 0!==p.checked&&p.checked!==t.checked&&(t.checked=p.checked))),t}function xe(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){Yt.__e(t,i)}}function we(t,e,i){var s,n,r;if(Yt.unmount&&Yt.unmount(t),(s=t.ref)&&xe(s,null,e),i||"function"==typeof t.type||(i=null!=(n=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){Yt.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(r=0;r<s.length;r++)s[r]&&we(s[r],e,i);null!=n&&ne(n)}function Se(t,e,i){return this.constructor(t,i)}function Ce(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function ke(){return ke=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}return t},ke.apply(this,arguments)}Yt={},le.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=se({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&se(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),de(this))},le.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,de(this))},le.prototype.render=ae,Xt=[],Zt="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Jt=Yt.debounceRendering,Yt.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return de(s.__E=s)}catch(e){t=e}throw t},Qt=te;var Pe="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",Ie="[\\s|\\(]+("+Pe+")[,|\\s]+("+Pe+")[,|\\s]+("+Pe+")\\s*\\)?",Me="[\\s|\\(]+("+Pe+")[,|\\s]+("+Pe+")[,|\\s]+("+Pe+")[,|\\s]+("+Pe+")\\s*\\)?",Ae=new RegExp("rgb"+Ie),$e=new RegExp("rgba"+Me),Ee=new RegExp("hsl"+Ie),Le=new RegExp("hsla"+Me),Te="^(?:#?|0x?)",Re="([0-9a-fA-F]{1})",Fe="([0-9a-fA-F]{2})",De=new RegExp(Te+Re+Re+Re+"$"),Oe=new RegExp(Te+Re+Re+Re+Re+"$"),Ne=new RegExp(Te+Fe+Fe+Fe+"$"),Ue=new RegExp(Te+Fe+Fe+Fe+Fe+"$"),Ge=Math.log,ze=Math.round,Be=Math.floor;function Ve(t,e,i){return Math.min(Math.max(t,e),i)}function We(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function He(t){return parseInt(t,16)}function je(t){return t.toString(16).padStart(2,"0")}var qe=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=ke({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=ke({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,n=Be(e),r=e-n,o=s*(1-i),a=s*(1-r*i),l=s*(1-(1-r)*i),h=n%6,c=[l,s,s,a,o,o][h],d=[o,o,l,s,s,a][h];return{r:Ve(255*[s,a,o,o,l,s][h],0,255),g:Ve(255*c,0,255),b:Ve(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,n=Math.max(e,i,s),r=Math.min(e,i,s),o=n-r,a=0,l=n,h=0===n?0:o/n;switch(n){case r:a=0;break;case e:a=(i-s)/o+(i<s?6:0);break;case i:a=(s-e)/o+2;break;case s:a=(e-i)/o+4}return{h:60*a%360,s:Ve(100*h,0,100),v:Ve(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,n=s<=1?s:2-s,r=n<1e-9?0:e*i/n;return{h:t.h,s:Ve(100*r,0,100),l:Ve(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:Ve(100*s,0,100),v:Ve((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,n=t/100;return n<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=n-2)+104.49216199393888*Ge(i),s=n<20?0:.8274096064007395*(s=n-10)-254.76935184120902+115.67994401066147*Ge(s)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*Ge(e),i=325.4494125711974+.07943456536662342*(i=n-50)-28.0852963507957*Ge(i),s=255),{r:Ve(Be(e),0,255),g:Ve(Be(i),0,255),b:Ve(Be(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,n=e.b,r=2e3,o=4e4;o-r>.4;){i=.5*(o+r);var a=t.kelvinToRgb(i);a.b/a.r>=n/s?o=i:r=i}return i},Ce(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=ke({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return ke({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=ke({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=ke({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=ke({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=ke({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,n=e.b;return{r:ze(i),g:ze(s),b:ze(n)}},set:function(e){this.hsv=ke({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return ke({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,n=e.l;return{h:ze(i),s:ze(s),l:ze(n)}},set:function(e){this.hsv=ke({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return ke({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,n,r=1;if((e=Ae.exec(t))?(i=We(e[1],255),s=We(e[2],255),n=We(e[3],255)):(e=$e.exec(t))&&(i=We(e[1],255),s=We(e[2],255),n=We(e[3],255),r=We(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:n,a:r}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+je(t.r)+je(t.g)+je(t.b)},set:function(t){var e,i,s,n,r=255;if((e=De.exec(t))?(i=17*He(e[1]),s=17*He(e[2]),n=17*He(e[3])):(e=Oe.exec(t))?(i=17*He(e[1]),s=17*He(e[2]),n=17*He(e[3]),r=17*He(e[4])):(e=Ne.exec(t))?(i=He(e[1]),s=He(e[2]),n=He(e[3])):(e=Ue.exec(t))&&(i=He(e[1]),s=He(e[2]),n=He(e[3]),r=He(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:n,a:r/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+je(t.r)+je(t.g)+je(t.b)+je(Be(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,n,r=1;if((e=Ee.exec(t))?(i=We(e[1],360),s=We(e[2],100),n=We(e[3],100)):(e=Le.exec(t))&&(i=We(e[1],360),s=We(e[2],100),n=We(e[3],100),r=We(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:n,a:r}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function Ke(t){var e,i=t.width,s=t.sliderSize,n=t.borderWidth,r=t.handleRadius,o=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*o+2*r,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*o-2*r,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-n/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function Ye(t,e){var i=Ke(t),s=i.width,n=i.height,r=i.handleRange,o=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var n=t.minTemperature,r=t.maxTemperature-n,o=(e.kelvin-n)/r*100;return Math.max(0,Math.min(o,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),h=a?s/2:n/2,c=o+l/100*r;return a&&(c=-1*c+r+2*o),{x:a?h:c,y:a?c:h}}var Xe,Ze=2*Math.PI,Je=function(t,e){return Math.sqrt(t*t+e*e)};function Qe(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function ti(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function ei(t,e,i){var s=t.wheelAngle,n=t.wheelDirection;return i&&"clockwise"===n?e=s+e:"clockwise"===n?e=360-s+e:i&&"anticlockwise"===n?e=s+180-e:"anticlockwise"===n&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function ii(t,e,i){var s=ti(t),n=s.cx,r=s.cy,o=Qe(t);e=n-e,i=r-i;var a=ei(t,Math.atan2(-i,-e)*(360/Ze)),l=Math.min(Je(e,i),o);return{h:Math.round(a),s:Math.round(100/o*l)}}function si(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function ni(t,e,i){var s=si(t),n=s.width,r=s.height,o=s.radius,a=(e-o)/(n-2*o)*100,l=(i-o)/(r-2*o)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function ri(t){Xe||(Xe=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),n=window.location;return(i||s)&&Xe.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function oi(t,e,i,s){for(var n=0;n<s.length;n++){var r=s[n].x-e,o=s[n].y-i;if(Math.sqrt(r*r+o*o)<t.handleRadius)return n}return null}function ai(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function li(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function hi(t){return"string"==typeof t?t:t+"px"}var ci=["mousemove","touchmove","mouseup","touchend"],di=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,r={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(r[s?"marginLeft":"marginTop"]=n),re(ae,null,t.children(this.uid,i,r))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,r=n.clientX-s.left,o=n.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(r,o,0)&&ci.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(r,o,1);break;case"mouseup":case"touchend":i(r,o,2),ci.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(le);function ui(t){var e=t.r,i=t.url,s=e,n=e;return re("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+hi(t.x)+", "+hi(t.y)+")",willChange:"transform",top:hi(-e),left:hi(-e),width:hi(2*e),height:hi(2*e),position:"absolute",overflow:"visible"}},i&&re("use",Object.assign({xlinkHref:ri(i)},t.props)),!i&&re("circle",{cx:s,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&re("circle",{cx:s,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function pi(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=Ke(t),n=s.width,r=s.height,o=s.radius,a=Ye(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var n=[],r=t.minTemperature,o=t.maxTemperature,a=o-r,l=r,h=0;l<o;l+=a/8,h+=1){var c=qe.kelvinToRgb(l),d=c.r,u=c.g,p=c.b;n.push([12.5*h,"rgb("+d+","+u+","+p+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var g=qe.hsvToHsl({h:i.h,s:0,v:i.v}),f=qe.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"],[100,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"]];default:var _=qe.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"]]}}(t,i);return re(di,Object.assign({},t,{onInput:function(e,s,n){var r=function(t,e,i){var s,n=Ke(t),r=n.handleRange,o=n.handleStart;s="horizontal"===t.layoutDirection?-1*i+r+o:e-o,s=Math.max(Math.min(s,r),0);var a=Math.round(100/r*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=r,t.onInput(n,t.id)}}),function(e,s,h){return re("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:hi(n),height:hi(r),borderRadius:hi(o),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},h)}),re("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:hi(o),background:li("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},ai(t))}),re(ui,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function gi(t){var e=si(t),i=e.width,s=e.height,n=e.radius,r=t.colors,o=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,h=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],c=r.map(function(e){return function(t,e){var i=si(t),s=i.width,n=i.height,r=i.radius,o=e.hsv,a=r,l=s-2*r,h=n-2*r;return{x:a+o.s/100*l,y:a+(h-o.v/100*h)}}(t,e)});return re(di,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var n=oi(t,e,i,c);null!==n?o.setActiveColor(n):(o.inputActive=!0,l.hsv=ni(t,e,i),t.onInput(s,t.id))}else 1===s&&(o.inputActive=!0,l.hsv=ni(t,e,i));t.onInput(s,t.id)}}),function(e,o,a){return re("div",Object.assign({},o,{className:"IroBox",style:Object.assign({},{width:hi(i),height:hi(s),position:"relative"},a)}),re("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:hi(n)},ai(t),{background:li("linear","to bottom",h[1])+","+li("linear","to right",h[0])})}),r.filter(function(t){return t!==l}).map(function(e){return re(ui,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:c[e.index].x,y:c[e.index].y})}),re(ui,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:c[l.index].x,y:c[l.index].y}))})}ui.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},pi.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function fi(t){var e=ti(t).width,i=t.colors;t.borderWidth;var s=t.parent,n=t.color,r=n.hsv,o=i.map(function(e){return function(t,e){var i=e.hsv,s=ti(t),n=s.cx,r=s.cy,o=Qe(t),a=(180+ei(t,i.h,!0))*(Ze/360),l=i.s/100*o,h="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*h,y:r+l*Math.sin(a)*h}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return re(di,Object.assign({},t,{onInput:function(e,i,r){if(0===r){if(!function(t,e,i){var s=ti(t),n=s.cx,r=s.cy,o=t.width/2;return Je(n-e,r-i)<o}(t,e,i))return!1;var a=oi(t,e,i,o);null!==a?s.setActiveColor(a):(s.inputActive=!0,n.hsv=ii(t,e,i),t.onInput(r,t.id))}else 1===r&&(s.inputActive=!0,n.hsv=ii(t,e,i));t.onInput(r,t.id)}}),function(s,l,h){return re("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:hi(e),height:hi(e),position:"relative"},h)}),re("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),re("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&re("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-r.v/100})}),re("div",{className:"IroWheelBorder",style:Object.assign({},a,ai(t))}),i.filter(function(t){return t!==n}).map(function(e){return re(ui,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[e.index].x,y:o[e.index].y})}),re(ui,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[n.index].x,y:o[n.index].y}))})}var _i=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new qe(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(n[t]||(n[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:fi},{component:pi}],e.transparency&&s.push({component:pi,options:{sliderType:"alpha"}})),re("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var n=t.component,r=t.options;return re(n,Object.assign({},e,r,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(le);_i.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var mi,vi,yi,bi=(vi=function(t,e){var i,s=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,n,r;Yt.__p&&Yt.__p(t,e),n=(s=i===Qt)?null:e.__k,t=re(ae,null,[t]),r=[],ve(e,e.__k=t,n||te,te,void 0!==e.ownerSVGElement,n?null:ee.slice.call(e.childNodes),r,!1,te,s),ye(r,t)}(re(mi,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),i},vi.prototype=(mi=_i).prototype,Object.assign(vi,mi),vi.__component=mi,vi);!function(t){var e;t.version="5.5.2",t.Color=qe,t.ColorPicker=bi,(e=t.ui||(t.ui={})).h=re,e.ComponentBase=di,e.Handle=ui,e.Slider=pi,e.Wheel=fi,e.Box=gi}(yi||(yi={}));var xi=yi;let wi=class extends vt{constructor(){super(...arguments),this.rgb=[255,128,0],this.white=0,this.awm=0,this.showWhite=!0,this._suppress=!1}updated(){this._host&&!this._picker&&(this._picker=xi.ColorPicker(this._host,{width:140,color:{r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},borderWidth:1,borderColor:"var(--divider-color, #444)",layout:[{component:xi.ui.Wheel}]}),this._picker.on("color:change",t=>{this._suppress||this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:[t.rgb.r,t.rgb.g,t.rgb.b],white:this.white},bubbles:!0,composed:!0}))}),this._syncPicker())}willUpdate(){this._picker&&this._syncPicker()}_syncPicker(){this._picker&&(this._suppress=!0,this._picker.color.rgb={r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},this._suppress=!1)}_onWhite(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:this.rgb,white:e},bubbles:!0,composed:!0}))}_onAwm(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("awm-change",{detail:{awm:e},bubbles:!0,composed:!0}))}render(){return V`
    ...
    `]}};t([ct({type:Array})],wi.prototype,"rgb",void 0),t([ct({type:Number})],wi.prototype,"white",void 0),t([ct({type:Number})],wi.prototype,"awm",void 0),t([ct({type:Boolean})],wi.prototype,"showWhite",void 0),t([ut(".wheel-host")],wi.prototype,"_host",void 0),wi=t([pt("wled-color-wheel-rgbw")],wi);function Si(t,e="strip",i,s=0){let n=String(t);return s&&(n=`${n}_p${s}`),i?.trim()&&(n=`${n}_${function(t){return(t||"").trim().replace(/[^\w.-]+/g,"_")||"unknown"}(i)}`),`${n}_${e}.webp`}function Ci(t,e,i="strip",s,n,r){if(!t||e<0)return;const o=void 0!==r?function(t,e,i="strip",s){const n=e instanceof Set?e:new Set(e);if(!n.size)return;const r=[Si(t,i,s),Si(t,i)];for(const t of r)if(n.has(t))return t;const o=`${t}_`,a=`_${i}.webp`;for(const t of n)if(t.startsWith(o)&&t.endsWith(a))return t}(e,r,i,s):Si(e,i,s);return o?function(t,e){if(!t.startsWith("/"))return t;const i=e?.auth?.data?.access_token;if(!i)return t;const s=t.includes("?")?"&":"?";return`${t}${s}auth=${encodeURIComponent(i)}`}(function(t,e){return`/local/wled_studio/thumbs/${encodeURIComponent(t)}/${encodeURIComponent(e)}`}(t,o),n):void 0}const ki="wled_studio.recent_effects",Pi="wled_studio.recent_scenes";function Ii(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function Mi(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function Ai(t){return t?Ii(ki)[t]??[]:[]}function $i(t,e=72,i=6,s=10){if(t<=0)return 1;const n=e+i;return Math.max(1,Math.min(s,Math.floor((t+i)/n)))}let Ei=class extends vt{constructor(){super(...arguments),this.fxId=0,this.thumbUrl="",this.thumbUrlAnimated="",this.label="",this._hover=!1}render(){const t=this.thumbUrlAnimated||(this.thumbUrl.endsWith(".webp")?this.thumbUrl:""),e=this.thumbUrl||t,i=this._hover&&t?t:e;return V`
      <button
        class="tile"
        type="button"
    ...
    `]}};t([ct({type:Number})],Ei.prototype,"fxId",void 0),t([ct()],Ei.prototype,"thumbUrl",void 0),t([ct()],Ei.prototype,"thumbUrlAnimated",void 0),t([ct()],Ei.prototype,"label",void 0),t([dt()],Ei.prototype,"_hover",void 0),Ei=t([pt("wled-effect-tile")],Ei);let Li=class extends vt{constructor(){super(...arguments),this.effectsByName={},this.soundFlags=[],this.selectedFx=0,this.filter="",this.controllerId="",this.fwVer="",this.thumbBasenames=[],this.toggleOff=!0,this.showRecents=!0,this._category="all",this._recentEntries=[],this._recentVisible=6}onPoweredConnect(){this._loadRecents(),this._ro=new ResizeObserver(()=>this._measureRecents()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._loadRecents();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._recentRowEl&&(this._recentRowEl=e,this._ro?.observe(e),this._measureRecents())}_loadRecents(){this._recentEntries=Ai(this.controllerId)}_measureRecents(){const t=this._recentRowEl;if(!t)return;const e=$i(t.clientWidth,76,6,10);e!==this._recentVisible&&(this._recentVisible=e)}_effectName(t){return Object.entries(this.effectsByName).find(([,e])=>e===t)?.[0]??`Effect ${t}`}render(){const t=this.filter.trim().toLowerCase(),e=Object.keys(this.effectsByName).sort((t,e)=>t.localeCompare(e)),i=Dt(this.effectsByName),s=e.filter(e=>!!function(t,e,i,s,n){if("all"===i)return!0;const r=s[e]??null,o=t.toLowerCase();return"solid"===i?e===Dt(n):"2d"===i?"2"===r||o.includes("2d"):"1d"===i?"2"!==r&&!o.includes("2d"):"sound"===i?"v"===r||"f"===r:"palette"!==i||o.includes("palette")||o.includes("colorloop")||o.includes("pride")||o.includes("cycle")}(e,this.effectsByName[e],this._category,this.soundFlags,this.effectsByName)&&!(t&&!e.toLowerCase().includes(t))),n=this.showRecents&&!t&&this._recentEntries.length>0,r=this._recentEntries.slice(0,this._recentVisible);return V`
      <div class="wrap">
        ...
        <div class="grid" role="listbox" aria-label="Effects">
          ${0===s.length?V`<p class="empty">No effects match this filter.</p>`:s.map(t=>{const e=this.effectsByName[t],s=this.soundFlags[e],n=e===this.selectedFx,r=Ci(this.controllerId,e,"strip",this.fwVer,this.hass,this.thumbBasenames);return r?V`
                    <wled-effect-tile
    ...
    `]}};t([ct({type:Object})],Li.prototype,"effectsByName",void 0),t([ct({type:Array})],Li.prototype,"soundFlags",void 0),t([ct({type:Number})],Li.prototype,"selectedFx",void 0),t([ct({type:String})],Li.prototype,"filter",void 0),t([ct()],Li.prototype,"controllerId",void 0),t([ct()],Li.prototype,"fwVer",void 0),t([ct({type:Array})],Li.prototype,"thumbBasenames",void 0),t([ct({type:Boolean})],Li.prototype,"toggleOff",void 0),t([ct({type:Boolean})],Li.prototype,"showRecents",void 0),t([dt()],Li.prototype,"_category",void 0),t([dt()],Li.prototype,"_recentEntries",void 0),t([dt()],Li.prototype,"_recentVisible",void 0),Li=t([pt("wled-effect-chips")],Li);let Ti=class extends vt{constructor(){super(...arguments),this.controllerId="",this.segments=[],this.editIds=[],this.pixelCount=210,this._merged=!1,this._busy=!1,this._error=""}onPoweredConnect(){this._merged=Bt(this.controllerId)}willUpdate(t){t.has("controllerId")&&(this._merged=Bt(this.controllerId))}render(){const t=Wt(this.controllerId),e=t&&this._merged?`${t.segments.length} segment layout saved`:null;return V`
    ...
    `]}};t([ct({attribute:!1})],Ti.prototype,"connection",void 0),t([ct()],Ti.prototype,"controllerId",void 0),t([ct({type:Array})],Ti.prototype,"segments",void 0),t([ct({type:Array})],Ti.prototype,"editIds",void 0),t([ct({type:Number})],Ti.prototype,"pixelCount",void 0),t([dt()],Ti.prototype,"_merged",void 0),t([dt()],Ti.prototype,"_busy",void 0),t([dt()],Ti.prototype,"_error",void 0),Ti=t([pt("wled-effect-merge-toggle")],Ti);let Ri=class extends vt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return V`
    ...
    `]}};t([ct({type:Array})],Ri.prototype,"presets",void 0),Ri=t([pt("wled-preset-bar")],Ri);const Fi={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Di=class extends vt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this.selectedSegId=-1,this._loading=!0,this._error="",this._segId=0,this._editIds=[],this._segments=[],this._effectFilter="",this._presets=[],this._colorSlot=0,this._toast="",this._mergeActive=!1}onPoweredConnect(){this._mergeActive=Bt(this.controllerId),this._load()}willUpdate(t){t.has("selectedSegId")&&this.selectedSegId>=0&&(this._segId=this.selectedSegId,this._refreshMeta()),(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&(this._optimistic?.cancel(),this._optimistic=Kt(this.connection,this.controllerId,(t,e)=>this._reconcile(t,e)),this._load())}onPoweredDisconnect(){this._optimistic?.cancel(),this._optimistic=void 0}selectSegment(t){if(this._mergeActive)return this._segId=0,void this._refreshMeta();this._editIds.includes(t)||(this._editIds=[...this._editIds,t].sort((t,e)=>t-e)),this._segId=t,this._colorSlot=0,this._refreshMeta(),this._syncSelToDevice(),this.dispatchEvent(new CustomEvent("segment-change",{detail:{segmentId:t,editIds:[...this._editIds]},bubbles:!0,composed:!0}))}async _load(){if(this.connection&&this.controllerId){this._loading=!0,this._error="";try{const t=await kt(this.connection,this.controllerId);if(this._snapshot=t,this._segments=[...t.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length){const t=this._segments.map(t=>t.id);t.includes(this._segId)||(this._segId=this._segments[0].id);const e=this._editIds.filter(e=>t.includes(e));this._editIds=e.length?e:[this._segId]}await this._refreshMeta(),await this._loadPresets(),this._mergeActive=Bt(this.controllerId);const e=this._pixelCount(),i=this._segments.find(t=>0===t.id),s=(i?.stop??0)-(i?.start??0);this._mergeActive&&this._segments.length>1&&e>0&&s<.9*e&&(Vt(this.controllerId,!1),this._mergeActive=!1,this._toast="Merge for effects was turned off — WLED is using a multi-segment layout."),this._mergeActive&&(this._editIds=jt(this._segments),this._segId=this._editIds[0]??0)}catch(t){this._error=Rt(t)}finally{this._loading=!1}}}async _loadPresets(){if(this.connection&&this.controllerId)try{const t=await async function(t,e){return(await t.sendMessagePromise({type:"wled_studio/get_presets",schema_version:1,controller_id:e})).presets??{}}(this.connection,this.controllerId),e=[];for(const[i,s]of Object.entries(t)){if(!s||"object"!=typeof s)continue;const t=s;e.push({id:i,name:String(t.n??t.name??`Preset ${i}`),ql:t.ql?String(t.ql):void 0})}e.sort((t,e)=>Number(t.id)-Number(e.id)),this._presets=e}catch{this._presets=[]}}_reconcile(t,e){const i=this._segments.findIndex(e=>e.id===t.id);if(i>=0){const e=[...this._segments];e[i]={...e[i],...t,id:t.id},this._segments=e}e?(this._toast=e,this.requestUpdate(),window.setTimeout(()=>{this._toast="",this.requestUpdate()},4e3)):this.requestUpdate()}_activeSeg(){return this._segments.find(t=>t.id===this._segId)??this._segments[0]}async _refreshMeta(){const t=this._activeSeg();this.connection&&this.controllerId&&t&&(this._meta=await It(this.connection,this.controllerId,t.fx??0))}async _syncHaSegment(t,e){if(!this.hass)return;const i=function(t,e){for(const i of e){if(i.wled_segment_id===t)return i.entity_id;if($t(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}(t.id,this._snapshot?.segment_entities??[]);if(!i)return;const s={entity_id:i};if(e.col?.length){const t=Mt(e.col[0]);t[3]>0?s.rgbw_color=[t[0],t[1],t[2],t[3]]:s.rgb_color=[t[0],t[1],t[2]]}if(void 0!==e.bri&&(s.brightness=e.bri),void 0!==e.fx&&this._snapshot?.effects_by_name){const t=Object.entries(this._snapshot.effects_by_name).find(([,t])=>t===e.fx)?.[0];t&&(s.effect=t)}!1!==e.on?Object.keys(s).length>1&&await this.hass.callService("light","turn_on",s):await this.hass.callService("light","turn_off",{entity_id:i})}_pixelCount(){const t=this._snapshot?.info?.leds;return Number(t?.count)||210}_targetIds(){if(this._mergeActive){const t=jt(this._segments);return t.length?t:[0]}return this._editIds.length?this._editIds:[this._segId]}_onMergeChanged(){this._mergeActive=Bt(this.controllerId),this._load(),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}_patchSeg(t){const e=this._targetIds();if(!e.length||!this._optimistic)return;const i=[...this._segments];for(const s of e){const e=i.findIndex(t=>t.id===s);if(e<0)continue;const n=i[e];i[e]={...n,...t,id:s,sel:!0,on:void 0!==t.on?t.on:!1!==n.on},this._syncHaSegment(n,t)}this._segments=i;const s=this._activeSeg();this._optimistic.push(Et(e,t,this._segments),s??{id:e[0]})}async _syncSelToDevice(){if(!this.connection||!this.controllerId||!this._segments.length)return;const t=this._targetIds();await Pt(this.connection,this.controllerId,function(t,e){const i=new Set(t);return{seg:e.map(t=>({id:t.id,sel:i.has(t.id)}))}}(t,this._segments)),this._segments=this._segments.map(e=>({...e,sel:t.includes(e.id)}))}_toggleSegEdit(t){if(this._mergeActive)return;let e=Lt(this._editIds,t);e.length||(e=[t]),this._editIds=e,this._segId=t,this._colorSlot=0,this._refreshMeta(),this._syncSelToDevice(),this.dispatchEvent(new CustomEvent("segment-change",{detail:{segmentId:t,editIds:[...this._editIds]},bubbles:!0,composed:!0}))}async _onEffectSelect(t){this._patchSeg({fx:t.detail.effectId}),await this._refreshMeta()}_cols(t){const e=t.col??[],i=[];for(let t=0;t<3;t++)i.push(Mt(e[t]));return i}_onColor(t){const e=this._activeSeg();if(!e)return;const{rgb:i,white:s}=t.detail,n=this._cols(e);n[this._colorSlot]=[i[0],i[1],i[2],s];const r=Dt(this._snapshot?.effects_by_name??{});this._patchSeg({col:n.map(t=>[t[0],t[1],t[2],t[3]]),fx:r}),this._refreshMeta()}async _onAwm(t){const e=t.detail.awm;if(this.connection&&this.controllerId)try{const t=await async function(t,e,i,s=0){return await wt(t),(await t.sendMessagePromise({type:"wled_studio/apply_rgbwm",schema_version:1,controller_id:e,rgbwm:i,bus_index:s})).rgbwm??i}(this.connection,this.controllerId,e);this._snapshot&&(this._snapshot={...this._snapshot,rgbwm:t}),this.requestUpdate()}catch(t){this._toast=t instanceof Error?t.message:String(t),this.requestUpdate()}}_slider(t,e){const i=Number(e.target.value);this._patchSeg({[t]:i})}async _loadPreset(t){this.connection&&this.controllerId&&(await Pt(this.connection,this.controllerId,{ps:Number(t)}),await this._load())}render(){if(this._loading)return V`<p class="muted">Loading segments…</p>`;if(this._error)return V`<p class="err">${this._error}</p>`;const t=this._activeSeg();if(!t)return V`<p class="muted">No segments on this controller.</p>`;const e=this._cols(t),i=e[this._colorSlot]??e[0],s=this._meta,n=s?.sliders??{},r=!1!==s?.colors_enabled?3:1,o=this._snapshot?.rgbwm??0;return V`
      <div class="controls ${this.compact?"compact":""}">
        ...
        <div class="sliders">
          ${Object.entries(Fi).map(([e,i])=>{if(!n[e])return null;const s=t[e];return V`
              <label>
                ${i}
                <ha-slider
                  min="0"
    ...
    `]}};t([ct({attribute:!1})],Co.prototype,"connection",void 0),t([ct()],Co.prototype,"controllerId",void 0),t([ct()],Co.prototype,"layoutId",void 0),t([ct()],Co.prototype,"fixtureId",void 0),t([ct({type:Number})],Co.prototype,"pixelCount",void 0),t([ct({type:Number})],Co.prototype,"dotRadius",void 0),t([dt()],Co.prototype,"_positions",void 0),t([dt()],Co.prototype,"_status",void 0),t([dt()],Co.prototype,"_showDots",void 0),t([dt()],Co.prototype,"_closed",void 0),Co=t([pt("wled-geometry-preview")],Co);let ko=class extends vt{constructor(){super(...arguments),this.controllerId="",this._layouts=[],this._status="Loading layouts…",this._busy=!1,this._viewMode="list",this._activeLayoutId="",this._activeFixtureId="",this._activePixelCount=210,this._onDesignerSave=async()=>{await this._load();const t=this.renderRoot.querySelector("wled-geometry-preview");await(t?.refresh()),this._activeLayoutId&&await this._applySegments(this._activeLayoutId)}}onPoweredConnect(){this._load(),this._attachLive()}onPoweredDisconnect(){this._liveUnsub?.(),this._liveUnsub=void 0}updated(t){super.updated(t),(t.has("connection")||t.has("controllerId"))&&(this._load(),this._attachLive())}_attachLive(){this._liveUnsub?.(),this.connection&&this.controllerId&&(this._liveUnsub=xt(this.connection,this.controllerId,t=>{this._forwardFrame(t)}))}_forwardFrame(t){const e=this.renderRoot.querySelector("wled-geometry-preview");e?.setFrame(t)}async _load(){if(this.connection&&this.controllerId)try{this._layouts=await async function(t,e){return(await Ui(t,{type:"wled_studio/layout_list",controller_id:e})).layouts??[]}(this.connection,this.controllerId),this._status=0===this._layouts.length?"No layouts yet — use the button below to seed the kitchen-island template.":`${this._layouts.length} layout(s) saved`}catch(t){this._status=t instanceof Error?t.message:String(t)}}async _seedKitchenIsland(){if(this.connection&&this.controllerId){this._busy=!0;try{await zi(this.connection,this.controllerId,(t=this.controllerId,{id:"kitchen-island",controller_id:t,name:"Kitchen island",pixel_count:210,fixtures:[{id:"kitchen-island",name:"Kitchen island",kind:"polyline",closed:!0,points:[[0,0],[100,0],[110,10],[200,10]],anchors:[{led:0,vertex_index:0},{led:85,vertex_index:1},{led:96,vertex_index:2},{led:186,vertex_index:3}]}]})),await this._load()}finally{this._busy=!1}var t}}async _applySegments(t){if(this.connection&&this.controllerId){this._busy=!0;try{await async function(t,e,i,s){return Ui(t,{type:"wled_studio/layout_to_segments",controller_id:e,layout_id:i,fixture_id:s})}(this.connection,this.controllerId,t),this._status="WLED segments updated from layout anchors"}catch(t){this._status=t instanceof Error?t.message:String(t)}finally{this._busy=!1}}}_openDesigner(t){this._activeLayoutId=String(t.id);const e=t.fixtures[0];this._activeFixtureId=e?String(e.id??"fixture-0"):"fixture-0",this._activePixelCount=t.pixel_count??210,this._viewMode="designer"}render(){return"designer"===this._viewMode?this._renderDesigner():this._renderList()}_renderList(){return V`
    ...
    `]}};t([ct({attribute:!1})],ko.prototype,"connection",void 0),t([ct()],ko.prototype,"controllerId",void 0),t([dt()],ko.prototype,"_layouts",void 0),t([dt()],ko.prototype,"_status",void 0),t([dt()],ko.prototype,"_busy",void 0),t([dt()],ko.prototype,"_viewMode",void 0),t([dt()],ko.prototype,"_activeLayoutId",void 0),t([dt()],ko.prototype,"_activeFixtureId",void 0),t([dt()],ko.prototype,"_activePixelCount",void 0),ko=t([pt("wled-view-layout")],ko);class Po extends Error{constructor(t,e){super("Scene conflict"),this.name="SceneConflictError",this.remote=t,this.etag=e}}async function Io(t,e){return await wt(t),t.sendMessagePromise({...e,schema_version:1})}async function Mo(t,e){return(await Io(t,{type:"wled_studio/scene_list",controller_id:e})).scenes??[]}let Ao=class extends vt{constructor(){super(...arguments),this.segments=[],this.selectedIds=[],this.segmentEntities=[],this.hint="Tap segments to toggle"}render(){return this.segments.length?V`
      <div class="block">
    ...
    `]}};t([ct({type:Array})],Ao.prototype,"segments",void 0),t([ct({type:Array})],Ao.prototype,"selectedIds",void 0),t([ct({type:Array})],Ao.prototype,"segmentEntities",void 0),t([ct()],Ao.prototype,"hint",void 0),Ao=t([pt("wled-segment-bar")],Ao);let $o=class extends vt{constructor(){super(...arguments),this.controllerId="",this.scenes=[],this.disabled=!1,this._recents=[],this._visibleCount=6}onPoweredConnect(){this._reload(),this._ro=new ResizeObserver(()=>this._measure()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._reload();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._rowEl&&(this._rowEl=e,this._ro?.observe(e),this._measure())}reload(){this._reload()}_reload(){var t;this._recents=(t=this.controllerId)?Ii(Pi)[t]??[]:[]}_measure(){const t=this._rowEl;if(!t)return;const e=$i(t.clientWidth,88,8,8);e!==this._visibleCount&&(this._visibleCount=e)}render(){const t=this._recents.filter(t=>this.scenes.some(e=>e.id===t.id)).slice(0,this._visibleCount);return t.length?V`
      <div class="block">
    ...
    `]}};t([ct()],$o.prototype,"controllerId",void 0),t([ct({type:Array})],$o.prototype,"scenes",void 0),t([ct({type:Boolean})],$o.prototype,"disabled",void 0),t([dt()],$o.prototype,"_recents",void 0),t([dt()],$o.prototype,"_visibleCount",void 0),$o=t([pt("wled-recent-scenes-row")],$o);let Eo=class extends vt{constructor(){super(...arguments),this.controllerId="",this._scenes=[],this._status="Loading scenes…",this._busy=!1,this._toast="",this._captureName="",this._segments=[],this._applySegIds=[]}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}onPoweredDisconnect(){this._applyAbort?.abort(),this._applyAbort=void 0}async _load(){if(this.connection&&this.controllerId){this._status="Loading scenes…";try{const[t,e]=await Promise.all([Mo(this.connection,this.controllerId),kt(this.connection,this.controllerId)]);if(this._scenes=t,this._snapshot=e,this._segments=[...e.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length&&!this._applySegIds.length)this._applySegIds=this._segments.map(t=>t.id);else{const t=new Set(this._segments.map(t=>t.id));this._applySegIds=this._applySegIds.filter(e=>t.has(e)),!this._applySegIds.length&&this._segments.length&&(this._applySegIds=this._segments.map(t=>t.id))}this._status=0===this._scenes.length?"No scenes yet — capture the current look or use starter scenes after reload.":""}catch{this._status="Could not load scenes."}}}selectSegmentFromPreview(t){this._toggleApplySeg(t)}_toggleApplySeg(t){let e=Lt(this._applySegIds,t);e.length||(e=[t]),this._applySegIds=e}render(){return V`
      <div class="wrap">
        <header class="head">
          <div>
            <h2>Scenes</h2>
    ...
    `]}};t([ct({attribute:!1})],Lo.prototype,"connection",void 0),t([dt()],Lo.prototype,"_controllers",void 0),t([dt()],Lo.prototype,"_status",void 0),t([dt()],Lo.prototype,"_cardUrl",void 0),t([dt()],Lo.prototype,"_cardToast",void 0),Lo=t([pt("wled-view-devices")],Lo);const To={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Ro=class extends vt{constructor(){super(...arguments),this.controllerId="",this._segments=[],this._editIds=[],this._focusSegId=0,this._filter="",this._status="Loading effects…",this._toast="",this._mergeActive=!1}onPoweredConnect(){this._mergeActive=Bt(this.controllerId),this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}async _load(){if(this.connection&&this.controllerId){this._status="Loading effects…";try{if(this._snapshot=await kt(this.connection,this.controllerId),this._segments=[...this._snapshot.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length){const t=this._segments.map(t=>t.id),e=this._editIds.filter(e=>t.includes(e));this._editIds=e.length?e:t,t.includes(this._focusSegId)||(this._focusSegId=this._segments[0].id)}this._mergeActive=Bt(this.controllerId),this._mergeActive&&(this._editIds=jt(this._segments),this._focusSegId=this._editIds[0]??0),await this._refreshMeta(),this._status=""}catch{this._status="Could not load device state."}}}_activeSeg(){return this._segments.find(t=>t.id===this._focusSegId)??this._segments[0]}async _refreshMeta(){const t=this._activeSeg();this.connection&&this.controllerId&&t&&(this._meta=await It(this.connection,this.controllerId,t.fx??0))}selectSegmentFromPreview(t){if(this._mergeActive)return this._focusSegId=0,void this._refreshMeta();this._editIds.includes(t)||(this._editIds=[...this._editIds,t].sort((t,e)=>t-e)),this._focusSegId=t,this._refreshMeta()}_onSegToggle(t){if(this._mergeActive)return;let e=Lt(this._editIds,t.detail.id);e.length||(e=[t.detail.id]),this._editIds=e,this._focusSegId=t.detail.id,this._refreshMeta()}_pixelCount(){const t=this._snapshot?.info?.leds;return Number(t?.count)||210}_targetIds(){if(this._mergeActive){const t=jt(this._segments);return t.length?t:[0]}return this._editIds.length?this._editIds:[this._focusSegId]}_onMergeChanged(){this._mergeActive=Bt(this.controllerId),this._load()}render(){const t=this._snapshot,e=this._activeSeg(),i=e?.fx??0,s=this._meta,n=s?.sliders??{},r=this._targetIds().length;return V`
      <div class="wrap">
        ...
        ${t&&e?V`
              ...
              <div class="sliders">
                ${Object.entries(To).map(([t,i])=>{if(!n[t])return null;const s=e[t];return V`
                    <label>
                      ${i}
                      <ha-slider
                        min="0"
    ...
    `]}};async function Fo(t,e){await wt(t);try{return await t.sendMessagePromise({...e,schema_version:1})}catch(t){throw new Error(Rt(t))}}async function Do(t,e,i=!0){await Fo(t,{type:"wled_studio/paint_stop",controller_id:e,commit:i})}t([ct({attribute:!1})],Ro.prototype,"connection",void 0),t([ct()],Ro.prototype,"controllerId",void 0),t([dt()],Ro.prototype,"_snapshot",void 0),t([dt()],Ro.prototype,"_segments",void 0),t([dt()],Ro.prototype,"_editIds",void 0),t([dt()],Ro.prototype,"_focusSegId",void 0),t([dt()],Ro.prototype,"_filter",void 0),t([dt()],Ro.prototype,"_status",void 0),t([dt()],Ro.prototype,"_toast",void 0),t([dt()],Ro.prototype,"_meta",void 0),t([dt()],Ro.prototype,"_mergeActive",void 0),Ro=t([pt("wled-view-effects")],Ro);let Oo=class extends vt{constructor(){super(...arguments),this.controllerId="",this._pixelCount=210,this._rgbw=!0,this._active=!1,this._color="#ff3366",this._brush=6,this._status="",this._warn="",this._buffer=null,this._ctx=null,this._painting=!1,this._flushDebounced=Ct(()=>{this._flushNow()},33,120)}updated(){this._canvas&&!this._ctx&&(this._ctx=this._canvas.getContext("2d"),this._drawStrip())}async onPoweredConnect(){if(this.connection&&this.controllerId)try{const t=await async function(t,e){return Fo(t,{type:"wled_studio/paint_start",controller_id:e})}(this.connection,this.controllerId);this._active=!0,this._warn=t.wifi_sleep_warning??"",t.pixel_count&&(this._pixelCount=t.pixel_count),"boolean"==typeof t.rgbw&&(this._rgbw=t.rgbw),this._allocBuffer(),this._status="Paint ready"}catch(t){this._status=Rt(t)}}async onPoweredDisconnect(){if(this._flushDebounced.cancel(),this._active&&this.connection&&this.controllerId)try{await Do(this.connection,this.controllerId,!0)}catch{}this._active=!1}_allocBuffer(){const t=this._rgbw?4:3;this._buffer=new Uint8Array(this._pixelCount*t);for(let e=0;e<this._pixelCount;e++){const i=e*t;this._buffer[i]=0,this._buffer[i+1]=0,this._buffer[i+2]=0,this._rgbw&&(this._buffer[i+3]=0)}}_parseColor(){const t=this._color.replace("#","");return t.length<6?[255,51,102]:[parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16)]}_strokeAt(t){if(!this._buffer)return;const[e,i,s]=this._parseColor(),n=this._rgbw?4:3,r=Math.max(1,Math.floor(this._brush/2));for(let o=-r;o<=r;o++){const r=t+o;if(r<0||r>=this._pixelCount)continue;const a=r*n;this._buffer[a]=e,this._buffer[a+1]=i,this._buffer[a+2]=s,this._rgbw&&(this._buffer[a+3]=0)}this._flushDebounced(),this._drawStrip()}async _flushNow(){if(this._active&&this.connection&&this._buffer)try{await async function(t,e,i,s=!0){let n="";for(let t=0;t<i.length;t++)n+=String.fromCharCode(i[t]);const r=btoa(n);await Fo(t,{type:"wled_studio/paint_frame",controller_id:e,data:r,rgbw:s})}(this.connection,this.controllerId,this._buffer,this._rgbw),this._status="Live paint"}catch(t){this._status=Rt(t)}}_drawStrip(){if(!this._ctx||!this._buffer)return;const t=this._canvas?.width??640,e=this._canvas?.height??48;this._ctx.clearRect(0,0,t,e);const i=this._rgbw?4:3,s=t/this._pixelCount;for(let t=0;t<this._pixelCount;t++){const n=t*i;this._ctx.fillStyle=`rgb(${this._buffer[n]},${this._buffer[n+1]},${this._buffer[n+2]})`,this._ctx.fillRect(t*s,0,Math.max(1,s),e)}}_onPointer(t){if(!this._canvas)return;const e=this._canvas.getBoundingClientRect(),i=t.clientX-e.left,s=Math.min(this._pixelCount-1,Math.max(0,Math.floor(i/e.width*this._pixelCount)));this._strokeAt(s)}async _commit(){this.connection&&(this._flushDebounced.cancel(),await this._flushNow(),await Do(this.connection,this.controllerId,!0),this._active=!1,this._status="Committed")}render(){return V`
      <section class="paint">
        <p class="lead">
    ...
    `]}};t([ct()],Uo.prototype,"controllerId",void 0),t([dt()],Uo.prototype,"_fft",void 0),t([dt()],Uo.prototype,"_peak",void 0),Uo=t([pt("wled-view-audio")],Uo);let Go=class extends vt{constructor(){super(...arguments),this.controllerId="",this._scenes=[]}async onPoweredConnect(){if(this.connection&&this.controllerId)try{this._scenes=await Mo(this.connection,this.controllerId)}catch{this._scenes=[]}}render(){return V`
      <section class="voice">
        <p>
    ...
    `]}};t([ct({attribute:!1})],zo.prototype,"connection",void 0),t([ct()],zo.prototype,"controllerId",void 0),t([dt()],zo.prototype,"_minutes",void 0),t([dt()],zo.prototype,"_status",void 0),zo=t([pt("wled-view-schedules")],zo);const Bo="wled-studio-panel",Vo="wled_studio.onboarded";let Wo=class extends vt{constructor(){super(...arguments),this._view="devices",this._controllerId="",this._controllers=[],this._drawerOpen=!1,this._previewSegId=-1,this._showOnboard=!1}onPoweredConnect(){try{this._showOnboard=!localStorage.getItem(Vo)}catch{this._showOnboard=!1}this._loadController()}async _loadController(){if(this.hass?.connection)try{const t=await St(this.hass.connection);if(this._controllers=t,this._controllerId&&t.some(t=>t.entry_id===this._controllerId))return;const e=t[0];e?.entry_id&&(this._controllerId=String(e.entry_id))}catch{}}_dismissOnboard(){try{localStorage.setItem(Vo,"1")}catch{}this._showOnboard=!1}_onControllerPick(t){const e=t.target.value;e&&(this._controllerId=e)}render(){const t=this.remote.state;return V`
    ...
    `:null}_onPreviewSegmentSelect(t){const e=t.detail.segmentId;this._previewSegId=e,"segments"===this._view?this.renderRoot.querySelector("wled-segment-controls")?.selectSegment(e):"effects"===this._view?this.renderRoot.querySelector("wled-view-effects")?.selectSegmentFromPreview(e):"scenes"===this._view&&this.renderRoot.querySelector("wled-view-scenes")?.selectSegmentFromPreview(e)}_livePreview(){return this.renderRoot.querySelector("wled-studio-live-preview")??null}refreshLivePreview(){this._livePreview()?.refreshSegments()}_renderView(){const t=this.hass?.connection,e=this._controllerId;return"devices"!==this._view&&"settings"!==this._view&&!e?V`
      ...
      `]}};t([dt()],Wo.prototype,"_view",void 0),t([dt()],Wo.prototype,"_controllerId",void 0),t([dt()],Wo.prototype,"_controllers",void 0),t([dt()],Wo.prototype,"_drawerOpen",void 0),t([dt()],Wo.prototype,"_previewSegId",void 0),t([dt()],Wo.prototype,"_showOnboard",void 0),Wo=t([pt(Bo)],Wo),customElements.get(Bo)||customElements.define(Bo,Wo),console.info("[wled-studio] panel bundle loaded",{panel:Bo});export{Bo as PANEL_TAG,Wo as WledStudioPanel};
