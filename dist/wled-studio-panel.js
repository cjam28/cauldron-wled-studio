...
`;class ft{constructor(t,e){this.host=t,this._hass=e,this._isRemote=!1,t.addController(this)}hostConnected(){this._refresh()}setHass(t){this._hass=t,this._refresh(),this.host.requestUpdate()}get state(){return{isRemote:this._isRemote,previewFps:this._isRemote?10:20,useBinaryPack:this._isRemote,disableBloom:this._isRemote}}_refresh(){if("undefined"==typeof location)return void(this._isRemote=!1);const t=location.hostname.endsWith(".ui.nabu.casa"),e=this._hass?.config?.external_url,i=!!e&&e.replace(/\/$/,"")===location.origin;this._isRemote=t||i}}const vt=[pt,_t];class gt extends ot{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new ft(this),this._visible=!0,this._inView=!0}static{this.styles=vt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}t([ht({attribute:!1})],gt.prototype,"hass",void 0);const mt=/^[0-9a-fA-F]+$/;function yt(t,e,i,s){let n,r=!1;const o=async()=>{n?.(),n=void 0,r||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let n=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&mt.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let r=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(r=t)}return{leds_hex:s,n:r,channels:n,scale:r/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:!1}))};o();const a=function(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}(t,()=>{o()});return()=>{r=!0,a(),n?.(),n=void 0}}async function bt(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",n),i(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function xt(t,e){await bt(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function wt(t,e,i,s){await bt(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}function $t(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function St(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function kt(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}function It(t,e){for(const i of e){if(kt(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}function At(t,e,i){const s=(i.length?i:[{id:t}]).map(i=>i.id===t?{...e,id:t,sel:!0,on:void 0!==e.on?e.on:!1===i.on||i.on}:{id:i.id,sel:!1});return{seg:s}}function Et(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:St(t.col),awm:t.awm};return JSON.stringify(e)}function Ct(t,e,i){let s,n=null,r=0;const o=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await xt(t,e)).segments??[]).find(t=>t.id===r);if(!s||!n)return;const o=Et(n);if(o===Et(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(St(t.col))!==JSON.stringify(St(e.col))}(n,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=function(t,e,i=100){let s,n,r;const o=()=>{if(s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,r){const e=r;r=void 0,t(...e)}},a=(...t)=>{r=t,s&&clearTimeout(s),s=setTimeout(o,e),n||(n=setTimeout(o,i))};return a.cancel=()=>{s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,r=void 0},a}((s,a)=>{n=a,r=a.id,wt(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(n={...a,...i,id:a.id}),o()}).catch(()=>{i(a,"Failed to apply state to WLED")})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var Pt,Mt,Ot,Rt,Lt,Tt={},Nt=[],Ut=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function Dt(t,e){for(var i in e)t[i]=e[i];return t}function zt(t){var e=t.parentNode;e&&e.removeChild(t)}function Ht(t,e,i){var s,n,r,o,a=arguments;if(e=Dt({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return o=e.key,null!=(r=e.ref)&&delete e.ref,null!=o&&delete e.key,jt(t,e,o,r)}function jt(t,e,i,s){var n={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return Pt.vnode&&Pt.vnode(n),n}function qt(t){return t.children}function Wt(t,e){this.props=t,this.context=e}function Ft(t,e){if(null==e)return t.__p?Ft(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?Ft(t):null}function Bt(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return Bt(t)}}function Vt(t){(!t.__d&&(t.__d=!0)&&1===Mt.push(t)||Rt!==Pt.debounceRendering)&&(Rt=Pt.debounceRendering,(Pt.debounceRendering||Ot)(Kt))}function Kt(){var t,e,i,s,n,r,o,a;for(Mt.sort(function(t,e){return e.__v.__b-t.__v.__b});t=Mt.pop();)t.__d&&(i=void 0,s=void 0,r=(n=(e=t).__v).__e,o=e.__P,a=e.u,e.u=!1,o&&(i=[],s=Qt(o,n,Dt({},n),e.__n,void 0!==o.ownerSVGElement,null,i,a,null==r?Ft(n):r),te(i,n),s!=r&&Bt(n)))}function Xt(t,e,i,s,n,r,o,a,l){var c,h,d,u,p,_,f,v=i&&i.__k||Nt,g=v.length;if(a==Tt&&(a=null!=r?r[0]:g?Ft(i,0):null),c=0,e.__k=Yt(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=v[c])||d&&i.key==d.key&&i.type===d.type)v[c]=void 0;else for(h=0;h<g;h++){if((d=v[h])&&i.key==d.key&&i.type===d.type){v[h]=void 0;break}d=null}if(u=Qt(t,i,d=d||Tt,s,n,r,o,null,a,l),(h=i.ref)&&d.ref!=h&&(f||(f=[])).push(h,i.__c||u,i),null!=u){if(null==_&&(_=u),null!=i.l)u=i.l,i.l=null;else if(r==d||u!=a||null==u.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(u);else{for(p=a,h=0;(p=p.nextSibling)&&h<g;h+=2)if(p==u)break t;t.insertBefore(u,a)}"option"==e.type&&(t.value="")}a=u.nextSibling,"function"==typeof e.type&&(e.l=u)}}return c++,i}),e.__e=_,null!=r&&"function"!=typeof e.type)for(c=r.length;c--;)null!=r[c]&&zt(r[c]);for(c=g;c--;)null!=v[c]&&se(v[c],v[c]);if(f)for(c=0;c<f.length;c++)ie(f[c],f[++c],f[++c])}function Yt(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)Yt(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return jt(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=jt(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function Jt(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===Ut.test(e)?i+"px":null==i?"":i}function Gt(t,e,i,s,n){var r,o,a,l,c;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(r=t.style,"string"==typeof i)r.cssText=i;else{if("string"==typeof s&&(r.cssText="",s=null),s)for(o in s)i&&o in i||Jt(r,o,"");if(i)for(a in i)s&&i[a]===s[a]||Jt(r,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),c=e.toLowerCase(),e=(c in t?c:e).slice(2),i?(s||t.addEventListener(e,Zt,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,Zt,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function Zt(t){return this.t[t.type](Pt.event?Pt.event(t):t)}function Qt(t,e,i,s,n,r,o,a,l,c){var h,d,u,p,_,f,v,g,m,y,b=e.type;if(void 0!==e.constructor)return null;(h=Pt.__b)&&h(e);try{t:if("function"==typeof b){if(g=e.props,m=(h=b.contextType)&&s[h.__c],y=h?m?m.props.value:h.__p:s,i.__c?v=(d=e.__c=i.__c).__p=d.__E:("prototype"in b&&b.prototype.render?e.__c=d=new b(g,y):(e.__c=d=new Wt(g,y),d.constructor=b,d.render=ne),m&&m.sub(d),d.props=g,d.state||(d.state={}),d.context=y,d.__n=s,u=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=b.getDerivedStateFromProps&&Dt(d.__s==d.state?d.__s=Dt({},d.__s):d.__s,b.getDerivedStateFromProps(g,d.__s)),u)null==b.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&o.push(d);else{if(null==b.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(g,y),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(g,d.__s,y)){for(d.props=g,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,h=0;h<e.__k.length;h++)e.__k[h]&&(e.__k[h].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(g,d.__s,y)}for(p=d.props,_=d.state,d.context=y,d.props=g,d.state=d.__s,(h=Pt.__r)&&h(e),d.__d=!1,d.__v=e,d.__P=t,h=d.render(d.props,d.state,d.context),e.__k=Yt(null!=h&&h.type==qt&&null==h.key?h.props.children:h),null!=d.getChildContext&&(s=Dt(Dt({},s),d.getChildContext())),u||null==d.getSnapshotBeforeUpdate||(f=d.getSnapshotBeforeUpdate(p,_)),Xt(t,e,i,s,n,r,o,l,c),d.base=e.__e;h=d.__h.pop();)d.__s&&(d.state=d.__s),h.call(d);u||null==p||null==d.componentDidUpdate||d.componentDidUpdate(p,_,f),v&&(d.__E=d.__p=null)}else e.__e=ee(i.__e,e,i,s,n,r,o,c);(h=Pt.diffed)&&h(e)}catch(t){Pt.__e(t,e,i)}return e.__e}function te(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){Pt.__e(t,i.__v)}Pt.__c&&Pt.__c(e)}function ee(t,e,i,s,n,r,o,a){var l,c,h,d,u=i.props,p=e.props;if(n="svg"===e.type||n,null==t&&null!=r)for(l=0;l<r.length;l++)if(null!=(c=r[l])&&(null===e.type?3===c.nodeType:c.localName===e.type)){t=c,r[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(p);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),r=null}return null===e.type?u!==p&&(null!=r&&(r[r.indexOf(t)]=null),t.data=p):e!==i&&(null!=r&&(r=Nt.slice.call(t.childNodes)),h=(u=i.props||Tt).dangerouslySetInnerHTML,d=p.dangerouslySetInnerHTML,a||(d||h)&&(d&&h&&d.__html==h.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,n){var r;for(r in i)r in e||Gt(t,r,null,i[r],s);for(r in e)n&&"function"!=typeof e[r]||"value"===r||"checked"===r||i[r]===e[r]||Gt(t,r,e[r],i[r],s)}(t,p,u,n,a),e.__k=e.props.children,d||Xt(t,e,i,s,"foreignObject"!==e.type&&n,r,o,Tt,a),a||("value"in p&&void 0!==p.value&&p.value!==t.value&&(t.value=null==p.value?"":p.value),"checked"in p&&void 0!==p.checked&&p.checked!==t.checked&&(t.checked=p.checked))),t}function ie(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){Pt.__e(t,i)}}function se(t,e,i){var s,n,r;if(Pt.unmount&&Pt.unmount(t),(s=t.ref)&&ie(s,null,e),i||"function"==typeof t.type||(i=null!=(n=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){Pt.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(r=0;r<s.length;r++)s[r]&&se(s[r],e,i);null!=n&&zt(n)}function ne(t,e,i){return this.constructor(t,i)}function re(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function oe(){return oe=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}return t},oe.apply(this,arguments)}Pt={},Wt.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=Dt({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&Dt(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),Vt(this))},Wt.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,Vt(this))},Wt.prototype.render=qt,Mt=[],Ot="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Rt=Pt.debounceRendering,Pt.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return Vt(s.__E=s)}catch(e){t=e}throw t},Lt=Tt;var ae="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",le="[\\s|\\(]+("+ae+")[,|\\s]+("+ae+")[,|\\s]+("+ae+")\\s*\\)?",ce="[\\s|\\(]+("+ae+")[,|\\s]+("+ae+")[,|\\s]+("+ae+")[,|\\s]+("+ae+")\\s*\\)?",he=new RegExp("rgb"+le),de=new RegExp("rgba"+ce),ue=new RegExp("hsl"+le),pe=new RegExp("hsla"+ce),_e="^(?:#?|0x?)",fe="([0-9a-fA-F]{1})",ve="([0-9a-fA-F]{2})",ge=new RegExp(_e+fe+fe+fe+"$"),me=new RegExp(_e+fe+fe+fe+fe+"$"),ye=new RegExp(_e+ve+ve+ve+"$"),be=new RegExp(_e+ve+ve+ve+ve+"$"),xe=Math.log,we=Math.round,$e=Math.floor;function Se(t,e,i){return Math.min(Math.max(t,e),i)}function ke(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function Ie(t){return parseInt(t,16)}function Ae(t){return t.toString(16).padStart(2,"0")}var Ee=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=oe({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=oe({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,n=$e(e),r=e-n,o=s*(1-i),a=s*(1-r*i),l=s*(1-(1-r)*i),c=n%6,h=[l,s,s,a,o,o][c],d=[o,o,l,s,s,a][c];return{r:Se(255*[s,a,o,o,l,s][c],0,255),g:Se(255*h,0,255),b:Se(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,n=Math.max(e,i,s),r=Math.min(e,i,s),o=n-r,a=0,l=n,c=0===n?0:o/n;switch(n){case r:a=0;break;case e:a=(i-s)/o+(i<s?6:0);break;case i:a=(s-e)/o+2;break;case s:a=(e-i)/o+4}return{h:60*a%360,s:Se(100*c,0,100),v:Se(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,n=s<=1?s:2-s,r=n<1e-9?0:e*i/n;return{h:t.h,s:Se(100*r,0,100),l:Se(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:Se(100*s,0,100),v:Se((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,n=t/100;return n<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=n-2)+104.49216199393888*xe(i),s=n<20?0:.8274096064007395*(s=n-10)-254.76935184120902+115.67994401066147*xe(s)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*xe(e),i=325.4494125711974+.07943456536662342*(i=n-50)-28.0852963507957*xe(i),s=255),{r:Se($e(e),0,255),g:Se($e(i),0,255),b:Se($e(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,n=e.b,r=2e3,o=4e4;o-r>.4;){i=.5*(o+r);var a=t.kelvinToRgb(i);a.b/a.r>=n/s?o=i:r=i}return i},re(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=oe({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return oe({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=oe({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=oe({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=oe({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=oe({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,n=e.b;return{r:we(i),g:we(s),b:we(n)}},set:function(e){this.hsv=oe({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return oe({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,n=e.l;return{h:we(i),s:we(s),l:we(n)}},set:function(e){this.hsv=oe({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return oe({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,n,r=1;if((e=he.exec(t))?(i=ke(e[1],255),s=ke(e[2],255),n=ke(e[3],255)):(e=de.exec(t))&&(i=ke(e[1],255),s=ke(e[2],255),n=ke(e[3],255),r=ke(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:n,a:r}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+Ae(t.r)+Ae(t.g)+Ae(t.b)},set:function(t){var e,i,s,n,r=255;if((e=ge.exec(t))?(i=17*Ie(e[1]),s=17*Ie(e[2]),n=17*Ie(e[3])):(e=me.exec(t))?(i=17*Ie(e[1]),s=17*Ie(e[2]),n=17*Ie(e[3]),r=17*Ie(e[4])):(e=ye.exec(t))?(i=Ie(e[1]),s=Ie(e[2]),n=Ie(e[3])):(e=be.exec(t))&&(i=Ie(e[1]),s=Ie(e[2]),n=Ie(e[3]),r=Ie(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:n,a:r/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+Ae(t.r)+Ae(t.g)+Ae(t.b)+Ae($e(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,n,r=1;if((e=ue.exec(t))?(i=ke(e[1],360),s=ke(e[2],100),n=ke(e[3],100)):(e=pe.exec(t))&&(i=ke(e[1],360),s=ke(e[2],100),n=ke(e[3],100),r=ke(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:n,a:r}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function Ce(t){var e,i=t.width,s=t.sliderSize,n=t.borderWidth,r=t.handleRadius,o=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*o+2*r,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*o-2*r,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-n/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function Pe(t,e){var i=Ce(t),s=i.width,n=i.height,r=i.handleRange,o=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var n=t.minTemperature,r=t.maxTemperature-n,o=(e.kelvin-n)/r*100;return Math.max(0,Math.min(o,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),c=a?s/2:n/2,h=o+l/100*r;return a&&(h=-1*h+r+2*o),{x:a?c:h,y:a?h:c}}var Me,Oe=2*Math.PI,Re=function(t,e){return Math.sqrt(t*t+e*e)};function Le(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function Te(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function Ne(t,e,i){var s=t.wheelAngle,n=t.wheelDirection;return i&&"clockwise"===n?e=s+e:"clockwise"===n?e=360-s+e:i&&"anticlockwise"===n?e=s+180-e:"anticlockwise"===n&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function Ue(t,e,i){var s=Te(t),n=s.cx,r=s.cy,o=Le(t);e=n-e,i=r-i;var a=Ne(t,Math.atan2(-i,-e)*(360/Oe)),l=Math.min(Re(e,i),o);return{h:Math.round(a),s:Math.round(100/o*l)}}function De(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function ze(t,e,i){var s=De(t),n=s.width,r=s.height,o=s.radius,a=(e-o)/(n-2*o)*100,l=(i-o)/(r-2*o)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function He(t){Me||(Me=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),n=window.location;return(i||s)&&Me.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function je(t,e,i,s){for(var n=0;n<s.length;n++){var r=s[n].x-e,o=s[n].y-i;if(Math.sqrt(r*r+o*o)<t.handleRadius)return n}return null}function qe(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function We(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function Fe(t){return"string"==typeof t?t:t+"px"}var Be=["mousemove","touchmove","mouseup","touchend"],Ve=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,r={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(r[s?"marginLeft":"marginTop"]=n),Ht(qt,null,t.children(this.uid,i,r))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,r=n.clientX-s.left,o=n.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(r,o,0)&&Be.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(r,o,1);break;case"mouseup":case"touchend":i(r,o,2),Be.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(Wt);function Ke(t){var e=t.r,i=t.url,s=e,n=e;return Ht("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+Fe(t.x)+", "+Fe(t.y)+")",willChange:"transform",top:Fe(-e),left:Fe(-e),width:Fe(2*e),height:Fe(2*e),position:"absolute",overflow:"visible"}},i&&Ht("use",Object.assign({xlinkHref:He(i)},t.props)),!i&&Ht("circle",{cx:s,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&Ht("circle",{cx:s,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function Xe(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=Ce(t),n=s.width,r=s.height,o=s.radius,a=Pe(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var n=[],r=t.minTemperature,o=t.maxTemperature,a=o-r,l=r,c=0;l<o;l+=a/8,c+=1){var h=Ee.kelvinToRgb(l),d=h.r,u=h.g,p=h.b;n.push([12.5*c,"rgb("+d+","+u+","+p+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var _=Ee.hsvToHsl({h:i.h,s:0,v:i.v}),f=Ee.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"],[100,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"]];default:var v=Ee.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+v.h+","+v.s+"%,"+v.l+"%)"]]}}(t,i);return Ht(Ve,Object.assign({},t,{onInput:function(e,s,n){var r=function(t,e,i){var s,n=Ce(t),r=n.handleRange,o=n.handleStart;s="horizontal"===t.layoutDirection?-1*i+r+o:e-o,s=Math.max(Math.min(s,r),0);var a=Math.round(100/r*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=r,t.onInput(n,t.id)}}),function(e,s,c){return Ht("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:Fe(n),height:Fe(r),borderRadius:Fe(o),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),Ht("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:Fe(o),background:We("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},qe(t))}),Ht(Ke,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function Ye(t){var e=De(t),i=e.width,s=e.height,n=e.radius,r=t.colors,o=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,c=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],h=r.map(function(e){return function(t,e){var i=De(t),s=i.width,n=i.height,r=i.radius,o=e.hsv,a=r,l=s-2*r,c=n-2*r;return{x:a+o.s/100*l,y:a+(c-o.v/100*c)}}(t,e)});return Ht(Ve,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var n=je(t,e,i,h);null!==n?o.setActiveColor(n):(o.inputActive=!0,l.hsv=ze(t,e,i),t.onInput(s,t.id))}else 1===s&&(o.inputActive=!0,l.hsv=ze(t,e,i));t.onInput(s,t.id)}}),function(e,o,a){return Ht("div",Object.assign({},o,{className:"IroBox",style:Object.assign({},{width:Fe(i),height:Fe(s),position:"relative"},a)}),Ht("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:Fe(n)},qe(t),{background:We("linear","to bottom",c[1])+","+We("linear","to right",c[0])})}),r.filter(function(t){return t!==l}).map(function(e){return Ht(Ke,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[e.index].x,y:h[e.index].y})}),Ht(Ke,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[l.index].x,y:h[l.index].y}))})}Ke.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},Xe.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function Je(t){var e=Te(t).width,i=t.colors;t.borderWidth;var s=t.parent,n=t.color,r=n.hsv,o=i.map(function(e){return function(t,e){var i=e.hsv,s=Te(t),n=s.cx,r=s.cy,o=Le(t),a=(180+Ne(t,i.h,!0))*(Oe/360),l=i.s/100*o,c="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*c,y:r+l*Math.sin(a)*c}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return Ht(Ve,Object.assign({},t,{onInput:function(e,i,r){if(0===r){if(!function(t,e,i){var s=Te(t),n=s.cx,r=s.cy,o=t.width/2;return Re(n-e,r-i)<o}(t,e,i))return!1;var a=je(t,e,i,o);null!==a?s.setActiveColor(a):(s.inputActive=!0,n.hsv=Ue(t,e,i),t.onInput(r,t.id))}else 1===r&&(s.inputActive=!0,n.hsv=Ue(t,e,i));t.onInput(r,t.id)}}),function(s,l,c){return Ht("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:Fe(e),height:Fe(e),position:"relative"},c)}),Ht("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),Ht("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&Ht("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-r.v/100})}),Ht("div",{className:"IroWheelBorder",style:Object.assign({},a,qe(t))}),i.filter(function(t){return t!==n}).map(function(e){return Ht(Ke,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[e.index].x,y:o[e.index].y})}),Ht(Ke,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[n.index].x,y:o[n.index].y}))})}var Ge=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new Ee(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(n[t]||(n[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:Je},{component:Xe}],e.transparency&&s.push({component:Xe,options:{sliderType:"alpha"}})),Ht("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var n=t.component,r=t.options;return Ht(n,Object.assign({},e,r,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(Wt);Ge.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var Ze,Qe,ti,ei=(Qe=function(t,e){var i,s=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,n,r;Pt.__p&&Pt.__p(t,e),n=(s=i===Lt)?null:e.__k,t=Ht(qt,null,[t]),r=[],Qt(e,e.__k=t,n||Tt,Tt,void 0!==e.ownerSVGElement,n?null:Nt.slice.call(e.childNodes),r,!1,Tt,s),te(r,t)}(Ht(Ze,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),i},Qe.prototype=(Ze=Ge).prototype,Object.assign(Qe,Ze),Qe.__component=Ze,Qe);!function(t){var e;t.version="5.5.2",t.Color=Ee,t.ColorPicker=ei,(e=t.ui||(t.ui={})).h=Ht,e.ComponentBase=Ve,e.Handle=Ke,e.Slider=Xe,e.Wheel=Je,e.Box=Ye}(ti||(ti={}));var ii=ti;let si=class extends gt{constructor(){super(...arguments),this.rgb=[255,128,0],this.white=0,this.awm=0,this.showWhite=!0,this._suppress=!1}updated(){this._host&&!this._picker&&(this._picker=ii.ColorPicker(this._host,{width:140,color:{r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},borderWidth:1,borderColor:"var(--divider-color, #444)",layout:[{component:ii.ui.Wheel}]}),this._picker.on("color:change",t=>{this._suppress||this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:[t.rgb.r,t.rgb.g,t.rgb.b],white:this.white},bubbles:!0,composed:!0}))}),this._syncPicker())}willUpdate(){this._picker&&this._syncPicker()}_syncPicker(){this._picker&&(this._suppress=!0,this._picker.color.rgb={r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},this._suppress=!1)}_onWhite(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:this.rgb,white:e},bubbles:!0,composed:!0}))}_onAwm(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("awm-change",{detail:{awm:e},bubbles:!0,composed:!0}))}render(){return W`
      <div class="wrap">
    ...
    `]}};t([ht({type:Object})],ri.prototype,"effectsByName",void 0),t([ht({type:Array})],ri.prototype,"soundFlags",void 0),t([ht({type:Number})],ri.prototype,"selectedFx",void 0),t([ht({type:String})],ri.prototype,"filter",void 0),t([ht()],ri.prototype,"controllerId",void 0),ri=t([ut("wled-effect-chips")],ri);let oi=class extends gt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return W`
    ...
    `]}};t([ht({type:Array})],oi.prototype,"presets",void 0),oi=t([ut("wled-preset-bar")],oi);const ai={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let li=class extends gt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this.selectedSegId=-1,this._loading=!0,this._error="",this._segId=0,this._segments=[],this._effectFilter="",this._presets=[],this._colorSlot=0,this._toast=""}onPoweredConnect(){this._load()}willUpdate(t){t.has("selectedSegId")&&this.selectedSegId>=0&&(this._segId=this.selectedSegId,this._refreshMeta()),(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&(this._optimistic?.cancel(),this._optimistic=Ct(this.connection,this.controllerId,(t,e)=>this._reconcile(t,e)),this._load())}onPoweredDisconnect(){this._optimistic?.cancel(),this._optimistic=void 0}selectSegment(t){this._selectSeg(t),this.dispatchEvent(new CustomEvent("segment-change",{detail:{segmentId:t},bubbles:!0,composed:!0}))}async _load(){if(this.connection&&this.controllerId){this._loading=!0,this._error="";try{const t=await xt(this.connection,this.controllerId);if(this._snapshot=t,this._segments=[...t.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length){const t=this._segments.map(t=>t.id);t.includes(this._segId)||(this._segId=this._segments[0].id)}await this._refreshMeta(),await this._loadPresets()}catch(t){this._error=t instanceof Error?t.message:String(t)}finally{this._loading=!1}}}async _loadPresets(){if(this.connection&&this.controllerId)try{const t=await async function(t,e){return(await t.sendMessagePromise({type:"wled_studio/get_presets",schema_version:1,controller_id:e})).presets??{}}(this.connection,this.controllerId),e=[];for(const[i,s]of Object.entries(t)){if(!s||"object"!=typeof s)continue;const t=s;e.push({id:i,name:String(t.n??t.name??`Preset ${i}`),ql:t.ql?String(t.ql):void 0})}e.sort((t,e)=>Number(t.id)-Number(e.id)),this._presets=e}catch{this._presets=[]}}_reconcile(t,e){const i=this._segments.findIndex(e=>e.id===t.id);if(i>=0){const e=[...this._segments];e[i]={...e[i],...t,id:t.id},this._segments=e}e?(this._toast=e,this.requestUpdate(),window.setTimeout(()=>{this._toast="",this.requestUpdate()},4e3)):this.requestUpdate()}_activeSeg(){return this._segments.find(t=>t.id===this._segId)??this._segments[0]}async _refreshMeta(){const t=this._activeSeg();this.connection&&this.controllerId&&t&&(this._meta=await async function(t,e,i){return(await t.sendMessagePromise({type:"wled_studio/effect_meta",schema_version:1,controller_id:e,effect_id:i})).meta??{sliders:{},colors_enabled:!0,palette_enabled:!0,flag:null,defaults:{}}}(this.connection,this.controllerId,t.fx??0))}async _syncHaSegment(t,e){if(!this.hass)return;const i=It(t.id,this._snapshot?.segment_entities??[]);if(!i)return;const s={entity_id:i};if(e.col?.length){const t=$t(e.col[0]);t[3]>0?s.rgbw_color=[t[0],t[1],t[2],t[3]]:s.rgb_color=[t[0],t[1],t[2]]}if(void 0!==e.bri&&(s.brightness=e.bri),void 0!==e.fx&&this._snapshot?.effects_by_name){const t=Object.entries(this._snapshot.effects_by_name).find(([,t])=>t===e.fx)?.[0];t&&(s.effect=t)}!1!==e.on?Object.keys(s).length>1&&await this.hass.callService("light","turn_on",s):await this.hass.callService("light","turn_off",{entity_id:i})}_patchSeg(t){const e=this._activeSeg();if(!e||!this._optimistic)return;const i={...e,...t,id:e.id,sel:!0,on:void 0!==t.on?t.on:!1!==e.on},s=this._segments.findIndex(t=>t.id===e.id);if(s>=0){const t=[...this._segments];t[s]=i,this._segments=t}this._syncHaSegment(e,t),this._optimistic.push(At(e.id,t,this._segments),i)}_selectSeg(t){this._segId=t,this._colorSlot=0,this._refreshMeta(),this.connection&&this.controllerId&&wt(this.connection,this.controllerId,At(t,{sel:!0},this._segments));const e=this._segments.findIndex(e=>e.id===t);if(e>=0){const e=this._segments.map(e=>({...e,sel:e.id===t}));this._segments=e}}async _onEffectSelect(t){this._patchSeg({fx:t.detail.effectId}),await this._refreshMeta()}_cols(t){const e=t.col??[],i=[];for(let t=0;t<3;t++)i.push($t(e[t]));return i}_onColor(t){const e=this._activeSeg();if(!e)return;const{rgb:i,white:s}=t.detail,n=this._cols(e);n[this._colorSlot]=[i[0],i[1],i[2],s],this._patchSeg({col:n.map(t=>[t[0],t[1],t[2],t[3]])})}_onAwm(t){this._patchSeg({awm:t.detail.awm})}_slider(t,e){const i=Number(e.target.value);this._patchSeg({[t]:i})}async _loadPreset(t){this.connection&&this.controllerId&&(await wt(this.connection,this.controllerId,{ps:Number(t)}),await this._load())}render(){if(this._loading)return W`<p class="muted">Loading segments…</p>`;if(this._error)return W`<p class="err">${this._error}</p>`;const t=this._activeSeg();if(!t)return W`<p class="muted">No segments on this controller.</p>`;const e=this._cols(t),i=e[this._colorSlot]??e[0],s=this._meta,n=s?.sliders??{},r=!1!==s?.colors_enabled?3:1;return W`
      <div class="controls ${this.compact?"compact":""}">
        ...
        <div class="sliders">
          ${Object.entries(ai).map(([e,i])=>{if(!n[e])return null;const s=t[e];return W`
              <label>
                ${i}
                <ha-slider
                  min="0"
    ...
    `}_labelForSeg(t){const e=this._snapshot?.segment_entities??[],i=e.find(e=>It(t.id,[e])===e.entity_id)??e.find(e=>e.segment_index===t.id);return`${i?.name?.replace(/^.*\s—\s/,"")??`Seg ${t.id+1}`} (${t.start??"?"}–${t.stop??"?"})`}get segments(){return this._segments}static{this.styles=[...vt,o`
      .controls {
        display: flex;
        flex-direction: column;
        gap: 10px;
    ...
    `]}};async function ci(t,e){return await bt(t),t.sendMessagePromise({...e,schema_version:1})}async function hi(t,e,i){return(await ci(t,{type:"wled_studio/layout_save",controller_id:e,layout:i})).layout??i}async function di(t,e,i,s){return(await ci(t,{type:"wled_studio/layout_resolve_positions",controller_id:e,fixture_id:i,layout_id:s})).positions??[]}t([ht({attribute:!1})],li.prototype,"connection",void 0),t([ht({attribute:!1})],li.prototype,"hass",void 0),t([ht()],li.prototype,"controllerId",void 0),t([ht({type:Boolean})],li.prototype,"compact",void 0),t([ht({type:Number})],li.prototype,"selectedSegId",void 0),t([dt()],li.prototype,"_loading",void 0),t([dt()],li.prototype,"_error",void 0),t([dt()],li.prototype,"_segId",void 0),t([dt()],li.prototype,"_segments",void 0),t([dt()],li.prototype,"_snapshot",void 0),t([dt()],li.prototype,"_meta",void 0),t([dt()],li.prototype,"_effectFilter",void 0),t([dt()],li.prototype,"_presets",void 0),t([dt()],li.prototype,"_colorSlot",void 0),t([dt()],li.prototype,"_toast",void 0),li=t([ut("wled-segment-controls")],li);const ui="#6366f1";function pi(t,e,i){return t+(e-t)*i}let _i=class extends gt{constructor(){super(...arguments),this.controllerId="",this.layoutId="",this.fixtureId="",this.pixelCount=210,this._vertices=[],this._ledPositions=[],this._selectedVtx=-1,this._anchorInput="",this._status="",this._busy=!1,this._drag=null,this._viewOx=0,this._viewOy=0,this._viewScale=1,this._onPointerDown=t=>{t.preventDefault();const[e,i]=this._canvasXY(t),s=this._hitVertex(e,i);s>=0&&(this._selectedVtx=s,this._anchorInput=String(this._vertices[s].anchorLed??""),this._drag={idx:s,ox:e,oy:i},this._canvas?.setPointerCapture(t.pointerId)),this._paint()},this._onPointerMove=t=>{if(!this._drag)return;const[e,i]=this._canvasXY(t),[s,n]=this._canvasToModel(e,i),r=[...this._vertices];r[this._drag.idx]={...r[this._drag.idx],x:s,y:n},this._vertices=r,this._paint()},this._onPointerUp=t=>{this._drag&&(this._canvas?.releasePointerCapture(t.pointerId),this._drag=null,this._refreshPositions())},this._onDblClick=t=>{const e=this._canvas.getBoundingClientRect(),i=t.clientX-e.left,s=t.clientY-e.top;if(this._hitVertex(i,s)>=0)return;const[n,r]=this._canvasToModel(i,s);this._vertices=[...this._vertices,{x:n,y:r,anchorLed:null}],this._selectedVtx=this._vertices.length-1,this._anchorInput="",this._paint(),this._refreshPositions()},this._onContextMenu=t=>{t.preventDefault();const e=this._canvas.getBoundingClientRect(),i=t.clientX-e.left,s=t.clientY-e.top,n=this._hitVertex(i,s);n<0||(this._vertices=this._vertices.filter((t,e)=>e!==n),this._selectedVtx===n?this._selectedVtx=-1:this._selectedVtx>n&&this._selectedVtx--,this._paint(),this._refreshPositions())}}onPoweredConnect(){this._loadLayout()}updated(t){super.updated(t),(t.has("connection")||t.has("layoutId")||t.has("fixtureId"))&&this._loadLayout()}firstUpdated(){this._canvas=this.renderRoot.querySelector("canvas")??void 0,this._canvas&&(this._ctx=this._canvas.getContext("2d",{alpha:!0})??void 0,this._canvas.addEventListener("pointerdown",this._onPointerDown),this._canvas.addEventListener("pointermove",this._onPointerMove),this._canvas.addEventListener("pointerup",this._onPointerUp),this._canvas.addEventListener("pointercancel",this._onPointerUp),this._canvas.addEventListener("dblclick",this._onDblClick),this._canvas.addEventListener("contextmenu",this._onContextMenu),this.addUnsub(()=>{this._canvas?.removeEventListener("pointerdown",this._onPointerDown),this._canvas?.removeEventListener("pointermove",this._onPointerMove),this._canvas?.removeEventListener("pointerup",this._onPointerUp),this._canvas?.removeEventListener("pointercancel",this._onPointerUp),this._canvas?.removeEventListener("dblclick",this._onDblClick),this._canvas?.removeEventListener("contextmenu",this._onContextMenu)})),this._resizeObs=new ResizeObserver(()=>this._onResize()),this._resizeObs.observe(this),this._onResize()}_onResize(){const t=this._canvas;if(!t)return;const e=this.getBoundingClientRect(),i=Math.max(400,e.width||400),s=Math.max(300,e.height||300);t.width===i&&t.height===s||(t.width=i,t.height=s),this._fitView(),this._paint()}_fitView(){if(0===this._vertices.length)return this._viewOx=40,this._viewOy=40,void(this._viewScale=1);const t=this._canvas;if(!t)return;let e=1/0,i=-1/0,s=1/0,n=-1/0;for(const t of this._vertices)t.x<e&&(e=t.x),t.x>i&&(i=t.x),t.y<s&&(s=t.y),t.y>n&&(n=t.y);const r=i-e||100,o=n-s||100,a=Math.min((t.width-96)/r,(t.height-96)/o,4);this._viewScale=a,this._viewOx=48-e*a,this._viewOy=48-s*a}_vtxToCanvas(t){return[t.x*this._viewScale+this._viewOx,t.y*this._viewScale+this._viewOy]}_canvasToModel(t,e){return[(t-this._viewOx)/this._viewScale,(e-this._viewOy)/this._viewScale]}_hitVertex(t,e){for(let i=this._vertices.length-1;i>=0;i--){const[s,n]=this._vtxToCanvas(this._vertices[i]);if(Math.hypot(t-s,e-n)<=14)return i}return-1}_canvasXY(t){const e=this._canvas.getBoundingClientRect();return[t.clientX-e.left,t.clientY-e.top]}_paint(){const t=this._ctx,e=this._canvas;if(!t||!e)return;const i=e.width,s=e.height;t.clearRect(0,0,i,s),t.fillStyle="#111827",t.fillRect(0,0,i,s);const n=this._vertices;if(0===n.length)return t.fillStyle="rgba(255,255,255,0.25)",t.font="14px sans-serif",t.textAlign="center",void t.fillText("Double-click to add vertices",i/2,s/2);t.fillStyle="rgba(120,220,120,0.65)";for(const{x:e,y:i}of this._ledPositions){const s=e*this._viewScale+this._viewOx,n=i*this._viewScale+this._viewOy;t.beginPath(),t.arc(s,n,3,0,2*Math.PI),t.fill()}if(n.length>=2){t.beginPath(),t.strokeStyle="rgba(99,102,241,0.6)",t.lineWidth=2;const[e,i]=this._vtxToCanvas(n[0]);t.moveTo(e,i);for(let e=1;e<n.length;e++){const[i,s]=this._vtxToCanvas(n[e]);t.lineTo(i,s)}t.stroke()}for(let e=0;e<n.length;e++){const i=n[e],[s,r]=this._vtxToCanvas(i),o=null!==i.anchorLed,a=e===this._selectedVtx,l=o?9:7;t.beginPath(),t.arc(s,r,l,0,2*Math.PI),t.fillStyle=a?"white":o?"#f59e0b":ui,t.fill(),a&&(t.strokeStyle=ui,t.lineWidth=2,t.stroke()),o&&null!==i.anchorLed&&(t.fillStyle="#111",t.font=`bold ${Math.max(9,l-1)}px monospace`,t.textAlign="center",t.textBaseline="middle",t.fillText(String(i.anchorLed),s,r)),t.fillStyle="rgba(255,255,255,0.5)",t.font="10px sans-serif",t.textBaseline="bottom",t.textAlign="left",t.fillText(`v${e}`,s+l+2,r-2)}}async _loadLayout(){if(this.connection&&this.controllerId&&this.layoutId)try{const t=await async function(t,e,i){return(await ci(t,{type:"wled_studio/layout_get",controller_id:e,layout_id:i})).layout??null}(this.connection,this.controllerId,this.layoutId);if(!t)return;const e=this._findFixture(t);if(!e)return void(this._vertices=[]);const i=e.points??[],s=e.anchors??[],n=new Map(s.map(t=>[t.vertex_index,t.led]));this._vertices=i.map((t,e)=>({x:t[0],y:t[1],anchorLed:n.get(e)??null})),this._fitView(),await this._refreshPositions(),this._paint()}catch(t){this._status=t instanceof Error?t.message:String(t)}}_findFixture(t){const e=t.fixtures??[];return this.fixtureId?e.find(t=>t.id===this.fixtureId)??null:e[0]??null}async _refreshPositions(){if(this.connection&&this.controllerId&&this.fixtureId)try{this._ledPositions=await di(this.connection,this.controllerId,this.fixtureId,this.layoutId||void 0),this._paint()}catch{this._ledPositions=[]}}_buildLayout(){const t=this._vertices.map(t=>[t.x,t.y]),e=this._vertices.map((t,e)=>null!==t.anchorLed?{led:t.anchorLed,vertex_index:e}:null).filter(t=>null!==t);return{id:this.layoutId||"layout-0",controller_id:this.controllerId,name:"Layout",pixel_count:this.pixelCount,fixtures:[{id:this.fixtureId||"fixture-0",name:"Fixture",kind:"polyline",closed:!1,points:t,anchors:e}]}}async _save(){if(this.connection&&this.controllerId&&!this._busy){this._busy=!0,this._status="Saving…";try{await hi(this.connection,this.controllerId,this._buildLayout()),this._status="Saved",await this._refreshPositions()}catch(t){this._status=t instanceof Error?t.message:String(t)}finally{this._busy=!1}}}_setAnchorLed(){const t=this._selectedVtx;if(t<0)return;const e=this._anchorInput.trim(),i=""===e?null:parseInt(e,10);if(null!==i&&(isNaN(i)||i<0||i>=this.pixelCount))return;const s=[...this._vertices];s[t]={...s[t],anchorLed:i},this._vertices=s,this._paint()}_mirrorSliderMax(){return Math.max(0,this.pixelCount-1)}_onMirrorSlider(t){const e=t.target,i=parseInt(e.value,10);if(isNaN(i)||0===this._vertices.length)return;const s=[...this._vertices];for(let t=0;t<s.length;t++){const e=s[t].anchorLed;if(null===e)continue;const n=e/this._mirrorSliderMax(),r=Math.round(pi(0,i,n));s[t]={...s[t],anchorLed:r}}this._vertices=s,this._paint()}render(){const t=this._vertices[this._selectedVtx];return W`
      <div class="designer">
    ...
    `}_toggleDrawer(){}static{this.styles=[...vt,o`
        .shell {
          display: grid;
          grid-template-columns: 1fr;
          min-height: 100%;
