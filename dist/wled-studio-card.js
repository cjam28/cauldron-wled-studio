...
`];class bt extends ot{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new mt(this),this._visible=!0,this._inView=!0}static{this.styles=_t}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}t([ht({attribute:!1})],bt.prototype,"hass",void 0);const vt="0.11.5";function yt(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}const wt=/^[0-9a-fA-F]+$/;function xt(t,e,i,s){let r,n=!1;const o=async()=>{r?.(),r=void 0,n||(r=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let r=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&wt.test(e)){if(8===e.length)r=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let n=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(n=t)}return{leds_hex:s,n:n,channels:r,scale:n/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:s?.remote??!1}))};o();const a=yt(t,()=>{o()});return()=>{n=!0,a(),r?.(),r=void 0}}async function $t(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",r),i(new Error("Home Assistant WebSocket not connected"))},15e3),r=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",r),e())};t.addEventListener("ready",r)})}async function St(t){await $t(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,i=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${i}`)}}function It(t,e,i=100){let s,r,n;const o=()=>{if(s&&clearTimeout(s),r&&clearTimeout(r),s=r=void 0,n){const e=n;n=void 0,t(...e)}},a=(...t)=>{n=t,s&&clearTimeout(s),s=setTimeout(o,e),r||(r=setTimeout(o,i))};return a.cancel=()=>{s&&clearTimeout(s),r&&clearTimeout(r),s=r=void 0,n=void 0},a}async function kt(t,e){await $t(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function Ct(t,e,i,s){await $t(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}async function Pt(t,e,i){return(await t.sendMessagePromise({type:"wled_studio/effect_meta",schema_version:1,controller_id:e,effect_id:i})).meta??{sliders:{},colors_enabled:!0,palette_enabled:!0,flag:null,defaults:{}}}async function Mt(t,e){await $t(t);return(await t.sendMessagePromise({type:"wled_studio/get_palette_previews",schema_version:1,controller_id:e})).palette_previews??{}}function Et(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function At(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function Tt(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}function Lt(t,e){for(const i of e){if(i.wled_segment_id===t)return i.entity_id;if(Tt(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}function Dt(t,e,i){const s=new Set(t),r=(i.length?i:t.map(t=>({id:t}))).map(t=>s.has(t.id)?{...e,id:t.id,sel:!0,on:void 0!==e.on?e.on:!1===t.on||t.on}:{id:t.id,sel:!1});return{seg:r}}async function Nt(t,e){return await $t(t),t.sendMessagePromise({...e,schema_version:1})}async function Bt(t,e){return(await Nt(t,{type:"wled_studio/layout_list",controller_id:e})).layouts??[]}function Ot(t){if(!t)return 0;const e=t.attributes?.brightness_pct;if("number"==typeof e&&Number.isFinite(e))return Math.max(0,Math.min(100,Math.round(e)));const i=t.attributes?.brightness;return"number"==typeof i&&Number.isFinite(i)?Math.round(Math.max(0,Math.min(255,i))/255*100):"on"===t.state?100:0}function Rt(t){return Math.round(Math.max(0,Math.min(100,t))/100*255)}class Ft{constructor(t){this.host=t,this._selectedSegId=-1,this._highlightSegIds=[],this._segments=[],t.addController(this)}hostConnected(){}get selectedSegId(){return this._selectedSegId}get highlightSegIds(){return this._highlightSegIds}get segments(){return this._segments}selectSegment(t){this._selectedSegId!==t&&(this._selectedSegId=t,this.host.requestUpdate())}applyTargetsChanged(t){this._selectedSegId=t.segmentId,t.highlightIds?.length?this._highlightSegIds=[...t.highlightIds]:t.editIds?.length?this._highlightSegIds=[...t.editIds]:this._highlightSegIds=[t.segmentId],this.host.requestUpdate()}applySegmentChange(t){this._selectedSegId=t.segmentId,t.editIds?.length&&(this._highlightSegIds=[...t.editIds]),this.host.requestUpdate()}setSegments(t){this._segments=t,this.host.requestUpdate()}}function zt(t){return t<0?-1:0===t?0:1}function Ut(t,e,i){return(1-i)*t+i*e}function Ht(t,e,i){return i<t?t:i>e?e:i}function jt(t){return(t%=360)<0&&(t+=360),t}function Wt(t,e){return[t[0]*e[0][0]+t[1]*e[0][1]+t[2]*e[0][2],t[0]*e[1][0]+t[1]*e[1][1]+t[2]*e[1][2],t[0]*e[2][0]+t[1]*e[2][1]+t[2]*e[2][2]]}const Vt=[[.41233895,.35762064,.18051042],[.2126,.7152,.0722],[.01932141,.11916382,.95034478]],qt=[[3.2413774792388685,-1.5376652402851851,-.49885366846268053],[-.9691452513005321,1.8758853451067872,.04156585616912061],[.05562093689691305,-.20395524564742123,1.0571799111220335]],Gt=[95.047,100,108.883];function Yt(t,e,i){return(255<<24|(255&t)<<16|(255&e)<<8|255&i)>>>0}function Kt(t){return Yt(se(t[0]),se(t[1]),se(t[2]))}function Xt(t){return t>>16&255}function Jt(t){return t>>8&255}function Zt(t){return 255&t}function Qt(t){const e=function(t){return Wt([ie(Xt(t)),ie(Jt(t)),ie(Zt(t))],Vt)}(t)[1];return 116*re(e/100)-16}function te(t){return 100*function(t){const e=216/24389,i=24389/27,s=t*t*t;return s>e?s:(116*t-16)/i}((t+16)/116)}function ee(t){return 116*re(t/100)-16}function ie(t){const e=t/255;return e<=.040449936?e/12.92*100:100*Math.pow((e+.055)/1.055,2.4)}function se(t){const e=t/100;let i=0;return i=e<=.0031308?12.92*e:1.055*Math.pow(e,1/2.4)-.055,s=0,r=255,(n=Math.round(255*i))<s?s:n>r?r:n;var s,r,n}function re(t){const e=24389/27;return t>216/24389?Math.pow(t,1/3):(e*t+16)/116}class ne{static make(t=function(){return Gt}(),e=200/Math.PI*te(50)/100,i=50,s=2,r=!1){const n=t,o=.401288*n[0]+.650173*n[1]+-.051461*n[2],a=-.250268*n[0]+1.204414*n[1]+.045854*n[2],l=-.002079*n[0]+.048952*n[1]+.953127*n[2],c=.8+s/10,h=c>=.9?Ut(.59,.69,10*(c-.9)):Ut(.525,.59,10*(c-.8));let d=r?1:c*(1-1/3.6*Math.exp((-e-42)/92));d=d>1?1:d<0?0:d;const p=c,u=[d*(100/o)+1-d,d*(100/a)+1-d,d*(100/l)+1-d],g=1/(5*e+1),f=g*g*g*g,m=1-f,_=f*e+.1*m*m*Math.cbrt(5*e),b=te(i)/t[1],v=1.48+Math.sqrt(b),y=.725/Math.pow(b,.2),w=y,x=[Math.pow(_*u[0]*o/100,.42),Math.pow(_*u[1]*a/100,.42),Math.pow(_*u[2]*l/100,.42)],$=[400*x[0]/(x[0]+27.13),400*x[1]/(x[1]+27.13),400*x[2]/(x[2]+27.13)];return new ne(b,(2*$[0]+$[1]+.05*$[2])*y,y,w,h,p,u,_,Math.pow(_,.25),v)}constructor(t,e,i,s,r,n,o,a,l,c){this.n=t,this.aw=e,this.nbb=i,this.ncb=s,this.c=r,this.nc=n,this.rgbD=o,this.fl=a,this.fLRoot=l,this.z=c}}ne.DEFAULT=ne.make();class oe{constructor(t,e,i,s,r,n,o,a,l){this.hue=t,this.chroma=e,this.j=i,this.q=s,this.m=r,this.s=n,this.jstar=o,this.astar=a,this.bstar=l}distance(t){const e=this.jstar-t.jstar,i=this.astar-t.astar,s=this.bstar-t.bstar,r=Math.sqrt(e*e+i*i+s*s);return 1.41*Math.pow(r,.63)}static fromInt(t){return oe.fromIntInViewingConditions(t,ne.DEFAULT)}static fromIntInViewingConditions(t,e){const i=(65280&t)>>8,s=255&t,r=ie((16711680&t)>>16),n=ie(i),o=ie(s),a=.41233895*r+.35762064*n+.18051042*o,l=.2126*r+.7152*n+.0722*o,c=.01932141*r+.11916382*n+.95034478*o,h=.401288*a+.650173*l-.051461*c,d=-.250268*a+1.204414*l+.045854*c,p=-.002079*a+.048952*l+.953127*c,u=e.rgbD[0]*h,g=e.rgbD[1]*d,f=e.rgbD[2]*p,m=Math.pow(e.fl*Math.abs(u)/100,.42),_=Math.pow(e.fl*Math.abs(g)/100,.42),b=Math.pow(e.fl*Math.abs(f)/100,.42),v=400*zt(u)*m/(m+27.13),y=400*zt(g)*_/(_+27.13),w=400*zt(f)*b/(b+27.13),x=(11*v+-12*y+w)/11,$=(v+y-2*w)/9,S=(20*v+20*y+21*w)/20,I=(40*v+20*y+w)/20,k=180*Math.atan2($,x)/Math.PI,C=k<0?k+360:k>=360?k-360:k,P=C*Math.PI/180,M=I*e.nbb,E=100*Math.pow(M/e.aw,e.c*e.z),A=4/e.c*Math.sqrt(E/100)*(e.aw+4)*e.fLRoot,T=C<20.14?C+360:C,L=5e4/13*(.25*(Math.cos(T*Math.PI/180+2)+3.8))*e.nc*e.ncb*Math.sqrt(x*x+$*$)/(S+.305),D=Math.pow(L,.9)*Math.pow(1.64-Math.pow(.29,e.n),.73),N=D*Math.sqrt(E/100),B=N*e.fLRoot,O=50*Math.sqrt(D*e.c/(e.aw+4)),R=(1+100*.007)*E/(1+.007*E),F=1/.0228*Math.log(1+.0228*B),z=F*Math.cos(P),U=F*Math.sin(P);return new oe(C,N,E,A,B,O,R,z,U)}static fromJch(t,e,i){return oe.fromJchInViewingConditions(t,e,i,ne.DEFAULT)}static fromJchInViewingConditions(t,e,i,s){const r=4/s.c*Math.sqrt(t/100)*(s.aw+4)*s.fLRoot,n=e*s.fLRoot,o=e/Math.sqrt(t/100),a=50*Math.sqrt(o*s.c/(s.aw+4)),l=i*Math.PI/180,c=(1+100*.007)*t/(1+.007*t),h=1/.0228*Math.log(1+.0228*n),d=h*Math.cos(l),p=h*Math.sin(l);return new oe(i,e,t,r,n,a,c,d,p)}static fromUcs(t,e,i){return oe.fromUcsInViewingConditions(t,e,i,ne.DEFAULT)}static fromUcsInViewingConditions(t,e,i,s){const r=e,n=i,o=Math.sqrt(r*r+n*n),a=(Math.exp(.0228*o)-1)/.0228/s.fLRoot;let l=Math.atan2(n,r)*(180/Math.PI);l<0&&(l+=360);const c=t/(1-.007*(t-100));return oe.fromJchInViewingConditions(c,a,l,s)}toInt(){return this.viewed(ne.DEFAULT)}viewed(t){const e=0===this.chroma||0===this.j?0:this.chroma/Math.sqrt(this.j/100),i=Math.pow(e/Math.pow(1.64-Math.pow(.29,t.n),.73),1/.9),s=this.hue*Math.PI/180,r=.25*(Math.cos(s+2)+3.8),n=t.aw*Math.pow(this.j/100,1/t.c/t.z),o=r*(5e4/13)*t.nc*t.ncb,a=n/t.nbb,l=Math.sin(s),c=Math.cos(s),h=23*(a+.305)*i/(23*o+11*i*c+108*i*l),d=h*c,p=h*l,u=(460*a+451*d+288*p)/1403,g=(460*a-891*d-261*p)/1403,f=(460*a-220*d-6300*p)/1403,m=Math.max(0,27.13*Math.abs(u)/(400-Math.abs(u))),_=zt(u)*(100/t.fl)*Math.pow(m,1/.42),b=Math.max(0,27.13*Math.abs(g)/(400-Math.abs(g))),v=zt(g)*(100/t.fl)*Math.pow(b,1/.42),y=Math.max(0,27.13*Math.abs(f)/(400-Math.abs(f))),w=zt(f)*(100/t.fl)*Math.pow(y,1/.42),x=_/t.rgbD[0],$=v/t.rgbD[1],S=w/t.rgbD[2],I=function(t,e,i){const s=qt,r=s[0][0]*t+s[0][1]*e+s[0][2]*i,n=s[1][0]*t+s[1][1]*e+s[1][2]*i,o=s[2][0]*t+s[2][1]*e+s[2][2]*i;return Yt(se(r),se(n),se(o))}(1.86206786*x-1.01125463*$+.14918677*S,.38752654*x+.62144744*$-.00897398*S,-.0158415*x-.03412294*$+1.04996444*S);return I}static fromXyzInViewingConditions(t,e,i,s){const r=.401288*t+.650173*e-.051461*i,n=-.250268*t+1.204414*e+.045854*i,o=-.002079*t+.048952*e+.953127*i,a=s.rgbD[0]*r,l=s.rgbD[1]*n,c=s.rgbD[2]*o,h=Math.pow(s.fl*Math.abs(a)/100,.42),d=Math.pow(s.fl*Math.abs(l)/100,.42),p=Math.pow(s.fl*Math.abs(c)/100,.42),u=400*zt(a)*h/(h+27.13),g=400*zt(l)*d/(d+27.13),f=400*zt(c)*p/(p+27.13),m=(11*u+-12*g+f)/11,_=(u+g-2*f)/9,b=(20*u+20*g+21*f)/20,v=(40*u+20*g+f)/20,y=180*Math.atan2(_,m)/Math.PI,w=y<0?y+360:y>=360?y-360:y,x=w*Math.PI/180,$=v*s.nbb,S=100*Math.pow($/s.aw,s.c*s.z),I=4/s.c*Math.sqrt(S/100)*(s.aw+4)*s.fLRoot,k=w<20.14?w+360:w,C=5e4/13*(1/4*(Math.cos(k*Math.PI/180+2)+3.8))*s.nc*s.ncb*Math.sqrt(m*m+_*_)/(b+.305),P=Math.pow(C,.9)*Math.pow(1.64-Math.pow(.29,s.n),.73),M=P*Math.sqrt(S/100),E=M*s.fLRoot,A=50*Math.sqrt(P*s.c/(s.aw+4)),T=(1+100*.007)*S/(1+.007*S),L=Math.log(1+.0228*E)/.0228,D=L*Math.cos(x),N=L*Math.sin(x);return new oe(w,M,S,I,E,A,T,D,N)}xyzInViewingConditions(t){const e=0===this.chroma||0===this.j?0:this.chroma/Math.sqrt(this.j/100),i=Math.pow(e/Math.pow(1.64-Math.pow(.29,t.n),.73),1/.9),s=this.hue*Math.PI/180,r=.25*(Math.cos(s+2)+3.8),n=t.aw*Math.pow(this.j/100,1/t.c/t.z),o=r*(5e4/13)*t.nc*t.ncb,a=n/t.nbb,l=Math.sin(s),c=Math.cos(s),h=23*(a+.305)*i/(23*o+11*i*c+108*i*l),d=h*c,p=h*l,u=(460*a+451*d+288*p)/1403,g=(460*a-891*d-261*p)/1403,f=(460*a-220*d-6300*p)/1403,m=Math.max(0,27.13*Math.abs(u)/(400-Math.abs(u))),_=zt(u)*(100/t.fl)*Math.pow(m,1/.42),b=Math.max(0,27.13*Math.abs(g)/(400-Math.abs(g))),v=zt(g)*(100/t.fl)*Math.pow(b,1/.42),y=Math.max(0,27.13*Math.abs(f)/(400-Math.abs(f))),w=zt(f)*(100/t.fl)*Math.pow(y,1/.42),x=_/t.rgbD[0],$=v/t.rgbD[1],S=w/t.rgbD[2];return[1.86206786*x-1.01125463*$+.14918677*S,.38752654*x+.62144744*$-.00897398*S,-.0158415*x-.03412294*$+1.04996444*S]}}class ae{static sanitizeRadians(t){return(t+8*Math.PI)%(2*Math.PI)}static trueDelinearized(t){const e=t/100;let i=0;return i=e<=.0031308?12.92*e:1.055*Math.pow(e,1/2.4)-.055,255*i}static chromaticAdaptation(t){const e=Math.pow(Math.abs(t),.42);return 400*zt(t)*e/(e+27.13)}static hueOf(t){const e=Wt(t,ae.SCALED_DISCOUNT_FROM_LINRGB),i=ae.chromaticAdaptation(e[0]),s=ae.chromaticAdaptation(e[1]),r=ae.chromaticAdaptation(e[2]),n=(11*i+-12*s+r)/11,o=(i+s-2*r)/9;return Math.atan2(o,n)}static areInCyclicOrder(t,e,i){return ae.sanitizeRadians(e-t)<ae.sanitizeRadians(i-t)}static intercept(t,e,i){return(e-t)/(i-t)}static lerpPoint(t,e,i){return[t[0]+(i[0]-t[0])*e,t[1]+(i[1]-t[1])*e,t[2]+(i[2]-t[2])*e]}static setCoordinate(t,e,i,s){const r=ae.intercept(t[s],e,i[s]);return ae.lerpPoint(t,r,i)}static isBounded(t){return 0<=t&&t<=100}static nthVertex(t,e){const i=ae.Y_FROM_LINRGB[0],s=ae.Y_FROM_LINRGB[1],r=ae.Y_FROM_LINRGB[2],n=e%4<=1?0:100,o=e%2==0?0:100;if(e<4){const e=n,a=o,l=(t-e*s-a*r)/i;return ae.isBounded(l)?[l,e,a]:[-1,-1,-1]}if(e<8){const e=n,a=o,l=(t-a*i-e*r)/s;return ae.isBounded(l)?[a,l,e]:[-1,-1,-1]}{const e=n,a=o,l=(t-e*i-a*s)/r;return ae.isBounded(l)?[e,a,l]:[-1,-1,-1]}}static bisectToSegment(t,e){let i=[-1,-1,-1],s=i,r=0,n=0,o=!1,a=!0;for(let l=0;l<12;l++){const c=ae.nthVertex(t,l);if(c[0]<0)continue;const h=ae.hueOf(c);o?(a||ae.areInCyclicOrder(r,h,n))&&(a=!1,ae.areInCyclicOrder(r,e,h)?(s=c,n=h):(i=c,r=h)):(i=c,s=c,r=h,n=h,o=!0)}return[i,s]}static midpoint(t,e){return[(t[0]+e[0])/2,(t[1]+e[1])/2,(t[2]+e[2])/2]}static criticalPlaneBelow(t){return Math.floor(t-.5)}static criticalPlaneAbove(t){return Math.ceil(t-.5)}static bisectToLimit(t,e){const i=ae.bisectToSegment(t,e);let s=i[0],r=ae.hueOf(s),n=i[1];for(let t=0;t<3;t++)if(s[t]!==n[t]){let i=-1,o=255;s[t]<n[t]?(i=ae.criticalPlaneBelow(ae.trueDelinearized(s[t])),o=ae.criticalPlaneAbove(ae.trueDelinearized(n[t]))):(i=ae.criticalPlaneAbove(ae.trueDelinearized(s[t])),o=ae.criticalPlaneBelow(ae.trueDelinearized(n[t])));for(let a=0;a<8&&!(Math.abs(o-i)<=1);a++){const a=Math.floor((i+o)/2),l=ae.CRITICAL_PLANES[a],c=ae.setCoordinate(s,l,n,t),h=ae.hueOf(c);ae.areInCyclicOrder(r,e,h)?(n=c,o=a):(s=c,r=h,i=a)}}return ae.midpoint(s,n)}static inverseChromaticAdaptation(t){const e=Math.abs(t),i=Math.max(0,27.13*e/(400-e));return zt(t)*Math.pow(i,1/.42)}static findResultByJ(t,e,i){let s=11*Math.sqrt(i);const r=ne.DEFAULT,n=1/Math.pow(1.64-Math.pow(.29,r.n),.73),o=.25*(Math.cos(t+2)+3.8)*(5e4/13)*r.nc*r.ncb,a=Math.sin(t),l=Math.cos(t);for(let t=0;t<5;t++){const c=s/100,h=0===e||0===s?0:e/Math.sqrt(c),d=Math.pow(h*n,1/.9),p=r.aw*Math.pow(c,1/r.c/r.z)/r.nbb,u=23*(p+.305)*d/(23*o+11*d*l+108*d*a),g=u*l,f=u*a,m=(460*p+451*g+288*f)/1403,_=(460*p-891*g-261*f)/1403,b=(460*p-220*g-6300*f)/1403,v=Wt([ae.inverseChromaticAdaptation(m),ae.inverseChromaticAdaptation(_),ae.inverseChromaticAdaptation(b)],ae.LINRGB_FROM_SCALED_DISCOUNT);if(v[0]<0||v[1]<0||v[2]<0)return 0;const y=ae.Y_FROM_LINRGB[0],w=ae.Y_FROM_LINRGB[1],x=ae.Y_FROM_LINRGB[2],$=y*v[0]+w*v[1]+x*v[2];if($<=0)return 0;if(4===t||Math.abs($-i)<.002)return v[0]>100.01||v[1]>100.01||v[2]>100.01?0:Kt(v);s-=($-i)*s/(2*$)}return 0}static solveToInt(t,e,i){if(e<1e-4||i<1e-4||i>99.9999)return function(t){const e=se(te(t));return Yt(e,e,e)}(i);const s=(t=jt(t))/180*Math.PI,r=te(i),n=ae.findResultByJ(s,e,r);if(0!==n)return n;return Kt(ae.bisectToLimit(r,s))}static solveToCam(t,e,i){return oe.fromInt(ae.solveToInt(t,e,i))}}ae.SCALED_DISCOUNT_FROM_LINRGB=[[.001200833568784504,.002389694492170889,.0002795742885861124],[.0005891086651375999,.0029785502573438758,.0003270666104008398],[.00010146692491640572,.0005364214359186694,.0032979401770712076]],ae.LINRGB_FROM_SCALED_DISCOUNT=[[1373.2198709594231,-1100.4251190754821,-7.278681089101213],[-271.815969077903,559.6580465940733,-32.46047482791194],[1.9622899599665666,-57.173814538844006,308.7233197812385]],ae.Y_FROM_LINRGB=[.2126,.7152,.0722],ae.CRITICAL_PLANES=[.015176349177441876,.045529047532325624,.07588174588720938,.10623444424209313,.13658714259697685,.16693984095186062,.19729253930674434,.2276452376616281,.2579979360165119,.28835063437139563,.3188300904430532,.350925934958123,.3848314933096426,.42057480301049466,.458183274052838,.4976837250274023,.5391024159806381,.5824650784040898,.6277969426914107,.6751227633498623,.7244668422128921,.775853049866786,.829304845476233,.8848452951698498,.942497089126609,1.0022825574869039,1.0642236851973577,1.1283421258858297,1.1946592148522128,1.2631959812511864,1.3339731595349034,1.407011200216447,1.4823302800086415,1.5599503113873272,1.6398909516233677,1.7221716113234105,1.8068114625156377,1.8938294463134073,1.9832442801866852,2.075074464868551,2.1693382909216234,2.2660538449872063,2.36523901573795,2.4669114995532007,2.5710888059345764,2.6777882626779785,2.7870270208169257,2.898822059350997,3.0131901897720907,3.1301480604002863,3.2497121605402226,3.3718988244681087,3.4967242352587946,3.624204428461639,3.754355295633311,3.887192587735158,4.022731918402185,4.160988767090289,4.301978482107941,4.445716283538092,4.592217266055746,4.741496401646282,4.893568542229298,5.048448422192488,5.20615066083972,5.3666897647573375,5.5300801301023865,5.696336044816294,5.865471690767354,6.037501145825082,6.212438385869475,6.390297286737924,6.571091626112461,6.7548350853498045,6.941541251256611,7.131223617812143,7.323895587840543,7.5195704746346665,7.7182615035334345,7.919981813454504,8.124744458384042,8.332562408825165,8.543448553206703,8.757415699253682,8.974476575321063,9.194643831691977,9.417930041841839,9.644347703669503,9.873909240696694,10.106627003236781,10.342513269534024,10.58158024687427,10.8238400726681,11.069304815507364,11.317986476196008,11.569896988756009,11.825048221409341,12.083451977536606,12.345119996613247,12.610063955123938,12.878295467455942,13.149826086772048,13.42466730586372,13.702830557985108,13.984327217668513,14.269168601521828,14.55736596900856,14.848930523210871,15.143873411576273,15.44220572664832,15.743938506781891,16.04908273684337,16.35764934889634,16.66964922287304,16.985093187232053,17.30399201960269,17.62635644741625,17.95219714852476,18.281524751807332,18.614349837764564,18.95068293910138,19.290534541298456,19.633915083172692,19.98083495742689,20.331304511189067,20.685334046541502,21.042933821039977,21.404114048223256,21.76888489811322,22.137256497705877,22.50923893145328,22.884842241736916,23.264076429332462,23.6469514538663,24.033477234264016,24.42366364919083,24.817520537484558,25.21505769858089,25.61628489293138,26.021211842414342,26.429848230738664,26.842203703840827,27.258287870275353,27.678110301598522,28.10168053274597,28.529008062403893,28.96010235337422,29.39497283293396,29.83362889318845,30.276079891419332,30.722335150426627,31.172403958865512,31.62629557157785,32.08401920991837,32.54558406207592,33.010999283389665,33.4802739966603,33.953417292456834,34.430438229418264,34.911345834551085,35.39614910352207,35.88485700094671,36.37747846067349,36.87402238606382,37.37449765026789,37.87891309649659,38.38727753828926,38.89959975977785,39.41588851594697,39.93615253289054,40.460400508064545,40.98864111053629,41.520882981230194,42.05713473317016,42.597404951718396,43.141702194811224,43.6900349931913,44.24241185063697,44.798841244188324,45.35933162437017,45.92389141541209,46.49252901546552,47.065252796817916,47.64207110610409,48.22299226451468,48.808024568002054,49.3971762874833,49.9904556690408,50.587870934119984,51.189430279724725,51.79514187861014,52.40501387947288,53.0190544071392,53.637271562750364,54.259673423945976,54.88626804504493,55.517063457223934,56.15206766869424,56.79128866487574,57.43473440856916,58.08241284012621,58.734331877617365,59.39049941699807,60.05092333227251,60.715611475655585,61.38457167773311,62.057811747619894,62.7353394731159,63.417162620860914,64.10328893648692,64.79372614476921,65.48848194977529,66.18756403501224,66.89098006357258,67.59873767827808,68.31084450182222,69.02730813691093,69.74813616640164,70.47333615344107,71.20291564160104,71.93688215501312,72.67524319850172,73.41800625771542,74.16517879925733,74.9167682708136,75.67278210128072,76.43322770089146,77.1981124613393,77.96744375590167,78.74122893956174,79.51947534912904,80.30219030335869,81.08938110306934,81.88105503125999,82.67721935322541,83.4778813166706,84.28304815182372,85.09272707154808,85.90692527145302,86.72564993000343,87.54890820862819,88.3767072518277,89.2090541872801,90.04595612594655,90.88742016217518,91.73345337380438,92.58406282226491,93.43925555268066,94.29903859396902,95.16341895893969,96.03240364439274,96.9059996312159,97.78421388448044,98.6670533535366,99.55452497210776];class le{static from(t,e,i){return new le(ae.solveToInt(t,e,i))}static fromInt(t){return new le(t)}toInt(){return this.argb}get hue(){return this.internalHue}set hue(t){this.setInternalState(ae.solveToInt(t,this.internalChroma,this.internalTone))}get chroma(){return this.internalChroma}set chroma(t){this.setInternalState(ae.solveToInt(this.internalHue,t,this.internalTone))}get tone(){return this.internalTone}set tone(t){this.setInternalState(ae.solveToInt(this.internalHue,this.internalChroma,t))}constructor(t){this.argb=t;const e=oe.fromInt(t);this.internalHue=e.hue,this.internalChroma=e.chroma,this.internalTone=Qt(t),this.argb=t}setInternalState(t){const e=oe.fromInt(t);this.internalHue=e.hue,this.internalChroma=e.chroma,this.internalTone=Qt(t),this.argb=t}inViewingConditions(t){const e=oe.fromInt(this.toInt()).xyzInViewingConditions(t),i=oe.fromXyzInViewingConditions(e[0],e[1],e[2],ne.make());return le.from(i.hue,i.chroma,ee(e[1]))}}class ce{static ratioOfTones(t,e){return t=Ht(0,100,t),e=Ht(0,100,e),ce.ratioOfYs(te(t),te(e))}static ratioOfYs(t,e){const i=t>e?t:e;return(i+5)/((i===e?t:e)+5)}static lighter(t,e){if(t<0||t>100)return-1;const i=te(t),s=e*(i+5)-5,r=ce.ratioOfYs(s,i),n=Math.abs(r-e);if(r<e&&n>.04)return-1;const o=ee(s)+.4;return o<0||o>100?-1:o}static darker(t,e){if(t<0||t>100)return-1;const i=te(t),s=(i+5)/e-5,r=ce.ratioOfYs(i,s),n=Math.abs(r-e);if(r<e&&n>.04)return-1;const o=ee(s)-.4;return o<0||o>100?-1:o}static lighterUnsafe(t,e){const i=ce.lighter(t,e);return i<0?100:i}static darkerUnsafe(t,e){const i=ce.darker(t,e);return i<0?0:i}}class he{static isDisliked(t){const e=Math.round(t.hue)>=90&&Math.round(t.hue)<=111,i=Math.round(t.chroma)>16,s=Math.round(t.tone)<65;return e&&i&&s}static fixIfDisliked(t){return he.isDisliked(t)?le.from(t.hue,t.chroma,70):t}}class de{static fromPalette(t){return new de(t.name??"",t.palette,t.tone,t.isBackground??!1,t.background,t.secondBackground,t.contrastCurve,t.toneDeltaPair)}constructor(t,e,i,s,r,n,o,a){if(this.name=t,this.palette=e,this.tone=i,this.isBackground=s,this.background=r,this.secondBackground=n,this.contrastCurve=o,this.toneDeltaPair=a,this.hctCache=new Map,!r&&n)throw new Error(`Color ${t} has secondBackgrounddefined, but background is not defined.`);if(!r&&o)throw new Error(`Color ${t} has contrastCurvedefined, but background is not defined.`);if(r&&!o)throw new Error(`Color ${t} has backgrounddefined, but contrastCurve is not defined.`)}getArgb(t){return this.getHct(t).toInt()}getHct(t){const e=this.hctCache.get(t);if(null!=e)return e;const i=this.getTone(t),s=this.palette(t).getHct(i);return this.hctCache.size>4&&this.hctCache.clear(),this.hctCache.set(t,s),s}getTone(t){const e=t.contrastLevel<0;if(this.toneDeltaPair){const i=this.toneDeltaPair(t),s=i.roleA,r=i.roleB,n=i.delta,o=i.polarity,a=i.stayTogether,l=this.background(t).getTone(t),c="nearer"===o||"lighter"===o&&!t.isDark||"darker"===o&&t.isDark,h=c?s:r,d=c?r:s,p=this.name===h.name,u=t.isDark?1:-1,g=h.contrastCurve.get(t.contrastLevel),f=d.contrastCurve.get(t.contrastLevel),m=h.tone(t);let _=ce.ratioOfTones(l,m)>=g?m:de.foregroundTone(l,g);const b=d.tone(t);let v=ce.ratioOfTones(l,b)>=f?b:de.foregroundTone(l,f);return e&&(_=de.foregroundTone(l,g),v=de.foregroundTone(l,f)),(v-_)*u>=n||(v=Ht(0,100,_+n*u),(v-_)*u>=n||(_=Ht(0,100,v-n*u))),50<=_&&_<60?u>0?(_=60,v=Math.max(v,_+n*u)):(_=49,v=Math.min(v,_+n*u)):50<=v&&v<60&&(a?u>0?(_=60,v=Math.max(v,_+n*u)):(_=49,v=Math.min(v,_+n*u)):v=u>0?60:49),p?_:v}{let i=this.tone(t);if(null==this.background)return i;const s=this.background(t).getTone(t),r=this.contrastCurve.get(t.contrastLevel);if(ce.ratioOfTones(s,i)>=r||(i=de.foregroundTone(s,r)),e&&(i=de.foregroundTone(s,r)),this.isBackground&&50<=i&&i<60&&(i=ce.ratioOfTones(49,s)>=r?49:60),this.secondBackground){const[e,s]=[this.background,this.secondBackground],[n,o]=[e(t).getTone(t),s(t).getTone(t)],[a,l]=[Math.max(n,o),Math.min(n,o)];if(ce.ratioOfTones(a,i)>=r&&ce.ratioOfTones(l,i)>=r)return i;const c=ce.lighter(a,r),h=ce.darker(l,r),d=[];-1!==c&&d.push(c),-1!==h&&d.push(h);return de.tonePrefersLightForeground(n)||de.tonePrefersLightForeground(o)?c<0?100:c:1===d.length?d[0]:h<0?0:h}return i}}static foregroundTone(t,e){const i=ce.lighterUnsafe(t,e),s=ce.darkerUnsafe(t,e),r=ce.ratioOfTones(i,t),n=ce.ratioOfTones(s,t);if(de.tonePrefersLightForeground(t)){const t=Math.abs(r-n)<.1&&r<e&&n<e;return r>=e||r>=n||t?i:s}return n>=e||n>=r?s:i}static tonePrefersLightForeground(t){return Math.round(t)<60}static toneAllowsLightForeground(t){return Math.round(t)<=49}static enableLightForeground(t){return de.tonePrefersLightForeground(t)&&!de.toneAllowsLightForeground(t)?49:t}}class pe{static fromInt(t){const e=le.fromInt(t);return pe.fromHct(e)}static fromHct(t){return new pe(t.hue,t.chroma,t)}static fromHueAndChroma(t,e){const i=new ue(t,e).create();return new pe(t,e,i)}constructor(t,e,i){this.hue=t,this.chroma=e,this.keyColor=i,this.cache=new Map}tone(t){let e=this.cache.get(t);return void 0===e&&(e=le.from(this.hue,this.chroma,t).toInt(),this.cache.set(t,e)),e}getHct(t){return le.fromInt(this.tone(t))}}class ue{constructor(t,e){this.hue=t,this.requestedChroma=e,this.chromaCache=new Map,this.maxChromaValue=200}create(){let t=0,e=100;for(;t<e;){const i=Math.floor((t+e)/2),s=this.maxChroma(i)<this.maxChroma(i+1);if(this.maxChroma(i)>=this.requestedChroma-.01)if(Math.abs(t-50)<Math.abs(e-50))e=i;else{if(t===i)return le.from(this.hue,this.requestedChroma,t);t=i}else s?t=i+1:e=i}return le.from(this.hue,this.requestedChroma,t)}maxChroma(t){if(this.chromaCache.has(t))return this.chromaCache.get(t);const e=le.from(this.hue,this.maxChromaValue,t).chroma;return this.chromaCache.set(t,e),e}}class ge{constructor(t,e,i,s){this.low=t,this.normal=e,this.medium=i,this.high=s}get(t){return t<=-1?this.low:t<0?Ut(this.low,this.normal,(t- -1)/1):t<.5?Ut(this.normal,this.medium,(t-0)/.5):t<1?Ut(this.medium,this.high,(t-.5)/.5):this.high}}class fe{constructor(t,e,i,s,r){this.roleA=t,this.roleB=e,this.delta=i,this.polarity=s,this.stayTogether=r}}var me;function _e(t){return t.variant===me.FIDELITY||t.variant===me.CONTENT}function be(t){return t.variant===me.MONOCHROME}!function(t){t[t.MONOCHROME=0]="MONOCHROME",t[t.NEUTRAL=1]="NEUTRAL",t[t.TONAL_SPOT=2]="TONAL_SPOT",t[t.VIBRANT=3]="VIBRANT",t[t.EXPRESSIVE=4]="EXPRESSIVE",t[t.FIDELITY=5]="FIDELITY",t[t.CONTENT=6]="CONTENT",t[t.RAINBOW=7]="RAINBOW",t[t.FRUIT_SALAD=8]="FRUIT_SALAD"}(me||(me={}));class ve{static highestSurface(t){return t.isDark?ve.surfaceBright:ve.surfaceDim}}ve.contentAccentToneDelta=15,ve.primaryPaletteKeyColor=de.fromPalette({name:"primary_palette_key_color",palette:t=>t.primaryPalette,tone:t=>t.primaryPalette.keyColor.tone}),ve.secondaryPaletteKeyColor=de.fromPalette({name:"secondary_palette_key_color",palette:t=>t.secondaryPalette,tone:t=>t.secondaryPalette.keyColor.tone}),ve.tertiaryPaletteKeyColor=de.fromPalette({name:"tertiary_palette_key_color",palette:t=>t.tertiaryPalette,tone:t=>t.tertiaryPalette.keyColor.tone}),ve.neutralPaletteKeyColor=de.fromPalette({name:"neutral_palette_key_color",palette:t=>t.neutralPalette,tone:t=>t.neutralPalette.keyColor.tone}),ve.neutralVariantPaletteKeyColor=de.fromPalette({name:"neutral_variant_palette_key_color",palette:t=>t.neutralVariantPalette,tone:t=>t.neutralVariantPalette.keyColor.tone}),ve.background=de.fromPalette({name:"background",palette:t=>t.neutralPalette,tone:t=>t.isDark?6:98,isBackground:!0}),ve.onBackground=de.fromPalette({name:"on_background",palette:t=>t.neutralPalette,tone:t=>t.isDark?90:10,background:t=>ve.background,contrastCurve:new ge(3,3,4.5,7)}),ve.surface=de.fromPalette({name:"surface",palette:t=>t.neutralPalette,tone:t=>t.isDark?6:98,isBackground:!0}),ve.surfaceDim=de.fromPalette({name:"surface_dim",palette:t=>t.neutralPalette,tone:t=>t.isDark?6:new ge(87,87,80,75).get(t.contrastLevel),isBackground:!0}),ve.surfaceBright=de.fromPalette({name:"surface_bright",palette:t=>t.neutralPalette,tone:t=>t.isDark?new ge(24,24,29,34).get(t.contrastLevel):98,isBackground:!0}),ve.surfaceContainerLowest=de.fromPalette({name:"surface_container_lowest",palette:t=>t.neutralPalette,tone:t=>t.isDark?new ge(4,4,2,0).get(t.contrastLevel):100,isBackground:!0}),ve.surfaceContainerLow=de.fromPalette({name:"surface_container_low",palette:t=>t.neutralPalette,tone:t=>t.isDark?new ge(10,10,11,12).get(t.contrastLevel):new ge(96,96,96,95).get(t.contrastLevel),isBackground:!0}),ve.surfaceContainer=de.fromPalette({name:"surface_container",palette:t=>t.neutralPalette,tone:t=>t.isDark?new ge(12,12,16,20).get(t.contrastLevel):new ge(94,94,92,90).get(t.contrastLevel),isBackground:!0}),ve.surfaceContainerHigh=de.fromPalette({name:"surface_container_high",palette:t=>t.neutralPalette,tone:t=>t.isDark?new ge(17,17,21,25).get(t.contrastLevel):new ge(92,92,88,85).get(t.contrastLevel),isBackground:!0}),ve.surfaceContainerHighest=de.fromPalette({name:"surface_container_highest",palette:t=>t.neutralPalette,tone:t=>t.isDark?new ge(22,22,26,30).get(t.contrastLevel):new ge(90,90,84,80).get(t.contrastLevel),isBackground:!0}),ve.onSurface=de.fromPalette({name:"on_surface",palette:t=>t.neutralPalette,tone:t=>t.isDark?90:10,background:t=>ve.highestSurface(t),contrastCurve:new ge(4.5,7,11,21)}),ve.surfaceVariant=de.fromPalette({name:"surface_variant",palette:t=>t.neutralVariantPalette,tone:t=>t.isDark?30:90,isBackground:!0}),ve.onSurfaceVariant=de.fromPalette({name:"on_surface_variant",palette:t=>t.neutralVariantPalette,tone:t=>t.isDark?80:30,background:t=>ve.highestSurface(t),contrastCurve:new ge(3,4.5,7,11)}),ve.inverseSurface=de.fromPalette({name:"inverse_surface",palette:t=>t.neutralPalette,tone:t=>t.isDark?90:20}),ve.inverseOnSurface=de.fromPalette({name:"inverse_on_surface",palette:t=>t.neutralPalette,tone:t=>t.isDark?20:95,background:t=>ve.inverseSurface,contrastCurve:new ge(4.5,7,11,21)}),ve.outline=de.fromPalette({name:"outline",palette:t=>t.neutralVariantPalette,tone:t=>t.isDark?60:50,background:t=>ve.highestSurface(t),contrastCurve:new ge(1.5,3,4.5,7)}),ve.outlineVariant=de.fromPalette({name:"outline_variant",palette:t=>t.neutralVariantPalette,tone:t=>t.isDark?30:80,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5)}),ve.shadow=de.fromPalette({name:"shadow",palette:t=>t.neutralPalette,tone:t=>0}),ve.scrim=de.fromPalette({name:"scrim",palette:t=>t.neutralPalette,tone:t=>0}),ve.surfaceTint=de.fromPalette({name:"surface_tint",palette:t=>t.primaryPalette,tone:t=>t.isDark?80:40,isBackground:!0}),ve.primary=de.fromPalette({name:"primary",palette:t=>t.primaryPalette,tone:t=>be(t)?t.isDark?100:0:t.isDark?80:40,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(3,4.5,7,7),toneDeltaPair:t=>new fe(ve.primaryContainer,ve.primary,10,"nearer",!1)}),ve.onPrimary=de.fromPalette({name:"on_primary",palette:t=>t.primaryPalette,tone:t=>be(t)?t.isDark?10:90:t.isDark?20:100,background:t=>ve.primary,contrastCurve:new ge(4.5,7,11,21)}),ve.primaryContainer=de.fromPalette({name:"primary_container",palette:t=>t.primaryPalette,tone:t=>_e(t)?t.sourceColorHct.tone:be(t)?t.isDark?85:25:t.isDark?30:90,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.primaryContainer,ve.primary,10,"nearer",!1)}),ve.onPrimaryContainer=de.fromPalette({name:"on_primary_container",palette:t=>t.primaryPalette,tone:t=>_e(t)?de.foregroundTone(ve.primaryContainer.tone(t),4.5):be(t)?t.isDark?0:100:t.isDark?90:30,background:t=>ve.primaryContainer,contrastCurve:new ge(3,4.5,7,11)}),ve.inversePrimary=de.fromPalette({name:"inverse_primary",palette:t=>t.primaryPalette,tone:t=>t.isDark?40:80,background:t=>ve.inverseSurface,contrastCurve:new ge(3,4.5,7,7)}),ve.secondary=de.fromPalette({name:"secondary",palette:t=>t.secondaryPalette,tone:t=>t.isDark?80:40,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(3,4.5,7,7),toneDeltaPair:t=>new fe(ve.secondaryContainer,ve.secondary,10,"nearer",!1)}),ve.onSecondary=de.fromPalette({name:"on_secondary",palette:t=>t.secondaryPalette,tone:t=>be(t)?t.isDark?10:100:t.isDark?20:100,background:t=>ve.secondary,contrastCurve:new ge(4.5,7,11,21)}),ve.secondaryContainer=de.fromPalette({name:"secondary_container",palette:t=>t.secondaryPalette,tone:t=>{const e=t.isDark?30:90;return be(t)?t.isDark?30:85:_e(t)?function(t,e,i,s){let r=i,n=le.from(t,e,i);if(n.chroma<e){let i=n.chroma;for(;n.chroma<e;){r+=s?-1:1;const o=le.from(t,e,r);if(i>o.chroma)break;if(Math.abs(o.chroma-e)<.4)break;Math.abs(o.chroma-e)<Math.abs(n.chroma-e)&&(n=o),i=Math.max(i,o.chroma)}}return r}(t.secondaryPalette.hue,t.secondaryPalette.chroma,e,!t.isDark):e},isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.secondaryContainer,ve.secondary,10,"nearer",!1)}),ve.onSecondaryContainer=de.fromPalette({name:"on_secondary_container",palette:t=>t.secondaryPalette,tone:t=>be(t)?t.isDark?90:10:_e(t)?de.foregroundTone(ve.secondaryContainer.tone(t),4.5):t.isDark?90:30,background:t=>ve.secondaryContainer,contrastCurve:new ge(3,4.5,7,11)}),ve.tertiary=de.fromPalette({name:"tertiary",palette:t=>t.tertiaryPalette,tone:t=>be(t)?t.isDark?90:25:t.isDark?80:40,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(3,4.5,7,7),toneDeltaPair:t=>new fe(ve.tertiaryContainer,ve.tertiary,10,"nearer",!1)}),ve.onTertiary=de.fromPalette({name:"on_tertiary",palette:t=>t.tertiaryPalette,tone:t=>be(t)?t.isDark?10:90:t.isDark?20:100,background:t=>ve.tertiary,contrastCurve:new ge(4.5,7,11,21)}),ve.tertiaryContainer=de.fromPalette({name:"tertiary_container",palette:t=>t.tertiaryPalette,tone:t=>{if(be(t))return t.isDark?60:49;if(!_e(t))return t.isDark?30:90;const e=t.tertiaryPalette.getHct(t.sourceColorHct.tone);return he.fixIfDisliked(e).tone},isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.tertiaryContainer,ve.tertiary,10,"nearer",!1)}),ve.onTertiaryContainer=de.fromPalette({name:"on_tertiary_container",palette:t=>t.tertiaryPalette,tone:t=>be(t)?t.isDark?0:100:_e(t)?de.foregroundTone(ve.tertiaryContainer.tone(t),4.5):t.isDark?90:30,background:t=>ve.tertiaryContainer,contrastCurve:new ge(3,4.5,7,11)}),ve.error=de.fromPalette({name:"error",palette:t=>t.errorPalette,tone:t=>t.isDark?80:40,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(3,4.5,7,7),toneDeltaPair:t=>new fe(ve.errorContainer,ve.error,10,"nearer",!1)}),ve.onError=de.fromPalette({name:"on_error",palette:t=>t.errorPalette,tone:t=>t.isDark?20:100,background:t=>ve.error,contrastCurve:new ge(4.5,7,11,21)}),ve.errorContainer=de.fromPalette({name:"error_container",palette:t=>t.errorPalette,tone:t=>t.isDark?30:90,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.errorContainer,ve.error,10,"nearer",!1)}),ve.onErrorContainer=de.fromPalette({name:"on_error_container",palette:t=>t.errorPalette,tone:t=>be(t)?t.isDark?90:10:t.isDark?90:30,background:t=>ve.errorContainer,contrastCurve:new ge(3,4.5,7,11)}),ve.primaryFixed=de.fromPalette({name:"primary_fixed",palette:t=>t.primaryPalette,tone:t=>be(t)?40:90,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.primaryFixed,ve.primaryFixedDim,10,"lighter",!0)}),ve.primaryFixedDim=de.fromPalette({name:"primary_fixed_dim",palette:t=>t.primaryPalette,tone:t=>be(t)?30:80,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.primaryFixed,ve.primaryFixedDim,10,"lighter",!0)}),ve.onPrimaryFixed=de.fromPalette({name:"on_primary_fixed",palette:t=>t.primaryPalette,tone:t=>be(t)?100:10,background:t=>ve.primaryFixedDim,secondBackground:t=>ve.primaryFixed,contrastCurve:new ge(4.5,7,11,21)}),ve.onPrimaryFixedVariant=de.fromPalette({name:"on_primary_fixed_variant",palette:t=>t.primaryPalette,tone:t=>be(t)?90:30,background:t=>ve.primaryFixedDim,secondBackground:t=>ve.primaryFixed,contrastCurve:new ge(3,4.5,7,11)}),ve.secondaryFixed=de.fromPalette({name:"secondary_fixed",palette:t=>t.secondaryPalette,tone:t=>be(t)?80:90,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.secondaryFixed,ve.secondaryFixedDim,10,"lighter",!0)}),ve.secondaryFixedDim=de.fromPalette({name:"secondary_fixed_dim",palette:t=>t.secondaryPalette,tone:t=>be(t)?70:80,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.secondaryFixed,ve.secondaryFixedDim,10,"lighter",!0)}),ve.onSecondaryFixed=de.fromPalette({name:"on_secondary_fixed",palette:t=>t.secondaryPalette,tone:t=>10,background:t=>ve.secondaryFixedDim,secondBackground:t=>ve.secondaryFixed,contrastCurve:new ge(4.5,7,11,21)}),ve.onSecondaryFixedVariant=de.fromPalette({name:"on_secondary_fixed_variant",palette:t=>t.secondaryPalette,tone:t=>be(t)?25:30,background:t=>ve.secondaryFixedDim,secondBackground:t=>ve.secondaryFixed,contrastCurve:new ge(3,4.5,7,11)}),ve.tertiaryFixed=de.fromPalette({name:"tertiary_fixed",palette:t=>t.tertiaryPalette,tone:t=>be(t)?40:90,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.tertiaryFixed,ve.tertiaryFixedDim,10,"lighter",!0)}),ve.tertiaryFixedDim=de.fromPalette({name:"tertiary_fixed_dim",palette:t=>t.tertiaryPalette,tone:t=>be(t)?30:80,isBackground:!0,background:t=>ve.highestSurface(t),contrastCurve:new ge(1,1,3,4.5),toneDeltaPair:t=>new fe(ve.tertiaryFixed,ve.tertiaryFixedDim,10,"lighter",!0)}),ve.onTertiaryFixed=de.fromPalette({name:"on_tertiary_fixed",palette:t=>t.tertiaryPalette,tone:t=>be(t)?100:10,background:t=>ve.tertiaryFixedDim,secondBackground:t=>ve.tertiaryFixed,contrastCurve:new ge(4.5,7,11,21)}),ve.onTertiaryFixedVariant=de.fromPalette({name:"on_tertiary_fixed_variant",palette:t=>t.tertiaryPalette,tone:t=>be(t)?90:30,background:t=>ve.tertiaryFixedDim,secondBackground:t=>ve.tertiaryFixed,contrastCurve:new ge(3,4.5,7,11)});class ye{constructor(t){this.sourceColorArgb=t.sourceColorArgb,this.variant=t.variant,this.contrastLevel=t.contrastLevel,this.isDark=t.isDark,this.sourceColorHct=le.fromInt(t.sourceColorArgb),this.primaryPalette=t.primaryPalette,this.secondaryPalette=t.secondaryPalette,this.tertiaryPalette=t.tertiaryPalette,this.neutralPalette=t.neutralPalette,this.neutralVariantPalette=t.neutralVariantPalette,this.errorPalette=pe.fromHueAndChroma(25,84)}static getRotatedHue(t,e,i){const s=t.hue;if(e.length!==i.length)throw new Error(`mismatch between hue length ${e.length} & rotations ${i.length}`);if(1===i.length)return jt(t.hue+i[0]);const r=e.length;for(let t=0;t<=r-2;t++){const r=e[t],n=e[t+1];if(r<s&&s<n)return jt(s+i[t])}return s}getArgb(t){return t.getArgb(this)}getHct(t){return t.getHct(this)}get primaryPaletteKeyColor(){return this.getArgb(ve.primaryPaletteKeyColor)}get secondaryPaletteKeyColor(){return this.getArgb(ve.secondaryPaletteKeyColor)}get tertiaryPaletteKeyColor(){return this.getArgb(ve.tertiaryPaletteKeyColor)}get neutralPaletteKeyColor(){return this.getArgb(ve.neutralPaletteKeyColor)}get neutralVariantPaletteKeyColor(){return this.getArgb(ve.neutralVariantPaletteKeyColor)}get background(){return this.getArgb(ve.background)}get onBackground(){return this.getArgb(ve.onBackground)}get surface(){return this.getArgb(ve.surface)}get surfaceDim(){return this.getArgb(ve.surfaceDim)}get surfaceBright(){return this.getArgb(ve.surfaceBright)}get surfaceContainerLowest(){return this.getArgb(ve.surfaceContainerLowest)}get surfaceContainerLow(){return this.getArgb(ve.surfaceContainerLow)}get surfaceContainer(){return this.getArgb(ve.surfaceContainer)}get surfaceContainerHigh(){return this.getArgb(ve.surfaceContainerHigh)}get surfaceContainerHighest(){return this.getArgb(ve.surfaceContainerHighest)}get onSurface(){return this.getArgb(ve.onSurface)}get surfaceVariant(){return this.getArgb(ve.surfaceVariant)}get onSurfaceVariant(){return this.getArgb(ve.onSurfaceVariant)}get inverseSurface(){return this.getArgb(ve.inverseSurface)}get inverseOnSurface(){return this.getArgb(ve.inverseOnSurface)}get outline(){return this.getArgb(ve.outline)}get outlineVariant(){return this.getArgb(ve.outlineVariant)}get shadow(){return this.getArgb(ve.shadow)}get scrim(){return this.getArgb(ve.scrim)}get surfaceTint(){return this.getArgb(ve.surfaceTint)}get primary(){return this.getArgb(ve.primary)}get onPrimary(){return this.getArgb(ve.onPrimary)}get primaryContainer(){return this.getArgb(ve.primaryContainer)}get onPrimaryContainer(){return this.getArgb(ve.onPrimaryContainer)}get inversePrimary(){return this.getArgb(ve.inversePrimary)}get secondary(){return this.getArgb(ve.secondary)}get onSecondary(){return this.getArgb(ve.onSecondary)}get secondaryContainer(){return this.getArgb(ve.secondaryContainer)}get onSecondaryContainer(){return this.getArgb(ve.onSecondaryContainer)}get tertiary(){return this.getArgb(ve.tertiary)}get onTertiary(){return this.getArgb(ve.onTertiary)}get tertiaryContainer(){return this.getArgb(ve.tertiaryContainer)}get onTertiaryContainer(){return this.getArgb(ve.onTertiaryContainer)}get error(){return this.getArgb(ve.error)}get onError(){return this.getArgb(ve.onError)}get errorContainer(){return this.getArgb(ve.errorContainer)}get onErrorContainer(){return this.getArgb(ve.onErrorContainer)}get primaryFixed(){return this.getArgb(ve.primaryFixed)}get primaryFixedDim(){return this.getArgb(ve.primaryFixedDim)}get onPrimaryFixed(){return this.getArgb(ve.onPrimaryFixed)}get onPrimaryFixedVariant(){return this.getArgb(ve.onPrimaryFixedVariant)}get secondaryFixed(){return this.getArgb(ve.secondaryFixed)}get secondaryFixedDim(){return this.getArgb(ve.secondaryFixedDim)}get onSecondaryFixed(){return this.getArgb(ve.onSecondaryFixed)}get onSecondaryFixedVariant(){return this.getArgb(ve.onSecondaryFixedVariant)}get tertiaryFixed(){return this.getArgb(ve.tertiaryFixed)}get tertiaryFixedDim(){return this.getArgb(ve.tertiaryFixedDim)}get onTertiaryFixed(){return this.getArgb(ve.onTertiaryFixed)}get onTertiaryFixedVariant(){return this.getArgb(ve.onTertiaryFixedVariant)}}class we extends ye{constructor(t,e,i){super({sourceColorArgb:t.toInt(),variant:me.EXPRESSIVE,contrastLevel:i,isDark:e,primaryPalette:pe.fromHueAndChroma(jt(t.hue+240),40),secondaryPalette:pe.fromHueAndChroma(ye.getRotatedHue(t,we.hues,we.secondaryRotations),24),tertiaryPalette:pe.fromHueAndChroma(ye.getRotatedHue(t,we.hues,we.tertiaryRotations),32),neutralPalette:pe.fromHueAndChroma(t.hue+15,8),neutralVariantPalette:pe.fromHueAndChroma(t.hue+15,12)})}}we.hues=[0,21,51,121,151,191,271,321,360],we.secondaryRotations=[45,95,45,20,45,90,45,45,45],we.tertiaryRotations=[120,120,20,45,20,15,20,120,120];class xe extends ye{constructor(t,e,i){super({sourceColorArgb:t.toInt(),variant:me.TONAL_SPOT,contrastLevel:i,isDark:e,primaryPalette:pe.fromHueAndChroma(t.hue,36),secondaryPalette:pe.fromHueAndChroma(t.hue,16),tertiaryPalette:pe.fromHueAndChroma(jt(t.hue+60),24),neutralPalette:pe.fromHueAndChroma(t.hue,6),neutralVariantPalette:pe.fromHueAndChroma(t.hue,8)})}}class $e extends ye{constructor(t,e,i){super({sourceColorArgb:t.toInt(),variant:me.VIBRANT,contrastLevel:i,isDark:e,primaryPalette:pe.fromHueAndChroma(t.hue,200),secondaryPalette:pe.fromHueAndChroma(ye.getRotatedHue(t,$e.hues,$e.secondaryRotations),24),tertiaryPalette:pe.fromHueAndChroma(ye.getRotatedHue(t,$e.hues,$e.tertiaryRotations),32),neutralPalette:pe.fromHueAndChroma(t.hue,10),neutralVariantPalette:pe.fromHueAndChroma(t.hue,12)})}}function Se(t){const e=Xt(t),i=Jt(t),s=Zt(t),r=[e.toString(16),i.toString(16),s.toString(16)];for(const[t,e]of r.entries())1===e.length&&(r[t]="0"+e);return"#"+r.join("")}function Ie(t,e,i,s={}){const r=function(t,e,i,s={}){const r=s.dark??!1,n=t=>Math.max(0,Math.min(255,Math.round(t))),o=Yt(n(t),n(e),n(i)),a=le.fromInt(o);return new xe(a,r,0)}(t,e,i,s);return{accent:Se(ve.primary.getArgb(r)),onAccent:Se(ve.onPrimary.getArgb(r))}}$e.hues=[0,41,61,101,131,181,251,301,360],$e.secondaryRotations=[18,15,10,12,15,18,15,12,12],$e.tertiaryRotations=[35,30,20,25,30,35,30,25,25];const ke="--wled-led-accent",Ce="--wled-on-led-accent";class Pe{constructor(t){this.host=t,this._controllerId="",this._controllers=[],this._lastSeed=null,this._applyAccentDebounced=It((t,e)=>{const i=this.host.style;if(!i)return;const{accent:s,onAccent:r}=Ie(t[0],t[1],t[2],e);i.setProperty(ke,s),i.setProperty(Ce,r)},50,100),t.addController(this)}hostConnected(){}hostDisconnected(){this._applyAccentDebounced.cancel()}get controllerId(){return this._controllerId}get controllers(){return this._controllers}masterEntityFor(t){return this._controllers.find(e=>e.entry_id===t)?.master_entity_id??""}get masterEntity(){return this.masterEntityFor(this._controllerId)}setControllerId(t){t&&t!==this._controllerId&&(this._controllerId=t,this.host.requestUpdate())}applyAccentFromSegment(t,e={}){const i=function(t){const e=At(t?.col)[0];if(!e)return null;const[i,s,r]=[e[0]??0,e[1]??0,e[2]??0];return 0===i&&0===s&&0===r?null:[i,s,r]}(t);if(!i)return void this.clearAccent();const s=function(t){if("boolean"==typeof t)return t;try{return"function"==typeof matchMedia&&matchMedia("(prefers-color-scheme: dark)").matches}catch{return!1}}(e.dark),r=`${i[0]},${i[1]},${i[2]},${s?1:0}`;r!==this._lastSeed&&(this._lastSeed=r,this._applyAccentDebounced(i,{...e,dark:s}))}clearAccent(){if(this._applyAccentDebounced.cancel(),null===this._lastSeed)return;this._lastSeed=null;const t=this.host.style;t&&(t.removeProperty?.(ke),t.removeProperty?.(Ce))}async loadControllers(t){try{const e=await St(t);this._controllers=e;const i=this._controllerId&&e.some(t=>t.entry_id===this._controllerId);if(!i){const t=e[0];t?.entry_id&&(this._controllerId=String(t.entry_id))}this.host.requestUpdate()}catch{}}}function Me(t){return(e,i)=>{const s=customElements.get(t);return s||(customElements.define(t,e),e)}}const Ee=.55,Ae=1,Te=1,Le=0,De=0,Ne=0,Be=1,Oe=0,Re=0,Fe=1,ze=1;function Ue(t){return function(t,e){return t?{url:t,opacity:e?.opacity??Ee,brightness:e?.brightness??Ae,saturation:e?.saturation??Te,rotation:e?.rotation??Le,offsetX:e?.offsetX??De,offsetY:e?.offsetY??Ne,scale:e?.scale??Be,cropX:e?.cropX??Oe,cropY:e?.cropY??Re,cropW:e?.cropW??Fe,cropH:e?.cropH??ze}:null}(t.background?.url??t.background_url,t.background??null)}function He(t,e=!1){return new Promise((i,s)=>{const r=new Image;r.onload=()=>i(r),r.onerror=()=>s(new Error(`Could not load image (${t})`)),function(t,e,i=!1){let s=e;if(i&&!s.includes("?")&&(s=`${s}?v=${Date.now()}`),t.removeAttribute("crossorigin"),s.startsWith("http://")||s.startsWith("https://"))try{new URL(s,window.location.href).origin!==window.location.origin&&(t.crossOrigin="anonymous")}catch{t.crossOrigin="anonymous"}t.src=s}(r,t,e)})}let je=class extends bt{constructor(){super(...arguments),this.controllerId="",this.layoutId="",this.fixtureId="",this.pixelCount=210,this.dotRadius=4,this.compact=!1,this.heightPx=200,this.externalLive=!1,this.paintMode=!1,this.paintLivePreview=!1,this.paintBrushSize=6,this.segments=[],this.selectedSegId=-1,this.highlightSegIds=[],this._positions=[],this._status="waiting",this._showDots=!1,this._closed=!1,this._bgLayer=null,this._bgImage=null,this._raf=0,this._hoverLed=-1,this._painting=!1,this._lastLivePaintMs=0,this._onCanvasClick=t=>{if(this.paintMode)return;const e=this._ledAtEvent(t);if(e<0)return;const i=this._segmentForLed(e);i<0||this.dispatchEvent(new CustomEvent("segment-select",{detail:{segmentId:i,ledIndex:e},bubbles:!0,composed:!0}))},this._onPaintPointerDown=t=>{if(!this.paintMode)return;this._painting=!0,t.target.setPointerCapture(t.pointerId);const e=this._ledAtEvent(t);this._emitPaintStroke(e)},this._onPaintPointerMove=t=>{if(!this.paintMode||!this._painting)return;const e=this._ledAtEvent(t);this._emitPaintStroke(e)},this._onPaintPointerUp=t=>{if(this.paintMode){this._painting=!1;try{t.target.releasePointerCapture(t.pointerId)}catch{}}},this._onPaintPointerLeave=()=>{this._painting=!1},this._onCanvasMove=t=>{const e=this._ledAtEvent(t);e!==this._hoverLed&&(this._hoverLed=e,this._schedPaint())},this._onCanvasLeave=()=>{this._hoverLed>=0&&(this._hoverLed=-1,this._schedPaint())}}setFrame(t){if(t&&(!this.paintMode||this.paintLivePreview)){if(this.paintMode&&this.paintLivePreview){const t=performance.now();if(t-this._lastLivePaintMs<50)return;this._lastLivePaintMs=t}this._pixels=function(t,e){const i=new Uint8ClampedArray(4*e);for(let s=0;s<e;s++){const e=Math.min(t.count-1,Math.max(0,Math.round(s/t.scale))),r=t.leds_hex[e]??"000000",n=4*s;8===r.length?(i[n]=parseInt(r.slice(0,2),16),i[n+1]=parseInt(r.slice(2,4),16),i[n+2]=parseInt(r.slice(4,6),16),i[n+3]=parseInt(r.slice(6,8),16)):(i[n]=parseInt(r.slice(0,2),16),i[n+1]=parseInt(r.slice(2,4),16),i[n+2]=parseInt(r.slice(4,6),16),i[n+3]=255)}return i}(t,this.pixelCount),this._status="live",this._schedPaint()}}setPaintPixels(t){this._paintPixels=t??void 0,this.paintMode&&(this._status=t?"paint":"ready"),this._schedPaint()}setStatus(t){this._status=t,this.requestUpdate()}async refresh(){await this._resolvePositions()}onPoweredConnect(){this._resolvePositions(),this._syncLiveSubscription()}onPoweredDisconnect(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0,this._resizeObs?.disconnect(),this._unsubLive?.(),this._unsubLive=void 0}_wantsLiveStream(){return!this.externalLive||this.paintMode&&this.paintLivePreview}_syncLiveSubscription(){this._wantsLiveStream()?this._unsubLive||this._attachLiveStream():(this._unsubLive?.(),this._unsubLive=void 0)}updated(t){super.updated(t),(t.has("connection")||t.has("controllerId")||t.has("layoutId")||t.has("fixtureId"))&&(this._resolvePositions(),this._syncLiveSubscription()),(t.has("externalLive")||t.has("paintLivePreview")||t.has("paintMode"))&&this._syncLiveSubscription(),(t.has("selectedSegId")||t.has("highlightSegIds")||t.has("segments")||t.has("paintMode"))&&(this._schedPaint(),t.has("paintMode")&&this._canvas&&(this._canvas.style.cursor=this.paintMode?"crosshair":"pointer",this.paintMode&&queueMicrotask(()=>this._onResize())))}firstUpdated(){if(this._canvas=this.renderRoot.querySelector("canvas")??void 0,this._canvas){this._ctx=this._canvas.getContext("2d",{alpha:!0})??void 0,this._resizeObs=new ResizeObserver(()=>this._onResize()),this._resizeObs.observe(this._canvas);const t=this._canvas;t.style.touchAction="none",t.addEventListener("pointerdown",this._onPaintPointerDown),t.addEventListener("pointermove",this._onPaintPointerMove),t.addEventListener("pointerup",this._onPaintPointerUp),t.addEventListener("pointerleave",this._onPaintPointerLeave),t.addEventListener("click",this._onCanvasClick),t.addEventListener("mousemove",this._onCanvasMove),t.addEventListener("mouseleave",this._onCanvasLeave),this.addUnsub(()=>{t.removeEventListener("pointerdown",this._onPaintPointerDown),t.removeEventListener("pointermove",this._onPaintPointerMove),t.removeEventListener("pointerup",this._onPaintPointerUp),t.removeEventListener("pointerleave",this._onPaintPointerLeave),t.removeEventListener("click",this._onCanvasClick),t.removeEventListener("mousemove",this._onCanvasMove),t.removeEventListener("mouseleave",this._onCanvasLeave)})}this._onResize()}_emitPaintStroke(t){if(t<0)return;const e=Math.max(1,Math.floor(this.paintBrushSize/2)),i=[];for(let s=-e;s<=e;s++){const e=t+s;e>=0&&e<this.pixelCount&&i.push(e)}i.length&&this.dispatchEvent(new CustomEvent("paint-stroke",{detail:{led:t,leds:i},bubbles:!0,composed:!0}))}_segmentForLed(t){for(const e of this.segments){const i=e.start??0,s=e.stop??e.len??this.pixelCount;if(t>=i&&t<s)return e.id}return 1===this.segments.length?this.segments[0].id:-1}_ledInSegment(t,e){if(e<0)return!1;const i=this.segments.find(t=>t.id===e);if(!i)return!1;const s=i.start??0,r=i.stop??i.len??this.pixelCount;return t>=s&&t<r}_ledAtEvent(t){const e=this._hitTest(t.clientX,t.clientY);return e?.led??-1}_logicalCanvasSize(){const t=this._canvas;if(!t)return{w:0,h:0};const e=Math.min(2,window.devicePixelRatio||1);return{w:t.width/e,h:t.height/e}}_pointerToLogical(t,e){const i=this._canvas;if(!i)return null;const s=i.getBoundingClientRect();if(s.width<1||s.height<1)return null;const{w:r,h:n}=this._logicalCanvasSize();return[(t-s.left)/s.width*r,(e-s.top)/s.height*n]}_hitTest(t,e){if(!this._canvas||0===this._positions.length)return null;const i=this._pointerToLogical(t,e);if(!i)return null;const[s,r]=i,{w:n,h:o}=this._logicalCanvasSize(),a=this._layoutMap(n,o);if(!a)return null;const{toCanvas:l,hitR:c}=a;let h=null,d=c*c;for(const t of this._positions){const[e,i]=l(t.x,t.y),n=e-s,o=i-r,a=n*n+o*o;a<d&&(d=a,h=t)}return h}_positionExtents(){if(0===this._positions.length)return null;let t=1/0,e=-1/0,i=1/0,s=-1/0;for(const r of this._positions)r.x<t&&(t=r.x),r.x>e&&(e=r.x),r.y<i&&(i=r.y),r.y>s&&(s=r.y);return{minX:t,maxX:e,minY:i,maxY:s,rangeX:e-t||1,rangeY:s-i||1}}_applyLayoutAspectCss(){if(!this.paintMode)return void this.style.removeProperty("--wled-layout-aspect");const t=this._positionExtents();if(!t)return void this.style.removeProperty("--wled-layout-aspect");const e=Math.max(.35,Math.min(3.5,t.rangeX/t.rangeY));this.style.setProperty("--wled-layout-aspect",String(e)),queueMicrotask(()=>this._onResize())}_layoutMap(t,e){const i=this._positionExtents();if(!i)return null;const{minX:s,minY:r,rangeX:n,rangeY:o}=i,a=this.dotRadius,l=this.paintMode?2*a:3*a,c=(t-2*l)/n,h=(e-2*l)/o,d=Math.min(c,h),p=this.compact?Math.max(8,3*a):Math.max(3.5,1.75*a);return{toCanvas:(t,e)=>[l+(t-s)*d,l+(e-r)*d],hitR:Math.max(10,2.5*p),lineW:p}}_accentStroke(){return getComputedStyle(this).getPropertyValue("--wled-accent").trim()||"#03a9f4"}_surfaceFill(){return getComputedStyle(this).getPropertyValue("--wled-surface").trim()||"#1e1e1e"}_onResize(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect();if(e.width<2||e.height<2)return;const i=Math.min(1200,Math.max(1,Math.floor(e.width))),s=Math.min(600,Math.max(1,Math.floor(e.height))),r=Math.min(2,window.devicePixelRatio||1),n=Math.floor(i*r),o=Math.floor(s*r);if(t.width!==n||t.height!==o){t.width=n,t.height=o;const e=this._ctx;e&&e.setTransform(r,0,0,r,0,0),this._schedPaint()}}async _resolvePositions(){if(this.connection&&this.controllerId&&this.fixtureId)try{if(this.layoutId){const t=await async function(t,e,i){return(await Nt(t,{type:"wled_studio/layout_get",controller_id:e,layout_id:i})).layout??null}(this.connection,this.controllerId,this.layoutId);if(t){this._bgLayer=Ue(t),this._loadBackgroundImage();const e=t.fixtures??[],i=this.fixtureId?e.find(t=>String(t.id??"")===this.fixtureId):e[0];this._closed=Boolean(i?.closed??!1)}}this._positions=await async function(t,e,i,s){return(await Nt(t,{type:"wled_studio/layout_resolve_positions",controller_id:e,fixture_id:i,layout_id:s})).positions??[]}(this.connection,this.controllerId,this.fixtureId,this.layoutId||void 0),this._applyLayoutAspectCss(),queueMicrotask(()=>this._onResize()),this._schedPaint()}catch{this._positions=[],this._applyLayoutAspectCss()}}_loadBackgroundImage(){const t=this._bgLayer?.url;t?He(t).then(t=>{this._bgImage=t,this._schedPaint()},()=>{this._bgImage=null}):this._bgImage=null}_attachLiveStream(){this.connection&&this.controllerId&&!this._unsubLive&&(this._unsubLive=xt(this.connection,this.controllerId,t=>{this.setFrame(t)}),this.addUnsub(()=>{this._unsubLive?.(),this._unsubLive=void 0}))}_schedPaint(){this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0,this._paint()}))}_rgbForLed(t,e){if(!t)return[80,80,80];const i=4*e;return[t[i],t[i+1],t[i+2]]}_paint(){const t=this._ctx,e=this._canvas;if(!t||!e)return;const{w:i,h:s}=this._logicalCanvasSize();if(i<1||s<1)return;t.clearRect(0,0,i,s),t.fillStyle=this._surfaceFill(),t.fillRect(0,0,i,s),this._bgImage?.complete&&this._bgLayer&&function(t,e,i,s,r){const n=r.opacity??Ee,o=r.brightness??1,a=r.saturation??1,l=(r.rotation??0)*Math.PI/180,c=(r.offsetX??0)*e,h=(r.offsetY??0)*i,d=r.scale??1,p=r.cropX??0,u=r.cropY??0,g=r.cropW??1,f=r.cropH??1,m=s.naturalWidth*g,_=s.naturalHeight*f,b=s.naturalWidth*p,v=s.naturalHeight*u,y=Math.max(e/m,i/_)*d,w=m*y,x=_*y;t.save(),t.globalAlpha=n,t.filter=`brightness(${o}) saturate(${a})`,t.translate(e/2+c,i/2+h),t.rotate(l),t.drawImage(s,b,v,m,_,-w/2,-x/2,w,x),t.restore()}(t,i,s,this._bgImage,this._bgLayer);const r=this.paintMode&&this._paintPixels&&!this.paintLivePreview?this._paintPixels:this._pixels,n=[...this._positions].sort((t,e)=>t.led-e.led),o=this.dotRadius,a=this._layoutMap(i,s);if(n.length>0&&a){const{toCanvas:e,lineW:i}=a,s=this.remote.state.disableBloom;if(!this._showDots){t.lineCap="round",t.lineJoin="round",t.lineWidth=i;const o=(n,o)=>{const[a,l]=e(n.x,n.y),[c,h]=e(o.x,o.y),[d,p,u]=this._rgbForLed(r,n.led);!s&&(d>10||p>10||u>10)?(t.shadowColor=`rgba(${d},${p},${u},0.55)`,t.shadowBlur=i*(this.compact?2:1.5)):t.shadowBlur=0,t.strokeStyle=`rgb(${d},${p},${u})`,t.beginPath(),t.moveTo(a,l),t.lineTo(c,h),t.stroke()};for(let t=0;t<n.length-1;t++)o(n[t],n[t+1]);this._closed&&n.length>=2&&o(n[n.length-1],n[0]),t.shadowBlur=0}if(this._showDots){for(const{x:i,y:a,led:l}of n){const[n,c]=e(i,a),[h,d,p]=this._rgbForLed(r,l);!s&&(h>10||d>10||p>10)?(t.shadowColor=`rgba(${h},${d},${p},0.7)`,t.shadowBlur=2.5*o):t.shadowBlur=0,t.beginPath(),t.arc(n,c,o,0,2*Math.PI),t.fillStyle=`rgb(${h},${d},${p})`,t.fill()}t.shadowBlur=0}this.paintMode?this._hoverLed>=0&&this._paintBrushHover(t,n,e):this._paintSegmentSelection(t,n,e,i)}else{const e=this.pixelCount,n=(i-8)/e,a=s/2;for(let i=0;i<e;i++){let e=80,s=80,l=80;if(r){const t=4*i;e=r[t],s=r[t+1],l=r[t+2]}t.beginPath(),t.arc(4+i*n+n/2,a,o,0,2*Math.PI),t.fillStyle=`rgb(${e},${s},${l})`,t.fill()}}}_paintBrushHover(t,e,i){const s=e.find(t=>t.led===this._hoverLed);if(!s)return;const[r,n]=i(s.x,s.y),o=Math.max(8,2.5*this.dotRadius);t.save(),t.strokeStyle="rgba(255, 255, 255, 0.9)",t.lineWidth=2,t.beginPath(),t.arc(r,n,o,0,2*Math.PI),t.stroke(),t.strokeStyle=this._accentStroke(),t.lineWidth=1.5,t.beginPath(),t.moveTo(r-o-4,n),t.lineTo(r+o+4,n),t.moveTo(r,n-o-4),t.lineTo(r,n+o+4),t.stroke(),t.restore()}_highlightIds(){if(this.highlightSegIds.length)return[...new Set(this.highlightSegIds)];if(this.selectedSegId>=0)return[this.selectedSegId];if(this._hoverLed>=0){const t=this._segmentForLed(this._hoverLed);return t>=0?[t]:[]}return[]}_paintSegmentSelection(t,e,i,s){const r=this._highlightIds();if(!r.length||0===this.segments.length)return;const n=this._accentStroke(),o=Math.max(1.25,Math.min(2.5,.45*s));t.save(),t.lineCap="round",t.lineJoin="round",t.shadowBlur=0;for(const s of r){const r=e.filter(t=>this._ledInSegment(t.led,s)).sort((t,e)=>t.led-e.led);if(r.length<2)continue;const[a,l]=i(r[0].x,r[0].y);t.beginPath(),t.moveTo(a,l);for(let e=1;e<r.length;e++){const[s,n]=i(r[e].x,r[e].y);t.lineTo(s,n)}t.strokeStyle="rgba(0, 0, 0, 0.55)",t.lineWidth=o+1.5,t.stroke(),t.strokeStyle=n,t.lineWidth=o,t.stroke()}t.restore()}render(){const t=this.paintMode?"Paint on layout — drag along the fixture path":this.compact?"Live layout preview — tap the strip to select a segment":"LED geometry preview — positions mapped from fixture layout",e=!this.paintMode&&"live"!==this._status&&"paint"!==this._status;return j`
    ...
    `]}};t([ht({attribute:!1})],je.prototype,"connection",void 0),t([ht()],je.prototype,"controllerId",void 0),t([ht()],je.prototype,"layoutId",void 0),t([ht()],je.prototype,"fixtureId",void 0),t([ht({type:Number})],je.prototype,"pixelCount",void 0),t([ht({type:Number})],je.prototype,"dotRadius",void 0),t([ht({type:Boolean,reflect:!0})],je.prototype,"compact",void 0),t([ht({type:Number})],je.prototype,"heightPx",void 0),t([ht({type:Boolean})],je.prototype,"externalLive",void 0),t([ht({type:Boolean,reflect:!0})],je.prototype,"paintMode",void 0),t([ht({type:Boolean})],je.prototype,"paintLivePreview",void 0),t([ht({type:Number})],je.prototype,"paintBrushSize",void 0),t([ht({type:Array})],je.prototype,"segments",void 0),t([ht({type:Number})],je.prototype,"selectedSegId",void 0),t([ht({type:Array})],je.prototype,"highlightSegIds",void 0),t([dt()],je.prototype,"_positions",void 0),t([dt()],je.prototype,"_status",void 0),t([dt()],je.prototype,"_showDots",void 0),t([dt()],je.prototype,"_closed",void 0),je=t([Me("wled-geometry-preview")],je);const We="wled-toast";function Ve(t,e){const i=e.trim();i&&t.dispatchEvent(new CustomEvent(We,{detail:{message:i},bubbles:!0,composed:!0}))}class qe extends Error{constructor(t,e){super("Scene conflict"),this.name="SceneConflictError",this.remote=t,this.etag=e}}async function Ge(t,e){return await $t(t),t.sendMessagePromise({...e,schema_version:1})}async function Ye(t,e){return(await Ge(t,{type:"wled_studio/scene_list",controller_id:e})).scenes??[]}async function Ke(t,e,i,s){try{return(await Ge(t,{type:"wled_studio/scene_capture",controller_id:e,name:i,scene_id:s?.sceneId,layout_id:s?.layoutId,transition_ms:s?.transitionMs??2500})).scene??{id:"",controller_id:e,name:i,wled_state:{}}}catch(t){const e=t;if("conflict"===e?.code&&e.data?.scene)throw new qe(e.data.scene,String(e.data.etag??e.message??""));throw t}}function Xe(t,e){const i=new Set(t);return i.has(e)?i.delete(e):i.add(e),[...i].sort((t,e)=>t-e)}function Je(t,e){const i=t.id,s=e.find(t=>t.wled_segment_id===i||t.segment_index===i||t.entity_id.endsWith(`_segment_${i}`));return`${("string"==typeof t.n&&t.n.trim()?t.n.trim():"")||s?.name?.replace(/^.*\s—\s/,"")||`Seg ${i+1}`} (${t.start??"?"}–${t.stop??"?"})`}const Ze="wled_studio.effect_defaults",Qe="wled_studio.effect_library";function ti(t){return Number.isFinite(t)?Math.min(255,Math.max(0,Math.round(t))):null}function ei(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function ii(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function si(t,e){if(!t)return null;const i=function(t){return ei(Ze)[t]??{}}(t)[String(e)];return i??null}function ri(t){return t?ei(Qe)[t]??[]:[]}function ni(t){if(t instanceof Error)return t.message;if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t;if("string"==typeof e.message)return"string"==typeof e.code?`${e.code}: ${e.message}`:e.message;const i=e.error;if(i&&"object"==typeof i){const t=i;if("string"==typeof t.message)return"string"==typeof t.code?`${t.code}: ${t.message}`:t.message}if("string"==typeof e.code)return e.code}try{return JSON.stringify(t)}catch{return"Unknown error"}}const oi={all:"All","1d":"1D","2d":"2D",solid:"Solid",sound:"Music",palette:"Palette"};function ai(t){return void 0!==t.Solid?t.Solid:0}const li=/\b(dj|sound|music|audio|beat|freq|grav|jugg|ripple|water|pixel|rock|streak|popcorn|balls|fireworks|matrix|stream|peak|level|radio|sync|reactive|volume|puddle|ripple|noisem|noisep|noisemove|pixels|juggle|sinelon|phased|blurz|djlight)\b/i;function ci(t,e,i,s,r){if("all"===i)return!0;const n=s[e]??null,o=t.toLowerCase();return"solid"===i?e===ai(r):"2d"===i?"2"===n||o.includes("2d"):"1d"===i?"2"!==n&&!o.includes("2d"):"sound"===i?function(t,e,i){const s=i[e]??null;return"v"===s||"f"===s||li.test(t)}(t,e,s):"palette"!==i||(o.includes("palette")||o.includes("colorloop")||o.includes("pride")||o.includes("cycle"))}const hi="wled_studio.segment_snapshot",di="wled_studio.merge_for_effects",pi=["start","stop","len","grp","spc","of","on","bri","col","fx","sx","ix","c1","c2","c3","o1","o2","o3","pal","n","rev","mi","sel","awm"];function ui(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function gi(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function fi(t){if(!t)return!1;const e=ui(di);return!(t in e)||Boolean(e[t])}function mi(t){if(!t)return!1;const e=ui(di);return t in e&&Boolean(e[t])}function _i(t,e){const i=t.find(t=>0===t.id);if(!i||e<=0)return!1;return(i.stop??0)-(i.start??0)>=.9*e}function bi(t,e){const i=ui(di);e?i[t]=!0:delete i[t],gi(di,i)}function vi(t){return ui(hi)[t]??null}function yi(t,e,i){const s={savedAt:Date.now(),segments:e.map(t=>({...t})),pixelCount:i},r=ui(hi);return r[t]=s,gi(hi,r),s}function wi(t){return{seg:t.segments.map(t=>function(t){const e=t,i={id:t.id};for(const t of pi){const s=e[t];void 0!==s&&(i[t]=s)}return i}(t))}}function xi(t,e,i){const s=t.length?[...t].sort((t,e)=>t.id-e.id):[{id:0,start:0,stop:e,on:!0}],r=i?.length?new Set(i):null,n=r?s.filter(t=>r.has(t.id)):s,o=n.filter(t=>(t.stop??0)>(t.start??0)),a=o.length?o:n.length?n:s,l=Math.min(...a.map(t=>t.start??0)),c=Math.max(...a.map(t=>t.stop??e)),h=a[0],d={id:0,start:l,stop:c,on:!1!==h.on,sel:!0,bri:h.bri??255,fx:h.fx??0,n:"Merged (effects)"};void 0!==h.col&&(d.col=h.col),void 0!==h.pal&&(d.pal=h.pal);const p=[d];for(const t of s){if(0===t.id)continue;const e=t.stop??t.start??0;p.push({id:t.id,start:e,stop:e,on:!1,sel:!1})}return{seg:p}}function $i(t,e){const i=t.find(t=>0===t.id);return i?[0]:t.length?[t[0].id]:[0]}function Si(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:At(t.col),awm:t.awm};return JSON.stringify(e)}function Ii(t,e,i){let s,r=null,n=0;const o=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await kt(t,e)).segments??[]).find(t=>t.id===n);if(!s||!r)return;const o=Si(r);if(o===Si(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(At(t.col))!==JSON.stringify(At(e.col))}(r,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=It((s,a)=>{r=a,n=a.id,Ct(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(r={...a,...i,id:a.id}),o()}).catch(t=>{i(a,`Failed to apply state to WLED: ${ni(t)}`)})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var ki,Ci,Pi,Mi,Ei,Ai={},Ti=[],Li=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function Di(t,e){for(var i in e)t[i]=e[i];return t}function Ni(t){var e=t.parentNode;e&&e.removeChild(t)}function Bi(t,e,i){var s,r,n,o,a=arguments;if(e=Di({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(r in t.defaultProps)void 0===e[r]&&(e[r]=t.defaultProps[r]);return o=e.key,null!=(n=e.ref)&&delete e.ref,null!=o&&delete e.key,Oi(t,e,o,n)}function Oi(t,e,i,s){var r={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return ki.vnode&&ki.vnode(r),r}function Ri(t){return t.children}function Fi(t,e){this.props=t,this.context=e}function zi(t,e){if(null==e)return t.__p?zi(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?zi(t):null}function Ui(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return Ui(t)}}function Hi(t){(!t.__d&&(t.__d=!0)&&1===Ci.push(t)||Mi!==ki.debounceRendering)&&(Mi=ki.debounceRendering,(ki.debounceRendering||Pi)(ji))}function ji(){var t,e,i,s,r,n,o,a;for(Ci.sort(function(t,e){return e.__v.__b-t.__v.__b});t=Ci.pop();)t.__d&&(i=void 0,s=void 0,n=(r=(e=t).__v).__e,o=e.__P,a=e.u,e.u=!1,o&&(i=[],s=Ki(o,r,Di({},r),e.__n,void 0!==o.ownerSVGElement,null,i,a,null==n?zi(r):n),Xi(i,r),s!=n&&Ui(r)))}function Wi(t,e,i,s,r,n,o,a,l){var c,h,d,p,u,g,f,m=i&&i.__k||Ti,_=m.length;if(a==Ai&&(a=null!=n?n[0]:_?zi(i,0):null),c=0,e.__k=Vi(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=m[c])||d&&i.key==d.key&&i.type===d.type)m[c]=void 0;else for(h=0;h<_;h++){if((d=m[h])&&i.key==d.key&&i.type===d.type){m[h]=void 0;break}d=null}if(p=Ki(t,i,d=d||Ai,s,r,n,o,null,a,l),(h=i.ref)&&d.ref!=h&&(f||(f=[])).push(h,i.__c||p,i),null!=p){if(null==g&&(g=p),null!=i.l)p=i.l,i.l=null;else if(n==d||p!=a||null==p.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(p);else{for(u=a,h=0;(u=u.nextSibling)&&h<_;h+=2)if(u==p)break t;t.insertBefore(p,a)}"option"==e.type&&(t.value="")}a=p.nextSibling,"function"==typeof e.type&&(e.l=p)}}return c++,i}),e.__e=g,null!=n&&"function"!=typeof e.type)for(c=n.length;c--;)null!=n[c]&&Ni(n[c]);for(c=_;c--;)null!=m[c]&&Qi(m[c],m[c]);if(f)for(c=0;c<f.length;c++)Zi(f[c],f[++c],f[++c])}function Vi(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)Vi(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return Oi(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=Oi(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function qi(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===Li.test(e)?i+"px":null==i?"":i}function Gi(t,e,i,s,r){var n,o,a,l,c;if("key"===(e=r?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(n=t.style,"string"==typeof i)n.cssText=i;else{if("string"==typeof s&&(n.cssText="",s=null),s)for(o in s)i&&o in i||qi(n,o,"");if(i)for(a in i)s&&i[a]===s[a]||qi(n,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),c=e.toLowerCase(),e=(c in t?c:e).slice(2),i?(s||t.addEventListener(e,Yi,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,Yi,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!r&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function Yi(t){return this.t[t.type](ki.event?ki.event(t):t)}function Ki(t,e,i,s,r,n,o,a,l,c){var h,d,p,u,g,f,m,_,b,v,y=e.type;if(void 0!==e.constructor)return null;(h=ki.__b)&&h(e);try{t:if("function"==typeof y){if(_=e.props,b=(h=y.contextType)&&s[h.__c],v=h?b?b.props.value:h.__p:s,i.__c?m=(d=e.__c=i.__c).__p=d.__E:("prototype"in y&&y.prototype.render?e.__c=d=new y(_,v):(e.__c=d=new Fi(_,v),d.constructor=y,d.render=ts),b&&b.sub(d),d.props=_,d.state||(d.state={}),d.context=v,d.__n=s,p=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=y.getDerivedStateFromProps&&Di(d.__s==d.state?d.__s=Di({},d.__s):d.__s,y.getDerivedStateFromProps(_,d.__s)),p)null==y.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&o.push(d);else{if(null==y.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(_,v),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(_,d.__s,v)){for(d.props=_,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,h=0;h<e.__k.length;h++)e.__k[h]&&(e.__k[h].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(_,d.__s,v)}for(u=d.props,g=d.state,d.context=v,d.props=_,d.state=d.__s,(h=ki.__r)&&h(e),d.__d=!1,d.__v=e,d.__P=t,h=d.render(d.props,d.state,d.context),e.__k=Vi(null!=h&&h.type==Ri&&null==h.key?h.props.children:h),null!=d.getChildContext&&(s=Di(Di({},s),d.getChildContext())),p||null==d.getSnapshotBeforeUpdate||(f=d.getSnapshotBeforeUpdate(u,g)),Wi(t,e,i,s,r,n,o,l,c),d.base=e.__e;h=d.__h.pop();)d.__s&&(d.state=d.__s),h.call(d);p||null==u||null==d.componentDidUpdate||d.componentDidUpdate(u,g,f),m&&(d.__E=d.__p=null)}else e.__e=Ji(i.__e,e,i,s,r,n,o,c);(h=ki.diffed)&&h(e)}catch(t){ki.__e(t,e,i)}return e.__e}function Xi(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){ki.__e(t,i.__v)}ki.__c&&ki.__c(e)}function Ji(t,e,i,s,r,n,o,a){var l,c,h,d,p=i.props,u=e.props;if(r="svg"===e.type||r,null==t&&null!=n)for(l=0;l<n.length;l++)if(null!=(c=n[l])&&(null===e.type?3===c.nodeType:c.localName===e.type)){t=c,n[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(u);t=r?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),n=null}return null===e.type?p!==u&&(null!=n&&(n[n.indexOf(t)]=null),t.data=u):e!==i&&(null!=n&&(n=Ti.slice.call(t.childNodes)),h=(p=i.props||Ai).dangerouslySetInnerHTML,d=u.dangerouslySetInnerHTML,a||(d||h)&&(d&&h&&d.__html==h.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,r){var n;for(n in i)n in e||Gi(t,n,null,i[n],s);for(n in e)r&&"function"!=typeof e[n]||"value"===n||"checked"===n||i[n]===e[n]||Gi(t,n,e[n],i[n],s)}(t,u,p,r,a),e.__k=e.props.children,d||Wi(t,e,i,s,"foreignObject"!==e.type&&r,n,o,Ai,a),a||("value"in u&&void 0!==u.value&&u.value!==t.value&&(t.value=null==u.value?"":u.value),"checked"in u&&void 0!==u.checked&&u.checked!==t.checked&&(t.checked=u.checked))),t}function Zi(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){ki.__e(t,i)}}function Qi(t,e,i){var s,r,n;if(ki.unmount&&ki.unmount(t),(s=t.ref)&&Zi(s,null,e),i||"function"==typeof t.type||(i=null!=(r=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){ki.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(n=0;n<s.length;n++)s[n]&&Qi(s[n],e,i);null!=r&&Ni(r)}function ts(t,e,i){return this.constructor(t,i)}function es(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function is(){return is=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var r in s)Object.prototype.hasOwnProperty.call(s,r)&&(t[r]=s[r])}return t},is.apply(this,arguments)}ki={},Fi.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=Di({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&Di(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),Hi(this))},Fi.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,Hi(this))},Fi.prototype.render=Ri,Ci=[],Pi="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Mi=ki.debounceRendering,ki.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return Hi(s.__E=s)}catch(e){t=e}throw t},Ei=Ai;var ss="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",rs="[\\s|\\(]+("+ss+")[,|\\s]+("+ss+")[,|\\s]+("+ss+")\\s*\\)?",ns="[\\s|\\(]+("+ss+")[,|\\s]+("+ss+")[,|\\s]+("+ss+")[,|\\s]+("+ss+")\\s*\\)?",os=new RegExp("rgb"+rs),as=new RegExp("rgba"+ns),ls=new RegExp("hsl"+rs),cs=new RegExp("hsla"+ns),hs="^(?:#?|0x?)",ds="([0-9a-fA-F]{1})",ps="([0-9a-fA-F]{2})",us=new RegExp(hs+ds+ds+ds+"$"),gs=new RegExp(hs+ds+ds+ds+ds+"$"),fs=new RegExp(hs+ps+ps+ps+"$"),ms=new RegExp(hs+ps+ps+ps+ps+"$"),_s=Math.log,bs=Math.round,vs=Math.floor;function ys(t,e,i){return Math.min(Math.max(t,e),i)}function ws(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function xs(t){return parseInt(t,16)}function $s(t){return t.toString(16).padStart(2,"0")}var Ss=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=is({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=is({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,r=vs(e),n=e-r,o=s*(1-i),a=s*(1-n*i),l=s*(1-(1-n)*i),c=r%6,h=[l,s,s,a,o,o][c],d=[o,o,l,s,s,a][c];return{r:ys(255*[s,a,o,o,l,s][c],0,255),g:ys(255*h,0,255),b:ys(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,r=Math.max(e,i,s),n=Math.min(e,i,s),o=r-n,a=0,l=r,c=0===r?0:o/r;switch(r){case n:a=0;break;case e:a=(i-s)/o+(i<s?6:0);break;case i:a=(s-e)/o+2;break;case s:a=(e-i)/o+4}return{h:60*a%360,s:ys(100*c,0,100),v:ys(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,r=s<=1?s:2-s,n=r<1e-9?0:e*i/r;return{h:t.h,s:ys(100*n,0,100),l:ys(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:ys(100*s,0,100),v:ys((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,r=t/100;return r<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=r-2)+104.49216199393888*_s(i),s=r<20?0:.8274096064007395*(s=r-10)-254.76935184120902+115.67994401066147*_s(s)):(e=351.97690566805693+.114206453784165*(e=r-55)-40.25366309332127*_s(e),i=325.4494125711974+.07943456536662342*(i=r-50)-28.0852963507957*_s(i),s=255),{r:ys(vs(e),0,255),g:ys(vs(i),0,255),b:ys(vs(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,r=e.b,n=2e3,o=4e4;o-n>.4;){i=.5*(o+n);var a=t.kelvinToRgb(i);a.b/a.r>=r/s?o=i:n=i}return i},es(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=is({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return is({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=is({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=is({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=is({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=is({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,r=e.b;return{r:bs(i),g:bs(s),b:bs(r)}},set:function(e){this.hsv=is({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return is({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,r=e.l;return{h:bs(i),s:bs(s),l:bs(r)}},set:function(e){this.hsv=is({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return is({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,r,n=1;if((e=os.exec(t))?(i=ws(e[1],255),s=ws(e[2],255),r=ws(e[3],255)):(e=as.exec(t))&&(i=ws(e[1],255),s=ws(e[2],255),r=ws(e[3],255),n=ws(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:r,a:n}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+$s(t.r)+$s(t.g)+$s(t.b)},set:function(t){var e,i,s,r,n=255;if((e=us.exec(t))?(i=17*xs(e[1]),s=17*xs(e[2]),r=17*xs(e[3])):(e=gs.exec(t))?(i=17*xs(e[1]),s=17*xs(e[2]),r=17*xs(e[3]),n=17*xs(e[4])):(e=fs.exec(t))?(i=xs(e[1]),s=xs(e[2]),r=xs(e[3])):(e=ms.exec(t))&&(i=xs(e[1]),s=xs(e[2]),r=xs(e[3]),n=xs(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:r,a:n/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+$s(t.r)+$s(t.g)+$s(t.b)+$s(vs(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,r,n=1;if((e=ls.exec(t))?(i=ws(e[1],360),s=ws(e[2],100),r=ws(e[3],100)):(e=cs.exec(t))&&(i=ws(e[1],360),s=ws(e[2],100),r=ws(e[3],100),n=ws(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:r,a:n}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function Is(t){var e,i=t.width,s=t.sliderSize,r=t.borderWidth,n=t.handleRadius,o=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*o+2*n,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*o-2*n,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-r/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function ks(t,e){var i=Is(t),s=i.width,r=i.height,n=i.handleRange,o=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var r=t.minTemperature,n=t.maxTemperature-r,o=(e.kelvin-r)/n*100;return Math.max(0,Math.min(o,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),c=a?s/2:r/2,h=o+l/100*n;return a&&(h=-1*h+n+2*o),{x:a?c:h,y:a?h:c}}var Cs,Ps=2*Math.PI,Ms=function(t,e){return Math.sqrt(t*t+e*e)};function Es(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function As(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function Ts(t,e,i){var s=t.wheelAngle,r=t.wheelDirection;return i&&"clockwise"===r?e=s+e:"clockwise"===r?e=360-s+e:i&&"anticlockwise"===r?e=s+180-e:"anticlockwise"===r&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function Ls(t,e,i){var s=As(t),r=s.cx,n=s.cy,o=Es(t);e=r-e,i=n-i;var a=Ts(t,Math.atan2(-i,-e)*(360/Ps)),l=Math.min(Ms(e,i),o);return{h:Math.round(a),s:Math.round(100/o*l)}}function Ds(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function Ns(t,e,i){var s=Ds(t),r=s.width,n=s.height,o=s.radius,a=(e-o)/(r-2*o)*100,l=(i-o)/(n-2*o)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function Bs(t){Cs||(Cs=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),r=window.location;return(i||s)&&Cs.length>0?r.protocol+"//"+r.host+r.pathname+r.search+t:t}function Os(t,e,i,s){for(var r=0;r<s.length;r++){var n=s[r].x-e,o=s[r].y-i;if(Math.sqrt(n*n+o*o)<t.handleRadius)return r}return null}function Rs(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function Fs(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function zs(t){return"string"==typeof t?t:t+"px"}var Us=["mousemove","touchmove","mouseup","touchend"],Hs=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,r=null===t.margin?t.sliderMargin:t.margin,n={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(n[s?"marginLeft":"marginTop"]=r),Bi(Ri,null,t.children(this.uid,i,n))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var r=t.touches?t.changedTouches[0]:t,n=r.clientX-s.left,o=r.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(n,o,0)&&Us.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(n,o,1);break;case"mouseup":case"touchend":i(n,o,2),Us.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(Fi);function js(t){var e=t.r,i=t.url,s=e,r=e;return Bi("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+zs(t.x)+", "+zs(t.y)+")",willChange:"transform",top:zs(-e),left:zs(-e),width:zs(2*e),height:zs(2*e),position:"absolute",overflow:"visible"}},i&&Bi("use",Object.assign({xlinkHref:Bs(i)},t.props)),!i&&Bi("circle",{cx:s,cy:r,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&Bi("circle",{cx:s,cy:r,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function Ws(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=Is(t),r=s.width,n=s.height,o=s.radius,a=ks(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var r=[],n=t.minTemperature,o=t.maxTemperature,a=o-n,l=n,c=0;l<o;l+=a/8,c+=1){var h=Ss.kelvinToRgb(l),d=h.r,p=h.g,u=h.b;r.push([12.5*c,"rgb("+d+","+p+","+u+")"])}return r;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var g=Ss.hsvToHsl({h:i.h,s:0,v:i.v}),f=Ss.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"],[100,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"]];default:var m=Ss.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+m.h+","+m.s+"%,"+m.l+"%)"]]}}(t,i);return Bi(Hs,Object.assign({},t,{onInput:function(e,s,r){var n=function(t,e,i){var s,r=Is(t),n=r.handleRange,o=r.handleStart;s="horizontal"===t.layoutDirection?-1*i+n+o:e-o,s=Math.max(Math.min(s,n),0);var a=Math.round(100/n*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=n,t.onInput(r,t.id)}}),function(e,s,c){return Bi("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:zs(r),height:zs(n),borderRadius:zs(o),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),Bi("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:zs(o),background:Fs("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},Rs(t))}),Bi(js,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function Vs(t){var e=Ds(t),i=e.width,s=e.height,r=e.radius,n=t.colors,o=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,c=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],h=n.map(function(e){return function(t,e){var i=Ds(t),s=i.width,r=i.height,n=i.radius,o=e.hsv,a=n,l=s-2*n,c=r-2*n;return{x:a+o.s/100*l,y:a+(c-o.v/100*c)}}(t,e)});return Bi(Hs,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var r=Os(t,e,i,h);null!==r?o.setActiveColor(r):(o.inputActive=!0,l.hsv=Ns(t,e,i),t.onInput(s,t.id))}else 1===s&&(o.inputActive=!0,l.hsv=Ns(t,e,i));t.onInput(s,t.id)}}),function(e,o,a){return Bi("div",Object.assign({},o,{className:"IroBox",style:Object.assign({},{width:zs(i),height:zs(s),position:"relative"},a)}),Bi("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:zs(r)},Rs(t),{background:Fs("linear","to bottom",c[1])+","+Fs("linear","to right",c[0])})}),n.filter(function(t){return t!==l}).map(function(e){return Bi(js,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[e.index].x,y:h[e.index].y})}),Bi(js,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[l.index].x,y:h[l.index].y}))})}js.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},Ws.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function qs(t){var e=As(t).width,i=t.colors;t.borderWidth;var s=t.parent,r=t.color,n=r.hsv,o=i.map(function(e){return function(t,e){var i=e.hsv,s=As(t),r=s.cx,n=s.cy,o=Es(t),a=(180+Ts(t,i.h,!0))*(Ps/360),l=i.s/100*o,c="clockwise"===t.wheelDirection?-1:1;return{x:r+l*Math.cos(a)*c,y:n+l*Math.sin(a)*c}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return Bi(Hs,Object.assign({},t,{onInput:function(e,i,n){if(0===n){if(!function(t,e,i){var s=As(t),r=s.cx,n=s.cy,o=t.width/2;return Ms(r-e,n-i)<o}(t,e,i))return!1;var a=Os(t,e,i,o);null!==a?s.setActiveColor(a):(s.inputActive=!0,r.hsv=Ls(t,e,i),t.onInput(n,t.id))}else 1===n&&(s.inputActive=!0,r.hsv=Ls(t,e,i));t.onInput(n,t.id)}}),function(s,l,c){return Bi("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:zs(e),height:zs(e),position:"relative"},c)}),Bi("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),Bi("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&Bi("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-n.v/100})}),Bi("div",{className:"IroWheelBorder",style:Object.assign({},a,Rs(t))}),i.filter(function(t){return t!==r}).map(function(e){return Bi(js,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[e.index].x,y:o[e.index].y})}),Bi(js,{isActive:!0,index:r.index,fill:r.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[r.index].x,y:o[r.index].y}))})}var Gs=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new Ss(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var r=this.activeEvents;!!r.hasOwnProperty(t)&&r[t]||(r[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),r[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var r=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(r[t]||(r[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:qs},{component:Ws}],e.transparency&&s.push({component:Ws,options:{sliderType:"alpha"}})),Bi("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var r=t.component,n=t.options;return Bi(r,Object.assign({},e,n,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(Fi);Gs.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var Ys,Ks,Xs,Js=(Ks=function(t,e){var i,s=document.createElement("div");function r(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,r,n;ki.__p&&ki.__p(t,e),r=(s=i===Ei)?null:e.__k,t=Bi(Ri,null,[t]),n=[],Ki(e,e.__k=t,r||Ai,Ai,void 0!==e.ownerSVGElement,r?null:Ti.slice.call(e.childNodes),n,!1,Ai,s),Xi(n,t)}(Bi(Ys,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?r():document.addEventListener("DOMContentLoaded",r),i},Ks.prototype=(Ys=Gs).prototype,Object.assign(Ks,Ys),Ks.__component=Ys,Ks);!function(t){var e;t.version="5.5.2",t.Color=Ss,t.ColorPicker=Js,(e=t.ui||(t.ui={})).h=Bi,e.ComponentBase=Hs,e.Handle=js,e.Slider=Ws,e.Wheel=qs,e.Box=Vs}(Xs||(Xs={}));var Zs=Xs;const Qs="wled_studio.color_swatches";function tr(t){return t.trim()||"_default"}function er(){try{const t=localStorage.getItem(Qs);if(!t)return{};const e=JSON.parse(t);return e&&"object"==typeof e?e:{}}catch{return{}}}function ir(t){const e=er()[tr(t)];return Array.isArray(e)?[...e]:[]}function sr(t,e){const i=er();var s;i[tr(t)]=e.slice(0,32),s=i,localStorage.setItem(Qs,JSON.stringify(s))}function rr(t,e){return`${t[0]},${t[1]},${t[2]},${e}`}function nr(t,e){const i="#"+[t[0],t[1],t[2]].map(t=>Math.max(0,Math.min(255,t)).toString(16).padStart(2,"0")).join("");return e>0?`${i} +W`:i.toUpperCase()}let or=class extends bt{constructor(){super(...arguments),this.controllerId="",this.rgb=[255,128,0],this.white=0,this._swatches=[],this._saving=!1,this._saveName="",this._editingId=null,this._editName="",this._pressTimer=null,this._pressSwatch=null,this._suppressChipClick=!1}onPoweredConnect(){this._reload()}updated(t){super.updated(t),t.has("controllerId")&&this._reload()}_reload(){this._swatches=ir(this.controllerId)}_currentKey(){return rr(this.rgb,this.white)}_swatchCss(t){const[e,i,s]=t.rgb;return t.white>0?`linear-gradient(135deg, rgb(${e},${i},${s}) 55%, rgba(255,255,255,0.95) 55%)`:`rgb(${e},${i},${s})`}_apply(t){this.dispatchEvent(new CustomEvent("swatch-select",{detail:{rgb:[...t.rgb],white:t.white},bubbles:!0,composed:!0}))}_openSave(){this._saveName=nr(this.rgb,this.white),this._saving=!0,this._editingId=null}_confirmSave(){!function(t,e){const i=ir(t),s=rr(e.rgb,e.white),r=i.find(t=>rr(t.rgb,t.white)===s);if(r)return r.name=e.name.trim()||r.name,sr(t,i),r;const n={id:`sw_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,name:e.name.trim()||nr(e.rgb,e.white),rgb:[...e.rgb],white:e.white};i.unshift(n),sr(t,i)}(this.controllerId,{name:this._saveName,rgb:this.rgb,white:this.white}),this._saving=!1,this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_cancelSave(){this._saving=!1}_startEdit(t,e){e.stopPropagation(),this._editingId=t.id,this._editName=t.name,this._saving=!1}_confirmEdit(){this._editingId&&(!function(t,e,i){const s=ir(t),r=s.findIndex(t=>t.id===e);if(r<0)return null;const n=s[r],o={...n,...i,rgb:i.rgb?[...i.rgb]:n.rgb};void 0!==i.name&&(o.name=i.name.trim()||nr(o.rgb,o.white)),s[r]=o,sr(t,s)}(this.controllerId,this._editingId,{name:this._editName}),this._editingId=null,this._reload())}_cancelEdit(){this._editingId=null}_delete(t,e){e?.stopPropagation(),function(t,e){const i=ir(t).filter(t=>t.id!==e);sr(t,i)}(this.controllerId,t),this._editingId===t&&(this._editingId=null),this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_clearPressTimer(){null!==this._pressTimer&&(clearTimeout(this._pressTimer),this._pressTimer=null),this._pressSwatch=null}_confirmDelete(t){confirm(`Delete swatch "${t.name}"?`)&&this._delete(t.id),this._suppressChipClick=!1}_onChipTouchStart(t){this._clearPressTimer(),this._pressSwatch=t,this._pressTimer=setTimeout(()=>{this._pressTimer=null,this._suppressChipClick=!0,this._confirmDelete(t)},500)}_onChipTouchEnd(){this._clearPressTimer()}_onChipTouchMove(t){if(!this._pressSwatch||1!==t.touches.length)return;const e=t.touches[0],i=t.currentTarget.getBoundingClientRect();(e.clientX<i.left-12||e.clientX>i.right+12||e.clientY<i.top-12||e.clientY>i.bottom+12)&&this._clearPressTimer()}_onChipClick(t,e){if(this._suppressChipClick)return this._suppressChipClick=!1,e.preventDefault(),void e.stopPropagation();this._apply(t)}render(){const t=this._currentKey();return j`
        ...
        ${0!==this._swatches.length||this._saving?j`
              <div class="grid" role="list">
                ${this._swatches.map(e=>j`
                    <div
                      class="chip-wrap ${rr(e.rgb,e.white)===t?"active":""}"
                      role="listitem"
                    >
                      <button
                        type="button"
    ...
    `]}};t([ht({type:Array,hasChanged:(t,e)=>!t||!e||!function(t,e){return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]}(t,e)})],ar.prototype,"rgb",void 0),t([ht({type:Number})],ar.prototype,"white",void 0),t([ht({type:Number})],ar.prototype,"awm",void 0),t([ht({type:Boolean})],ar.prototype,"showWhite",void 0),t([ht()],ar.prototype,"controllerId",void 0),t([pt(".wheel-host")],ar.prototype,"_host",void 0),ar=t([Me("wled-color-wheel-rgbw")],ar);function lr(t,e="strip",i,s=0){let r=String(t);return s&&(r=`${r}_p${s}`),i?.trim()&&(r=`${r}_${function(t){return(t||"").trim().replace(/[^\w.-]+/g,"_")||"unknown"}(i)}`),`${r}_${e}.webp`}function cr(t,e,i="strip",s,r=0){const n=e instanceof Set?e:new Set(e);if(!n.size)return;const o=[lr(t,i,s,r),lr(t,i,s),lr(t,i,void 0,r),lr(t,i)];for(const t of o)if(n.has(t))return t;const a=r?`${t}_p${r}_`:`${t}_`,l=`_${i}.webp`;for(const t of n)if(t.startsWith(a)&&t.endsWith(l))return t;return r?cr(t,n,i,s,0):void 0}function hr(t,e,i="strip",s,r,n,o=0){if(!t||e<0)return;const a=void 0!==n?cr(e,n,i,s,o):lr(e,i,s,o);return a?function(t,e){if(!t.startsWith("/"))return t;const i=e?.auth?.data?.access_token;if(!i)return t;const s=t.includes("?")?"&":"?";return`${t}${s}auth=${encodeURIComponent(i)}`}(function(t,e){return`/local/wled_studio/thumbs/${encodeURIComponent(t)}/${encodeURIComponent(e)}`}(t,a),r):void 0}const dr="wled_studio.recent_effects",pr="wled_studio.recent_scenes";function ur(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function gr(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function fr(t){return t?ur(dr)[t]??[]:[]}function mr(t,e=72,i=6,s=10){if(t<=0)return 1;const r=e+i;return Math.max(1,Math.min(s,Math.floor((t+i)/r)))}const _r="wled_studio.pinned_effects";function br(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function vr(t,e,i){if(!t)return[];const s=br(_r),r=s[t]??[],n=r.findIndex(t=>t.id===e);return n>=0?r.splice(n,1):r.unshift({id:e,name:i}),s[t]=r,function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(_r,s),s[t]}let yr=class extends bt{constructor(){super(...arguments),this.fxId=0,this.thumbUrl="",this.thumbUrlAnimated="",this.label="",this.listboxOption=!1,this.selected=!1,this._hover=!1}render(){const t=this.thumbUrlAnimated||(this.thumbUrl.endsWith(".webp")?this.thumbUrl:""),e=this.thumbUrl||t,i=this._hover&&t?t:e,s=this.label||`Effect ${this.fxId}`;return j`
      <button
        class="tile"
        type="button"
        aria-label=${s}
    ...
    `]}};t([ht({type:Number})],yr.prototype,"fxId",void 0),t([ht()],yr.prototype,"thumbUrl",void 0),t([ht()],yr.prototype,"thumbUrlAnimated",void 0),t([ht()],yr.prototype,"label",void 0),t([ht({type:Boolean,attribute:"listbox-option"})],yr.prototype,"listboxOption",void 0),t([ht({type:Boolean})],yr.prototype,"selected",void 0),t([dt()],yr.prototype,"_hover",void 0),yr=t([Me("wled-effect-tile")],yr);let wr=class extends bt{constructor(){super(...arguments),this.effectsByName={},this.soundFlags=[],this.selectedFx=0,this.filter="",this.controllerId="",this.fwVer="",this.thumbBasenames=[],this.toggleOff=!0,this.showRecents=!0,this.tileGrid=!1,this.scrollPane=!1,this.selectedPalette=0,this.paletteAware=!1,this._category="all",this._recentEntries=[],this._pinnedEntries=[],this._recentVisible=6}onPoweredConnect(){this._loadRecents(),this._ro=new ResizeObserver(()=>this._measureRecents()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._loadRecents();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._recentRowEl&&(this._recentRowEl=e,this._ro?.observe(e),this._measureRecents())}_loadRecents(){var t;this._recentEntries=fr(this.controllerId),this._pinnedEntries=(t=this.controllerId)?br(_r)[t]??[]:[],this.soundFlags.length&&!this.soundFlags.some(t=>"v"===t||"f"===t)&&console.debug(`[wled-studio] sound_flags for ${this.controllerId} contain no v/f entries — Music filter will rely on name heuristics`)}_togglePin(t,e){e.stopPropagation(),this.controllerId&&(this._pinnedEntries=vr(this.controllerId,t,this._effectName(t)))}_measureRecents(){const t=this._recentRowEl;if(!t)return;const e=mr(t.clientWidth,76,6,10);e!==this._recentVisible&&(this._recentVisible=e)}_effectName(t){return Object.entries(this.effectsByName).find(([,e])=>e===t)?.[0]??`Effect ${t}`}render(){const t=this.filter.trim().toLowerCase(),e=Object.keys(this.effectsByName).sort((t,e)=>t.localeCompare(e)),i=ai(this.effectsByName),s=e.filter(e=>!!ci(e,this.effectsByName[e],this._category,this.soundFlags,this.effectsByName)&&!(t&&!e.toLowerCase().includes(t))),r=this.showRecents&&!t&&this._recentEntries.length>0,n=this._recentEntries.slice(0,this._recentVisible),o=!t&&this._pinnedEntries.length>0;return j`
      ...
      >
        ...
        <div class="grid" role="listbox" aria-label="Effects">
          ${0===s.length?j`<p class="empty">No effects match this filter.</p>`:s.map(t=>{const e=this.effectsByName[t],s=this.soundFlags[e],r=e===this.selectedFx,n=hr(this.controllerId,e,"strip",this.fwVer,this.hass,this.thumbBasenames,this.paletteAware?this.selectedPalette:0),o=t+("v"===s?" ♪":"")+("f"===s?" ♫":"")+("2"===s?" 2D":"");return n?j`
                    <wled-effect-tile
    ...
    `]}};t([ht({type:Object})],wr.prototype,"effectsByName",void 0),t([ht({type:Array})],wr.prototype,"soundFlags",void 0),t([ht({type:Number})],wr.prototype,"selectedFx",void 0),t([ht({type:String})],wr.prototype,"filter",void 0),t([ht()],wr.prototype,"controllerId",void 0),t([ht()],wr.prototype,"fwVer",void 0),t([ht({type:Array})],wr.prototype,"thumbBasenames",void 0),t([ht({type:Boolean})],wr.prototype,"toggleOff",void 0),t([ht({type:Boolean})],wr.prototype,"showRecents",void 0),t([ht({type:Boolean,attribute:"tile-grid"})],wr.prototype,"tileGrid",void 0),t([ht({type:Boolean,attribute:"scroll-pane"})],wr.prototype,"scrollPane",void 0),t([ht({type:Number})],wr.prototype,"selectedPalette",void 0),t([ht({type:Boolean,attribute:"palette-aware"})],wr.prototype,"paletteAware",void 0),t([dt()],wr.prototype,"_category",void 0),t([dt()],wr.prototype,"_recentEntries",void 0),t([dt()],wr.prototype,"_pinnedEntries",void 0),t([dt()],wr.prototype,"_recentVisible",void 0),wr=t([Me("wled-effect-chips")],wr);let xr=class extends bt{constructor(){super(...arguments),this.controllerId="",this.segments=[],this.editIds=[],this.pixelCount=210,this.compact=!1,this._merged=!1,this._busy=!1,this._error=""}onPoweredConnect(){this._merged=fi(this.controllerId)}willUpdate(t){t.has("controllerId")&&(this._merged=fi(this.controllerId))}render(){const t=vi(this.controllerId),e=t&&this._merged?`${t.segments.length} segment layout saved`:null;return j`
    ...
    `}async _onToggle(t){const e=t.target.checked;if(this.connection&&this.controllerId){this._busy=!0,this._error="";try{if(e){const t=await kt(this.connection,this.controllerId),e=t.segments??this.segments,i=t.info?.leds,s=Number(i?.count)||this.pixelCount;yi(this.controllerId,e,s);const r=xi(e,s,this.editIds.length?this.editIds:void 0);await Ct(this.connection,this.controllerId,r,{fullResponse:!0}),bi(this.controllerId,!0),this._merged=!0}else{const t=vi(this.controllerId);if(!t)throw new Error("No saved segment layout to restore");await Ct(this.connection,this.controllerId,wi(t),{fullResponse:!0}),bi(this.controllerId,!1),function(t){const e=ui(hi);delete e[t],gi(hi,e)}(this.controllerId),this._merged=!1}this.dispatchEvent(new CustomEvent("merge-changed",{detail:{merged:this._merged},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(e){this._error=e instanceof Error?e.message:String(e),t.target.checked=this._merged}finally{this._busy=!1}}}static{this.styles=[..._t,o`
      .merge-row {
        display: flex;
        gap: 10px;
        align-items: flex-start;
    ...
    `]}};t([ht({type:Object})],Ir.prototype,"palettesByName",void 0),t([ht({type:Object})],Ir.prototype,"palettePreviews",void 0),t([ht({type:Number})],Ir.prototype,"selectedPal",void 0),t([ht()],Ir.prototype,"filter",void 0),t([ht()],Ir.prototype,"deviceHost",void 0),t([ht({type:Boolean})],Ir.prototype,"compact",void 0),t([ht({type:Boolean,attribute:"collapsible"})],Ir.prototype,"collapsible",void 0),t([dt()],Ir.prototype,"_open",void 0),t([dt()],Ir.prototype,"_localFilter",void 0),t([dt()],Ir.prototype,"_editorOpen",void 0),Ir=t([Me("wled-palette-chips")],Ir);let kr=class extends bt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return j`
    ...
    `]}};t([ht({type:Array})],kr.prototype,"presets",void 0),kr=t([Me("wled-preset-bar")],kr);const Cr=["For each","Bar","Arc","Corner"],Pr=["Replace","Add","Subtract","Multiply","Lighten","Darken"],Mr=["Off","GEQ pulse","WaveSin","Sweep"];let Er=class extends bt{constructor(){super(...arguments),this.compact=!1}_emit(t){this.dispatchEvent(new CustomEvent("segment-patch",{detail:t,bubbles:!0,composed:!0}))}_num(t,e,i,s){const r=this.segment;if(!r)return null;const n=r[t]??i;return j`
      <label class="cell">
    ...
    `}render(){if(!this.segment)return null;const t=this.meta,e=[];for(const i of["o1","o2","o3"])if(t?.sliders?.[i]){const s="string"==typeof t.defaults?.[i]&&t.defaults[i].trim()?t.defaults[i]:i.toUpperCase();e.push({key:i,label:s})}return j`
      <details class="adv" ?open=${!this.compact}>
        ...
        <div class="grid">
          ...
          ${this._select("m12","1D-in-2D mode",Cr)}
          ${this._select("bm","Blend mode",Pr)}
        </div>
      </details>
    `}static{this.styles=[..._t,o`
      .adv {
    ...
    `]}};t([ht({attribute:!1})],Er.prototype,"segment",void 0),t([ht({attribute:!1})],Er.prototype,"meta",void 0),t([ht({type:Boolean})],Er.prototype,"compact",void 0),Er=t([Me("wled-segment-advanced")],Er);let Ar=class extends bt{constructor(){super(...arguments),this.width="100%",this.height="1rem",this.roundedFull=!1}render(){return j`
      <div
    ...
    `}render(){if(this._loading)return this._renderSkeleton();if(this._error)return j`<p class="err">${this._error}</p>`;const t=this._activeSeg();if(!t)return j`<p class="muted">No segments on this controller.</p>`;const e=this._cols(t),i=e[this._colorSlot]??e[0],s=this._meta,r=s?.sliders??{},n=!1!==s?.colors_enabled?3:1,o=this._snapshot?.rgbwm??0;return j`
      <div class="controls ${this.compact?"compact":""}">
          ...
          ${this._segments.map(t=>j`
              ...
              >
                ${this.compact?null:j`
                    ...
                    `}
                <span class="seg-label">${Je(t,this._snapshot?.segment_entities??[])}</span>
              </button>
            `)}
        </div>
            `}
        ...
        <div class="sliders">
          ${Object.entries(Tr).map(([e,i])=>{if(!r[e])return null;const s=t[e];return j`
              <label>
                ${i}
                <ha-slider
                  min="0"
    ...
    `}async _confirmSaveScene(){if(this.connection&&this.controllerId&&this._saveSceneName.trim())try{await Ke(this.connection,this.controllerId,this._saveSceneName.trim()),this._saveSceneOpen=!1,Ve(this,`Scene "${this._saveSceneName.trim()}" saved`)}catch(t){Ve(this,t instanceof Error?t.message:String(t))}}get segments(){return this._segments}static{this.styles=[..._t,o`
      .controls {
        display: flex;
        flex-direction: column;
        gap: 10px;
    ...
    `]}};t([ht({attribute:!1})],Lr.prototype,"connection",void 0),t([ht({attribute:!1})],Lr.prototype,"hass",void 0),t([ht()],Lr.prototype,"controllerId",void 0),t([ht({type:Boolean})],Lr.prototype,"compact",void 0),t([ht({type:Boolean})],Lr.prototype,"wholeMode",void 0),t([ht({type:Boolean,attribute:"hide-segment-brightness"})],Lr.prototype,"hideSegmentBrightness",void 0),t([ht({type:Number})],Lr.prototype,"selectedSegId",void 0),t([ht()],Lr.prototype,"masterEntity",void 0),t([dt()],Lr.prototype,"_loading",void 0),t([dt()],Lr.prototype,"_error",void 0),t([dt()],Lr.prototype,"_segId",void 0),t([dt()],Lr.prototype,"_editIds",void 0),t([dt()],Lr.prototype,"_segments",void 0),t([dt()],Lr.prototype,"_snapshot",void 0),t([dt()],Lr.prototype,"_meta",void 0),t([dt()],Lr.prototype,"_effectFilter",void 0),t([dt()],Lr.prototype,"_presets",void 0),t([dt()],Lr.prototype,"_colorSlot",void 0),t([dt()],Lr.prototype,"_mergeActive",void 0),t([dt()],Lr.prototype,"_saveSceneOpen",void 0),t([dt()],Lr.prototype,"_saveSceneName",void 0),Lr=t([Me("wled-segment-controls")],Lr);let Dr=class extends bt{constructor(){super(...arguments),this.segments=[],this.selectedIds=[],this.segmentEntities=[],this.hint="Tap segments to toggle",this._dragSegId=null}render(){return this.segments.length?j`
      <div class="block">
        ...
        <div class="bar" role="group" aria-label="Segments">
          ${this.segments.map(t=>j`
              ...
              >
                ...
                <span class="btn-label">${Je(t,this.segmentEntities)}</span>
              </button>
            `)}
        </div>
      </div>
    ...
    `]}};t([ht({type:Array})],Dr.prototype,"segments",void 0),t([ht({type:Array})],Dr.prototype,"selectedIds",void 0),t([ht({type:Array})],Dr.prototype,"segmentEntities",void 0),t([ht()],Dr.prototype,"hint",void 0),t([dt()],Dr.prototype,"_dragSegId",void 0),Dr=t([Me("wled-segment-bar")],Dr);const Nr={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Br=class extends bt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this._segments=[],this._editIds=[],this._focusSegId=0,this._filter="",this._status="Loading effects…",this._mergeActive=!1,this._library=[],this._saveCopyOpen=!1,this._saveCopyName="",this._saveSceneOpen=!1,this._saveSceneName="",this._needsMergeApply=!1}onPoweredConnect(){this._mergeActive=fi(this.controllerId),this._library=ri(this.controllerId),this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}async _refreshPalettePreviews(){if(this.connection&&this.controllerId&&this._snapshot)try{const t=await Mt(this.connection,this.controllerId);this._snapshot={...this._snapshot,palette_previews:t}}catch{}}_onPaletteCatalogChanged(){this._refreshPalettePreviews()}async _load(){if(this.connection&&this.controllerId){this._status="Loading effects…";try{if(this._snapshot=await kt(this.connection,this.controllerId),this._segments=[...this._snapshot.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length){const t=this._segments.map(t=>t.id),e=this._editIds.filter(e=>t.includes(e));this._editIds=e.length?e:t,t.includes(this._focusSegId)||(this._focusSegId=this._segments[0].id)}const t=this._pixelCount();this._mergeActive=fi(this.controllerId);const e=_i(this._segments,t);this._needsMergeApply=this._mergeActive&&this._segments.length>1&&!e,mi(this.controllerId)&&e&&(this._editIds=$i(this._segments),this._focusSegId=this._editIds[0]??0),await this._refreshMeta(),this._status="",this._emitTargetsChanged()}catch{this._status="Could not load device state."}}}get highlightSegmentIds(){return this._targetIds()}_emitTargetsChanged(){this.dispatchEvent(new CustomEvent("segment-targets-changed",{detail:{segmentId:this._focusSegId,editIds:[...this._editIds],mergeActive:this._mergeActive,highlightIds:this.highlightSegmentIds},bubbles:!0,composed:!0}))}async confirmMergeApply(){await this._applyMergeOnDevice(this._pixelCount()),this._needsMergeApply=!1,await this._load()}async _applyMergeOnDevice(t){if(!this.connection||!this.controllerId||!this._snapshot)return;yi(this.controllerId,this._segments,t);const e=xi(this._segments,t,this._editIds.length?this._editIds:void 0);await Ct(this.connection,this.controllerId,e,{fullResponse:!0}),bi(this.controllerId,!0),this._snapshot=await kt(this.connection,this.controllerId),this._segments=[...this._snapshot.segments??[]].sort((t,e)=>t.id-e.id)}_activeSeg(){return this._segments.find(t=>t.id===this._focusSegId)??this._segments[0]}async _refreshMeta(){const t=this._activeSeg();this.connection&&this.controllerId&&t&&(this._meta=await Pt(this.connection,this.controllerId,t.fx??0))}selectSegmentFromPreview(t){if(this._mergeActive)return this._focusSegId=0,this._refreshMeta(),void this._emitTargetsChanged();this._editIds.includes(t)||(this._editIds=[...this._editIds,t].sort((t,e)=>t-e)),this._focusSegId=t,this._refreshMeta(),this._emitTargetsChanged()}_onSegToggle(t){if(this._mergeActive)return;let e=Xe(this._editIds,t.detail.id);e.length||(e=[t.detail.id]),this._editIds=e,this._focusSegId=t.detail.id,this._refreshMeta(),this._emitTargetsChanged()}_pixelCount(){const t=this._snapshot?.info?.leds;return Number(t?.count)||210}_targetIds(){if(this._mergeActive){const t=$i(this._segments);return t.length?t:[0]}return this._editIds.length?this._editIds:[this._focusSegId]}_onMergeChanged(){this._mergeActive=fi(this.controllerId),this._load(),this._emitTargetsChanged()}_effectName(t){return Object.entries(this._snapshot?.effects_by_name??{}).find(([,e])=>e===t)?.[0]??`Effect ${t}`}_sliderValuesFromSeg(){const t=this._activeSeg();return t?function(t){const e={};for(const i of["sx","ix","c1","c2","c3","o1","o2","o3"]){const s=t[i];"number"==typeof s&&(e[i]=s)}return e}(t):{}}_saveAsDefault(){const t=this._activeSeg();t&&this.controllerId&&(!function(t,e,i){if(!t)return;const s=ei(Ze),r={...s[t]??{}};r[String(e)]={...i},s[t]=r,ii(Ze,s)}(this.controllerId,t.fx??0,this._sliderValuesFromSeg()),Ve(this,`Saved default options for ${this._effectName(t.fx??0)}`))}_openSaveCopy(){const t=this._activeSeg();t&&(this._saveCopyName=`${this._effectName(t.fx??0)} copy`,this._saveCopyOpen=!0)}_confirmSaveCopy(){const t=this._activeSeg();t&&this.controllerId&&this._saveCopyName.trim()&&(!function(t,e){const i={...e,id:`fx-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,savedAt:Date.now()},s=ei(Qe),r=[i,...s[t]??[]];s[t]=r.slice(0,48),ii(Qe,s)}(this.controllerId,{name:this._saveCopyName.trim(),effectId:t.fx??0,effectName:this._effectName(t.fx??0),pinned:!0,...this._sliderValuesFromSeg()}),this._library=ri(this.controllerId),this._saveCopyOpen=!1,Ve(this,`Saved "${this._saveCopyName.trim()}" to library`))}_openSaveScene(){const t=this._activeSeg();t&&(this._saveSceneName=`${this._effectName(t.fx??0)} scene`,this._saveSceneOpen=!0)}async _confirmSaveScene(){if(this.connection&&this.controllerId&&this._saveSceneName.trim())try{await Ke(this.connection,this.controllerId,this._saveSceneName.trim()),this._saveSceneOpen=!1,Ve(this,`Scene "${this._saveSceneName.trim()}" saved`)}catch(t){Ve(this,t instanceof Error?t.message:String(t))}}async _applyLibraryEntry(t){if(!this.connection||!this._snapshot)return;const e=this._targetIds(),i={fx:t.effectId,on:!0};for(const e of["sx","ix","c1","c2","c3","o1","o2","o3"]){const s=t[e];"number"==typeof s&&(i[e]=s)}const s=Dt(e,i,this._segments);await Ct(this.connection,this.controllerId,s),await this._load(),Ve(this,`Applied ${t.name}`)}_isLoading(){return"Loading effects…"===this._status}_renderSkeleton(){return j`
              ...
              <div class="merge-prompt">
                ...
                <div class="merge-prompt-row">
                  ...
                  <button
                    type="button"
                    class="ghost"
                    @click=${()=>{bi(this.controllerId,!1),this._mergeActive=!1,this._needsMergeApply=!1,this._emitTargetsChanged()}}
                  >
              ...
              <div class="effects-workspace ${o?"compact":""}">
                ...
                <div class="effects-tuning">
                  ...
                  <div class="sliders ${o?"compact":""}">
                    ${Object.entries(Nr).map(([t,i])=>{if(!r[t])return null;const s=e[t];return j`
                        <label>
                          ${i}
                          <ha-slider
                            min="0"
    ...
    `}async _onFx(t,e){if(!this.connection||!this._snapshot)return;const i=this._targetIds(),s=Dt(i,{fx:t,on:!0},this._segments);try{await Ct(this.connection,this.controllerId,s);for(const e of i){const i=this._segments.findIndex(t=>t.id===e);if(i>=0){const e=[...this._segments];e[i]={...e[i],fx:t,on:!0},this._segments=e}}this._focusSegId=i[0],await this._refreshMeta();const r=Object.entries(this._snapshot.effects_by_name).find(([,e])=>e===t)?.[0]??(e?"Solid":`#${t}`),n=si(this.controllerId,t);if(n&&Object.keys(n).length){const t=Dt(i,n,this._segments);await Ct(this.connection,this.controllerId,t)}Ve(this,e?`Solid on ${i.length} segment(s)`:`Applied ${r}`),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(t){Ve(this,`Apply failed: ${t.message||"error"}`)}}_slider(t,e){const i=ti(Number(e.target.value));null!==i&&this._segPatch({[t]:i})}async _segPatch(t){if(!this.connection||!this._snapshot)return;const e=this._targetIds(),i=Dt(e,t,this._segments);try{await Ct(this.connection,this.controllerId,i)}catch(t){return void Ve(this,`Apply failed: ${t.message||"error"}`)}const s=[...this._segments];for(const i of e){const e=s.findIndex(t=>t.id===i);e>=0&&(s[e]={...s[e],...t})}this._segments=s}static{this.styles=[..._t,o`
      .wrap {
        max-width: 100%;
      }
      :host {
    ...
    `]}};function Or(t,e){return Math.max(0,Math.min(255,Math.round(t*e)))}function Rr(t,e,i){return`rgb(${t}, ${e}, ${i})`}function Fr(t){return function(t){if(!t.length)return"linear-gradient(135deg, var(--wled-surface-elevated), var(--wled-surface))";if(1===t.length){const e=t[0];return`linear-gradient(135deg, ${e}, color-mix(in srgb, ${e} 55%, rgb(0 0 0)))`}const e=t.map((e,i)=>`${e} ${Math.round(i/(t.length-1)*100)}%`).join(", ");return`linear-gradient(135deg, ${e})`}(function(t){const e=t??{};if(!1===e.on)return["rgb(26, 26, 26)","rgb(13, 13, 13)"];const i="number"==typeof e.bri&&Number.isFinite(e.bri)?Math.max(0,Math.min(255,e.bri)):128,s=(Array.isArray(e.seg)?e.seg:[])[0]??{};if(!1===s.on)return["rgb(26, 26, 26)","rgb(13, 13, 13)"];const r=("number"==typeof s.bri&&Number.isFinite(s.bri)?Math.max(0,Math.min(255,s.bri)):i)/255,n=[];if(Array.isArray(s.col))for(const t of s.col.slice(0,3)){const[e,i,s]=Et(t);n.push(Rr(Or(e,r),Or(i,r),Or(s,r)))}if(!n.length){const t=Or(255,r),e=Or(220,r);n.push(Rr(t,e,Math.min(255,e-20)))}return n}(t.wled_state))}function zr(t){return Boolean(t.scene_thumb_url?.trim())}t([ht({attribute:!1})],Br.prototype,"connection",void 0),t([ht()],Br.prototype,"controllerId",void 0),t([ht({type:Boolean,reflect:!0})],Br.prototype,"compact",void 0),t([dt()],Br.prototype,"_snapshot",void 0),t([dt()],Br.prototype,"_segments",void 0),t([dt()],Br.prototype,"_editIds",void 0),t([dt()],Br.prototype,"_focusSegId",void 0),t([dt()],Br.prototype,"_filter",void 0),t([dt()],Br.prototype,"_status",void 0),t([dt()],Br.prototype,"_meta",void 0),t([dt()],Br.prototype,"_mergeActive",void 0),t([dt()],Br.prototype,"_library",void 0),t([dt()],Br.prototype,"_saveCopyOpen",void 0),t([dt()],Br.prototype,"_saveCopyName",void 0),t([dt()],Br.prototype,"_saveSceneOpen",void 0),t([dt()],Br.prototype,"_saveSceneName",void 0),t([dt()],Br.prototype,"_needsMergeApply",void 0),Br=t([Me("wled-view-effects")],Br);let Ur=class extends bt{constructor(){super(...arguments),this.controllerId="",this.scenes=[],this.disabled=!1,this._recents=[],this._visibleCount=6}onPoweredConnect(){this._reload(),this._ro=new ResizeObserver(()=>this._measure()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._reload();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._rowEl&&(this._rowEl=e,this._ro?.observe(e),this._measure())}reload(){this._reload()}_reload(){var t;this._recents=(t=this.controllerId)?ur(pr)[t]??[]:[]}_measure(){const t=this._rowEl;if(!t)return;const e=mr(t.clientWidth,104,8,8);e!==this._visibleCount&&(this._visibleCount=e)}_sceneFor(t){return this.scenes.find(e=>e.id===t)}render(){const t=this._recents.filter(t=>this.scenes.some(e=>e.id===t.id)).slice(0,this._visibleCount);return t.length?j`
      <div class="block">
        <span class="label">Recent scenes</span>
        <div class="recent-row" role="group" aria-label="Recent scenes">
          ${t.map(t=>{const e=this._sceneFor(t.id),i=e?.name??t.name,s=e?Fr(e):"linear-gradient(135deg, var(--wled-surface-elevated), var(--wled-surface))",r=e&&zr(e)?e.scene_thumb_url.trim():"";return j`
              <button
                type="button"
                class="chip"
    ...
    `]}};t([ht()],Ur.prototype,"controllerId",void 0),t([ht({type:Array})],Ur.prototype,"scenes",void 0),t([ht({type:Boolean})],Ur.prototype,"disabled",void 0),t([dt()],Ur.prototype,"_recents",void 0),t([dt()],Ur.prototype,"_visibleCount",void 0),Ur=t([Me("wled-recent-scenes-row")],Ur);let Hr=class extends bt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this._scenes=[],this._status="Loading scenes…",this._busy=!1,this._captureName="",this._segments=[],this._applySegIds=[]}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}onPoweredDisconnect(){this._applyAbort?.abort(),this._applyAbort=void 0}async _load(){if(this.connection&&this.controllerId){this._status="Loading scenes…";try{const[t,e]=await Promise.all([Ye(this.connection,this.controllerId),kt(this.connection,this.controllerId)]);if(this._scenes=t,this._snapshot=e,this._segments=[...e.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length&&!this._applySegIds.length)this._applySegIds=this._segments.map(t=>t.id);else{const t=new Set(this._segments.map(t=>t.id));this._applySegIds=this._applySegIds.filter(e=>t.has(e)),!this._applySegIds.length&&this._segments.length&&(this._applySegIds=this._segments.map(t=>t.id))}this._status=0===this._scenes.length?"No scenes yet — capture the current look or use starter scenes after reload.":""}catch{this._status="Could not load scenes."}}}selectSegmentFromPreview(t){this._toggleApplySeg(t)}_toggleApplySeg(t){let e=Xe(this._applySegIds,t);e.length||(e=[t]),this._applySegIds=e}_isLoading(){return"Loading scenes…"===this._status}_renderSkeleton(){return j`
    ...
    `}_sceneTile(t){const e=t.transition_ms??2500,i=Fr(t),s=zr(t)?t.scene_thumb_url.trim():"";return j`
    ...
    `}_recentScenesRow(){return this.renderRoot.querySelector("wled-recent-scenes-row")??null}async _apply(t){if(this.connection){this._busy=!0,this._applyAbort?.abort(),this._applyAbort=new AbortController;try{const e=this._segments.length>0&&this._applySegIds.length===this._segments.length;await async function(t,e,i,s){await $t(t);const r={type:"wled_studio/scene_apply",schema_version:1,controller_id:e,scene_id:i,transition_ms:s?.transitionMs,segment_ids:s?.segmentIds?.length?s.segmentIds:void 0};return s?.signal?new Promise((e,i)=>{const n=()=>i(new DOMException("Aborted","AbortError"));s.signal?.aborted?n():(s.signal?.addEventListener("abort",n,{once:!0}),t.sendMessagePromise(r).then(t=>{s.signal?.removeEventListener("abort",n),e(t.state??{})}).catch(t=>{s.signal?.removeEventListener("abort",n),i(t)}))}):(await t.sendMessagePromise(r)).state??{}}(this.connection,this.controllerId,t.id,{signal:this._applyAbort.signal,segmentIds:e?void 0:[...this._applySegIds]}),function(t,e,i){if(!t)return[];const s=ur(pr),r=(s[t]??[]).filter(t=>t.id!==e);r.unshift({id:e,name:i}),s[t]=r.slice(0,10),gr(pr,s),s[t]}(this.controllerId,t.id,t.name),this._recentScenesRow()?.reload(),await this._load(),Ve(this,`Applied ${t.name}`),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(t){if("AbortError"!==t.name){Ve(this,`Apply failed: ${t.message||t.message||"error"}`)}}finally{this._busy=!1}}}async _capture(){if(!this.connection)return;const t=this._captureName.trim();if(t){this._busy=!0;try{const e=await Ke(this.connection,this.controllerId,t);this._captureName="",Ve(this,`Saved ${e.name}`),await this._load()}catch(e){Ve(this,e instanceof qe?`"${t}" was changed on another device — reload and save again.`:`Save failed: ${e.message||"error"}`)}finally{this._busy=!1}}}async _delete(t){if(this.connection&&confirm(`Delete scene "${t.name}"?`)){this._busy=!0;try{await async function(t,e,i){await Ge(t,{type:"wled_studio/scene_delete",controller_id:e,scene_id:i})}(this.connection,this.controllerId,t.id),Ve(this,`Deleted ${t.name}`),await this._load()}catch{Ve(this,"Delete failed")}finally{this._busy=!1}}}_dismissConflict(){this._conflict=void 0,this._load()}async _overwriteConflict(){if(!this.connection||!this._conflict)return;const t=this._scenes.find(t=>t.id===this._conflict?.id);if(t){this._busy=!0;try{await async function(t,e,i,s){try{return(await Ge(t,{type:"wled_studio/scene_save",controller_id:e,scene:i,if_match_etag:s?.ifMatchEtag})).scene??i}catch(t){const e=t;if("conflict"===e?.code&&e.data?.scene)throw new qe(e.data.scene,String(e.data.etag??e.message??""));throw t}}(this.connection,this.controllerId,t,{ifMatchEtag:this._conflict.etag}),this._conflict=void 0,Ve(this,"Scene overwritten"),await this._load()}catch(t){t instanceof qe?this._conflict=t.remote:Ve(this,`Overwrite failed: ${t.message||"error"}`)}finally{this._busy=!1}}}static{this.styles=[..._t,o`
      .wrap {
        max-width: 960px;
      }
      .wrap.compact {
    ...
    `]}};function jr(t=0,e=[255,51,102,0]){return{on:!0,bri:255,fx:t,pal:0,col:e,sx:128,ix:128,c1:128,c2:128,c3:128,o1:!1,o2:!1,o3:!1}}function Wr(t="off"){return{mode:t,on:"off"!==t,bri:"off"===t?0:128,fx:0,pal:0,col:"custom"===t?[72,72,72,0]:[0,0,0,0],sx:128,ix:128,c1:128,c2:128,c3:128,o1:!1,o2:!1,o3:!1}}function Vr(t,e){const i=e.Solid??0;return t.fx===i?"color":"effect"}async function qr(t,e){await $t(t);try{return await t.sendMessagePromise({...e,schema_version:1})}catch(t){throw new Error(ni(t))}}async function Gr(t,e,i,s){const r=function(t){let e="";for(let i=0;i<t.length;i+=32768){const s=t.subarray(i,i+32768);e+=String.fromCharCode(...s)}return btoa(e)}(i),n=s?.brush,o=s?.fill,a=n?Vr(n,s?.effectsByName??{}):"color";await qr(t,{type:"wled_studio/paint_frame",controller_id:e,data:r,rgbw:s?.rgbw??!0,paint_mode:a,...s?.touched?.length?{touched:s.touched}:{},...n?{brush:n}:{},...o?{fill:o}:{},..."effect"===a&&n?{effect_id:n.fx}:{}})}async function Yr(t,e,i=!0){await qr(t,{type:"wled_studio/paint_stop",controller_id:e,commit:i})}function Kr(t,e,i){const s=i?4:3,r=new Uint8ClampedArray(4*e);for(let n=0;n<e;n++){const e=n*s,o=4*n;r[o]=t[e]??0,r[o+1]=t[e+1]??0,r[o+2]=t[e+2]??0,r[o+3]=i?t[e+3]??0:255}return r}t([ht({attribute:!1})],Hr.prototype,"connection",void 0),t([ht()],Hr.prototype,"controllerId",void 0),t([ht({type:Boolean})],Hr.prototype,"compact",void 0),t([dt()],Hr.prototype,"_scenes",void 0),t([dt()],Hr.prototype,"_status",void 0),t([dt()],Hr.prototype,"_busy",void 0),t([dt()],Hr.prototype,"_conflict",void 0),t([dt()],Hr.prototype,"_captureName",void 0),t([dt()],Hr.prototype,"_segments",void 0),t([dt()],Hr.prototype,"_applySegIds",void 0),t([dt()],Hr.prototype,"_snapshot",void 0),Hr=t([Me("wled-view-scenes")],Hr);const Xr={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Jr=class extends bt{constructor(){super(...arguments),this.controllerId="",this.heading="Brush",this.showOnToggle=!1,this._loadingEffects=!0,this._error="",this._effectFilter=""}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load(),t.has("settings")&&void 0!==this.settings?.fx&&this._refreshMeta()}async _load(){if(this.connection&&this.controllerId){this._loadingEffects=!0,this._error="";try{this._snapshot=await kt(this.connection,this.controllerId),await this._refreshMeta()}catch(t){this._error=ni(t)}finally{this._loadingEffects=!1}}}async _refreshMeta(){this.connection&&this.controllerId&&this.settings&&(this._meta=await Pt(this.connection,this.controllerId,this.settings.fx))}_emit(t){const e={...this.settings,...t};this.dispatchEvent(new CustomEvent("settings-change",{detail:e,bubbles:!0,composed:!0}))}_onColor(t){const{rgb:e,white:i}=t.detail,s={col:[e[0],e[1],e[2],i]};"Fill look"!==this.heading&&(s.fx=ai(this._snapshot?.effects_by_name??{})),this._emit(s)}async _onEffectSelect(t){this._emit({fx:t.detail.effectId}),await this._refreshMeta()}_slider(t,e){const i=e.target.value;if(t.startsWith("o"))return void this._emit({[t]:Number(i)>0});const s=ti(Number(i));null!==s&&this._emit({[t]:s})}render(){if(!this.settings)return null;const t=Et(this.settings.col),e=this._meta,i=e?.sliders??{},s=this._snapshot?.rgbwm??0;return j`
      <div class="block">
        ...
        ${this._loadingEffects?j`<p class="muted">Loading effects…</p>`:j`
              ...
              <div class="sliders">
                ${Object.entries(Xr).map(([t,e])=>{if(!i[t])return null;const s=this.settings[t];return"boolean"==typeof s?j`
                      <label class="row">
                        <input
                          type="checkbox"
                          .checked=${s}
    ...
    `]}};t([ht({attribute:!1})],Jr.prototype,"connection",void 0),t([ht({attribute:!1})],Jr.prototype,"hass",void 0),t([ht()],Jr.prototype,"controllerId",void 0),t([ht()],Jr.prototype,"heading",void 0),t([ht({attribute:!1})],Jr.prototype,"settings",void 0),t([ht({type:Boolean})],Jr.prototype,"showOnToggle",void 0),t([dt()],Jr.prototype,"_loadingEffects",void 0),t([dt()],Jr.prototype,"_error",void 0),t([dt()],Jr.prototype,"_snapshot",void 0),t([dt()],Jr.prototype,"_meta",void 0),t([dt()],Jr.prototype,"_effectFilter",void 0),Jr=t([Me("wled-paint-settings")],Jr);let Zr=class extends bt{constructor(){super(...arguments),this.controllerId="",this.embedMode=!1,this.embedLayoutId="",this.embedFixtureId="",this.embedPixelCount=0,this._pixelCount=210,this._rgbw=!0,this._active=!1,this._brush=jr(),this._fill=Wr("off"),this._brushSize=6,this._status="",this._warn="",this._effectsByName={},this._layouts=[],this._layoutId="",this._fixtureId="",this._buffer=null,this._previewPixels=null,this._touched=new Set,this._flushInFlight=!1,this._flushQueued=!1,this._flushColor=function(t,e){let i,s,r=0;const n=(...n)=>{s=n;const o=Date.now(),a=o-r;if(a>=e)return r=o,i&&(clearTimeout(i),i=void 0),void t(...n);i||(i=setTimeout(()=>{i=void 0,r=Date.now(),s&&t(...s)},e-a))};return n.cancel=()=>{i&&clearTimeout(i),i=void 0,s=void 0},n}(()=>{this._flushNow()},20),this._flushEffect=It(()=>{this._flushNow()},60,180)}_previewEl(){return this.embedMode?this._externalPreview:this._internalPreview}get brushSize(){return this._brushSize}get paintLivePreview(){return this._brushIsEffect()}get paintExternalLive(){return!this._brushIsEffect()}bindExternalPreview(t){this._externalPreview=t,t&&this._active&&t.setStatus("live paint"),t&&this._previewPixels?this._syncPreviewPixels():t&&t.refresh()}handleExternalPaintStroke(t){this._onPaintStroke(t)}_emitPaintConfig(){this.dispatchEvent(new CustomEvent("paint-config-change",{bubbles:!0,composed:!0}))}_brushIsEffect(){return"effect"===Vr(this._brush,this._effectsByName)}updated(t){(t.has("_fill")||t.has("_brush")||t.has("_buffer")||t.has("_layoutId"))&&(this._applyFillToBuffer(),this._brushIsEffect()?this._previewEl()?.setPaintPixels(null):this._syncPreviewPixels()),(t.has("_brush")||t.has("_brushSize"))&&(this.requestUpdate(),this._emitPaintConfig()),this.embedMode&&(t.has("embedLayoutId")||t.has("embedFixtureId")||t.has("embedPixelCount"))&&(this.embedLayoutId&&(this._layoutId=this.embedLayoutId),this.embedFixtureId&&(this._fixtureId=this.embedFixtureId),this.embedPixelCount>0&&(this._pixelCount=this.embedPixelCount),this._previewEl()?.refresh())}async onPoweredConnect(){if(this.connection&&this.controllerId)try{const[t,e]=await Promise.all([kt(this.connection,this.controllerId),Bt(this.connection,this.controllerId)]),i=t.info?.leds;i?.count&&(this._pixelCount=i.count),"boolean"==typeof i?.rgbw&&(this._rgbw=i.rgbw),this._effectsByName=t.effects_by_name??{};const s=t.segments?.[0];if(s){const t=s.col?.[0],e=Array.isArray(t)&&t.length>=3?[t[0],t[1],t[2],t[3]??0]:void 0;this._brush=jr(s.fx??0,e)}this._layouts=e,this.embedMode&&this.embedLayoutId?(this._layoutId=this.embedLayoutId,this._fixtureId=this.embedFixtureId||"fixture-0",this.embedPixelCount>0&&(this._pixelCount=this.embedPixelCount)):this._applyLayout(e[0]),this._allocBuffer(),this._status=this.embedMode?this._layoutId?"Drag on the strip preview to paint":"Create a layout in Studio → Layout first":e.length?"Drag on the layout to paint":"Create a layout in the Layout tab first"}catch(t){this._status=ni(t)}}_applyLayout(t){if(!t)return this._layoutId="",void(this._fixtureId="");this._layoutId=t.id;const e=t.fixtures[0];this._fixtureId=e?String(e.id??"fixture-0"):"fixture-0",t.pixel_count&&(this._pixelCount=t.pixel_count),this._previewEl()?.refresh()}_onLayoutPick(t){const e=t.target.value,i=this._layouts.find(t=>t.id===e);this._applyLayout(i),this._allocBuffer()}async onPoweredDisconnect(){if(this._flushColor.cancel(),this._flushEffect.cancel(),this._active&&this.connection&&this.controllerId)try{await Yr(this.connection,this.controllerId,!1)}catch{}this._active=!1,this._touched.clear()}async _ensureSession(){if(this._active||!this.connection||!this.controllerId)return this._active;try{const t=await async function(t,e){return qr(t,{type:"wled_studio/paint_start",controller_id:e})}(this.connection,this.controllerId);return this._active=!0,this._touched.clear(),this._warn=t.wifi_sleep_warning??"",t.pixel_count&&(this._pixelCount=t.pixel_count),"boolean"==typeof t.rgbw&&(this._rgbw=t.rgbw),this._allocBuffer(),this._previewEl()?.setStatus("live paint"),this._status="Live paint",!0}catch(t){return this._status=ni(t),!1}}_allocBuffer(){const t=this._rgbw?4:3;this._buffer=new Uint8Array(this._pixelCount*t),this._previewPixels=null,this._applyFillToBuffer(),this._syncPreviewPixels()}_syncPreviewPixels(t){const e=this._previewEl();if(!this._buffer||!e)return;if(!this._previewPixels||this._previewPixels.length!==4*this._pixelCount)this._previewPixels=Kr(this._buffer,this._pixelCount,this._rgbw);else if(t?.length){const e=this._rgbw?4:3,i=this._previewPixels;for(const s of t){const t=s*e,r=4*s;i[r]=this._buffer[t]??0,i[r+1]=this._buffer[t+1]??0,i[r+2]=this._buffer[t+2]??0,i[r+3]=this._rgbw?this._buffer[t+3]??0:255}}else this._previewPixels=Kr(this._buffer,this._pixelCount,this._rgbw);e.setPaintPixels(this._previewPixels)}_brushRgb(){const t=Math.max(0,Math.min(255,this._brush.bri))/255;return[Math.round(this._brush.col[0]*t),Math.round(this._brush.col[1]*t),Math.round(this._brush.col[2]*t)]}async cancelLiveIfActive(){if(!this._active||!this.connection||!this.controllerId)return!1;this._flushColor.cancel(),this._flushEffect.cancel();try{await Yr(this.connection,this.controllerId,!1),this._status="Live paint ended — layout segments restored",this._previewEl()?.setStatus("ready")}catch(t){return this._status=ni(t),!1}return this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels(),this.dispatchEvent(new CustomEvent("wled-paint-ended",{bubbles:!0,composed:!0})),this._emitPaintConfig(),!0}_writeLed(t,e){if(!this._buffer)return;const i=t*(this._rgbw?4:3);this._buffer[i]=e[0],this._buffer[i+1]=e[1],this._buffer[i+2]=e[2],this._rgbw&&(this._buffer[i+3]=0)}_applyFillToBuffer(){if(!this._buffer)return;const t="off"===this._fill.mode?[0,0,0]:"custom"===this._fill.mode?[this._fill.col[0],this._fill.col[1],this._fill.col[2]]:[40,40,40];for(let e=0;e<this._pixelCount;e++)this._touched.has(e)||this._writeLed(e,t)}_scheduleFlush(){this._brushIsEffect()?this._flushEffect():this._flushColor()}_strokeLeds(t){if(!this._buffer||!t.length)return;if(this._brushIsEffect()){for(const e of t)this._touched.add(e);this._previewEl()?.setPaintPixels(null)}else{const e=this._brushRgb();for(const i of t)this._writeLed(i,e),this._touched.add(i);this._syncPreviewPixels(t)}this._scheduleFlush()}async _onPaintStroke(t){await this._ensureSession()&&this._strokeLeds(t.detail.leds)}async _flushNow(){if(this._active&&this.connection&&this._buffer)if(this._flushInFlight)this._flushQueued=!0;else{this._flushInFlight=!0;try{await Gr(this.connection,this.controllerId,this._buffer,{rgbw:this._rgbw,touched:[...this._touched],brush:this._brush,fill:this._fill,effectsByName:this._effectsByName});const t=this._brushIsEffect()?"effect (device preview)":"color";this._status=`Live paint · ${this._touched.size} LEDs · ${t} · fill: ${this._fill.mode}`}catch(t){this._status=ni(t)}finally{this._flushInFlight=!1,this._flushQueued&&(this._flushQueued=!1,this._flushNow())}}}_onBrushChange(t){this._brush=t.detail,this._emitPaintConfig(),this._active&&this._scheduleFlush()}_onFillChange(t){this._fill={...t.detail,mode:this._fill.mode},this._applyFillToBuffer(),this._syncPreviewPixels(),this._active&&this._scheduleFlush()}_onFillModeChange(t){this._fill=Wr(t),this._applyFillToBuffer(),this._syncPreviewPixels(),this._active&&this._flushNow()}async _commit(){if(this.connection&&this._active){this._flushColor.cancel(),this._flushEffect.cancel(),await this._flushNow();try{await Yr(this.connection,this.controllerId,!0),this._status="Committed to WLED",this._previewEl()?.setStatus("committed")}catch(t){this._status=ni(t)}this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels()}}async _cancel(){if(this.connection&&this._active){this._flushColor.cancel(),this._flushEffect.cancel();try{await Yr(this.connection,this.controllerId,!1),this._status="Live mode released",this._previewEl()?.setStatus("ready")}catch(t){this._status=ni(t)}this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels()}}render(){const t=Boolean(this._layoutId),e=this.embedMode;return j`
    ...
    `]}};t([ht({attribute:!1})],Zr.prototype,"connection",void 0),t([ht({attribute:!1})],Zr.prototype,"hass",void 0),t([ht()],Zr.prototype,"controllerId",void 0),t([ht({type:Boolean,attribute:"embed-mode"})],Zr.prototype,"embedMode",void 0),t([ht()],Zr.prototype,"embedLayoutId",void 0),t([ht()],Zr.prototype,"embedFixtureId",void 0),t([ht({type:Number})],Zr.prototype,"embedPixelCount",void 0),t([dt()],Zr.prototype,"_pixelCount",void 0),t([dt()],Zr.prototype,"_rgbw",void 0),t([dt()],Zr.prototype,"_active",void 0),t([dt()],Zr.prototype,"_brush",void 0),t([dt()],Zr.prototype,"_fill",void 0),t([dt()],Zr.prototype,"_brushSize",void 0),t([dt()],Zr.prototype,"_status",void 0),t([dt()],Zr.prototype,"_warn",void 0),t([dt()],Zr.prototype,"_effectsByName",void 0),t([dt()],Zr.prototype,"_layouts",void 0),t([dt()],Zr.prototype,"_layoutId",void 0),t([dt()],Zr.prototype,"_fixtureId",void 0),t([pt("wled-geometry-preview")],Zr.prototype,"_internalPreview",void 0),Zr=t([Me("wled-view-paint")],Zr);let Qr=class extends bt{constructor(){super(...arguments),this._toasts=[],this._nextId=0,this._timers=new Map,this._onToast=t=>{const e=t.detail;if(!e?.message)return;const i=++this._nextId;this._toasts=[...this._toasts,{id:i,message:e.message}];const s=this._toastDurationMs(),r=window.setTimeout(()=>this._dismiss(i),s);this._timers.set(i,r)}}onPoweredConnect(){this.getRootNode().addEventListener(We,this._onToast,{signal:this.abort.signal})}onPoweredDisconnect(){for(const t of this._timers.values())window.clearTimeout(t);this._timers.clear()}_toastDurationMs(){const t=getComputedStyle(this).getPropertyValue("--m-toast").trim(),e=Number.parseInt(t,10);return Number.isFinite(e)&&e>0?e:4e3}_dismiss(t){const e=this._timers.get(t);void 0!==e&&(window.clearTimeout(e),this._timers.delete(t)),this._toasts=this._toasts.filter(e=>e.id!==t)}render(){return this._toasts.length?j`
    ...
    `]}}function rn(){return{type:`custom:${tn}`,controller:"",height:200,show_segments:!1}}t([ht({attribute:!1})],sn.prototype,"config",void 0),t([dt()],sn.prototype,"_controllerId",void 0),t([dt()],sn.prototype,"_masterEntity",void 0),t([dt()],sn.prototype,"_pixelCount",void 0),t([dt()],sn.prototype,"_previewStatus",void 0),t([dt()],sn.prototype,"_hint",void 0),t([dt()],sn.prototype,"_layoutId",void 0),t([dt()],sn.prototype,"_fixtureId",void 0),t([dt()],sn.prototype,"_cardTab",void 0),t([pt("wled-geometry-preview")],sn.prototype,"_preview",void 0),t([pt("wled-segment-controls")],sn.prototype,"_segmentControls",void 0),t([pt("wled-view-effects")],sn.prototype,"_effectsView",void 0),t([pt("wled-view-paint")],sn.prototype,"_paintPanel",void 0),t([dt()],sn.prototype,"_globalBriPct",void 0),t([dt()],sn.prototype,"_lastNonZeroBri",void 0);const nn=[{key:"show_effects",label:"Show Effects tab"},{key:"show_scenes",label:"Show Scenes tab"},{key:"show_segments",label:"Show Segments tab (legacy)"},{key:"show_paint",label:"Show Paint tab"}];let on=class extends ot{constructor(){super(...arguments),this._config=rn()}setConfig(t){this._config={...rn(),...t,type:t.type??`custom:${tn}`}}render(){const t=this._config;return j`
      <div class="editor">
  ...
  `}};t([ht({attribute:!1})],on.prototype,"hass",void 0),t([dt()],on.prototype,"_config",void 0),on=t([Me("wled-studio-card-editor")],on),function(){const t=window.__WLED_STUDIO_BUILD__;t&&t!==vt&&(window.__WLED_STUDIO_STALE__=!0),window.__WLED_STUDIO_BUILD__=vt}(),function(t,e){const i=customElements.get(t);i||customElements.define(t,e)}(tn,sn),window.customCards=window.customCards||[],window.customCards.some(t=>t.type===tn)||window.customCards.push({type:tn,name:"WLED Studio",description:"Live LED strip preview and controls",preview:!0}),console.info("[wled-studio] lovelace bundle loaded",{card:tn});export{tn as CARD_TAG,sn as WledStudioCard,rn as getStubConfig};
