...
`;class _t{constructor(t,e){this.host=t,this._hass=e,this._isRemote=!1,t.addController(this)}hostConnected(){this._refresh()}setHass(t){this._hass=t,this._refresh(),this.host.requestUpdate()}get state(){return{isRemote:this._isRemote,previewFps:this._isRemote?10:20,useBinaryPack:this._isRemote,disableBloom:this._isRemote}}_refresh(){if("undefined"==typeof location)return void(this._isRemote=!1);const t=location.hostname.endsWith(".ui.nabu.casa"),e=this._hass?.config?.external_url,i=!!e&&e.replace(/\/$/,"")===location.origin;this._isRemote=t||i}}const mt=[ft,gt];class vt extends rt{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new _t(this),this._visible=!0,this._inView=!0}static{this.styles=mt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}function bt(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}t([ht({attribute:!1})],vt.prototype,"hass",void 0);const yt=/^[0-9a-fA-F]+$/;function wt(t,e,i,s){let n,o=!1;const r=async()=>{n?.(),n=void 0,o||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let n=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&yt.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let o=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(o=t)}return{leds_hex:s,n:o,channels:n,scale:o/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:s?.remote??!1}))};r();const a=bt(t,()=>{r()});return()=>{o=!0,a(),n?.(),n=void 0}}async function xt(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",n),i(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function $t(t){await xt(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,i=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${i}`)}}async function St(t,e){await xt(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function It(t,e,i,s){await xt(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}function kt(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function Et(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function Ct(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}async function At(t,e){return await xt(t),t.sendMessagePromise({...e,schema_version:1})}const Pt=.55,Rt=1,Mt=1,Nt=0,Lt=0,Ot=0,Tt=1,Ut=0,Dt=0,Wt=1,zt=1;function Ht(t){return function(t,e){return t?{url:t,opacity:e?.opacity??Pt,brightness:e?.brightness??Rt,saturation:e?.saturation??Mt,rotation:e?.rotation??Nt,offsetX:e?.offsetX??Lt,offsetY:e?.offsetY??Ot,scale:e?.scale??Tt,cropX:e?.cropX??Ut,cropY:e?.cropY??Dt,cropW:e?.cropW??Wt,cropH:e?.cropH??zt}:null}(t.background?.url??t.background_url,t.background??null)}function jt(t,e=!1){return new Promise((i,s)=>{const n=new Image;n.onload=()=>i(n),n.onerror=()=>s(new Error(`Could not load image (${t})`)),function(t,e,i=!1){let s=e;if(i&&!s.includes("?")&&(s=`${s}?v=${Date.now()}`),t.removeAttribute("crossorigin"),s.startsWith("http://")||s.startsWith("https://"))try{new URL(s,window.location.href).origin!==window.location.origin&&(t.crossOrigin="anonymous")}catch{t.crossOrigin="anonymous"}t.src=s}(n,t,e)})}let Bt=class extends vt{constructor(){super(...arguments),this.controllerId="",this.layoutId="",this.fixtureId="",this.pixelCount=210,this.dotRadius=4,this.compact=!1,this.heightPx=200,this.externalLive=!1,this.segments=[],this.selectedSegId=-1,this._positions=[],this._status="waiting",this._showDots=!1,this._closed=!1,this._bgLayer=null,this._bgImage=null,this._raf=0,this._hoverLed=-1,this._onCanvasClick=t=>{const e=this._ledAtEvent(t);if(e<0)return;const i=this._segmentForLed(e);i<0||this.dispatchEvent(new CustomEvent("segment-select",{detail:{segmentId:i,ledIndex:e},bubbles:!0,composed:!0}))},this._onCanvasMove=t=>{const e=this._ledAtEvent(t);e!==this._hoverLed&&(this._hoverLed=e,this._schedPaint())},this._onCanvasLeave=()=>{this._hoverLed>=0&&(this._hoverLed=-1,this._schedPaint())}}setFrame(t){t&&(this._pixels=function(t,e){const i=new Uint8ClampedArray(4*e);for(let s=0;s<e;s++){const e=Math.min(t.count-1,Math.max(0,Math.round(s/t.scale))),n=t.leds_hex[e]??"000000",o=4*s;8===n.length?(i[o]=parseInt(n.slice(0,2),16),i[o+1]=parseInt(n.slice(2,4),16),i[o+2]=parseInt(n.slice(4,6),16),i[o+3]=parseInt(n.slice(6,8),16)):(i[o]=parseInt(n.slice(0,2),16),i[o+1]=parseInt(n.slice(2,4),16),i[o+2]=parseInt(n.slice(4,6),16),i[o+3]=255)}return i}(t,this.pixelCount),this._status="live",this._schedPaint())}setStatus(t){this._status=t,this.requestUpdate()}async refresh(){await this._resolvePositions()}onPoweredConnect(){this._resolvePositions(),this.externalLive||this._attachLiveStream()}onPoweredDisconnect(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0,this._resizeObs?.disconnect()}updated(t){super.updated(t),(t.has("connection")||t.has("controllerId")||t.has("layoutId")||t.has("fixtureId"))&&(this._resolvePositions(),this.externalLive||this._attachLiveStream()),(t.has("selectedSegId")||t.has("segments"))&&this._schedPaint()}firstUpdated(){this._canvas=this.renderRoot.querySelector("canvas")??void 0;const t=this.renderRoot.querySelector(".wrap");this._canvas&&t&&(this._ctx=this._canvas.getContext("2d",{alpha:!0})??void 0,this._resizeObs=new ResizeObserver(()=>this._onResize()),this._resizeObs.observe(t),(this.compact||this.segments.length>0)&&(this._canvas.style.cursor="pointer",this._canvas.addEventListener("click",this._onCanvasClick),this._canvas.addEventListener("mousemove",this._onCanvasMove),this._canvas.addEventListener("mouseleave",this._onCanvasLeave),this.addUnsub(()=>{this._canvas?.removeEventListener("click",this._onCanvasClick),this._canvas?.removeEventListener("mousemove",this._onCanvasMove),this._canvas?.removeEventListener("mouseleave",this._onCanvasLeave)}))),this._onResize()}_segmentForLed(t){for(const e of this.segments){const i=e.start??0,s=e.stop??e.len??this.pixelCount;if(t>=i&&t<s)return e.id}return 1===this.segments.length?this.segments[0].id:-1}_ledInSegment(t,e){if(e<0)return!1;const i=this.segments.find(t=>t.id===e);if(!i)return!1;const s=i.start??0,n=i.stop??i.len??this.pixelCount;return t>=s&&t<n}_ledAtEvent(t){const e=this._hitTest(t.clientX,t.clientY);return e?.led??-1}_hitTest(t,e){const i=this._canvas;if(!i||0===this._positions.length)return null;const s=i.getBoundingClientRect(),n=t-s.left,o=e-s.top,r=Math.min(2,window.devicePixelRatio||1),a=i.width/r,l=i.height/r,c=this._layoutMap(a,l);if(!c)return null;const{toCanvas:h,hitR:d}=c;let u=null,p=d*d;for(const t of this._positions){const[e,i]=h(t.x,t.y),s=e-n,r=i-o,a=s*s+r*r;a<p&&(p=a,u=t)}return u}_layoutMap(t,e){const i=this._positions;if(0===i.length)return null;let s=1/0,n=-1/0,o=1/0,r=-1/0;for(const t of i)t.x<s&&(s=t.x),t.x>n&&(n=t.x),t.y<o&&(o=t.y),t.y>r&&(r=t.y);const a=n-s||1,l=r-o||1,c=this.dotRadius,h=3*c,d=(t-2*h)/a,u=(e-2*h)/l,p=Math.min(d,u),f=Math.max(2.5,1.35*c);return{toCanvas:(t,e)=>[h+(t-s)*p,h+(e-o)*p],hitR:Math.max(10,2.5*f),lineW:f}}_accentStroke(){return getComputedStyle(this).getPropertyValue("--primary-color").trim()||"#18a0fb"}_onResize(){const t=this._canvas,e=this.renderRoot.querySelector(".wrap");if(!t||!e)return;const i=e.getBoundingClientRect();if(i.width<2||i.height<2)return;const s=Math.min(1200,Math.max(1,Math.floor(i.width))),n=Math.min(600,Math.max(1,Math.floor(i.height))),o=Math.min(2,window.devicePixelRatio||1),r=Math.floor(s*o),a=Math.floor(n*o);if(t.width!==r||t.height!==a){t.width=r,t.height=a;const e=this._ctx;e&&e.setTransform(o,0,0,o,0,0),this._schedPaint()}}async _resolvePositions(){if(this.connection&&this.controllerId&&this.fixtureId)try{if(this.layoutId){const t=await async function(t,e,i){return(await At(t,{type:"wled_studio/layout_get",controller_id:e,layout_id:i})).layout??null}(this.connection,this.controllerId,this.layoutId);if(t){this._bgLayer=Ht(t),this._loadBackgroundImage();const e=t.fixtures??[],i=this.fixtureId?e.find(t=>String(t.id??"")===this.fixtureId):e[0];this._closed=Boolean(i?.closed??!1)}}this._positions=await async function(t,e,i,s){return(await At(t,{type:"wled_studio/layout_resolve_positions",controller_id:e,fixture_id:i,layout_id:s})).positions??[]}(this.connection,this.controllerId,this.fixtureId,this.layoutId||void 0),this._schedPaint()}catch{this._positions=[]}}_loadBackgroundImage(){const t=this._bgLayer?.url;t?jt(t).then(t=>{this._bgImage=t,this._schedPaint()},()=>{this._bgImage=null}):this._bgImage=null}_attachLiveStream(){if(!this.connection||!this.controllerId)return;const t=wt(this.connection,this.controllerId,t=>{this.setFrame(t)});this.addUnsub(t)}_schedPaint(){this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0,this._paint()}))}_rgbForLed(t,e){if(!t)return[80,80,80];const i=4*e;return[t[i],t[i+1],t[i+2]]}_paint(){const t=this._ctx,e=this._canvas;if(!t||!e)return;const i=Math.min(2,window.devicePixelRatio||1),s=e.width/i,n=e.height/i;t.clearRect(0,0,s,n),t.fillStyle="#0d0d0d",t.fillRect(0,0,s,n),this._bgImage?.complete&&this._bgLayer&&function(t,e,i,s,n){const o=n.opacity??Pt,r=n.brightness??1,a=n.saturation??1,l=(n.rotation??0)*Math.PI/180,c=(n.offsetX??0)*e,h=(n.offsetY??0)*i,d=n.scale??1,u=n.cropX??0,p=n.cropY??0,f=n.cropW??1,g=n.cropH??1,_=s.naturalWidth*f,m=s.naturalHeight*g,v=s.naturalWidth*u,b=s.naturalHeight*p,y=Math.max(e/_,i/m)*d,w=_*y,x=m*y;t.save(),t.globalAlpha=o,t.filter=`brightness(${r}) saturate(${a})`,t.translate(e/2+c,i/2+h),t.rotate(l),t.drawImage(s,v,b,_,m,-w/2,-x/2,w,x),t.restore()}(t,s,n,this._bgImage,this._bgLayer);const o=this._pixels,r=[...this._positions].sort((t,e)=>t.led-e.led),a=this.dotRadius,l=this._layoutMap(s,n);if(r.length>0&&l){const{toCanvas:e,lineW:i}=l,s=this.remote.state.disableBloom;if(!this._showDots){t.lineCap="round",t.lineJoin="round",t.lineWidth=i;const n=(n,r)=>{const[a,l]=e(n.x,n.y),[c,h]=e(r.x,r.y),[d,u,p]=this._rgbForLed(o,n.led);!s&&(d>10||u>10||p>10)?(t.shadowColor=`rgba(${d},${u},${p},0.55)`,t.shadowBlur=1.5*i):t.shadowBlur=0,t.strokeStyle=`rgb(${d},${u},${p})`,t.beginPath(),t.moveTo(a,l),t.lineTo(c,h),t.stroke()};for(let t=0;t<r.length-1;t++)n(r[t],r[t+1]);this._closed&&r.length>=2&&n(r[r.length-1],r[0]),t.shadowBlur=0}if(this._showDots){for(const{x:i,y:n,led:l}of r){const[r,c]=e(i,n),[h,d,u]=this._rgbForLed(o,l);!s&&(h>10||d>10||u>10)?(t.shadowColor=`rgba(${h},${d},${u},0.7)`,t.shadowBlur=2.5*a):t.shadowBlur=0,t.beginPath(),t.arc(r,c,a,0,2*Math.PI),t.fillStyle=`rgb(${h},${d},${u})`,t.fill()}t.shadowBlur=0}this._paintSegmentSelection(t,r,e,i)}else{const e=this.pixelCount,i=(s-8)/e,r=n/2;for(let s=0;s<e;s++){let e=80,n=80,l=80;if(o){const t=4*s;e=o[t],n=o[t+1],l=o[t+2]}t.beginPath(),t.arc(4+s*i+i/2,r,a,0,2*Math.PI),t.fillStyle=`rgb(${e},${n},${l})`,t.fill()}}}_paintSegmentSelection(t,e,i,s){const n=this.selectedSegId>=0?this.selectedSegId:this._hoverLed>=0?this._segmentForLed(this._hoverLed):-1;if(n<0||0===this.segments.length)return;const o=e.filter(t=>this._ledInSegment(t.led,n));if(o.length<2)return;const r=this._accentStroke(),a=()=>{const[e,s]=i(o[0].x,o[0].y);t.beginPath(),t.moveTo(e,s);for(let e=1;e<o.length;e++){const[s,n]=i(o[e].x,o[e].y);t.lineTo(s,n)}};t.save(),t.lineCap="round",t.lineJoin="round",t.shadowBlur=0,t.strokeStyle="rgba(0, 0, 0, 0.45)",t.lineWidth=s+6,a(),t.stroke(),t.strokeStyle="rgba(255, 255, 255, 0.55)",t.lineWidth=s+3,a(),t.stroke(),t.strokeStyle=r,t.lineWidth=2,a(),t.stroke(),t.restore()}render(){const t=this.compact?"Live layout preview — tap the strip to select a segment":"LED geometry preview — positions mapped from fixture layout";return B`
    ...
    `]}};function qt(t){if(t instanceof Error)return t.message;if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t;if("string"==typeof e.message)return"string"==typeof e.code?`${e.code}: ${e.message}`:e.message;const i=e.error;if(i&&"object"==typeof i){const t=i;if("string"==typeof t.message)return"string"==typeof t.code?`${t.code}: ${t.message}`:t.message}if("string"==typeof e.code)return e.code}try{return JSON.stringify(t)}catch{return"Unknown error"}}t([ht({attribute:!1})],Bt.prototype,"connection",void 0),t([ht()],Bt.prototype,"controllerId",void 0),t([ht()],Bt.prototype,"layoutId",void 0),t([ht()],Bt.prototype,"fixtureId",void 0),t([ht({type:Number})],Bt.prototype,"pixelCount",void 0),t([ht({type:Number})],Bt.prototype,"dotRadius",void 0),t([ht({type:Boolean,reflect:!0})],Bt.prototype,"compact",void 0),t([ht({type:Number})],Bt.prototype,"heightPx",void 0),t([ht({type:Boolean})],Bt.prototype,"externalLive",void 0),t([ht({type:Array})],Bt.prototype,"segments",void 0),t([ht({type:Number})],Bt.prototype,"selectedSegId",void 0),t([dt()],Bt.prototype,"_positions",void 0),t([dt()],Bt.prototype,"_status",void 0),t([dt()],Bt.prototype,"_showDots",void 0),t([dt()],Bt.prototype,"_closed",void 0),Bt=t([pt("wled-geometry-preview")],Bt);const Ft={all:"All","1d":"1D","2d":"2D",solid:"Solid",sound:"Sound",palette:"Palette"};function Vt(t){return void 0!==t.Solid?t.Solid:0}const Jt="wled_studio.segment_snapshot",Gt="wled_studio.merge_for_effects",Kt=["start","stop","len","grp","spc","of","on","bri","col","fx","sx","ix","c1","c2","c3","o1","o2","o3","pal","n","rev","mi","sel","awm"];function Xt(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function Yt(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function Zt(t){return Boolean(Xt(Gt)[t])}function Qt(t,e){const i=Xt(Gt);e?i[t]=!0:delete i[t],Yt(Gt,i)}function te(t){return Xt(Jt)[t]??null}function ee(t){return{seg:t.segments.map(t=>function(t){const e=t,i={id:t.id};for(const t of Kt){const s=e[t];void 0!==s&&(i[t]=s)}return i}(t))}}function ie(t,e){const i=t.find(t=>0===t.id);return i?[0]:t.length?[t[0].id]:[0]}function se(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:Et(t.col),awm:t.awm};return JSON.stringify(e)}function ne(t,e,i){let s,n=null,o=0;const r=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await St(t,e)).segments??[]).find(t=>t.id===o);if(!s||!n)return;const r=se(n);if(r===se(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(Et(t.col))!==JSON.stringify(Et(e.col))}(n,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=function(t,e,i=100){let s,n,o;const r=()=>{if(s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,o){const e=o;o=void 0,t(...e)}},a=(...t)=>{o=t,s&&clearTimeout(s),s=setTimeout(r,e),n||(n=setTimeout(r,i))};return a.cancel=()=>{s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,o=void 0},a}((s,a)=>{n=a,o=a.id,It(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(n={...a,...i,id:a.id}),r()}).catch(t=>{i(a,`Failed to apply state to WLED: ${qt(t)}`)})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var oe,re,ae,le,ce,he={},de=[],ue=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function pe(t,e){for(var i in e)t[i]=e[i];return t}function fe(t){var e=t.parentNode;e&&e.removeChild(t)}function ge(t,e,i){var s,n,o,r,a=arguments;if(e=pe({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return r=e.key,null!=(o=e.ref)&&delete e.ref,null!=r&&delete e.key,_e(t,e,r,o)}function _e(t,e,i,s){var n={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return oe.vnode&&oe.vnode(n),n}function me(t){return t.children}function ve(t,e){this.props=t,this.context=e}function be(t,e){if(null==e)return t.__p?be(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?be(t):null}function ye(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return ye(t)}}function we(t){(!t.__d&&(t.__d=!0)&&1===re.push(t)||le!==oe.debounceRendering)&&(le=oe.debounceRendering,(oe.debounceRendering||ae)(xe))}function xe(){var t,e,i,s,n,o,r,a;for(re.sort(function(t,e){return e.__v.__b-t.__v.__b});t=re.pop();)t.__d&&(i=void 0,s=void 0,o=(n=(e=t).__v).__e,r=e.__P,a=e.u,e.u=!1,r&&(i=[],s=Ce(r,n,pe({},n),e.__n,void 0!==r.ownerSVGElement,null,i,a,null==o?be(n):o),Ae(i,n),s!=o&&ye(n)))}function $e(t,e,i,s,n,o,r,a,l){var c,h,d,u,p,f,g,_=i&&i.__k||de,m=_.length;if(a==he&&(a=null!=o?o[0]:m?be(i,0):null),c=0,e.__k=Se(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=_[c])||d&&i.key==d.key&&i.type===d.type)_[c]=void 0;else for(h=0;h<m;h++){if((d=_[h])&&i.key==d.key&&i.type===d.type){_[h]=void 0;break}d=null}if(u=Ce(t,i,d=d||he,s,n,o,r,null,a,l),(h=i.ref)&&d.ref!=h&&(g||(g=[])).push(h,i.__c||u,i),null!=u){if(null==f&&(f=u),null!=i.l)u=i.l,i.l=null;else if(o==d||u!=a||null==u.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(u);else{for(p=a,h=0;(p=p.nextSibling)&&h<m;h+=2)if(p==u)break t;t.insertBefore(u,a)}"option"==e.type&&(t.value="")}a=u.nextSibling,"function"==typeof e.type&&(e.l=u)}}return c++,i}),e.__e=f,null!=o&&"function"!=typeof e.type)for(c=o.length;c--;)null!=o[c]&&fe(o[c]);for(c=m;c--;)null!=_[c]&&Me(_[c],_[c]);if(g)for(c=0;c<g.length;c++)Re(g[c],g[++c],g[++c])}function Se(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)Se(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return _e(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=_e(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function Ie(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===ue.test(e)?i+"px":null==i?"":i}function ke(t,e,i,s,n){var o,r,a,l,c;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(o=t.style,"string"==typeof i)o.cssText=i;else{if("string"==typeof s&&(o.cssText="",s=null),s)for(r in s)i&&r in i||Ie(o,r,"");if(i)for(a in i)s&&i[a]===s[a]||Ie(o,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),c=e.toLowerCase(),e=(c in t?c:e).slice(2),i?(s||t.addEventListener(e,Ee,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,Ee,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function Ee(t){return this.t[t.type](oe.event?oe.event(t):t)}function Ce(t,e,i,s,n,o,r,a,l,c){var h,d,u,p,f,g,_,m,v,b,y=e.type;if(void 0!==e.constructor)return null;(h=oe.__b)&&h(e);try{t:if("function"==typeof y){if(m=e.props,v=(h=y.contextType)&&s[h.__c],b=h?v?v.props.value:h.__p:s,i.__c?_=(d=e.__c=i.__c).__p=d.__E:("prototype"in y&&y.prototype.render?e.__c=d=new y(m,b):(e.__c=d=new ve(m,b),d.constructor=y,d.render=Ne),v&&v.sub(d),d.props=m,d.state||(d.state={}),d.context=b,d.__n=s,u=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=y.getDerivedStateFromProps&&pe(d.__s==d.state?d.__s=pe({},d.__s):d.__s,y.getDerivedStateFromProps(m,d.__s)),u)null==y.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&r.push(d);else{if(null==y.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(m,b),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(m,d.__s,b)){for(d.props=m,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,h=0;h<e.__k.length;h++)e.__k[h]&&(e.__k[h].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(m,d.__s,b)}for(p=d.props,f=d.state,d.context=b,d.props=m,d.state=d.__s,(h=oe.__r)&&h(e),d.__d=!1,d.__v=e,d.__P=t,h=d.render(d.props,d.state,d.context),e.__k=Se(null!=h&&h.type==me&&null==h.key?h.props.children:h),null!=d.getChildContext&&(s=pe(pe({},s),d.getChildContext())),u||null==d.getSnapshotBeforeUpdate||(g=d.getSnapshotBeforeUpdate(p,f)),$e(t,e,i,s,n,o,r,l,c),d.base=e.__e;h=d.__h.pop();)d.__s&&(d.state=d.__s),h.call(d);u||null==p||null==d.componentDidUpdate||d.componentDidUpdate(p,f,g),_&&(d.__E=d.__p=null)}else e.__e=Pe(i.__e,e,i,s,n,o,r,c);(h=oe.diffed)&&h(e)}catch(t){oe.__e(t,e,i)}return e.__e}function Ae(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){oe.__e(t,i.__v)}oe.__c&&oe.__c(e)}function Pe(t,e,i,s,n,o,r,a){var l,c,h,d,u=i.props,p=e.props;if(n="svg"===e.type||n,null==t&&null!=o)for(l=0;l<o.length;l++)if(null!=(c=o[l])&&(null===e.type?3===c.nodeType:c.localName===e.type)){t=c,o[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(p);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),o=null}return null===e.type?u!==p&&(null!=o&&(o[o.indexOf(t)]=null),t.data=p):e!==i&&(null!=o&&(o=de.slice.call(t.childNodes)),h=(u=i.props||he).dangerouslySetInnerHTML,d=p.dangerouslySetInnerHTML,a||(d||h)&&(d&&h&&d.__html==h.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,n){var o;for(o in i)o in e||ke(t,o,null,i[o],s);for(o in e)n&&"function"!=typeof e[o]||"value"===o||"checked"===o||i[o]===e[o]||ke(t,o,e[o],i[o],s)}(t,p,u,n,a),e.__k=e.props.children,d||$e(t,e,i,s,"foreignObject"!==e.type&&n,o,r,he,a),a||("value"in p&&void 0!==p.value&&p.value!==t.value&&(t.value=null==p.value?"":p.value),"checked"in p&&void 0!==p.checked&&p.checked!==t.checked&&(t.checked=p.checked))),t}function Re(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){oe.__e(t,i)}}function Me(t,e,i){var s,n,o;if(oe.unmount&&oe.unmount(t),(s=t.ref)&&Re(s,null,e),i||"function"==typeof t.type||(i=null!=(n=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){oe.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(o=0;o<s.length;o++)s[o]&&Me(s[o],e,i);null!=n&&fe(n)}function Ne(t,e,i){return this.constructor(t,i)}function Le(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function Oe(){return Oe=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}return t},Oe.apply(this,arguments)}oe={},ve.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=pe({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&pe(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),we(this))},ve.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,we(this))},ve.prototype.render=me,re=[],ae="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,le=oe.debounceRendering,oe.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return we(s.__E=s)}catch(e){t=e}throw t},ce=he;var Te="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",Ue="[\\s|\\(]+("+Te+")[,|\\s]+("+Te+")[,|\\s]+("+Te+")\\s*\\)?",De="[\\s|\\(]+("+Te+")[,|\\s]+("+Te+")[,|\\s]+("+Te+")[,|\\s]+("+Te+")\\s*\\)?",We=new RegExp("rgb"+Ue),ze=new RegExp("rgba"+De),He=new RegExp("hsl"+Ue),je=new RegExp("hsla"+De),Be="^(?:#?|0x?)",qe="([0-9a-fA-F]{1})",Fe="([0-9a-fA-F]{2})",Ve=new RegExp(Be+qe+qe+qe+"$"),Je=new RegExp(Be+qe+qe+qe+qe+"$"),Ge=new RegExp(Be+Fe+Fe+Fe+"$"),Ke=new RegExp(Be+Fe+Fe+Fe+Fe+"$"),Xe=Math.log,Ye=Math.round,Ze=Math.floor;function Qe(t,e,i){return Math.min(Math.max(t,e),i)}function ti(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function ei(t){return parseInt(t,16)}function ii(t){return t.toString(16).padStart(2,"0")}var si=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=Oe({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=Oe({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,n=Ze(e),o=e-n,r=s*(1-i),a=s*(1-o*i),l=s*(1-(1-o)*i),c=n%6,h=[l,s,s,a,r,r][c],d=[r,r,l,s,s,a][c];return{r:Qe(255*[s,a,r,r,l,s][c],0,255),g:Qe(255*h,0,255),b:Qe(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,n=Math.max(e,i,s),o=Math.min(e,i,s),r=n-o,a=0,l=n,c=0===n?0:r/n;switch(n){case o:a=0;break;case e:a=(i-s)/r+(i<s?6:0);break;case i:a=(s-e)/r+2;break;case s:a=(e-i)/r+4}return{h:60*a%360,s:Qe(100*c,0,100),v:Qe(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,n=s<=1?s:2-s,o=n<1e-9?0:e*i/n;return{h:t.h,s:Qe(100*o,0,100),l:Qe(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:Qe(100*s,0,100),v:Qe((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,n=t/100;return n<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=n-2)+104.49216199393888*Xe(i),s=n<20?0:.8274096064007395*(s=n-10)-254.76935184120902+115.67994401066147*Xe(s)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*Xe(e),i=325.4494125711974+.07943456536662342*(i=n-50)-28.0852963507957*Xe(i),s=255),{r:Qe(Ze(e),0,255),g:Qe(Ze(i),0,255),b:Qe(Ze(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,n=e.b,o=2e3,r=4e4;r-o>.4;){i=.5*(r+o);var a=t.kelvinToRgb(i);a.b/a.r>=n/s?r=i:o=i}return i},Le(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=Oe({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return Oe({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=Oe({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=Oe({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=Oe({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=Oe({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,n=e.b;return{r:Ye(i),g:Ye(s),b:Ye(n)}},set:function(e){this.hsv=Oe({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return Oe({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,n=e.l;return{h:Ye(i),s:Ye(s),l:Ye(n)}},set:function(e){this.hsv=Oe({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return Oe({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,n,o=1;if((e=We.exec(t))?(i=ti(e[1],255),s=ti(e[2],255),n=ti(e[3],255)):(e=ze.exec(t))&&(i=ti(e[1],255),s=ti(e[2],255),n=ti(e[3],255),o=ti(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:n,a:o}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+ii(t.r)+ii(t.g)+ii(t.b)},set:function(t){var e,i,s,n,o=255;if((e=Ve.exec(t))?(i=17*ei(e[1]),s=17*ei(e[2]),n=17*ei(e[3])):(e=Je.exec(t))?(i=17*ei(e[1]),s=17*ei(e[2]),n=17*ei(e[3]),o=17*ei(e[4])):(e=Ge.exec(t))?(i=ei(e[1]),s=ei(e[2]),n=ei(e[3])):(e=Ke.exec(t))&&(i=ei(e[1]),s=ei(e[2]),n=ei(e[3]),o=ei(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:n,a:o/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+ii(t.r)+ii(t.g)+ii(t.b)+ii(Ze(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,n,o=1;if((e=He.exec(t))?(i=ti(e[1],360),s=ti(e[2],100),n=ti(e[3],100)):(e=je.exec(t))&&(i=ti(e[1],360),s=ti(e[2],100),n=ti(e[3],100),o=ti(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:n,a:o}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function ni(t){var e,i=t.width,s=t.sliderSize,n=t.borderWidth,o=t.handleRadius,r=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*r+2*o,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*r-2*o,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-n/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function oi(t,e){var i=ni(t),s=i.width,n=i.height,o=i.handleRange,r=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var n=t.minTemperature,o=t.maxTemperature-n,r=(e.kelvin-n)/o*100;return Math.max(0,Math.min(r,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),c=a?s/2:n/2,h=r+l/100*o;return a&&(h=-1*h+o+2*r),{x:a?c:h,y:a?h:c}}var ri,ai=2*Math.PI,li=function(t,e){return Math.sqrt(t*t+e*e)};function ci(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function hi(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function di(t,e,i){var s=t.wheelAngle,n=t.wheelDirection;return i&&"clockwise"===n?e=s+e:"clockwise"===n?e=360-s+e:i&&"anticlockwise"===n?e=s+180-e:"anticlockwise"===n&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function ui(t,e,i){var s=hi(t),n=s.cx,o=s.cy,r=ci(t);e=n-e,i=o-i;var a=di(t,Math.atan2(-i,-e)*(360/ai)),l=Math.min(li(e,i),r);return{h:Math.round(a),s:Math.round(100/r*l)}}function pi(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function fi(t,e,i){var s=pi(t),n=s.width,o=s.height,r=s.radius,a=(e-r)/(n-2*r)*100,l=(i-r)/(o-2*r)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function gi(t){ri||(ri=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),n=window.location;return(i||s)&&ri.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function _i(t,e,i,s){for(var n=0;n<s.length;n++){var o=s[n].x-e,r=s[n].y-i;if(Math.sqrt(o*o+r*r)<t.handleRadius)return n}return null}function mi(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function vi(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function bi(t){return"string"==typeof t?t:t+"px"}var yi=["mousemove","touchmove","mouseup","touchend"],wi=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,o={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(o[s?"marginLeft":"marginTop"]=n),ge(me,null,t.children(this.uid,i,o))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,o=n.clientX-s.left,r=n.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(o,r,0)&&yi.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(o,r,1);break;case"mouseup":case"touchend":i(o,r,2),yi.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(ve);function xi(t){var e=t.r,i=t.url,s=e,n=e;return ge("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+bi(t.x)+", "+bi(t.y)+")",willChange:"transform",top:bi(-e),left:bi(-e),width:bi(2*e),height:bi(2*e),position:"absolute",overflow:"visible"}},i&&ge("use",Object.assign({xlinkHref:gi(i)},t.props)),!i&&ge("circle",{cx:s,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&ge("circle",{cx:s,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function $i(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=ni(t),n=s.width,o=s.height,r=s.radius,a=oi(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var n=[],o=t.minTemperature,r=t.maxTemperature,a=r-o,l=o,c=0;l<r;l+=a/8,c+=1){var h=si.kelvinToRgb(l),d=h.r,u=h.g,p=h.b;n.push([12.5*c,"rgb("+d+","+u+","+p+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var f=si.hsvToHsl({h:i.h,s:0,v:i.v}),g=si.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"],[100,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"]];default:var _=si.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"]]}}(t,i);return ge(wi,Object.assign({},t,{onInput:function(e,s,n){var o=function(t,e,i){var s,n=ni(t),o=n.handleRange,r=n.handleStart;s="horizontal"===t.layoutDirection?-1*i+o+r:e-r,s=Math.max(Math.min(s,o),0);var a=Math.round(100/o*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=o,t.onInput(n,t.id)}}),function(e,s,c){return ge("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:bi(n),height:bi(o),borderRadius:bi(r),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),ge("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:bi(r),background:vi("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},mi(t))}),ge(xi,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function Si(t){var e=pi(t),i=e.width,s=e.height,n=e.radius,o=t.colors,r=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,c=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],h=o.map(function(e){return function(t,e){var i=pi(t),s=i.width,n=i.height,o=i.radius,r=e.hsv,a=o,l=s-2*o,c=n-2*o;return{x:a+r.s/100*l,y:a+(c-r.v/100*c)}}(t,e)});return ge(wi,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var n=_i(t,e,i,h);null!==n?r.setActiveColor(n):(r.inputActive=!0,l.hsv=fi(t,e,i),t.onInput(s,t.id))}else 1===s&&(r.inputActive=!0,l.hsv=fi(t,e,i));t.onInput(s,t.id)}}),function(e,r,a){return ge("div",Object.assign({},r,{className:"IroBox",style:Object.assign({},{width:bi(i),height:bi(s),position:"relative"},a)}),ge("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:bi(n)},mi(t),{background:vi("linear","to bottom",c[1])+","+vi("linear","to right",c[0])})}),o.filter(function(t){return t!==l}).map(function(e){return ge(xi,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[e.index].x,y:h[e.index].y})}),ge(xi,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[l.index].x,y:h[l.index].y}))})}xi.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},$i.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function Ii(t){var e=hi(t).width,i=t.colors;t.borderWidth;var s=t.parent,n=t.color,o=n.hsv,r=i.map(function(e){return function(t,e){var i=e.hsv,s=hi(t),n=s.cx,o=s.cy,r=ci(t),a=(180+di(t,i.h,!0))*(ai/360),l=i.s/100*r,c="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*c,y:o+l*Math.sin(a)*c}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return ge(wi,Object.assign({},t,{onInput:function(e,i,o){if(0===o){if(!function(t,e,i){var s=hi(t),n=s.cx,o=s.cy,r=t.width/2;return li(n-e,o-i)<r}(t,e,i))return!1;var a=_i(t,e,i,r);null!==a?s.setActiveColor(a):(s.inputActive=!0,n.hsv=ui(t,e,i),t.onInput(o,t.id))}else 1===o&&(s.inputActive=!0,n.hsv=ui(t,e,i));t.onInput(o,t.id)}}),function(s,l,c){return ge("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:bi(e),height:bi(e),position:"relative"},c)}),ge("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),ge("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&ge("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-o.v/100})}),ge("div",{className:"IroWheelBorder",style:Object.assign({},a,mi(t))}),i.filter(function(t){return t!==n}).map(function(e){return ge(xi,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:r[e.index].x,y:r[e.index].y})}),ge(xi,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:r[n.index].x,y:r[n.index].y}))})}var ki=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new si(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(n[t]||(n[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:Ii},{component:$i}],e.transparency&&s.push({component:$i,options:{sliderType:"alpha"}})),ge("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var n=t.component,o=t.options;return ge(n,Object.assign({},e,o,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(ve);ki.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var Ei,Ci,Ai,Pi=(Ci=function(t,e){var i,s=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,n,o;oe.__p&&oe.__p(t,e),n=(s=i===ce)?null:e.__k,t=ge(me,null,[t]),o=[],Ce(e,e.__k=t,n||he,he,void 0!==e.ownerSVGElement,n?null:de.slice.call(e.childNodes),o,!1,he,s),Ae(o,t)}(ge(Ei,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),i},Ci.prototype=(Ei=ki).prototype,Object.assign(Ci,Ei),Ci.__component=Ei,Ci);!function(t){var e;t.version="5.5.2",t.Color=si,t.ColorPicker=Pi,(e=t.ui||(t.ui={})).h=ge,e.ComponentBase=wi,e.Handle=xi,e.Slider=$i,e.Wheel=Ii,e.Box=Si}(Ai||(Ai={}));var Ri=Ai;const Mi="wled_studio.color_swatches";function Ni(t){return t.trim()||"_default"}function Li(){try{const t=localStorage.getItem(Mi);if(!t)return{};const e=JSON.parse(t);return e&&"object"==typeof e?e:{}}catch{return{}}}function Oi(t){const e=Li()[Ni(t)];return Array.isArray(e)?[...e]:[]}function Ti(t,e){const i=Li();var s;i[Ni(t)]=e.slice(0,32),s=i,localStorage.setItem(Mi,JSON.stringify(s))}function Ui(t,e){return`${t[0]},${t[1]},${t[2]},${e}`}function Di(t,e){const i="#"+[t[0],t[1],t[2]].map(t=>Math.max(0,Math.min(255,t)).toString(16).padStart(2,"0")).join("");return e>0?`${i} +W`:i.toUpperCase()}let Wi=class extends vt{constructor(){super(...arguments),this.controllerId="",this.rgb=[255,128,0],this.white=0,this._swatches=[],this._saving=!1,this._saveName="",this._editingId=null,this._editName=""}onPoweredConnect(){this._reload()}updated(t){super.updated(t),t.has("controllerId")&&this._reload()}_reload(){this._swatches=Oi(this.controllerId)}_currentKey(){return Ui(this.rgb,this.white)}_swatchCss(t){const[e,i,s]=t.rgb;return t.white>0?`linear-gradient(135deg, rgb(${e},${i},${s}) 55%, rgba(255,255,255,0.95) 55%)`:`rgb(${e},${i},${s})`}_apply(t){this.dispatchEvent(new CustomEvent("swatch-select",{detail:{rgb:[...t.rgb],white:t.white},bubbles:!0,composed:!0}))}_openSave(){this._saveName=Di(this.rgb,this.white),this._saving=!0,this._editingId=null}_confirmSave(){!function(t,e){const i=Oi(t),s=Ui(e.rgb,e.white),n=i.find(t=>Ui(t.rgb,t.white)===s);if(n)return n.name=e.name.trim()||n.name,Ti(t,i),n;const o={id:`sw_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,name:e.name.trim()||Di(e.rgb,e.white),rgb:[...e.rgb],white:e.white};i.unshift(o),Ti(t,i)}(this.controllerId,{name:this._saveName,rgb:this.rgb,white:this.white}),this._saving=!1,this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_cancelSave(){this._saving=!1}_startEdit(t,e){e.stopPropagation(),this._editingId=t.id,this._editName=t.name,this._saving=!1}_confirmEdit(){this._editingId&&(!function(t,e,i){const s=Oi(t),n=s.findIndex(t=>t.id===e);if(n<0)return null;const o=s[n],r={...o,...i,rgb:i.rgb?[...i.rgb]:o.rgb};void 0!==i.name&&(r.name=i.name.trim()||Di(r.rgb,r.white)),s[n]=r,Ti(t,s)}(this.controllerId,this._editingId,{name:this._editName}),this._editingId=null,this._reload())}_cancelEdit(){this._editingId=null}_delete(t,e){e.stopPropagation(),function(t,e){const i=Oi(t).filter(t=>t.id!==e);Ti(t,i)}(this.controllerId,t),this._editingId===t&&(this._editingId=null),this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}render(){const t=this._currentKey();return B`
        ...
        ${0!==this._swatches.length||this._saving?B`
              <div class="grid" role="list">
                ${this._swatches.map(e=>B`
                    <div
                      class="chip-wrap ${Ui(e.rgb,e.white)===t?"active":""}"
                      role="listitem"
                    >
                      <button
                        type="button"
    ...
    `]}};t([ht()],Wi.prototype,"controllerId",void 0),t([ht({type:Array})],Wi.prototype,"rgb",void 0),t([ht({type:Number})],Wi.prototype,"white",void 0),t([dt()],Wi.prototype,"_swatches",void 0),t([dt()],Wi.prototype,"_saving",void 0),t([dt()],Wi.prototype,"_saveName",void 0),t([dt()],Wi.prototype,"_editingId",void 0),t([dt()],Wi.prototype,"_editName",void 0),Wi=t([pt("wled-color-swatch-bar")],Wi);let zi=class extends vt{constructor(){super(...arguments),this.rgb=[255,128,0],this.white=0,this.awm=0,this.showWhite=!0,this.controllerId="",this._suppress=!1}updated(){this._host&&!this._picker&&(this._picker=Ri.ColorPicker(this._host,{width:140,color:{r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},borderWidth:1,borderColor:"var(--divider-color, #444)",layout:[{component:Ri.ui.Wheel}]}),this._picker.on("color:change",t=>{this._suppress||this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:[t.rgb.r,t.rgb.g,t.rgb.b],white:this.white},bubbles:!0,composed:!0}))}),this._syncPicker())}willUpdate(){this._picker&&this._syncPicker()}_syncPicker(){this._picker&&(this._suppress=!0,this._picker.color.rgb={r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},this._suppress=!1)}_onWhite(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:this.rgb,white:e},bubbles:!0,composed:!0}))}_onAwm(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("awm-change",{detail:{awm:e},bubbles:!0,composed:!0}))}_onSwatchSelect(t){this.dispatchEvent(new CustomEvent("color-change",{detail:t.detail,bubbles:!0,composed:!0}))}render(){return B`
      <div class="picker">
        <div class="wrap">
    ...
    `]}};t([ht({type:Array})],zi.prototype,"rgb",void 0),t([ht({type:Number})],zi.prototype,"white",void 0),t([ht({type:Number})],zi.prototype,"awm",void 0),t([ht({type:Boolean})],zi.prototype,"showWhite",void 0),t([ht()],zi.prototype,"controllerId",void 0),t([ut(".wheel-host")],zi.prototype,"_host",void 0),zi=t([pt("wled-color-wheel-rgbw")],zi);function Hi(t,e="strip",i,s=0){let n=String(t);return s&&(n=`${n}_p${s}`),i?.trim()&&(n=`${n}_${function(t){return(t||"").trim().replace(/[^\w.-]+/g,"_")||"unknown"}(i)}`),`${n}_${e}.webp`}function ji(t,e,i="strip",s,n,o){if(!t||e<0)return;const r=void 0!==o?function(t,e,i="strip",s){const n=e instanceof Set?e:new Set(e);if(!n.size)return;const o=[Hi(t,i,s),Hi(t,i)];for(const t of o)if(n.has(t))return t;const r=`${t}_`,a=`_${i}.webp`;for(const t of n)if(t.startsWith(r)&&t.endsWith(a))return t}(e,o,i,s):Hi(e,i,s);return r?function(t,e){if(!t.startsWith("/"))return t;const i=e?.auth?.data?.access_token;if(!i)return t;const s=t.includes("?")?"&":"?";return`${t}${s}auth=${encodeURIComponent(i)}`}(function(t,e){return`/local/wled_studio/thumbs/${encodeURIComponent(t)}/${encodeURIComponent(e)}`}(t,r),n):void 0}const Bi="wled_studio.recent_effects";function qi(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function Fi(t){return t?qi(Bi)[t]??[]:[]}function Vi(t,e,i,s){if(!t)return[];if(e===(s.solidId??0))return Fi(t);const n=qi(Bi),o=(n[t]??[]).filter(t=>t.id!==e);return o.unshift({id:e,name:i}),n[t]=o.slice(0,10),function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(Bi,n),n[t]}let Ji=class extends vt{constructor(){super(...arguments),this.fxId=0,this.thumbUrl="",this.thumbUrlAnimated="",this.label="",this._hover=!1}render(){const t=this.thumbUrlAnimated||(this.thumbUrl.endsWith(".webp")?this.thumbUrl:""),e=this.thumbUrl||t,i=this._hover&&t?t:e;return B`
      <button
        class="tile"
        type="button"
    ...
    `]}};t([ht({type:Number})],Ji.prototype,"fxId",void 0),t([ht()],Ji.prototype,"thumbUrl",void 0),t([ht()],Ji.prototype,"thumbUrlAnimated",void 0),t([ht()],Ji.prototype,"label",void 0),t([dt()],Ji.prototype,"_hover",void 0),Ji=t([pt("wled-effect-tile")],Ji);let Gi=class extends vt{constructor(){super(...arguments),this.effectsByName={},this.soundFlags=[],this.selectedFx=0,this.filter="",this.controllerId="",this.fwVer="",this.thumbBasenames=[],this.toggleOff=!0,this.showRecents=!0,this._category="all",this._recentEntries=[],this._recentVisible=6}onPoweredConnect(){this._loadRecents(),this._ro=new ResizeObserver(()=>this._measureRecents()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._loadRecents();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._recentRowEl&&(this._recentRowEl=e,this._ro?.observe(e),this._measureRecents())}_loadRecents(){this._recentEntries=Fi(this.controllerId)}_measureRecents(){const t=this._recentRowEl;if(!t)return;const e=function(t,e=72,i=6,s=10){if(t<=0)return 1;const n=e+i;return Math.max(1,Math.min(s,Math.floor((t+i)/n)))}(t.clientWidth,76,6,10);e!==this._recentVisible&&(this._recentVisible=e)}_effectName(t){return Object.entries(this.effectsByName).find(([,e])=>e===t)?.[0]??`Effect ${t}`}render(){const t=this.filter.trim().toLowerCase(),e=Object.keys(this.effectsByName).sort((t,e)=>t.localeCompare(e)),i=Vt(this.effectsByName),s=e.filter(e=>!!function(t,e,i,s,n){if("all"===i)return!0;const o=s[e]??null,r=t.toLowerCase();return"solid"===i?e===Vt(n):"2d"===i?"2"===o||r.includes("2d"):"1d"===i?"2"!==o&&!r.includes("2d"):"sound"===i?"v"===o||"f"===o:"palette"!==i||r.includes("palette")||r.includes("colorloop")||r.includes("pride")||r.includes("cycle")}(e,this.effectsByName[e],this._category,this.soundFlags,this.effectsByName)&&!(t&&!e.toLowerCase().includes(t))),n=this.showRecents&&!t&&this._recentEntries.length>0,o=this._recentEntries.slice(0,this._recentVisible);return B`
      <div class="wrap">
        ...
        <div class="grid" role="listbox" aria-label="Effects">
          ${0===s.length?B`<p class="empty">No effects match this filter.</p>`:s.map(t=>{const e=this.effectsByName[t],s=this.soundFlags[e],n=e===this.selectedFx,o=ji(this.controllerId,e,"strip",this.fwVer,this.hass,this.thumbBasenames);return o?B`
                    <wled-effect-tile
    ...
    `]}};t([ht({type:Object})],Gi.prototype,"effectsByName",void 0),t([ht({type:Array})],Gi.prototype,"soundFlags",void 0),t([ht({type:Number})],Gi.prototype,"selectedFx",void 0),t([ht({type:String})],Gi.prototype,"filter",void 0),t([ht()],Gi.prototype,"controllerId",void 0),t([ht()],Gi.prototype,"fwVer",void 0),t([ht({type:Array})],Gi.prototype,"thumbBasenames",void 0),t([ht({type:Boolean})],Gi.prototype,"toggleOff",void 0),t([ht({type:Boolean})],Gi.prototype,"showRecents",void 0),t([dt()],Gi.prototype,"_category",void 0),t([dt()],Gi.prototype,"_recentEntries",void 0),t([dt()],Gi.prototype,"_recentVisible",void 0),Gi=t([pt("wled-effect-chips")],Gi);let Ki=class extends vt{constructor(){super(...arguments),this.controllerId="",this.segments=[],this.editIds=[],this.pixelCount=210,this._merged=!1,this._busy=!1,this._error=""}onPoweredConnect(){this._merged=Zt(this.controllerId)}willUpdate(t){t.has("controllerId")&&(this._merged=Zt(this.controllerId))}render(){const t=te(this.controllerId),e=t&&this._merged?`${t.segments.length} segment layout saved`:null;return B`
    ...
    `]}};t([ht({attribute:!1})],Ki.prototype,"connection",void 0),t([ht()],Ki.prototype,"controllerId",void 0),t([ht({type:Array})],Ki.prototype,"segments",void 0),t([ht({type:Array})],Ki.prototype,"editIds",void 0),t([ht({type:Number})],Ki.prototype,"pixelCount",void 0),t([dt()],Ki.prototype,"_merged",void 0),t([dt()],Ki.prototype,"_busy",void 0),t([dt()],Ki.prototype,"_error",void 0),Ki=t([pt("wled-effect-merge-toggle")],Ki);let Xi=class extends vt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return B`
    ...
    `]}};t([ht({type:Array})],Xi.prototype,"presets",void 0),Xi=t([pt("wled-preset-bar")],Xi);const Yi={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Zi=class extends vt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this.selectedSegId=-1,this._loading=!0,this._error="",this._segId=0,this._editIds=[],this._segments=[],this._effectFilter="",this._presets=[],this._colorSlot=0,this._toast="",this._mergeActive=!1}onPoweredConnect(){this._mergeActive=Zt(this.controllerId),this._load()}willUpdate(t){t.has("selectedSegId")&&this.selectedSegId>=0&&(this._segId=this.selectedSegId,this._refreshMeta()),(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&(this._optimistic?.cancel(),this._optimistic=ne(this.connection,this.controllerId,(t,e)=>this._reconcile(t,e)),this._load())}onPoweredDisconnect(){this._optimistic?.cancel(),this._optimistic=void 0}selectSegment(t){if(this._mergeActive)return this._segId=0,void this._refreshMeta();this._editIds.includes(t)||(this._editIds=[...this._editIds,t].sort((t,e)=>t-e)),this._segId=t,this._colorSlot=0,this._refreshMeta(),this._syncSelToDevice(),this.dispatchEvent(new CustomEvent("segment-change",{detail:{segmentId:t,editIds:[...this._editIds]},bubbles:!0,composed:!0}))}async _load(){if(this.connection&&this.controllerId){this._loading=!0,this._error="";try{const t=await St(this.connection,this.controllerId);if(this._snapshot=t,this._segments=[...t.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length){const t=this._segments.map(t=>t.id);t.includes(this._segId)||(this._segId=this._segments[0].id);const e=this._editIds.filter(e=>t.includes(e));this._editIds=e.length?e:[this._segId]}await this._refreshMeta(),await this._loadPresets(),this._mergeActive=Zt(this.controllerId);const e=this._pixelCount(),i=this._segments.find(t=>0===t.id),s=(i?.stop??0)-(i?.start??0);this._mergeActive&&this._segments.length>1&&e>0&&s<.9*e&&(Qt(this.controllerId,!1),this._mergeActive=!1,this._toast="Merge for effects was turned off — WLED is using a multi-segment layout."),this._mergeActive&&(this._editIds=ie(this._segments),this._segId=this._editIds[0]??0)}catch(t){this._error=qt(t)}finally{this._loading=!1}}}async _loadPresets(){if(this.connection&&this.controllerId)try{const t=await async function(t,e){return(await t.sendMessagePromise({type:"wled_studio/get_presets",schema_version:1,controller_id:e})).presets??{}}(this.connection,this.controllerId),e=[];for(const[i,s]of Object.entries(t)){if(!s||"object"!=typeof s)continue;const t=s;e.push({id:i,name:String(t.n??t.name??`Preset ${i}`),ql:t.ql?String(t.ql):void 0})}e.sort((t,e)=>Number(t.id)-Number(e.id)),this._presets=e}catch{this._presets=[]}}_reconcile(t,e){const i=this._segments.findIndex(e=>e.id===t.id);if(i>=0){const e=[...this._segments];e[i]={...e[i],...t,id:t.id},this._segments=e}e?(this._toast=e,this.requestUpdate(),window.setTimeout(()=>{this._toast="",this.requestUpdate()},4e3)):this.requestUpdate()}_activeSeg(){return this._segments.find(t=>t.id===this._segId)??this._segments[0]}async _refreshMeta(){const t=this._activeSeg();this.connection&&this.controllerId&&t&&(this._meta=await async function(t,e,i){return(await t.sendMessagePromise({type:"wled_studio/effect_meta",schema_version:1,controller_id:e,effect_id:i})).meta??{sliders:{},colors_enabled:!0,palette_enabled:!0,flag:null,defaults:{}}}(this.connection,this.controllerId,t.fx??0))}async _syncHaSegment(t,e){if(!this.hass)return;const i=function(t,e){for(const i of e){if(i.wled_segment_id===t)return i.entity_id;if(Ct(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}(t.id,this._snapshot?.segment_entities??[]);if(!i)return;const s={entity_id:i};if(e.col?.length){const t=kt(e.col[0]);t[3]>0?s.rgbw_color=[t[0],t[1],t[2],t[3]]:s.rgb_color=[t[0],t[1],t[2]]}if(void 0!==e.bri&&(s.brightness=e.bri),void 0!==e.fx&&this._snapshot?.effects_by_name){const t=Object.entries(this._snapshot.effects_by_name).find(([,t])=>t===e.fx)?.[0];t&&(s.effect=t)}!1!==e.on?Object.keys(s).length>1&&await this.hass.callService("light","turn_on",s):await this.hass.callService("light","turn_off",{entity_id:i})}_pixelCount(){const t=this._snapshot?.info?.leds;return Number(t?.count)||210}_targetIds(){if(this._mergeActive){const t=ie(this._segments);return t.length?t:[0]}return this._editIds.length?this._editIds:[this._segId]}_onMergeChanged(){this._mergeActive=Zt(this.controllerId),this._load(),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}_patchSeg(t){const e=this._targetIds();if(!e.length||!this._optimistic)return;const i=[...this._segments];for(const s of e){const e=i.findIndex(t=>t.id===s);if(e<0)continue;const n=i[e];i[e]={...n,...t,id:s,sel:!0,on:void 0!==t.on?t.on:!1!==n.on},this._syncHaSegment(n,t)}this._segments=i;const s=this._activeSeg();this._optimistic.push(function(t,e,i){const s=new Set(t),n=(i.length?i:t.map(t=>({id:t}))).map(t=>s.has(t.id)?{...e,id:t.id,sel:!0,on:void 0!==e.on?e.on:!1===t.on||t.on}:{id:t.id,sel:!1});return{seg:n}}(e,t,this._segments),s??{id:e[0]})}async _syncSelToDevice(){if(!this.connection||!this.controllerId||!this._segments.length)return;const t=this._targetIds();await It(this.connection,this.controllerId,function(t,e){const i=new Set(t);return{seg:e.map(t=>({id:t.id,sel:i.has(t.id)}))}}(t,this._segments)),this._segments=this._segments.map(e=>({...e,sel:t.includes(e.id)}))}_toggleSegEdit(t){if(this._mergeActive)return;let e=function(t,e){const i=new Set(t);return i.has(e)?i.delete(e):i.add(e),[...i].sort((t,e)=>t-e)}(this._editIds,t);e.length||(e=[t]),this._editIds=e,this._segId=t,this._colorSlot=0,this._refreshMeta(),this._syncSelToDevice(),this.dispatchEvent(new CustomEvent("segment-change",{detail:{segmentId:t,editIds:[...this._editIds]},bubbles:!0,composed:!0}))}async _onEffectSelect(t){this._patchSeg({fx:t.detail.effectId}),await this._refreshMeta()}_cols(t){const e=t.col??[],i=[];for(let t=0;t<3;t++)i.push(kt(e[t]));return i}_onColor(t){const e=this._activeSeg();if(!e)return;const{rgb:i,white:s}=t.detail,n=this._cols(e);n[this._colorSlot]=[i[0],i[1],i[2],s];const o=Vt(this._snapshot?.effects_by_name??{});this._patchSeg({col:n.map(t=>[t[0],t[1],t[2],t[3]]),fx:o}),this._refreshMeta()}async _onAwm(t){const e=t.detail.awm;if(this.connection&&this.controllerId)try{const t=await async function(t,e,i,s=0){return await xt(t),(await t.sendMessagePromise({type:"wled_studio/apply_rgbwm",schema_version:1,controller_id:e,rgbwm:i,bus_index:s})).rgbwm??i}(this.connection,this.controllerId,e);this._snapshot&&(this._snapshot={...this._snapshot,rgbwm:t}),this.requestUpdate()}catch(t){this._toast=t instanceof Error?t.message:String(t),this.requestUpdate()}}_slider(t,e){const i=Number(e.target.value);this._patchSeg({[t]:i})}async _loadPreset(t){this.connection&&this.controllerId&&(await It(this.connection,this.controllerId,{ps:Number(t)}),await this._load())}render(){if(this._loading)return B`<p class="muted">Loading segments…</p>`;if(this._error)return B`<p class="err">${this._error}</p>`;const t=this._activeSeg();if(!t)return B`<p class="muted">No segments on this controller.</p>`;const e=this._cols(t),i=e[this._colorSlot]??e[0],s=this._meta,n=s?.sliders??{},o=!1!==s?.colors_enabled?3:1,r=this._snapshot?.rgbwm??0;return B`
      <div class="controls ${this.compact?"compact":""}">
        ...
        <div class="sliders">
          ${Object.entries(Yi).map(([e,i])=>{if(!n[e])return null;const s=t[e];return B`
              <label>
                ${i}
                <ha-slider
                  min="0"
