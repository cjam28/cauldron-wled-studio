import{b as e,i as t,_ as i,n as o,d as s}from"./wled-studio-core.js";import{B as n,M as c,K as r}from"./geometry-preview.js";import{s as a}from"./wled-toast-host.js";let d=class extends n{constructor(){super(...arguments),this.controllerId="",this.masterEntity="",this._scenes=[],this._copied=""}async onPoweredConnect(){if(this.connection&&this.controllerId)try{this._scenes=await a(this.connection,this.controllerId)}catch{this._scenes=[]}}async _copy(e,t){if(e)try{await navigator.clipboard.writeText(e),this._copied=t,window.setTimeout(()=>{this._copied===t&&(this._copied="")},2e3)}catch{this._copied=""}}render(){const t=this.masterEntity.trim();return e`
      <section class="voice">
        <h2>Voice &amp; Assist</h2>
        <p>
    ...
    `]}};i([o({attribute:!1})],d.prototype,"connection",void 0),i([o()],d.prototype,"controllerId",void 0),i([o()],d.prototype,"masterEntity",void 0),i([s()],d.prototype,"_scenes",void 0),i([s()],d.prototype,"_copied",void 0),d=i([r("wled-view-voice")],d);export{d as WledViewVoice};
