...
`;class ft{constructor(t,e){this.host=t,this._hass=e,this._isRemote=!1,t.addController(this)}hostConnected(){this._refresh()}setHass(t){this._hass=t,this._refresh(),this.host.requestUpdate()}get state(){return{isRemote:this._isRemote,previewFps:this._isRemote?10:20,useBinaryPack:this._isRemote,disableBloom:this._isRemote}}_refresh(){if("undefined"==typeof location)return void(this._isRemote=!1);const t=location.hostname.endsWith(".ui.nabu.casa"),e=this._hass?.config?.external_url,i=!!e&&e.replace(/\/$/,"")===location.origin;this._isRemote=t||i}}const gt=[pt,_t];class vt extends rt{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new ft(this),this._visible=!0,this._inView=!0}static{this.styles=gt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}t([ht({attribute:!1})],vt.prototype,"hass",void 0);const yt=/^[0-9a-fA-F]+$/;function mt(t,e,i,s){let n,o=!1;const r=async()=>{n?.(),n=void 0,o||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let n=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&yt.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let o=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(o=t)}return{leds_hex:s,n:o,channels:n,scale:o/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:!1}))};r();const a=function(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}(t,()=>{r()});return()=>{o=!0,a(),n?.(),n=void 0}}async function bt(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",n),i(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function xt(t,e){await bt(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function wt(t,e,i,s){await bt(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}function $t(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function St(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function kt(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}function It(t,e){for(const i of e){if(kt(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}function Pt(t,e,i){const s=(i.length?i:[{id:t}]).map(i=>i.id===t?{...e,id:t,sel:!0,on:void 0!==e.on?e.on:!1===i.on||i.on}:{id:i.id,sel:!1});return{seg:s}}function Et(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:St(t.col),awm:t.awm};return JSON.stringify(e)}function Ct(t,e,i){let s,n=null,o=0;const r=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await xt(t,e)).segments??[]).find(t=>t.id===o);if(!s||!n)return;const r=Et(n);if(r===Et(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(St(t.col))!==JSON.stringify(St(e.col))}(n,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=function(t,e,i=100){let s,n,o;const r=()=>{if(s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,o){const e=o;o=void 0,t(...e)}},a=(...t)=>{o=t,s&&clearTimeout(s),s=setTimeout(r,e),n||(n=setTimeout(r,i))};return a.cancel=()=>{s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,o=void 0},a}((s,a)=>{n=a,o=a.id,wt(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(n={...a,...i,id:a.id}),r()}).catch(()=>{i(a,"Failed to apply state to WLED")})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var At,Mt,Lt,Rt,Ot,Dt={},Tt=[],Ut=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function Nt(t,e){for(var i in e)t[i]=e[i];return t}function zt(t){var e=t.parentNode;e&&e.removeChild(t)}function Wt(t,e,i){var s,n,o,r,a=arguments;if(e=Nt({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return r=e.key,null!=(o=e.ref)&&delete e.ref,null!=r&&delete e.key,Ht(t,e,r,o)}function Ht(t,e,i,s){var n={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return At.vnode&&At.vnode(n),n}function Ft(t){return t.children}function jt(t,e){this.props=t,this.context=e}function Bt(t,e){if(null==e)return t.__p?Bt(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?Bt(t):null}function qt(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return qt(t)}}function Vt(t){(!t.__d&&(t.__d=!0)&&1===Mt.push(t)||Rt!==At.debounceRendering)&&(Rt=At.debounceRendering,(At.debounceRendering||Lt)(Yt))}function Yt(){var t,e,i,s,n,o,r,a;for(Mt.sort(function(t,e){return e.__v.__b-t.__v.__b});t=Mt.pop();)t.__d&&(i=void 0,s=void 0,o=(n=(e=t).__v).__e,r=e.__P,a=e.u,e.u=!1,r&&(i=[],s=Qt(r,n,Nt({},n),e.__n,void 0!==r.ownerSVGElement,null,i,a,null==o?Bt(n):o),te(i,n),s!=o&&qt(n)))}function Xt(t,e,i,s,n,o,r,a,l){var c,h,d,u,p,_,f,g=i&&i.__k||Tt,v=g.length;if(a==Dt&&(a=null!=o?o[0]:v?Bt(i,0):null),c=0,e.__k=Gt(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=g[c])||d&&i.key==d.key&&i.type===d.type)g[c]=void 0;else for(h=0;h<v;h++){if((d=g[h])&&i.key==d.key&&i.type===d.type){g[h]=void 0;break}d=null}if(u=Qt(t,i,d=d||Dt,s,n,o,r,null,a,l),(h=i.ref)&&d.ref!=h&&(f||(f=[])).push(h,i.__c||u,i),null!=u){if(null==_&&(_=u),null!=i.l)u=i.l,i.l=null;else if(o==d||u!=a||null==u.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(u);else{for(p=a,h=0;(p=p.nextSibling)&&h<v;h+=2)if(p==u)break t;t.insertBefore(u,a)}"option"==e.type&&(t.value="")}a=u.nextSibling,"function"==typeof e.type&&(e.l=u)}}return c++,i}),e.__e=_,null!=o&&"function"!=typeof e.type)for(c=o.length;c--;)null!=o[c]&&zt(o[c]);for(c=v;c--;)null!=g[c]&&se(g[c],g[c]);if(f)for(c=0;c<f.length;c++)ie(f[c],f[++c],f[++c])}function Gt(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)Gt(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return Ht(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=Ht(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function Jt(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===Ut.test(e)?i+"px":null==i?"":i}function Kt(t,e,i,s,n){var o,r,a,l,c;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(o=t.style,"string"==typeof i)o.cssText=i;else{if("string"==typeof s&&(o.cssText="",s=null),s)for(r in s)i&&r in i||Jt(o,r,"");if(i)for(a in i)s&&i[a]===s[a]||Jt(o,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),c=e.toLowerCase(),e=(c in t?c:e).slice(2),i?(s||t.addEventListener(e,Zt,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,Zt,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function Zt(t){return this.t[t.type](At.event?At.event(t):t)}function Qt(t,e,i,s,n,o,r,a,l,c){var h,d,u,p,_,f,g,v,y,m,b=e.type;if(void 0!==e.constructor)return null;(h=At.__b)&&h(e);try{t:if("function"==typeof b){if(v=e.props,y=(h=b.contextType)&&s[h.__c],m=h?y?y.props.value:h.__p:s,i.__c?g=(d=e.__c=i.__c).__p=d.__E:("prototype"in b&&b.prototype.render?e.__c=d=new b(v,m):(e.__c=d=new jt(v,m),d.constructor=b,d.render=ne),y&&y.sub(d),d.props=v,d.state||(d.state={}),d.context=m,d.__n=s,u=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=b.getDerivedStateFromProps&&Nt(d.__s==d.state?d.__s=Nt({},d.__s):d.__s,b.getDerivedStateFromProps(v,d.__s)),u)null==b.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&r.push(d);else{if(null==b.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(v,m),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(v,d.__s,m)){for(d.props=v,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,h=0;h<e.__k.length;h++)e.__k[h]&&(e.__k[h].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(v,d.__s,m)}for(p=d.props,_=d.state,d.context=m,d.props=v,d.state=d.__s,(h=At.__r)&&h(e),d.__d=!1,d.__v=e,d.__P=t,h=d.render(d.props,d.state,d.context),e.__k=Gt(null!=h&&h.type==Ft&&null==h.key?h.props.children:h),null!=d.getChildContext&&(s=Nt(Nt({},s),d.getChildContext())),u||null==d.getSnapshotBeforeUpdate||(f=d.getSnapshotBeforeUpdate(p,_)),Xt(t,e,i,s,n,o,r,l,c),d.base=e.__e;h=d.__h.pop();)d.__s&&(d.state=d.__s),h.call(d);u||null==p||null==d.componentDidUpdate||d.componentDidUpdate(p,_,f),g&&(d.__E=d.__p=null)}else e.__e=ee(i.__e,e,i,s,n,o,r,c);(h=At.diffed)&&h(e)}catch(t){At.__e(t,e,i)}return e.__e}function te(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){At.__e(t,i.__v)}At.__c&&At.__c(e)}function ee(t,e,i,s,n,o,r,a){var l,c,h,d,u=i.props,p=e.props;if(n="svg"===e.type||n,null==t&&null!=o)for(l=0;l<o.length;l++)if(null!=(c=o[l])&&(null===e.type?3===c.nodeType:c.localName===e.type)){t=c,o[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(p);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),o=null}return null===e.type?u!==p&&(null!=o&&(o[o.indexOf(t)]=null),t.data=p):e!==i&&(null!=o&&(o=Tt.slice.call(t.childNodes)),h=(u=i.props||Dt).dangerouslySetInnerHTML,d=p.dangerouslySetInnerHTML,a||(d||h)&&(d&&h&&d.__html==h.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,n){var o;for(o in i)o in e||Kt(t,o,null,i[o],s);for(o in e)n&&"function"!=typeof e[o]||"value"===o||"checked"===o||i[o]===e[o]||Kt(t,o,e[o],i[o],s)}(t,p,u,n,a),e.__k=e.props.children,d||Xt(t,e,i,s,"foreignObject"!==e.type&&n,o,r,Dt,a),a||("value"in p&&void 0!==p.value&&p.value!==t.value&&(t.value=null==p.value?"":p.value),"checked"in p&&void 0!==p.checked&&p.checked!==t.checked&&(t.checked=p.checked))),t}function ie(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){At.__e(t,i)}}function se(t,e,i){var s,n,o;if(At.unmount&&At.unmount(t),(s=t.ref)&&ie(s,null,e),i||"function"==typeof t.type||(i=null!=(n=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){At.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(o=0;o<s.length;o++)s[o]&&se(s[o],e,i);null!=n&&zt(n)}function ne(t,e,i){return this.constructor(t,i)}function oe(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function re(){return re=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}return t},re.apply(this,arguments)}At={},jt.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=Nt({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&Nt(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),Vt(this))},jt.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,Vt(this))},jt.prototype.render=Ft,Mt=[],Lt="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Rt=At.debounceRendering,At.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return Vt(s.__E=s)}catch(e){t=e}throw t},Ot=Dt;var ae="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",le="[\\s|\\(]+("+ae+")[,|\\s]+("+ae+")[,|\\s]+("+ae+")\\s*\\)?",ce="[\\s|\\(]+("+ae+")[,|\\s]+("+ae+")[,|\\s]+("+ae+")[,|\\s]+("+ae+")\\s*\\)?",he=new RegExp("rgb"+le),de=new RegExp("rgba"+ce),ue=new RegExp("hsl"+le),pe=new RegExp("hsla"+ce),_e="^(?:#?|0x?)",fe="([0-9a-fA-F]{1})",ge="([0-9a-fA-F]{2})",ve=new RegExp(_e+fe+fe+fe+"$"),ye=new RegExp(_e+fe+fe+fe+fe+"$"),me=new RegExp(_e+ge+ge+ge+"$"),be=new RegExp(_e+ge+ge+ge+ge+"$"),xe=Math.log,we=Math.round,$e=Math.floor;function Se(t,e,i){return Math.min(Math.max(t,e),i)}function ke(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function Ie(t){return parseInt(t,16)}function Pe(t){return t.toString(16).padStart(2,"0")}var Ee=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=re({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=re({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,n=$e(e),o=e-n,r=s*(1-i),a=s*(1-o*i),l=s*(1-(1-o)*i),c=n%6,h=[l,s,s,a,r,r][c],d=[r,r,l,s,s,a][c];return{r:Se(255*[s,a,r,r,l,s][c],0,255),g:Se(255*h,0,255),b:Se(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,n=Math.max(e,i,s),o=Math.min(e,i,s),r=n-o,a=0,l=n,c=0===n?0:r/n;switch(n){case o:a=0;break;case e:a=(i-s)/r+(i<s?6:0);break;case i:a=(s-e)/r+2;break;case s:a=(e-i)/r+4}return{h:60*a%360,s:Se(100*c,0,100),v:Se(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,n=s<=1?s:2-s,o=n<1e-9?0:e*i/n;return{h:t.h,s:Se(100*o,0,100),l:Se(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:Se(100*s,0,100),v:Se((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,n=t/100;return n<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=n-2)+104.49216199393888*xe(i),s=n<20?0:.8274096064007395*(s=n-10)-254.76935184120902+115.67994401066147*xe(s)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*xe(e),i=325.4494125711974+.07943456536662342*(i=n-50)-28.0852963507957*xe(i),s=255),{r:Se($e(e),0,255),g:Se($e(i),0,255),b:Se($e(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,n=e.b,o=2e3,r=4e4;r-o>.4;){i=.5*(r+o);var a=t.kelvinToRgb(i);a.b/a.r>=n/s?r=i:o=i}return i},oe(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=re({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return re({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=re({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=re({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=re({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=re({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,n=e.b;return{r:we(i),g:we(s),b:we(n)}},set:function(e){this.hsv=re({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return re({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,n=e.l;return{h:we(i),s:we(s),l:we(n)}},set:function(e){this.hsv=re({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return re({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,n,o=1;if((e=he.exec(t))?(i=ke(e[1],255),s=ke(e[2],255),n=ke(e[3],255)):(e=de.exec(t))&&(i=ke(e[1],255),s=ke(e[2],255),n=ke(e[3],255),o=ke(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:n,a:o}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+Pe(t.r)+Pe(t.g)+Pe(t.b)},set:function(t){var e,i,s,n,o=255;if((e=ve.exec(t))?(i=17*Ie(e[1]),s=17*Ie(e[2]),n=17*Ie(e[3])):(e=ye.exec(t))?(i=17*Ie(e[1]),s=17*Ie(e[2]),n=17*Ie(e[3]),o=17*Ie(e[4])):(e=me.exec(t))?(i=Ie(e[1]),s=Ie(e[2]),n=Ie(e[3])):(e=be.exec(t))&&(i=Ie(e[1]),s=Ie(e[2]),n=Ie(e[3]),o=Ie(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:n,a:o/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+Pe(t.r)+Pe(t.g)+Pe(t.b)+Pe($e(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,n,o=1;if((e=ue.exec(t))?(i=ke(e[1],360),s=ke(e[2],100),n=ke(e[3],100)):(e=pe.exec(t))&&(i=ke(e[1],360),s=ke(e[2],100),n=ke(e[3],100),o=ke(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:n,a:o}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function Ce(t){var e,i=t.width,s=t.sliderSize,n=t.borderWidth,o=t.handleRadius,r=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*r+2*o,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*r-2*o,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-n/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function Ae(t,e){var i=Ce(t),s=i.width,n=i.height,o=i.handleRange,r=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var n=t.minTemperature,o=t.maxTemperature-n,r=(e.kelvin-n)/o*100;return Math.max(0,Math.min(r,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),c=a?s/2:n/2,h=r+l/100*o;return a&&(h=-1*h+o+2*r),{x:a?c:h,y:a?h:c}}var Me,Le=2*Math.PI,Re=function(t,e){return Math.sqrt(t*t+e*e)};function Oe(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function De(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function Te(t,e,i){var s=t.wheelAngle,n=t.wheelDirection;return i&&"clockwise"===n?e=s+e:"clockwise"===n?e=360-s+e:i&&"anticlockwise"===n?e=s+180-e:"anticlockwise"===n&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function Ue(t,e,i){var s=De(t),n=s.cx,o=s.cy,r=Oe(t);e=n-e,i=o-i;var a=Te(t,Math.atan2(-i,-e)*(360/Le)),l=Math.min(Re(e,i),r);return{h:Math.round(a),s:Math.round(100/r*l)}}function Ne(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function ze(t,e,i){var s=Ne(t),n=s.width,o=s.height,r=s.radius,a=(e-r)/(n-2*r)*100,l=(i-r)/(o-2*r)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function We(t){Me||(Me=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),n=window.location;return(i||s)&&Me.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function He(t,e,i,s){for(var n=0;n<s.length;n++){var o=s[n].x-e,r=s[n].y-i;if(Math.sqrt(o*o+r*r)<t.handleRadius)return n}return null}function Fe(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function je(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function Be(t){return"string"==typeof t?t:t+"px"}var qe=["mousemove","touchmove","mouseup","touchend"],Ve=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,o={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(o[s?"marginLeft":"marginTop"]=n),Wt(Ft,null,t.children(this.uid,i,o))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,o=n.clientX-s.left,r=n.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(o,r,0)&&qe.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(o,r,1);break;case"mouseup":case"touchend":i(o,r,2),qe.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(jt);function Ye(t){var e=t.r,i=t.url,s=e,n=e;return Wt("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+Be(t.x)+", "+Be(t.y)+")",willChange:"transform",top:Be(-e),left:Be(-e),width:Be(2*e),height:Be(2*e),position:"absolute",overflow:"visible"}},i&&Wt("use",Object.assign({xlinkHref:We(i)},t.props)),!i&&Wt("circle",{cx:s,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&Wt("circle",{cx:s,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function Xe(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=Ce(t),n=s.width,o=s.height,r=s.radius,a=Ae(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var n=[],o=t.minTemperature,r=t.maxTemperature,a=r-o,l=o,c=0;l<r;l+=a/8,c+=1){var h=Ee.kelvinToRgb(l),d=h.r,u=h.g,p=h.b;n.push([12.5*c,"rgb("+d+","+u+","+p+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var _=Ee.hsvToHsl({h:i.h,s:0,v:i.v}),f=Ee.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"],[100,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"]];default:var g=Ee.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"]]}}(t,i);return Wt(Ve,Object.assign({},t,{onInput:function(e,s,n){var o=function(t,e,i){var s,n=Ce(t),o=n.handleRange,r=n.handleStart;s="horizontal"===t.layoutDirection?-1*i+o+r:e-r,s=Math.max(Math.min(s,o),0);var a=Math.round(100/o*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=o,t.onInput(n,t.id)}}),function(e,s,c){return Wt("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:Be(n),height:Be(o),borderRadius:Be(r),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),Wt("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:Be(r),background:je("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},Fe(t))}),Wt(Ye,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function Ge(t){var e=Ne(t),i=e.width,s=e.height,n=e.radius,o=t.colors,r=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,c=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],h=o.map(function(e){return function(t,e){var i=Ne(t),s=i.width,n=i.height,o=i.radius,r=e.hsv,a=o,l=s-2*o,c=n-2*o;return{x:a+r.s/100*l,y:a+(c-r.v/100*c)}}(t,e)});return Wt(Ve,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var n=He(t,e,i,h);null!==n?r.setActiveColor(n):(r.inputActive=!0,l.hsv=ze(t,e,i),t.onInput(s,t.id))}else 1===s&&(r.inputActive=!0,l.hsv=ze(t,e,i));t.onInput(s,t.id)}}),function(e,r,a){return Wt("div",Object.assign({},r,{className:"IroBox",style:Object.assign({},{width:Be(i),height:Be(s),position:"relative"},a)}),Wt("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:Be(n)},Fe(t),{background:je("linear","to bottom",c[1])+","+je("linear","to right",c[0])})}),o.filter(function(t){return t!==l}).map(function(e){return Wt(Ye,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[e.index].x,y:h[e.index].y})}),Wt(Ye,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[l.index].x,y:h[l.index].y}))})}Ye.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},Xe.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function Je(t){var e=De(t).width,i=t.colors;t.borderWidth;var s=t.parent,n=t.color,o=n.hsv,r=i.map(function(e){return function(t,e){var i=e.hsv,s=De(t),n=s.cx,o=s.cy,r=Oe(t),a=(180+Te(t,i.h,!0))*(Le/360),l=i.s/100*r,c="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*c,y:o+l*Math.sin(a)*c}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return Wt(Ve,Object.assign({},t,{onInput:function(e,i,o){if(0===o){if(!function(t,e,i){var s=De(t),n=s.cx,o=s.cy,r=t.width/2;return Re(n-e,o-i)<r}(t,e,i))return!1;var a=He(t,e,i,r);null!==a?s.setActiveColor(a):(s.inputActive=!0,n.hsv=Ue(t,e,i),t.onInput(o,t.id))}else 1===o&&(s.inputActive=!0,n.hsv=Ue(t,e,i));t.onInput(o,t.id)}}),function(s,l,c){return Wt("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:Be(e),height:Be(e),position:"relative"},c)}),Wt("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),Wt("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&Wt("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-o.v/100})}),Wt("div",{className:"IroWheelBorder",style:Object.assign({},a,Fe(t))}),i.filter(function(t){return t!==n}).map(function(e){return Wt(Ye,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:r[e.index].x,y:r[e.index].y})}),Wt(Ye,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:r[n.index].x,y:r[n.index].y}))})}var Ke=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new Ee(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(n[t]||(n[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:Je},{component:Xe}],e.transparency&&s.push({component:Xe,options:{sliderType:"alpha"}})),Wt("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var n=t.component,o=t.options;return Wt(n,Object.assign({},e,o,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(jt);Ke.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var Ze,Qe,ti,ei=(Qe=function(t,e){var i,s=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,n,o;At.__p&&At.__p(t,e),n=(s=i===Ot)?null:e.__k,t=Wt(Ft,null,[t]),o=[],Qt(e,e.__k=t,n||Dt,Dt,void 0!==e.ownerSVGElement,n?null:Tt.slice.call(e.childNodes),o,!1,Dt,s),te(o,t)}(Wt(Ze,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),i},Qe.prototype=(Ze=Ke).prototype,Object.assign(Qe,Ze),Qe.__component=Ze,Qe);!function(t){var e;t.version="5.5.2",t.Color=Ee,t.ColorPicker=ei,(e=t.ui||(t.ui={})).h=Wt,e.ComponentBase=Ve,e.Handle=Ye,e.Slider=Xe,e.Wheel=Je,e.Box=Ge}(ti||(ti={}));var ii=ti;let si=class extends vt{constructor(){super(...arguments),this.rgb=[255,128,0],this.white=0,this.awm=0,this.showWhite=!0,this._suppress=!1}updated(){this._host&&!this._picker&&(this._picker=ii.ColorPicker(this._host,{width:140,color:{r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},borderWidth:1,borderColor:"var(--divider-color, #444)",layout:[{component:ii.ui.Wheel}]}),this._picker.on("color:change",t=>{this._suppress||this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:[t.rgb.r,t.rgb.g,t.rgb.b],white:this.white},bubbles:!0,composed:!0}))}),this._syncPicker())}willUpdate(){this._picker&&this._syncPicker()}_syncPicker(){this._picker&&(this._suppress=!0,this._picker.color.rgb={r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},this._suppress=!1)}_onWhite(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:this.rgb,white:e},bubbles:!0,composed:!0}))}_onAwm(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("awm-change",{detail:{awm:e},bubbles:!0,composed:!0}))}render(){return j`
    ...
    `]}};t([ht({attribute:!1})],Qi.prototype,"connection",void 0),t([ht()],Qi.prototype,"controllerId",void 0),t([ht()],Qi.prototype,"layoutId",void 0),t([ht()],Qi.prototype,"fixtureId",void 0),t([ht({type:Number})],Qi.prototype,"pixelCount",void 0),t([dt()],Qi.prototype,"_vertices",void 0),t([dt()],Qi.prototype,"_ledPositions",void 0),t([dt()],Qi.prototype,"_selectedVtx",void 0),t([dt()],Qi.prototype,"_anchorInput",void 0),t([dt()],Qi.prototype,"_status",void 0),t([dt()],Qi.prototype,"_busy",void 0),t([dt()],Qi.prototype,"_closed",void 0),t([dt()],Qi.prototype,"_tool",void 0),t([dt()],Qi.prototype,"_guide",void 0),t([dt()],Qi.prototype,"_backgroundUrl",void 0),t([dt()],Qi.prototype,"_bgLayer",void 0),t([dt()],Qi.prototype,"_scalePxPerM",void 0),t([dt()],Qi.prototype,"_calibActive",void 0),t([dt()],Qi.prototype,"_calibMeters",void 0),Qi=t([ut("wled-layout-designer")],Qi);let ts=class extends vt{constructor(){super(...arguments),this.controllerId="",this.layoutId="",this.fixtureId="",this.pixelCount=210,this.dotRadius=4,this._positions=[],this._status="waiting",this._bgLayer=null,this._bgImage=null,this._raf=0}setFrame(t){t&&(this._pixels=function(t,e){const i=new Uint8ClampedArray(4*e);for(let s=0;s<e;s++){const e=Math.min(t.count-1,Math.max(0,Math.round(s/t.scale))),n=t.leds_hex[e]??"000000",o=4*s;8===n.length?(i[o]=parseInt(n.slice(0,2),16),i[o+1]=parseInt(n.slice(2,4),16),i[o+2]=parseInt(n.slice(4,6),16),i[o+3]=parseInt(n.slice(6,8),16)):(i[o]=parseInt(n.slice(0,2),16),i[o+1]=parseInt(n.slice(2,4),16),i[o+2]=parseInt(n.slice(4,6),16),i[o+3]=255)}return i}(t,this.pixelCount),this._status="live",this._schedPaint())}setStatus(t){this._status=t,this.requestUpdate()}onPoweredConnect(){this._resolvePositions(),this._attachLiveStream()}onPoweredDisconnect(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0,this._resizeObs?.disconnect()}updated(t){super.updated(t),(t.has("connection")||t.has("controllerId")||t.has("layoutId")||t.has("fixtureId"))&&(this._resolvePositions(),this._attachLiveStream())}firstUpdated(){this._canvas=this.renderRoot.querySelector("canvas")??void 0,this._canvas&&(this._ctx=this._canvas.getContext("2d",{alpha:!0})??void 0,this._resizeObs=new ResizeObserver(()=>this._onResize()),this._resizeObs.observe(this)),this._onResize()}_onResize(){const t=this._canvas;if(!t)return;const e=this.getBoundingClientRect(),i=Math.max(320,e.width||320),s=Math.max(200,e.height||200);t.width===i&&t.height===s||(t.width=i,t.height=s,this._schedPaint())}async _resolvePositions(){if(this.connection&&this.controllerId&&this.fixtureId)try{if(this.layoutId){const t=await hi(this.connection,this.controllerId,this.layoutId);t&&(this._bgLayer=Li(t),this._loadBackgroundImage())}this._positions=await ui(this.connection,this.controllerId,this.fixtureId,this.layoutId||void 0),this._schedPaint()}catch{this._positions=[]}}_loadBackgroundImage(){const t=this._bgLayer?.url;t?Ji(t).then(t=>{this._bgImage=t,this._schedPaint()},()=>{this._bgImage=null}):this._bgImage=null}_attachLiveStream(){if(!this.connection||!this.controllerId)return;const t=mt(this.connection,this.controllerId,t=>{this.setFrame(t)});this.addUnsub(t)}_schedPaint(){this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0,this._paint()}))}_paint(){const t=this._ctx,e=this._canvas;if(!t||!e)return;const i=e.width,s=e.height;t.clearRect(0,0,i,s),t.fillStyle="#0d0d0d",t.fillRect(0,0,i,s),this._bgImage?.complete&&this._bgLayer&&Ri(t,i,s,this._bgImage,this._bgLayer);const n=this._pixels,o=this._positions,r=this.dotRadius;if(o.length>0){let e=1/0,a=-1/0,l=1/0,c=-1/0;for(const t of o)t.x<e&&(e=t.x),t.x>a&&(a=t.x),t.y<l&&(l=t.y),t.y>c&&(c=t.y);const h=3*r,d=(i-2*h)/(a-e||1),u=(s-2*h)/(c-l||1),p=Math.min(d,u),_=this.remote.state.disableBloom;for(const{x:i,y:s,led:a}of o){const o=h+(i-e)*p,c=h+(s-l)*p;let d=80,u=80,f=80;if(n){const t=4*a;d=n[t],u=n[t+1],f=n[t+2]}!_&&(d>10||u>10||f>10)?(t.shadowColor=`rgba(${d},${u},${f},0.7)`,t.shadowBlur=2.5*r):t.shadowBlur=0,t.beginPath(),t.arc(o,c,r,0,2*Math.PI),t.fillStyle=`rgb(${d},${u},${f})`,t.fill()}t.shadowBlur=0}else{const e=this.pixelCount,o=(i-8)/e,a=s/2;for(let i=0;i<e;i++){let e=80,s=80,l=80;if(n){const t=4*i;e=n[t],s=n[t+1],l=n[t+2]}t.beginPath(),t.arc(4+i*o+o/2,a,r,0,2*Math.PI),t.fillStyle=`rgb(${e},${s},${l})`,t.fill()}}}render(){return j`
      <div
        class="wrap"
        role="img"
    ...
    `]}};t([ht({attribute:!1})],es.prototype,"connection",void 0),t([ht()],es.prototype,"controllerId",void 0),t([dt()],es.prototype,"_layouts",void 0),t([dt()],es.prototype,"_status",void 0),t([dt()],es.prototype,"_busy",void 0),t([dt()],es.prototype,"_viewMode",void 0),t([dt()],es.prototype,"_activeLayoutId",void 0),t([dt()],es.prototype,"_activeFixtureId",void 0),t([dt()],es.prototype,"_activePixelCount",void 0),es=t([ut("wled-view-layout")],es);const is="wled-studio-panel";let ss=class extends vt{constructor(){super(...arguments),this._view="devices",this._controllerId=""}onPoweredConnect(){this._loadController()}async _loadController(){if(this.hass?.connection)try{const t=await async function(t){await bt(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,i=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${i}`)}}(this.hass.connection),e=t[0];e?.entry_id&&(this._controllerId=String(e.entry_id))}catch{}}render(){const t=this.remote.state;return j`
    ...
    `}_toggleDrawer(){}static{this.styles=[...gt,r`
      ...
      `]}};t([dt()],ss.prototype,"_view",void 0),t([dt()],ss.prototype,"_controllerId",void 0),ss=t([ut(is)],ss),customElements.get(is)||customElements.define(is,ss),console.info("[wled-studio] panel bundle loaded",{panel:is});export{is as PANEL_TAG,ss as WledStudioPanel};
