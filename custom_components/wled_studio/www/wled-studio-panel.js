...
`];class vt extends ot{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new _t(this),this._visible=!0,this._inView=!0}static{this.styles=mt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}t([ct({attribute:!1})],vt.prototype,"hass",void 0);const yt="0.11.5";function bt(t){return(e,i)=>{const s=customElements.get(t);return s||(customElements.define(t,e),e)}}const xt="wled-toast";function wt(t,e){const i=e.trim();i&&t.dispatchEvent(new CustomEvent(xt,{detail:{message:i},bubbles:!0,composed:!0}))}const St=/^[0-9a-fA-F]+$/;function kt(t,e){const i=new Uint8ClampedArray(4*e);for(let s=0;s<e;s++){const e=Math.min(t.count-1,Math.max(0,Math.round(s/t.scale))),n=t.leds_hex[e]??"000000",r=4*s;8===n.length?(i[r]=parseInt(n.slice(0,2),16),i[r+1]=parseInt(n.slice(2,4),16),i[r+2]=parseInt(n.slice(4,6),16),i[r+3]=parseInt(n.slice(6,8),16)):(i[r]=parseInt(n.slice(0,2),16),i[r+1]=parseInt(n.slice(2,4),16),i[r+2]=parseInt(n.slice(4,6),16),i[r+3]=255)}return i}function Ct(t,e,i,s){let n,r=!1;const o=async()=>{n?.(),n=void 0,r||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let n=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&St.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let r=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(r=t)}return{leds_hex:s,n:r,channels:n,scale:r/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:s?.remote??!1}))};o();const a=function(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}(t,()=>{o()});return()=>{r=!0,a(),n?.(),n=void 0}}async function Pt(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",n),i(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function $t(t){await Pt(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,i=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${i}`)}}class It extends Error{constructor(t,e){super("Scene conflict"),this.name="SceneConflictError",this.remote=t,this.etag=e}}async function Mt(t,e){return await Pt(t),t.sendMessagePromise({...e,schema_version:1})}async function Et(t,e){return(await Mt(t,{type:"wled_studio/scene_list",controller_id:e})).scenes??[]}async function At(t,e,i,s){try{return(await Mt(t,{type:"wled_studio/scene_capture",controller_id:e,name:i,scene_id:s?.sceneId,layout_id:s?.layoutId,transition_ms:s?.transitionMs??2500})).scene??{id:"",controller_id:e,name:i,wled_state:{}}}catch(t){const e=t;if("conflict"===e?.code&&e.data?.scene)throw new It(e.data.scene,String(e.data.etag??e.message??""));throw t}}function Lt(t,e,i=100){let s,n,r;const o=()=>{if(s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,r){const e=r;r=void 0,t(...e)}},a=(...t)=>{r=t,s&&clearTimeout(s),s=setTimeout(o,e),n||(n=setTimeout(o,i))};return a.cancel=()=>{s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,r=void 0},a}async function Tt(t,e){await Pt(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function Ft(t,e,i,s){await Pt(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}async function Dt(t,e,i){return(await t.sendMessagePromise({type:"wled_studio/effect_meta",schema_version:1,controller_id:e,effect_id:i})).meta??{sliders:{},colors_enabled:!0,palette_enabled:!0,flag:null,defaults:{}}}async function Rt(t,e){await Pt(t);return(await t.sendMessagePromise({type:"wled_studio/get_palette_previews",schema_version:1,controller_id:e})).palette_previews??{}}function Nt(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function Ot(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function Ut(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}function zt(t,e){for(const i of e){if(i.wled_segment_id===t)return i.entity_id;if(Ut(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}function Gt(t,e,i){const s=new Set(t),n=(i.length?i:t.map(t=>({id:t}))).map(t=>s.has(t.id)?{...e,id:t.id,sel:!0,on:void 0!==e.on?e.on:!1===t.on||t.on}:{id:t.id,sel:!1});return{seg:n}}function Bt(t,e){const i=new Set(t);return i.has(e)?i.delete(e):i.add(e),[...i].sort((t,e)=>t-e)}function Wt(t,e){const i=t.id,s=e.find(t=>t.wled_segment_id===i||t.segment_index===i||t.entity_id.endsWith(`_segment_${i}`));return`${("string"==typeof t.n&&t.n.trim()?t.n.trim():"")||s?.name?.replace(/^.*\s—\s/,"")||`Seg ${i+1}`} (${t.start??"?"}–${t.stop??"?"})`}const Vt="wled_studio.effect_defaults",Ht="wled_studio.effect_library";function jt(t){return Number.isFinite(t)?Math.min(255,Math.max(0,Math.round(t))):null}function qt(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function Kt(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function Yt(t,e){if(!t)return null;const i=function(t){return qt(Vt)[t]??{}}(t)[String(e)];return i??null}function Xt(t){return t?qt(Ht)[t]??[]:[]}function Jt(t){if(t instanceof Error)return t.message;if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t;if("string"==typeof e.message)return"string"==typeof e.code?`${e.code}: ${e.message}`:e.message;const i=e.error;if(i&&"object"==typeof i){const t=i;if("string"==typeof t.message)return"string"==typeof t.code?`${t.code}: ${t.message}`:t.message}if("string"==typeof e.code)return e.code}try{return JSON.stringify(t)}catch{return"Unknown error"}}const Zt={all:"All","1d":"1D","2d":"2D",solid:"Solid",sound:"Music",palette:"Palette"};function Qt(t){return void 0!==t.Solid?t.Solid:0}const te=/\b(dj|sound|music|audio|beat|freq|grav|jugg|ripple|water|pixel|rock|streak|popcorn|balls|fireworks|matrix|stream|peak|level|radio|sync|reactive|volume|puddle|ripple|noisem|noisep|noisemove|pixels|juggle|sinelon|phased|blurz|djlight)\b/i;function ee(t,e,i,s,n){if("all"===i)return!0;const r=s[e]??null,o=t.toLowerCase();return"solid"===i?e===Qt(n):"2d"===i?"2"===r||o.includes("2d"):"1d"===i?"2"!==r&&!o.includes("2d"):"sound"===i?function(t,e,i){const s=i[e]??null;return"v"===s||"f"===s||te.test(t)}(t,e,s):"palette"!==i||(o.includes("palette")||o.includes("colorloop")||o.includes("pride")||o.includes("cycle"))}const ie="wled_studio.segment_snapshot",se="wled_studio.merge_for_effects",ne=["start","stop","len","grp","spc","of","on","bri","col","fx","sx","ix","c1","c2","c3","o1","o2","o3","pal","n","rev","mi","sel","awm"];function re(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function oe(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function ae(t){if(!t)return!1;const e=re(se);return!(t in e)||Boolean(e[t])}function le(t){if(!t)return!1;const e=re(se);return t in e&&Boolean(e[t])}function he(t,e){const i=t.find(t=>0===t.id);if(!i||e<=0)return!1;return(i.stop??0)-(i.start??0)>=.9*e}function ce(t,e){const i=re(se);e?i[t]=!0:delete i[t],oe(se,i)}function de(t){return re(ie)[t]??null}function pe(t,e,i){const s={savedAt:Date.now(),segments:e.map(t=>({...t})),pixelCount:i},n=re(ie);return n[t]=s,oe(ie,n),s}function ue(t){return{seg:t.segments.map(t=>function(t){const e=t,i={id:t.id};for(const t of ne){const s=e[t];void 0!==s&&(i[t]=s)}return i}(t))}}function ge(t,e,i){const s=t.length?[...t].sort((t,e)=>t.id-e.id):[{id:0,start:0,stop:e,on:!0}],n=i?.length?new Set(i):null,r=n?s.filter(t=>n.has(t.id)):s,o=r.filter(t=>(t.stop??0)>(t.start??0)),a=o.length?o:r.length?r:s,l=Math.min(...a.map(t=>t.start??0)),h=Math.max(...a.map(t=>t.stop??e)),c=a[0],d={id:0,start:l,stop:h,on:!1!==c.on,sel:!0,bri:c.bri??255,fx:c.fx??0,n:"Merged (effects)"};void 0!==c.col&&(d.col=c.col),void 0!==c.pal&&(d.pal=c.pal);const p=[d];for(const t of s){if(0===t.id)continue;const e=t.stop??t.start??0;p.push({id:t.id,start:e,stop:e,on:!1,sel:!1})}return{seg:p}}function fe(t,e){const i=t.find(t=>0===t.id);return i?[0]:t.length?[t[0].id]:[0]}function _e(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:Ot(t.col),awm:t.awm};return JSON.stringify(e)}function me(t,e,i){let s,n=null,r=0;const o=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await Tt(t,e)).segments??[]).find(t=>t.id===r);if(!s||!n)return;const o=_e(n);if(o===_e(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(Ot(t.col))!==JSON.stringify(Ot(e.col))}(n,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=Lt((s,a)=>{n=a,r=a.id,Ft(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(n={...a,...i,id:a.id}),o()}).catch(t=>{i(a,`Failed to apply state to WLED: ${Jt(t)}`)})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var ve,ye,be,xe,we,Se={},ke=[],Ce=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function Pe(t,e){for(var i in e)t[i]=e[i];return t}function $e(t){var e=t.parentNode;e&&e.removeChild(t)}function Ie(t,e,i){var s,n,r,o,a=arguments;if(e=Pe({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return o=e.key,null!=(r=e.ref)&&delete e.ref,null!=o&&delete e.key,Me(t,e,o,r)}function Me(t,e,i,s){var n={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return ve.vnode&&ve.vnode(n),n}function Ee(t){return t.children}function Ae(t,e){this.props=t,this.context=e}function Le(t,e){if(null==e)return t.__p?Le(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?Le(t):null}function Te(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return Te(t)}}function Fe(t){(!t.__d&&(t.__d=!0)&&1===ye.push(t)||xe!==ve.debounceRendering)&&(xe=ve.debounceRendering,(ve.debounceRendering||be)(De))}function De(){var t,e,i,s,n,r,o,a;for(ye.sort(function(t,e){return e.__v.__b-t.__v.__b});t=ye.pop();)t.__d&&(i=void 0,s=void 0,r=(n=(e=t).__v).__e,o=e.__P,a=e.u,e.u=!1,o&&(i=[],s=Ge(o,n,Pe({},n),e.__n,void 0!==o.ownerSVGElement,null,i,a,null==r?Le(n):r),Be(i,n),s!=r&&Te(n)))}function Re(t,e,i,s,n,r,o,a,l){var h,c,d,p,u,g,f,_=i&&i.__k||ke,m=_.length;if(a==Se&&(a=null!=r?r[0]:m?Le(i,0):null),h=0,e.__k=Ne(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=_[h])||d&&i.key==d.key&&i.type===d.type)_[h]=void 0;else for(c=0;c<m;c++){if((d=_[c])&&i.key==d.key&&i.type===d.type){_[c]=void 0;break}d=null}if(p=Ge(t,i,d=d||Se,s,n,r,o,null,a,l),(c=i.ref)&&d.ref!=c&&(f||(f=[])).push(c,i.__c||p,i),null!=p){if(null==g&&(g=p),null!=i.l)p=i.l,i.l=null;else if(r==d||p!=a||null==p.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(p);else{for(u=a,c=0;(u=u.nextSibling)&&c<m;c+=2)if(u==p)break t;t.insertBefore(p,a)}"option"==e.type&&(t.value="")}a=p.nextSibling,"function"==typeof e.type&&(e.l=p)}}return h++,i}),e.__e=g,null!=r&&"function"!=typeof e.type)for(h=r.length;h--;)null!=r[h]&&$e(r[h]);for(h=m;h--;)null!=_[h]&&He(_[h],_[h]);if(f)for(h=0;h<f.length;h++)Ve(f[h],f[++h],f[++h])}function Ne(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)Ne(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return Me(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=Me(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function Oe(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===Ce.test(e)?i+"px":null==i?"":i}function Ue(t,e,i,s,n){var r,o,a,l,h;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(r=t.style,"string"==typeof i)r.cssText=i;else{if("string"==typeof s&&(r.cssText="",s=null),s)for(o in s)i&&o in i||Oe(r,o,"");if(i)for(a in i)s&&i[a]===s[a]||Oe(r,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),h=e.toLowerCase(),e=(h in t?h:e).slice(2),i?(s||t.addEventListener(e,ze,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,ze,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function ze(t){return this.t[t.type](ve.event?ve.event(t):t)}function Ge(t,e,i,s,n,r,o,a,l,h){var c,d,p,u,g,f,_,m,v,y,b=e.type;if(void 0!==e.constructor)return null;(c=ve.__b)&&c(e);try{t:if("function"==typeof b){if(m=e.props,v=(c=b.contextType)&&s[c.__c],y=c?v?v.props.value:c.__p:s,i.__c?_=(d=e.__c=i.__c).__p=d.__E:("prototype"in b&&b.prototype.render?e.__c=d=new b(m,y):(e.__c=d=new Ae(m,y),d.constructor=b,d.render=je),v&&v.sub(d),d.props=m,d.state||(d.state={}),d.context=y,d.__n=s,p=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=b.getDerivedStateFromProps&&Pe(d.__s==d.state?d.__s=Pe({},d.__s):d.__s,b.getDerivedStateFromProps(m,d.__s)),p)null==b.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&o.push(d);else{if(null==b.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(m,y),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(m,d.__s,y)){for(d.props=m,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,c=0;c<e.__k.length;c++)e.__k[c]&&(e.__k[c].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(m,d.__s,y)}for(u=d.props,g=d.state,d.context=y,d.props=m,d.state=d.__s,(c=ve.__r)&&c(e),d.__d=!1,d.__v=e,d.__P=t,c=d.render(d.props,d.state,d.context),e.__k=Ne(null!=c&&c.type==Ee&&null==c.key?c.props.children:c),null!=d.getChildContext&&(s=Pe(Pe({},s),d.getChildContext())),p||null==d.getSnapshotBeforeUpdate||(f=d.getSnapshotBeforeUpdate(u,g)),Re(t,e,i,s,n,r,o,l,h),d.base=e.__e;c=d.__h.pop();)d.__s&&(d.state=d.__s),c.call(d);p||null==u||null==d.componentDidUpdate||d.componentDidUpdate(u,g,f),_&&(d.__E=d.__p=null)}else e.__e=We(i.__e,e,i,s,n,r,o,h);(c=ve.diffed)&&c(e)}catch(t){ve.__e(t,e,i)}return e.__e}function Be(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){ve.__e(t,i.__v)}ve.__c&&ve.__c(e)}function We(t,e,i,s,n,r,o,a){var l,h,c,d,p=i.props,u=e.props;if(n="svg"===e.type||n,null==t&&null!=r)for(l=0;l<r.length;l++)if(null!=(h=r[l])&&(null===e.type?3===h.nodeType:h.localName===e.type)){t=h,r[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(u);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),r=null}return null===e.type?p!==u&&(null!=r&&(r[r.indexOf(t)]=null),t.data=u):e!==i&&(null!=r&&(r=ke.slice.call(t.childNodes)),c=(p=i.props||Se).dangerouslySetInnerHTML,d=u.dangerouslySetInnerHTML,a||(d||c)&&(d&&c&&d.__html==c.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,n){var r;for(r in i)r in e||Ue(t,r,null,i[r],s);for(r in e)n&&"function"!=typeof e[r]||"value"===r||"checked"===r||i[r]===e[r]||Ue(t,r,e[r],i[r],s)}(t,u,p,n,a),e.__k=e.props.children,d||Re(t,e,i,s,"foreignObject"!==e.type&&n,r,o,Se,a),a||("value"in u&&void 0!==u.value&&u.value!==t.value&&(t.value=null==u.value?"":u.value),"checked"in u&&void 0!==u.checked&&u.checked!==t.checked&&(t.checked=u.checked))),t}function Ve(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){ve.__e(t,i)}}function He(t,e,i){var s,n,r;if(ve.unmount&&ve.unmount(t),(s=t.ref)&&Ve(s,null,e),i||"function"==typeof t.type||(i=null!=(n=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){ve.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(r=0;r<s.length;r++)s[r]&&He(s[r],e,i);null!=n&&$e(n)}function je(t,e,i){return this.constructor(t,i)}function qe(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function Ke(){return Ke=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}return t},Ke.apply(this,arguments)}ve={},Ae.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=Pe({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&Pe(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),Fe(this))},Ae.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,Fe(this))},Ae.prototype.render=Ee,ye=[],be="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,xe=ve.debounceRendering,ve.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return Fe(s.__E=s)}catch(e){t=e}throw t},we=Se;var Ye="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",Xe="[\\s|\\(]+("+Ye+")[,|\\s]+("+Ye+")[,|\\s]+("+Ye+")\\s*\\)?",Je="[\\s|\\(]+("+Ye+")[,|\\s]+("+Ye+")[,|\\s]+("+Ye+")[,|\\s]+("+Ye+")\\s*\\)?",Ze=new RegExp("rgb"+Xe),Qe=new RegExp("rgba"+Je),ti=new RegExp("hsl"+Xe),ei=new RegExp("hsla"+Je),ii="^(?:#?|0x?)",si="([0-9a-fA-F]{1})",ni="([0-9a-fA-F]{2})",ri=new RegExp(ii+si+si+si+"$"),oi=new RegExp(ii+si+si+si+si+"$"),ai=new RegExp(ii+ni+ni+ni+"$"),li=new RegExp(ii+ni+ni+ni+ni+"$"),hi=Math.log,ci=Math.round,di=Math.floor;function pi(t,e,i){return Math.min(Math.max(t,e),i)}function ui(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function gi(t){return parseInt(t,16)}function fi(t){return t.toString(16).padStart(2,"0")}var _i=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=Ke({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=Ke({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,n=di(e),r=e-n,o=s*(1-i),a=s*(1-r*i),l=s*(1-(1-r)*i),h=n%6,c=[l,s,s,a,o,o][h],d=[o,o,l,s,s,a][h];return{r:pi(255*[s,a,o,o,l,s][h],0,255),g:pi(255*c,0,255),b:pi(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,n=Math.max(e,i,s),r=Math.min(e,i,s),o=n-r,a=0,l=n,h=0===n?0:o/n;switch(n){case r:a=0;break;case e:a=(i-s)/o+(i<s?6:0);break;case i:a=(s-e)/o+2;break;case s:a=(e-i)/o+4}return{h:60*a%360,s:pi(100*h,0,100),v:pi(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,n=s<=1?s:2-s,r=n<1e-9?0:e*i/n;return{h:t.h,s:pi(100*r,0,100),l:pi(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:pi(100*s,0,100),v:pi((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,n=t/100;return n<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=n-2)+104.49216199393888*hi(i),s=n<20?0:.8274096064007395*(s=n-10)-254.76935184120902+115.67994401066147*hi(s)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*hi(e),i=325.4494125711974+.07943456536662342*(i=n-50)-28.0852963507957*hi(i),s=255),{r:pi(di(e),0,255),g:pi(di(i),0,255),b:pi(di(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,n=e.b,r=2e3,o=4e4;o-r>.4;){i=.5*(o+r);var a=t.kelvinToRgb(i);a.b/a.r>=n/s?o=i:r=i}return i},qe(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=Ke({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return Ke({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=Ke({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=Ke({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=Ke({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=Ke({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,n=e.b;return{r:ci(i),g:ci(s),b:ci(n)}},set:function(e){this.hsv=Ke({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return Ke({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,n=e.l;return{h:ci(i),s:ci(s),l:ci(n)}},set:function(e){this.hsv=Ke({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return Ke({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,n,r=1;if((e=Ze.exec(t))?(i=ui(e[1],255),s=ui(e[2],255),n=ui(e[3],255)):(e=Qe.exec(t))&&(i=ui(e[1],255),s=ui(e[2],255),n=ui(e[3],255),r=ui(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:n,a:r}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+fi(t.r)+fi(t.g)+fi(t.b)},set:function(t){var e,i,s,n,r=255;if((e=ri.exec(t))?(i=17*gi(e[1]),s=17*gi(e[2]),n=17*gi(e[3])):(e=oi.exec(t))?(i=17*gi(e[1]),s=17*gi(e[2]),n=17*gi(e[3]),r=17*gi(e[4])):(e=ai.exec(t))?(i=gi(e[1]),s=gi(e[2]),n=gi(e[3])):(e=li.exec(t))&&(i=gi(e[1]),s=gi(e[2]),n=gi(e[3]),r=gi(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:n,a:r/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+fi(t.r)+fi(t.g)+fi(t.b)+fi(di(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,n,r=1;if((e=ti.exec(t))?(i=ui(e[1],360),s=ui(e[2],100),n=ui(e[3],100)):(e=ei.exec(t))&&(i=ui(e[1],360),s=ui(e[2],100),n=ui(e[3],100),r=ui(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:n,a:r}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function mi(t){var e,i=t.width,s=t.sliderSize,n=t.borderWidth,r=t.handleRadius,o=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*o+2*r,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*o-2*r,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-n/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function vi(t,e){var i=mi(t),s=i.width,n=i.height,r=i.handleRange,o=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var n=t.minTemperature,r=t.maxTemperature-n,o=(e.kelvin-n)/r*100;return Math.max(0,Math.min(o,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),h=a?s/2:n/2,c=o+l/100*r;return a&&(c=-1*c+r+2*o),{x:a?h:c,y:a?c:h}}var yi,bi=2*Math.PI,xi=function(t,e){return Math.sqrt(t*t+e*e)};function wi(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function Si(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function ki(t,e,i){var s=t.wheelAngle,n=t.wheelDirection;return i&&"clockwise"===n?e=s+e:"clockwise"===n?e=360-s+e:i&&"anticlockwise"===n?e=s+180-e:"anticlockwise"===n&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function Ci(t,e,i){var s=Si(t),n=s.cx,r=s.cy,o=wi(t);e=n-e,i=r-i;var a=ki(t,Math.atan2(-i,-e)*(360/bi)),l=Math.min(xi(e,i),o);return{h:Math.round(a),s:Math.round(100/o*l)}}function Pi(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function $i(t,e,i){var s=Pi(t),n=s.width,r=s.height,o=s.radius,a=(e-o)/(n-2*o)*100,l=(i-o)/(r-2*o)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function Ii(t){yi||(yi=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),n=window.location;return(i||s)&&yi.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function Mi(t,e,i,s){for(var n=0;n<s.length;n++){var r=s[n].x-e,o=s[n].y-i;if(Math.sqrt(r*r+o*o)<t.handleRadius)return n}return null}function Ei(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function Ai(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function Li(t){return"string"==typeof t?t:t+"px"}var Ti=["mousemove","touchmove","mouseup","touchend"],Fi=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,r={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(r[s?"marginLeft":"marginTop"]=n),Ie(Ee,null,t.children(this.uid,i,r))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,r=n.clientX-s.left,o=n.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(r,o,0)&&Ti.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(r,o,1);break;case"mouseup":case"touchend":i(r,o,2),Ti.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(Ae);function Di(t){var e=t.r,i=t.url,s=e,n=e;return Ie("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+Li(t.x)+", "+Li(t.y)+")",willChange:"transform",top:Li(-e),left:Li(-e),width:Li(2*e),height:Li(2*e),position:"absolute",overflow:"visible"}},i&&Ie("use",Object.assign({xlinkHref:Ii(i)},t.props)),!i&&Ie("circle",{cx:s,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&Ie("circle",{cx:s,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function Ri(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=mi(t),n=s.width,r=s.height,o=s.radius,a=vi(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var n=[],r=t.minTemperature,o=t.maxTemperature,a=o-r,l=r,h=0;l<o;l+=a/8,h+=1){var c=_i.kelvinToRgb(l),d=c.r,p=c.g,u=c.b;n.push([12.5*h,"rgb("+d+","+p+","+u+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var g=_i.hsvToHsl({h:i.h,s:0,v:i.v}),f=_i.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"],[100,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"]];default:var _=_i.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"]]}}(t,i);return Ie(Fi,Object.assign({},t,{onInput:function(e,s,n){var r=function(t,e,i){var s,n=mi(t),r=n.handleRange,o=n.handleStart;s="horizontal"===t.layoutDirection?-1*i+r+o:e-o,s=Math.max(Math.min(s,r),0);var a=Math.round(100/r*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=r,t.onInput(n,t.id)}}),function(e,s,h){return Ie("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:Li(n),height:Li(r),borderRadius:Li(o),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},h)}),Ie("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:Li(o),background:Ai("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},Ei(t))}),Ie(Di,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function Ni(t){var e=Pi(t),i=e.width,s=e.height,n=e.radius,r=t.colors,o=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,h=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],c=r.map(function(e){return function(t,e){var i=Pi(t),s=i.width,n=i.height,r=i.radius,o=e.hsv,a=r,l=s-2*r,h=n-2*r;return{x:a+o.s/100*l,y:a+(h-o.v/100*h)}}(t,e)});return Ie(Fi,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var n=Mi(t,e,i,c);null!==n?o.setActiveColor(n):(o.inputActive=!0,l.hsv=$i(t,e,i),t.onInput(s,t.id))}else 1===s&&(o.inputActive=!0,l.hsv=$i(t,e,i));t.onInput(s,t.id)}}),function(e,o,a){return Ie("div",Object.assign({},o,{className:"IroBox",style:Object.assign({},{width:Li(i),height:Li(s),position:"relative"},a)}),Ie("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:Li(n)},Ei(t),{background:Ai("linear","to bottom",h[1])+","+Ai("linear","to right",h[0])})}),r.filter(function(t){return t!==l}).map(function(e){return Ie(Di,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:c[e.index].x,y:c[e.index].y})}),Ie(Di,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:c[l.index].x,y:c[l.index].y}))})}Di.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},Ri.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function Oi(t){var e=Si(t).width,i=t.colors;t.borderWidth;var s=t.parent,n=t.color,r=n.hsv,o=i.map(function(e){return function(t,e){var i=e.hsv,s=Si(t),n=s.cx,r=s.cy,o=wi(t),a=(180+ki(t,i.h,!0))*(bi/360),l=i.s/100*o,h="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*h,y:r+l*Math.sin(a)*h}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return Ie(Fi,Object.assign({},t,{onInput:function(e,i,r){if(0===r){if(!function(t,e,i){var s=Si(t),n=s.cx,r=s.cy,o=t.width/2;return xi(n-e,r-i)<o}(t,e,i))return!1;var a=Mi(t,e,i,o);null!==a?s.setActiveColor(a):(s.inputActive=!0,n.hsv=Ci(t,e,i),t.onInput(r,t.id))}else 1===r&&(s.inputActive=!0,n.hsv=Ci(t,e,i));t.onInput(r,t.id)}}),function(s,l,h){return Ie("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:Li(e),height:Li(e),position:"relative"},h)}),Ie("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),Ie("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&Ie("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-r.v/100})}),Ie("div",{className:"IroWheelBorder",style:Object.assign({},a,Ei(t))}),i.filter(function(t){return t!==n}).map(function(e){return Ie(Di,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[e.index].x,y:o[e.index].y})}),Ie(Di,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[n.index].x,y:o[n.index].y}))})}var Ui=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new _i(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(n[t]||(n[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:Oi},{component:Ri}],e.transparency&&s.push({component:Ri,options:{sliderType:"alpha"}})),Ie("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var n=t.component,r=t.options;return Ie(n,Object.assign({},e,r,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(Ae);Ui.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var zi,Gi,Bi,Wi=(Gi=function(t,e){var i,s=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,n,r;ve.__p&&ve.__p(t,e),n=(s=i===we)?null:e.__k,t=Ie(Ee,null,[t]),r=[],Ge(e,e.__k=t,n||Se,Se,void 0!==e.ownerSVGElement,n?null:ke.slice.call(e.childNodes),r,!1,Se,s),Be(r,t)}(Ie(zi,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),i},Gi.prototype=(zi=Ui).prototype,Object.assign(Gi,zi),Gi.__component=zi,Gi);!function(t){var e;t.version="5.5.2",t.Color=_i,t.ColorPicker=Wi,(e=t.ui||(t.ui={})).h=Ie,e.ComponentBase=Fi,e.Handle=Di,e.Slider=Ri,e.Wheel=Oi,e.Box=Ni}(Bi||(Bi={}));var Vi=Bi;const Hi="wled_studio.color_swatches";function ji(t){return t.trim()||"_default"}function qi(){try{const t=localStorage.getItem(Hi);if(!t)return{};const e=JSON.parse(t);return e&&"object"==typeof e?e:{}}catch{return{}}}function Ki(t){const e=qi()[ji(t)];return Array.isArray(e)?[...e]:[]}function Yi(t,e){const i=qi();var s;i[ji(t)]=e.slice(0,32),s=i,localStorage.setItem(Hi,JSON.stringify(s))}function Xi(t,e){return`${t[0]},${t[1]},${t[2]},${e}`}function Ji(t,e){const i="#"+[t[0],t[1],t[2]].map(t=>Math.max(0,Math.min(255,t)).toString(16).padStart(2,"0")).join("");return e>0?`${i} +W`:i.toUpperCase()}let Zi=class extends vt{constructor(){super(...arguments),this.controllerId="",this.rgb=[255,128,0],this.white=0,this._swatches=[],this._saving=!1,this._saveName="",this._editingId=null,this._editName="",this._pressTimer=null,this._pressSwatch=null,this._suppressChipClick=!1}onPoweredConnect(){this._reload()}updated(t){super.updated(t),t.has("controllerId")&&this._reload()}_reload(){this._swatches=Ki(this.controllerId)}_currentKey(){return Xi(this.rgb,this.white)}_swatchCss(t){const[e,i,s]=t.rgb;return t.white>0?`linear-gradient(135deg, rgb(${e},${i},${s}) 55%, rgba(255,255,255,0.95) 55%)`:`rgb(${e},${i},${s})`}_apply(t){this.dispatchEvent(new CustomEvent("swatch-select",{detail:{rgb:[...t.rgb],white:t.white},bubbles:!0,composed:!0}))}_openSave(){this._saveName=Ji(this.rgb,this.white),this._saving=!0,this._editingId=null}_confirmSave(){!function(t,e){const i=Ki(t),s=Xi(e.rgb,e.white),n=i.find(t=>Xi(t.rgb,t.white)===s);if(n)return n.name=e.name.trim()||n.name,Yi(t,i),n;const r={id:`sw_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,name:e.name.trim()||Ji(e.rgb,e.white),rgb:[...e.rgb],white:e.white};i.unshift(r),Yi(t,i)}(this.controllerId,{name:this._saveName,rgb:this.rgb,white:this.white}),this._saving=!1,this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_cancelSave(){this._saving=!1}_startEdit(t,e){e.stopPropagation(),this._editingId=t.id,this._editName=t.name,this._saving=!1}_confirmEdit(){this._editingId&&(!function(t,e,i){const s=Ki(t),n=s.findIndex(t=>t.id===e);if(n<0)return null;const r=s[n],o={...r,...i,rgb:i.rgb?[...i.rgb]:r.rgb};void 0!==i.name&&(o.name=i.name.trim()||Ji(o.rgb,o.white)),s[n]=o,Yi(t,s)}(this.controllerId,this._editingId,{name:this._editName}),this._editingId=null,this._reload())}_cancelEdit(){this._editingId=null}_delete(t,e){e?.stopPropagation(),function(t,e){const i=Ki(t).filter(t=>t.id!==e);Yi(t,i)}(this.controllerId,t),this._editingId===t&&(this._editingId=null),this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_clearPressTimer(){null!==this._pressTimer&&(clearTimeout(this._pressTimer),this._pressTimer=null),this._pressSwatch=null}_confirmDelete(t){confirm(`Delete swatch "${t.name}"?`)&&this._delete(t.id),this._suppressChipClick=!1}_onChipTouchStart(t){this._clearPressTimer(),this._pressSwatch=t,this._pressTimer=setTimeout(()=>{this._pressTimer=null,this._suppressChipClick=!0,this._confirmDelete(t)},500)}_onChipTouchEnd(){this._clearPressTimer()}_onChipTouchMove(t){if(!this._pressSwatch||1!==t.touches.length)return;const e=t.touches[0],i=t.currentTarget.getBoundingClientRect();(e.clientX<i.left-12||e.clientX>i.right+12||e.clientY<i.top-12||e.clientY>i.bottom+12)&&this._clearPressTimer()}_onChipClick(t,e){if(this._suppressChipClick)return this._suppressChipClick=!1,e.preventDefault(),void e.stopPropagation();this._apply(t)}render(){const t=this._currentKey();return W`
    ...
    `]}};t([ct({type:Array,hasChanged:(t,e)=>!t||!e||!function(t,e){return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]}(t,e)})],Qi.prototype,"rgb",void 0),t([ct({type:Number})],Qi.prototype,"white",void 0),t([ct({type:Number})],Qi.prototype,"awm",void 0),t([ct({type:Boolean})],Qi.prototype,"showWhite",void 0),t([ct()],Qi.prototype,"controllerId",void 0),t([pt(".wheel-host")],Qi.prototype,"_host",void 0),Qi=t([bt("wled-color-wheel-rgbw")],Qi);function ts(t,e="strip",i,s=0){let n=String(t);return s&&(n=`${n}_p${s}`),i?.trim()&&(n=`${n}_${function(t){return(t||"").trim().replace(/[^\w.-]+/g,"_")||"unknown"}(i)}`),`${n}_${e}.webp`}function es(t,e,i="strip",s,n=0){const r=e instanceof Set?e:new Set(e);if(!r.size)return;const o=[ts(t,i,s,n),ts(t,i,s),ts(t,i,void 0,n),ts(t,i)];for(const t of o)if(r.has(t))return t;const a=n?`${t}_p${n}_`:`${t}_`,l=`_${i}.webp`;for(const t of r)if(t.startsWith(a)&&t.endsWith(l))return t;return n?es(t,r,i,s,0):void 0}function is(t,e,i="strip",s,n,r,o=0){if(!t||e<0)return;const a=void 0!==r?es(e,r,i,s,o):ts(e,i,s,o);return a?function(t,e){if(!t.startsWith("/"))return t;const i=e?.auth?.data?.access_token;if(!i)return t;const s=t.includes("?")?"&":"?";return`${t}${s}auth=${encodeURIComponent(i)}`}(function(t,e){return`/local/wled_studio/thumbs/${encodeURIComponent(t)}/${encodeURIComponent(e)}`}(t,a),n):void 0}const ss="wled_studio.recent_effects",ns="wled_studio.recent_scenes";function rs(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function os(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function as(t){return t?rs(ss)[t]??[]:[]}function ls(t,e=72,i=6,s=10){if(t<=0)return 1;const n=e+i;return Math.max(1,Math.min(s,Math.floor((t+i)/n)))}const hs="wled_studio.pinned_effects";function cs(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function ds(t,e,i){if(!t)return[];const s=cs(hs),n=s[t]??[],r=n.findIndex(t=>t.id===e);return r>=0?n.splice(r,1):n.unshift({id:e,name:i}),s[t]=n,function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(hs,s),s[t]}let ps=class extends vt{constructor(){super(...arguments),this.fxId=0,this.thumbUrl="",this.thumbUrlAnimated="",this.label="",this.listboxOption=!1,this.selected=!1,this._hover=!1}render(){const t=this.thumbUrlAnimated||(this.thumbUrl.endsWith(".webp")?this.thumbUrl:""),e=this.thumbUrl||t,i=this._hover&&t?t:e,s=this.label||`Effect ${this.fxId}`;return W`
      <button
        class="tile"
        type="button"
        aria-label=${s}
    ...
    `]}};t([ct({type:Number})],ps.prototype,"fxId",void 0),t([ct()],ps.prototype,"thumbUrl",void 0),t([ct()],ps.prototype,"thumbUrlAnimated",void 0),t([ct()],ps.prototype,"label",void 0),t([ct({type:Boolean,attribute:"listbox-option"})],ps.prototype,"listboxOption",void 0),t([ct({type:Boolean})],ps.prototype,"selected",void 0),t([dt()],ps.prototype,"_hover",void 0),ps=t([bt("wled-effect-tile")],ps);let us=class extends vt{constructor(){super(...arguments),this.effectsByName={},this.soundFlags=[],this.selectedFx=0,this.filter="",this.controllerId="",this.fwVer="",this.thumbBasenames=[],this.toggleOff=!0,this.showRecents=!0,this.tileGrid=!1,this.scrollPane=!1,this.selectedPalette=0,this.paletteAware=!1,this._category="all",this._recentEntries=[],this._pinnedEntries=[],this._recentVisible=6}onPoweredConnect(){this._loadRecents(),this._ro=new ResizeObserver(()=>this._measureRecents()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._loadRecents();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._recentRowEl&&(this._recentRowEl=e,this._ro?.observe(e),this._measureRecents())}_loadRecents(){var t;this._recentEntries=as(this.controllerId),this._pinnedEntries=(t=this.controllerId)?cs(hs)[t]??[]:[],this.soundFlags.length&&!this.soundFlags.some(t=>"v"===t||"f"===t)&&console.debug(`[wled-studio] sound_flags for ${this.controllerId} contain no v/f entries — Music filter will rely on name heuristics`)}_togglePin(t,e){e.stopPropagation(),this.controllerId&&(this._pinnedEntries=ds(this.controllerId,t,this._effectName(t)))}_measureRecents(){const t=this._recentRowEl;if(!t)return;const e=ls(t.clientWidth,76,6,10);e!==this._recentVisible&&(this._recentVisible=e)}_effectName(t){return Object.entries(this.effectsByName).find(([,e])=>e===t)?.[0]??`Effect ${t}`}render(){const t=this.filter.trim().toLowerCase(),e=Object.keys(this.effectsByName).sort((t,e)=>t.localeCompare(e)),i=Qt(this.effectsByName),s=e.filter(e=>!!ee(e,this.effectsByName[e],this._category,this.soundFlags,this.effectsByName)&&!(t&&!e.toLowerCase().includes(t))),n=this.showRecents&&!t&&this._recentEntries.length>0,r=this._recentEntries.slice(0,this._recentVisible),o=!t&&this._pinnedEntries.length>0;return W`
      ...
      >
        ${o?W`
              <div class="recent-block">
                ...
                <div class="recent-row" role="group" aria-label="Pinned effects">
                  ${this._pinnedEntries.map(t=>{const e=t.id,s=t.name,n=e===this.selectedFx;return W`
                      <button
                        type="button"
        ...
        <div class="grid" role="listbox" aria-label="Effects">
          ${0===s.length?W`<p class="empty">No effects match this filter.</p>`:s.map(t=>{const e=this.effectsByName[t],s=this.soundFlags[e],n=e===this.selectedFx,r=is(this.controllerId,e,"strip",this.fwVer,this.hass,this.thumbBasenames,this.paletteAware?this.selectedPalette:0),o=t+("v"===s?" ♪":"")+("f"===s?" ♫":"")+("2"===s?" 2D":"");return r?W`
                    <wled-effect-tile
    ...
    `]}};t([ct({type:Object})],us.prototype,"effectsByName",void 0),t([ct({type:Array})],us.prototype,"soundFlags",void 0),t([ct({type:Number})],us.prototype,"selectedFx",void 0),t([ct({type:String})],us.prototype,"filter",void 0),t([ct()],us.prototype,"controllerId",void 0),t([ct()],us.prototype,"fwVer",void 0),t([ct({type:Array})],us.prototype,"thumbBasenames",void 0),t([ct({type:Boolean})],us.prototype,"toggleOff",void 0),t([ct({type:Boolean})],us.prototype,"showRecents",void 0),t([ct({type:Boolean,attribute:"tile-grid"})],us.prototype,"tileGrid",void 0),t([ct({type:Boolean,attribute:"scroll-pane"})],us.prototype,"scrollPane",void 0),t([ct({type:Number})],us.prototype,"selectedPalette",void 0),t([ct({type:Boolean,attribute:"palette-aware"})],us.prototype,"paletteAware",void 0),t([dt()],us.prototype,"_category",void 0),t([dt()],us.prototype,"_recentEntries",void 0),t([dt()],us.prototype,"_pinnedEntries",void 0),t([dt()],us.prototype,"_recentVisible",void 0),us=t([bt("wled-effect-chips")],us);let gs=class extends vt{constructor(){super(...arguments),this.controllerId="",this.segments=[],this.editIds=[],this.pixelCount=210,this.compact=!1,this._merged=!1,this._busy=!1,this._error=""}onPoweredConnect(){this._merged=ae(this.controllerId)}willUpdate(t){t.has("controllerId")&&(this._merged=ae(this.controllerId))}render(){const t=de(this.controllerId),e=t&&this._merged?`${t.segments.length} segment layout saved`:null;return W`
    ...
    `}async _onToggle(t){const e=t.target.checked;if(this.connection&&this.controllerId){this._busy=!0,this._error="";try{if(e){const t=await Tt(this.connection,this.controllerId),e=t.segments??this.segments,i=t.info?.leds,s=Number(i?.count)||this.pixelCount;pe(this.controllerId,e,s);const n=ge(e,s,this.editIds.length?this.editIds:void 0);await Ft(this.connection,this.controllerId,n,{fullResponse:!0}),ce(this.controllerId,!0),this._merged=!0}else{const t=de(this.controllerId);if(!t)throw new Error("No saved segment layout to restore");await Ft(this.connection,this.controllerId,ue(t),{fullResponse:!0}),ce(this.controllerId,!1),function(t){const e=re(ie);delete e[t],oe(ie,e)}(this.controllerId),this._merged=!1}this.dispatchEvent(new CustomEvent("merge-changed",{detail:{merged:this._merged},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(e){this._error=e instanceof Error?e.message:String(e),t.target.checked=this._merged}finally{this._busy=!1}}}static{this.styles=[...mt,o`
      .merge-row {
        display: flex;
        gap: 10px;
        align-items: flex-start;
    ...
    `:null}_openEditor(){this._editorOpen=!0}_closeEditor(){this._editorOpen=!1,this.dispatchEvent(new CustomEvent("palette-catalog-changed",{bubbles:!0,composed:!0}))}render(){const t=(this._localFilter||this.filter).trim().toLowerCase(),e=Object.keys(this.palettesByName).sort((t,e)=>t.localeCompare(e)),i=e.filter(e=>!t||e.toLowerCase().includes(t)),s=this._paletteName(this.selectedPal),n=this._editorUrl(),r=W`
      <input
        class="search"
        type="search"
    ...
    `]}};t([ct({type:Object})],ms.prototype,"palettesByName",void 0),t([ct({type:Object})],ms.prototype,"palettePreviews",void 0),t([ct({type:Number})],ms.prototype,"selectedPal",void 0),t([ct()],ms.prototype,"filter",void 0),t([ct()],ms.prototype,"deviceHost",void 0),t([ct({type:Boolean})],ms.prototype,"compact",void 0),t([ct({type:Boolean,attribute:"collapsible"})],ms.prototype,"collapsible",void 0),t([dt()],ms.prototype,"_open",void 0),t([dt()],ms.prototype,"_localFilter",void 0),t([dt()],ms.prototype,"_editorOpen",void 0),ms=t([bt("wled-palette-chips")],ms);let vs=class extends vt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return W`
    ...
    `]}};t([ct({type:Array})],vs.prototype,"presets",void 0),vs=t([bt("wled-preset-bar")],vs);const ys=["For each","Bar","Arc","Corner"],bs=["Replace","Add","Subtract","Multiply","Lighten","Darken"],xs=["Off","GEQ pulse","WaveSin","Sweep"];let ws=class extends vt{constructor(){super(...arguments),this.compact=!1}_emit(t){this.dispatchEvent(new CustomEvent("segment-patch",{detail:t,bubbles:!0,composed:!0}))}_num(t,e,i,s){const n=this.segment;if(!n)return null;const r=n[t]??i;return W`
      <label class="cell">
        <span class="cell-label">${e}<span class="cell-val">${r}</span></span>
        <ha-slider
          min=${i}
          max=${s}
          step="1"
    ...
    `}_select(t,e,i){const s=this.segment;if(!s)return null;const n=s[t]??0;return W`
      <label class="cell">
        ...
        <select
          ...
          @change=${e=>{const i=Number(e.target.value);this._emit({[t]:i})}}
        >
          ${i.map((t,e)=>W`<option value=${e} ?selected=${e===n}>${t}</option>`)}
        </select>
      </label>
    `}render(){if(!this.segment)return null;const t=this.meta,e=[];for(const i of["o1","o2","o3"])if(t?.sliders?.[i]){const s="string"==typeof t.defaults?.[i]&&t.defaults[i].trim()?t.defaults[i]:i.toUpperCase();e.push({key:i,label:s})}return W`
      <details class="adv" ?open=${!this.compact}>
        ...
        <div class="grid">
          ...
          ${this._select("m12","1D-in-2D mode",ys)}
    ...
    `]}};t([ct({attribute:!1})],ws.prototype,"segment",void 0),t([ct({attribute:!1})],ws.prototype,"meta",void 0),t([ct({type:Boolean})],ws.prototype,"compact",void 0),ws=t([bt("wled-segment-advanced")],ws);let Ss=class extends vt{constructor(){super(...arguments),this.width="100%",this.height="1rem",this.roundedFull=!1}render(){return W`
      <div
    ...
    `}render(){if(this._loading)return this._renderSkeleton();if(this._error)return W`<p class="err">${this._error}</p>`;const t=this._activeSeg();if(!t)return W`<p class="muted">No segments on this controller.</p>`;const e=this._cols(t),i=e[this._colorSlot]??e[0],s=this._meta,n=s?.sliders??{},r=!1!==s?.colors_enabled?3:1,o=this._snapshot?.rgbwm??0;return W`
      <div class="controls ${this.compact?"compact":""}">
        ...
        <div class="sliders">
          ${Object.entries(Cs).map(([e,i])=>{if(!n[e])return null;const s=t[e];return W`
              <label>
                ${i}
                <ha-slider
                  min="0"
    ...
    `]}};t([ct({attribute:!1})],Is.prototype,"connection",void 0),t([ct()],Is.prototype,"controllerId",void 0),t([ct({type:Number})],Is.prototype,"heightPx",void 0),t([ct({type:Number})],Is.prototype,"selectedSegId",void 0),t([ct({type:Array})],Is.prototype,"highlightSegIds",void 0),t([dt()],Is.prototype,"_pixelCount",void 0),t([dt()],Is.prototype,"_segments",void 0),t([dt()],Is.prototype,"_status",void 0),Is=t([bt("wled-studio-live-preview")],Is);let Ms=class extends vt{constructor(){super(...arguments),this._toasts=[],this._nextId=0,this._timers=new Map,this._onToast=t=>{const e=t.detail;if(!e?.message)return;const i=++this._nextId;this._toasts=[...this._toasts,{id:i,message:e.message}];const s=this._toastDurationMs(),n=window.setTimeout(()=>this._dismiss(i),s);this._timers.set(i,n)}}onPoweredConnect(){this.getRootNode().addEventListener(xt,this._onToast,{signal:this.abort.signal})}onPoweredDisconnect(){for(const t of this._timers.values())window.clearTimeout(t);this._timers.clear()}_toastDurationMs(){const t=getComputedStyle(this).getPropertyValue("--m-toast").trim(),e=Number.parseInt(t,10);return Number.isFinite(e)&&e>0?e:4e3}_dismiss(t){const e=this._timers.get(t);void 0!==e&&(window.clearTimeout(e),this._timers.delete(t)),this._toasts=this._toasts.filter(e=>e.id!==t)}render(){return this._toasts.length?W`
                ...
                ${this._layouts.map(t=>W`
                    <li class="layout-item">
                      <div class="layout-info">
                        <span class="layout-name">${Ns(t)}</span>
    ...
    `]}};t([ct({type:Array})],Aa.prototype,"segments",void 0),t([ct({type:Array})],Aa.prototype,"selectedIds",void 0),t([ct({type:Array})],Aa.prototype,"segmentEntities",void 0),t([ct()],Aa.prototype,"hint",void 0),t([dt()],Aa.prototype,"_dragSegId",void 0),Aa=t([bt("wled-segment-bar")],Aa);let La=class extends vt{constructor(){super(...arguments),this.controllerId="",this.scenes=[],this.disabled=!1,this._recents=[],this._visibleCount=6}onPoweredConnect(){this._reload(),this._ro=new ResizeObserver(()=>this._measure()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._reload();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._rowEl&&(this._rowEl=e,this._ro?.observe(e),this._measure())}reload(){this._reload()}_reload(){var t;this._recents=(t=this.controllerId)?rs(ns)[t]??[]:[]}_measure(){const t=this._rowEl;if(!t)return;const e=ls(t.clientWidth,104,8,8);e!==this._visibleCount&&(this._visibleCount=e)}_sceneFor(t){return this.scenes.find(e=>e.id===t)}render(){const t=this._recents.filter(t=>this.scenes.some(e=>e.id===t.id)).slice(0,this._visibleCount);return t.length?W`
      <div class="block">
        <span class="label">Recent scenes</span>
        <div class="recent-row" role="group" aria-label="Recent scenes">
          ${t.map(t=>{const e=this._sceneFor(t.id),i=e?.name??t.name,s=e?Ma(e):"linear-gradient(135deg, var(--wled-surface-elevated), var(--wled-surface))",n=e&&Ea(e)?e.scene_thumb_url.trim():"";return W`
              <button
                type="button"
                class="chip"
    ...
    `}_sceneTile(t){const e=t.transition_ms??2500,i=Ma(t),s=Ea(t)?t.scene_thumb_url.trim():"";return W`
    ...
    `}render(){const t=this._snapshot,e=this._activeSeg(),i=e?.fx??0,s=this._meta,n=s?.sliders??{},r=this._targetIds().length,o=this.compact;return W`
              ...
              <div class="effects-workspace ${o?"compact":""}">
                ...
                <div class="effects-tuning">
                  ...
                  <div class="sliders ${o?"compact":""}">
                    ${Object.entries(Da).map(([t,i])=>{if(!n[t])return null;const s=e[t];return W`
                        <label>
                          ${i}
                          <ha-slider
                            min="0"
    ...
    `]}};function Na(t=0,e=[255,51,102,0]){return{on:!0,bri:255,fx:t,pal:0,col:e,sx:128,ix:128,c1:128,c2:128,c3:128,o1:!1,o2:!1,o3:!1}}function Oa(t="off"){return{mode:t,on:"off"!==t,bri:"off"===t?0:128,fx:0,pal:0,col:"custom"===t?[72,72,72,0]:[0,0,0,0],sx:128,ix:128,c1:128,c2:128,c3:128,o1:!1,o2:!1,o3:!1}}function Ua(t,e){const i=e.Solid??0;return t.fx===i?"color":"effect"}async function za(t,e){await Pt(t);try{return await t.sendMessagePromise({...e,schema_version:1})}catch(t){throw new Error(Jt(t))}}async function Ga(t,e,i,s){const n=function(t){let e="";for(let i=0;i<t.length;i+=32768){const s=t.subarray(i,i+32768);e+=String.fromCharCode(...s)}return btoa(e)}(i),r=s?.brush,o=s?.fill,a=r?Ua(r,s?.effectsByName??{}):"color";await za(t,{type:"wled_studio/paint_frame",controller_id:e,data:n,rgbw:s?.rgbw??!0,paint_mode:a,...s?.touched?.length?{touched:s.touched}:{},...r?{brush:r}:{},...o?{fill:o}:{},..."effect"===a&&r?{effect_id:r.fx}:{}})}async function Ba(t,e,i=!0){await za(t,{type:"wled_studio/paint_stop",controller_id:e,commit:i})}function Wa(t,e,i){const s=i?4:3,n=new Uint8ClampedArray(4*e);for(let r=0;r<e;r++){const e=r*s,o=4*r;n[o]=t[e]??0,n[o+1]=t[e+1]??0,n[o+2]=t[e+2]??0,n[o+3]=i?t[e+3]??0:255}return n}t([ct({attribute:!1})],Ra.prototype,"connection",void 0),t([ct()],Ra.prototype,"controllerId",void 0),t([ct({type:Boolean,reflect:!0})],Ra.prototype,"compact",void 0),t([dt()],Ra.prototype,"_snapshot",void 0),t([dt()],Ra.prototype,"_segments",void 0),t([dt()],Ra.prototype,"_editIds",void 0),t([dt()],Ra.prototype,"_focusSegId",void 0),t([dt()],Ra.prototype,"_filter",void 0),t([dt()],Ra.prototype,"_status",void 0),t([dt()],Ra.prototype,"_meta",void 0),t([dt()],Ra.prototype,"_mergeActive",void 0),t([dt()],Ra.prototype,"_library",void 0),t([dt()],Ra.prototype,"_saveCopyOpen",void 0),t([dt()],Ra.prototype,"_saveCopyName",void 0),t([dt()],Ra.prototype,"_saveSceneOpen",void 0),t([dt()],Ra.prototype,"_saveSceneName",void 0),t([dt()],Ra.prototype,"_needsMergeApply",void 0),Ra=t([bt("wled-view-effects")],Ra);const Va={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Ha=class extends vt{constructor(){super(...arguments),this.controllerId="",this.heading="Brush",this.showOnToggle=!1,this._loadingEffects=!0,this._error="",this._effectFilter=""}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load(),t.has("settings")&&void 0!==this.settings?.fx&&this._refreshMeta()}async _load(){if(this.connection&&this.controllerId){this._loadingEffects=!0,this._error="";try{this._snapshot=await Tt(this.connection,this.controllerId),await this._refreshMeta()}catch(t){this._error=Jt(t)}finally{this._loadingEffects=!1}}}async _refreshMeta(){this.connection&&this.controllerId&&this.settings&&(this._meta=await Dt(this.connection,this.controllerId,this.settings.fx))}_emit(t){const e={...this.settings,...t};this.dispatchEvent(new CustomEvent("settings-change",{detail:e,bubbles:!0,composed:!0}))}_onColor(t){const{rgb:e,white:i}=t.detail,s={col:[e[0],e[1],e[2],i]};"Fill look"!==this.heading&&(s.fx=Qt(this._snapshot?.effects_by_name??{})),this._emit(s)}async _onEffectSelect(t){this._emit({fx:t.detail.effectId}),await this._refreshMeta()}_slider(t,e){const i=e.target.value;if(t.startsWith("o"))return void this._emit({[t]:Number(i)>0});const s=jt(Number(i));null!==s&&this._emit({[t]:s})}render(){if(!this.settings)return null;const t=Nt(this.settings.col),e=this._meta,i=e?.sliders??{},s=this._snapshot?.rgbwm??0;return W`
      <div class="block">
        ...
        ${this._loadingEffects?W`<p class="muted">Loading effects…</p>`:W`
              ...
              <div class="sliders">
                ${Object.entries(Va).map(([t,e])=>{if(!i[t])return null;const s=this.settings[t];return"boolean"==typeof s?W`
                      <label class="row">
                        <input
                          type="checkbox"
                          .checked=${s}
    ...
    `]}};t([ct({attribute:!1})],Ha.prototype,"connection",void 0),t([ct({attribute:!1})],Ha.prototype,"hass",void 0),t([ct()],Ha.prototype,"controllerId",void 0),t([ct()],Ha.prototype,"heading",void 0),t([ct({attribute:!1})],Ha.prototype,"settings",void 0),t([ct({type:Boolean})],Ha.prototype,"showOnToggle",void 0),t([dt()],Ha.prototype,"_loadingEffects",void 0),t([dt()],Ha.prototype,"_error",void 0),t([dt()],Ha.prototype,"_snapshot",void 0),t([dt()],Ha.prototype,"_meta",void 0),t([dt()],Ha.prototype,"_effectFilter",void 0),Ha=t([bt("wled-paint-settings")],Ha);let ja=class extends vt{constructor(){super(...arguments),this.controllerId="",this.embedMode=!1,this.embedLayoutId="",this.embedFixtureId="",this.embedPixelCount=0,this._pixelCount=210,this._rgbw=!0,this._active=!1,this._brush=Na(),this._fill=Oa("off"),this._brushSize=6,this._status="",this._warn="",this._effectsByName={},this._layouts=[],this._layoutId="",this._fixtureId="",this._buffer=null,this._previewPixels=null,this._touched=new Set,this._flushInFlight=!1,this._flushQueued=!1,this._flushColor=function(t,e){let i,s,n=0;const r=(...r)=>{s=r;const o=Date.now(),a=o-n;if(a>=e)return n=o,i&&(clearTimeout(i),i=void 0),void t(...r);i||(i=setTimeout(()=>{i=void 0,n=Date.now(),s&&t(...s)},e-a))};return r.cancel=()=>{i&&clearTimeout(i),i=void 0,s=void 0},r}(()=>{this._flushNow()},20),this._flushEffect=Lt(()=>{this._flushNow()},60,180)}_previewEl(){return this.embedMode?this._externalPreview:this._internalPreview}get brushSize(){return this._brushSize}get paintLivePreview(){return this._brushIsEffect()}get paintExternalLive(){return!this._brushIsEffect()}bindExternalPreview(t){this._externalPreview=t,t&&this._active&&t.setStatus("live paint"),t&&this._previewPixels?this._syncPreviewPixels():t&&t.refresh()}handleExternalPaintStroke(t){this._onPaintStroke(t)}_emitPaintConfig(){this.dispatchEvent(new CustomEvent("paint-config-change",{bubbles:!0,composed:!0}))}_brushIsEffect(){return"effect"===Ua(this._brush,this._effectsByName)}updated(t){(t.has("_fill")||t.has("_brush")||t.has("_buffer")||t.has("_layoutId"))&&(this._applyFillToBuffer(),this._brushIsEffect()?this._previewEl()?.setPaintPixels(null):this._syncPreviewPixels()),(t.has("_brush")||t.has("_brushSize"))&&(this.requestUpdate(),this._emitPaintConfig()),this.embedMode&&(t.has("embedLayoutId")||t.has("embedFixtureId")||t.has("embedPixelCount"))&&(this.embedLayoutId&&(this._layoutId=this.embedLayoutId),this.embedFixtureId&&(this._fixtureId=this.embedFixtureId),this.embedPixelCount>0&&(this._pixelCount=this.embedPixelCount),this._previewEl()?.refresh())}async onPoweredConnect(){if(this.connection&&this.controllerId)try{const[t,e]=await Promise.all([Tt(this.connection,this.controllerId),As(this.connection,this.controllerId)]),i=t.info?.leds;i?.count&&(this._pixelCount=i.count),"boolean"==typeof i?.rgbw&&(this._rgbw=i.rgbw),this._effectsByName=t.effects_by_name??{};const s=t.segments?.[0];if(s){const t=s.col?.[0],e=Array.isArray(t)&&t.length>=3?[t[0],t[1],t[2],t[3]??0]:void 0;this._brush=Na(s.fx??0,e)}this._layouts=e,this.embedMode&&this.embedLayoutId?(this._layoutId=this.embedLayoutId,this._fixtureId=this.embedFixtureId||"fixture-0",this.embedPixelCount>0&&(this._pixelCount=this.embedPixelCount)):this._applyLayout(e[0]),this._allocBuffer(),this._status=this.embedMode?this._layoutId?"Drag on the strip preview to paint":"Create a layout in Studio → Layout first":e.length?"Drag on the layout to paint":"Create a layout in the Layout tab first"}catch(t){this._status=Jt(t)}}_applyLayout(t){if(!t)return this._layoutId="",void(this._fixtureId="");this._layoutId=t.id;const e=t.fixtures[0];this._fixtureId=e?String(e.id??"fixture-0"):"fixture-0",t.pixel_count&&(this._pixelCount=t.pixel_count),this._previewEl()?.refresh()}_onLayoutPick(t){const e=t.target.value,i=this._layouts.find(t=>t.id===e);this._applyLayout(i),this._allocBuffer()}async onPoweredDisconnect(){if(this._flushColor.cancel(),this._flushEffect.cancel(),this._active&&this.connection&&this.controllerId)try{await Ba(this.connection,this.controllerId,!1)}catch{}this._active=!1,this._touched.clear()}async _ensureSession(){if(this._active||!this.connection||!this.controllerId)return this._active;try{const t=await async function(t,e){return za(t,{type:"wled_studio/paint_start",controller_id:e})}(this.connection,this.controllerId);return this._active=!0,this._touched.clear(),this._warn=t.wifi_sleep_warning??"",t.pixel_count&&(this._pixelCount=t.pixel_count),"boolean"==typeof t.rgbw&&(this._rgbw=t.rgbw),this._allocBuffer(),this._previewEl()?.setStatus("live paint"),this._status="Live paint",!0}catch(t){return this._status=Jt(t),!1}}_allocBuffer(){const t=this._rgbw?4:3;this._buffer=new Uint8Array(this._pixelCount*t),this._previewPixels=null,this._applyFillToBuffer(),this._syncPreviewPixels()}_syncPreviewPixels(t){const e=this._previewEl();if(!this._buffer||!e)return;if(!this._previewPixels||this._previewPixels.length!==4*this._pixelCount)this._previewPixels=Wa(this._buffer,this._pixelCount,this._rgbw);else if(t?.length){const e=this._rgbw?4:3,i=this._previewPixels;for(const s of t){const t=s*e,n=4*s;i[n]=this._buffer[t]??0,i[n+1]=this._buffer[t+1]??0,i[n+2]=this._buffer[t+2]??0,i[n+3]=this._rgbw?this._buffer[t+3]??0:255}}else this._previewPixels=Wa(this._buffer,this._pixelCount,this._rgbw);e.setPaintPixels(this._previewPixels)}_brushRgb(){const t=Math.max(0,Math.min(255,this._brush.bri))/255;return[Math.round(this._brush.col[0]*t),Math.round(this._brush.col[1]*t),Math.round(this._brush.col[2]*t)]}async cancelLiveIfActive(){if(!this._active||!this.connection||!this.controllerId)return!1;this._flushColor.cancel(),this._flushEffect.cancel();try{await Ba(this.connection,this.controllerId,!1),this._status="Live paint ended — layout segments restored",this._previewEl()?.setStatus("ready")}catch(t){return this._status=Jt(t),!1}return this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels(),this.dispatchEvent(new CustomEvent("wled-paint-ended",{bubbles:!0,composed:!0})),this._emitPaintConfig(),!0}_writeLed(t,e){if(!this._buffer)return;const i=t*(this._rgbw?4:3);this._buffer[i]=e[0],this._buffer[i+1]=e[1],this._buffer[i+2]=e[2],this._rgbw&&(this._buffer[i+3]=0)}_applyFillToBuffer(){if(!this._buffer)return;const t="off"===this._fill.mode?[0,0,0]:"custom"===this._fill.mode?[this._fill.col[0],this._fill.col[1],this._fill.col[2]]:[40,40,40];for(let e=0;e<this._pixelCount;e++)this._touched.has(e)||this._writeLed(e,t)}_scheduleFlush(){this._brushIsEffect()?this._flushEffect():this._flushColor()}_strokeLeds(t){if(!this._buffer||!t.length)return;if(this._brushIsEffect()){for(const e of t)this._touched.add(e);this._previewEl()?.setPaintPixels(null)}else{const e=this._brushRgb();for(const i of t)this._writeLed(i,e),this._touched.add(i);this._syncPreviewPixels(t)}this._scheduleFlush()}async _onPaintStroke(t){await this._ensureSession()&&this._strokeLeds(t.detail.leds)}async _flushNow(){if(this._active&&this.connection&&this._buffer)if(this._flushInFlight)this._flushQueued=!0;else{this._flushInFlight=!0;try{await Ga(this.connection,this.controllerId,this._buffer,{rgbw:this._rgbw,touched:[...this._touched],brush:this._brush,fill:this._fill,effectsByName:this._effectsByName});const t=this._brushIsEffect()?"effect (device preview)":"color";this._status=`Live paint · ${this._touched.size} LEDs · ${t} · fill: ${this._fill.mode}`}catch(t){this._status=Jt(t)}finally{this._flushInFlight=!1,this._flushQueued&&(this._flushQueued=!1,this._flushNow())}}}_onBrushChange(t){this._brush=t.detail,this._emitPaintConfig(),this._active&&this._scheduleFlush()}_onFillChange(t){this._fill={...t.detail,mode:this._fill.mode},this._applyFillToBuffer(),this._syncPreviewPixels(),this._active&&this._scheduleFlush()}_onFillModeChange(t){this._fill=Oa(t),this._applyFillToBuffer(),this._syncPreviewPixels(),this._active&&this._flushNow()}async _commit(){if(this.connection&&this._active){this._flushColor.cancel(),this._flushEffect.cancel(),await this._flushNow();try{await Ba(this.connection,this.controllerId,!0),this._status="Committed to WLED",this._previewEl()?.setStatus("committed")}catch(t){this._status=Jt(t)}this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels()}}async _cancel(){if(this.connection&&this._active){this._flushColor.cancel(),this._flushEffect.cancel();try{await Ba(this.connection,this.controllerId,!1),this._status="Live mode released",this._previewEl()?.setStatus("ready")}catch(t){this._status=Jt(t)}this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels()}}render(){const t=Boolean(this._layoutId),e=this.embedMode;return W`
    ...
    `]}};t([ct({attribute:!1})],qa.prototype,"connection",void 0),t([ct()],qa.prototype,"controllerId",void 0),t([dt()],qa.prototype,"_thumbStatus",void 0),t([dt()],qa.prototype,"_capturing",void 0),qa=t([bt("wled-view-settings")],qa);const Ka=["Off","Normal","Vivid","Lazy"],Ya=["Off","Send","Receive"],Xa=["Linear","Square root","Logarithmic"],Ja=["Off","GEQ pulse","WaveSin","Sweep"];let Za=class extends vt{constructor(){super(...arguments),this.controllerId="",this._cfg={},this._info={},this._status="idle",this._busy=!1}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}async _load(){if(this.connection&&this.controllerId){this._status="loading";try{const t=(await Tt(this.connection,this.controllerId)).state,e=t?.AudioReactive??{};this._cfg=function(t){return{inputLevel:"number"==typeof t.inputLevel?t.inputLevel:128,squelch:"number"==typeof t.squelch?t.squelch:10,gain:"number"==typeof t.gain?t.gain:40,AGC:"number"==typeof t.AGC?t.AGC:2,sync:"number"==typeof t.sync?t.sync:0,port:"number"==typeof t.port?t.port:11988,freqDist:"number"==typeof t.freqDist?t.freqDist:1,limiterRise:"number"==typeof t.limiterRise?t.limiterRise:60,limiterFall:"number"==typeof t.limiterFall?t.limiterFall:800,PalAR:!0===t.PalAR}}(e),this._info=e,this._status="ready"}catch(t){this._status=t instanceof Error?t.message:"error"}}}async _patch(t){if(this.connection&&this.controllerId&&!this._busy){this._busy=!0,this._cfg={...this._cfg,...t};try{await async function(t,e,i){return Ft(t,e,{AudioReactive:i})}(this.connection,this.controllerId,t)}catch(t){wt(this,t instanceof Error?t.message:String(t))}finally{this._busy=!1}}}_slider(t,e,i,s,n=""){const r=this._cfg[t]??i;return W`
      <label class="ctrl">
        <span class="ctrl-label">${e}<span class="ctrl-val">${r}${n}</span></span>
        <ha-slider
          min=${i}
          max=${s}
          step="1"
    ...
    `}static simulationLabels(){return Ja}static{this.styles=[...mt,o`
      .ar h3 {
        margin: 0 0 6px;
        font-size: 1rem;
      }
    ...
    `]}};t([ct({attribute:!1})],il.prototype,"connection",void 0),t([ct()],il.prototype,"controllerId",void 0),t([ct()],il.prototype,"host",void 0),t([ct()],il.prototype,"controllerTitle",void 0),t([dt()],il.prototype,"_frameKey",void 0),t([dt()],il.prototype,"_skinStatus",void 0),t([dt()],il.prototype,"_skinBusy",void 0),il=t([bt("wled-view-firmware")],il);class sl{constructor(t){this.host=t,this._controllerId="",this._controllers=[],t.addController(this)}hostConnected(){}get controllerId(){return this._controllerId}get controllers(){return this._controllers}masterEntityFor(t){return this._controllers.find(e=>e.entry_id===t)?.master_entity_id??""}get masterEntity(){return this.masterEntityFor(this._controllerId)}setControllerId(t){t&&t!==this._controllerId&&(this._controllerId=t,this.host.requestUpdate())}async loadControllers(t){try{const e=await $t(t);this._controllers=e;const i=this._controllerId&&e.some(t=>t.entry_id===this._controllerId);if(!i){const t=e[0];t?.entry_id&&(this._controllerId=String(t.entry_id))}this.host.requestUpdate()}catch{}}}class nl{constructor(t,e){this.host=t,t.addController(this),this._normalize=e.normalize??(t=>t),this._view=this._normalize(e.initial)}hostConnected(){}get view(){return this._view}select(t){const e=this._normalize(t);e!==this._view&&(this._view=e,this.host.requestUpdate())}revalidate(){const t=this._normalize(this._view);t!==this._view&&(this._view=t,this.host.requestUpdate())}}class rl{constructor(t){this.host=t,this._selectedSegId=-1,this._highlightSegIds=[],this._segments=[],t.addController(this)}hostConnected(){}get selectedSegId(){return this._selectedSegId}get highlightSegIds(){return this._highlightSegIds}get segments(){return this._segments}selectSegment(t){this._selectedSegId!==t&&(this._selectedSegId=t,this.host.requestUpdate())}applyTargetsChanged(t){this._selectedSegId=t.segmentId,t.highlightIds?.length?this._highlightSegIds=[...t.highlightIds]:t.editIds?.length?this._highlightSegIds=[...t.editIds]:this._highlightSegIds=[t.segmentId],this.host.requestUpdate()}applySegmentChange(t){this._selectedSegId=t.segmentId,t.editIds?.length&&(this._highlightSegIds=[...t.editIds]),this.host.requestUpdate()}setSegments(t){this._segments=t,this.host.requestUpdate()}}const ol="wled-studio-panel",al="wled_studio.onboarded",ll=[{id:"color",label:"Color",icon:"mdi:palette"},{id:"effects",label:"Effects",icon:"mdi:auto-fix"},{id:"scenes",label:"Scenes",icon:"mdi:palette-swatch"},{id:"paint",label:"Paint",icon:"mdi:brush"}],hl=[{id:"layout",label:"Layout",icon:"mdi:vector-polygon"},{id:"devices",label:"Devices",icon:"mdi:devices"},{id:"audio",label:"Audio",icon:"mdi:music"},{id:"voice",label:"Voice",icon:"mdi:microphone-message"},{id:"schedules",label:"Schedules",icon:"mdi:clock-outline"},{id:"controller",label:"Controller",icon:"mdi:web"},{id:"settings",label:"Settings",icon:"mdi:cog"},{id:"firmware",label:"Firmware",icon:"mdi:chip"}];function cl(t){return hl.some(e=>e.id===t)}class dl extends vt{constructor(){super(...arguments),this._session=new sl(this),this._nav=new nl(this,{initial:"color",normalize:t=>"segments"===t?"color":t}),this._selection=new rl(this),this._drawerOpen=!1,this._moreExpanded=!1,this._showOnboard=!1}get _view(){return this._nav.view}get _controllerId(){return this._session.controllerId}get _controllers(){return this._session.controllers}get _previewSegId(){return this._selection.selectedSegId}get _previewHighlightIds(){return this._selection.highlightSegIds}onPoweredConnect(){try{this._showOnboard=!localStorage.getItem(al)}catch{this._showOnboard=!1}cl(this._view)&&(this._moreExpanded=!0),this._loadController()}onPoweredDisconnect(){this._unbindOnboardModal()}updated(t){super.updated(t),t.has("_showOnboard")&&(this._showOnboard?this._bindOnboardModal():this._unbindOnboardModal())}async _loadController(){this.hass?.connection&&await this._session.loadControllers(this.hass.connection)}_dismissOnboard(){try{localStorage.setItem(al,"1")}catch{}this._showOnboard=!1}_bindOnboardModal(){this._unbindOnboardModal(),this._onboardKeyHandler=t=>{if("Escape"===t.key)return t.preventDefault(),void this._dismissOnboard();if("Tab"!==t.key)return;const e=this.renderRoot.querySelector(".onboard-card");if(!e)return;const i=e.querySelectorAll('button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(!i.length)return;const s=i[0],n=i[i.length-1];t.shiftKey&&document.activeElement===s?(t.preventDefault(),n.focus()):t.shiftKey||document.activeElement!==n||(t.preventDefault(),s.focus())},document.addEventListener("keydown",this._onboardKeyHandler),this.scheduleRaf(()=>{this.renderRoot.querySelector(".onboard-primary")?.focus()})}_unbindOnboardModal(){this._onboardKeyHandler&&(document.removeEventListener("keydown",this._onboardKeyHandler),this._onboardKeyHandler=void 0)}_onControllerPick(t){this._session.setControllerId(t.target.value)}render(){const t=this.remote.state;return W`
      <div class="shell" role="application" aria-label="WLED Studio">
        ...
        >
          ...
          <nav class="rail-nav desktop-primary" aria-label="Primary sections">
            ${ll.map(t=>this._navItem(t.id,t.label,t.icon))}
          </nav>
          <div class="more-section desktop-more">
            ...
            ${this._moreExpanded?W`
                  <nav class="more-nav" aria-label="More sections">
                    ${hl.map(t=>this._navItem(t.id,t.label,t.icon))}
                  </nav>
                `:null}
          </div>
        ...
        <main class="stage">
          ...
          <nav class="primary-bar" aria-label="Primary sections">
            ${ll.map(t=>this._primaryTab(t.id,t.label,t.icon))}
          </nav>
          <section
            class="content"
            aria-live="polite"
    ...
    `]}}t([dt()],dl.prototype,"_drawerOpen",void 0),t([dt()],dl.prototype,"_moreExpanded",void 0),t([dt()],dl.prototype,"_showOnboard",void 0),function(){const t=window.__WLED_STUDIO_BUILD__;t&&t!==yt&&(window.__WLED_STUDIO_STALE__=!0),window.__WLED_STUDIO_BUILD__=yt}(),function(t,e){const i=customElements.get(t);i||customElements.define(t,e)}(ol,dl),console.info("[wled-studio] panel bundle loaded",{panel:ol});export{ol as PANEL_TAG,dl as WledStudioPanel};
