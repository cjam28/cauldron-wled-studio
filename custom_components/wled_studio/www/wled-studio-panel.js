import{b as e,i as t,_ as i,n as s,d as r}from"./wled-studio-core.js";import{B as o,m as n,N as a,L as l,z as d,n as c,Q as h,j as p}from"./geometry-preview.js";import{b as u,S as v,a as m,i as w,d as g}from"./wled-toast-host.js";import"./view-layout.js";import"./view-devices.js";import"./view-paint.js";import"./view-settings.js";import"./view-audio.js";import"./view-voice.js";import"./view-schedules.js";import"./view-firmware.js";import"./paint.js";class _{constructor(e,t=4e3){this.onChange=e,this.holdMs=t,this._active=!1}get active(){return this._active}ping(){this._active||(this._active=!0,this.onChange(!0)),clearTimeout(this.timer),this.timer=setTimeout(()=>{this._active=!1,this.onChange(!1)},this.holdMs)}clear(){clearTimeout(this.timer),this.timer=void 0,this._active=!1}}let b=class extends o{constructor(){super(...arguments),this.heightPx=56,this.pixelCount=210,this.segments=[],this.selectedSegId=-1,this.highlightSegIds=[],this._status="waiting",this._hoverLed=-1,this._raf=0,this._onCanvasClick=e=>{const t=this._ledAtEvent(e);if(t<0)return;const i=this._segmentForLed(t);i<0||this.dispatchEvent(new CustomEvent("segment-select",{detail:{segmentId:i,ledIndex:t},bubbles:!0,composed:!0}))},this._onCanvasMove=e=>{const t=this._ledAtEvent(e);t!==this._hoverLed&&(this._hoverLed=t,this.requestUpdate(),this._lastPixels&&this._schedulePaint())},this._onCanvasLeave=()=>{this._hoverLed>=0&&(this._hoverLed=-1,this.requestUpdate(),this._lastPixels&&this._schedulePaint())}}setFrame(e){e&&(this._lastPixels=n(e,this.pixelCount),this._status="live",this.requestUpdate(),this.isPowered&&this._schedulePaint())}setStatus(e){this._status=e,this.requestUpdate()}pulseApply(){const e=this.renderRoot.querySelector(".wrap");e&&(e.classList.remove("scene-pulse"),e.getBoundingClientRect(),e.classList.add("scene-pulse"),window.setTimeout(()=>e.classList.remove("scene-pulse"),200))}onPoweredConnect(){this._lastPixels&&this._schedulePaint()}onPoweredDisconnect(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0}firstUpdated(){this._canvas=this.renderRoot.querySelector("canvas")??void 0,this._canvas&&(this._ctx=this._canvas.getContext("2d",{alpha:!1})??void 0,this._canvas.addEventListener("click",this._onCanvasClick),this._canvas.addEventListener("mousemove",this._onCanvasMove),this._canvas.addEventListener("mouseleave",this._onCanvasLeave),this.addUnsub(()=>{this._canvas?.removeEventListener("click",this._onCanvasClick),this._canvas?.removeEventListener("mousemove",this._onCanvasMove),this._canvas?.removeEventListener("mouseleave",this._onCanvasLeave)}))}_ledAtEvent(e){const t=this._canvas;if(!t)return-1;const i=t.getBoundingClientRect(),s=(e.clientX-i.left)/i.width;return Math.min(this.pixelCount-1,Math.max(0,Math.floor(s*this.pixelCount)))}_segmentForLed(e){for(const t of this.segments){const i=t.start??0,s=t.stop??t.len??this.pixelCount;if(e>=i&&e<s)return t.id}return 1===this.segments.length?this.segments[0].id:-1}_ledInSelectedSeg(e){const t=this.highlightSegIds.length>0?this.highlightSegIds:this.selectedSegId>=0?[this.selectedSegId]:[];for(const i of t){const t=this.segments.find(e=>e.id===i);if(!t)continue;const s=t.start??0,r=t.stop??t.len??this.pixelCount;if(e>=s&&e<r)return!0}return!1}_surfaceFill(){return getComputedStyle(this).getPropertyValue("--wled-surface").trim()||"#1e1e1e"}_schedulePaint(){this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0,this._paint()}))}_paint(){const e=this._ctx,t=this._canvas;if(!e||!t||!this._lastPixels)return;const i=t.width,s=t.height,r=this.pixelCount,o=i/r;e.fillStyle=this._surfaceFill(),e.fillRect(0,0,i,s);for(let t=0;t<r;t++){const i=4*t,r=this._lastPixels[i],n=this._lastPixels[i+1],a=this._lastPixels[i+2],l=this._ledInSelectedSeg(t),d=t===this._hoverLed;e.fillStyle=`rgb(${r},${n},${a})`,e.shadowColor=`rgba(${r},${n},${a},0.85)`,e.shadowBlur=this.remote.state.disableBloom?0:l||d?10:6;const c=l?0:2,h=l?s:s-4;e.fillRect(t*o,c,Math.max(1,o-1),h),l&&(e.strokeStyle="rgba(255,255,255,0.9)",e.lineWidth=2,e.strokeRect(t*o+.5,.5,Math.max(1,o-2),s-1))}e.shadowBlur=0}render(){const t=Math.max(320,3*this.pixelCount);return e`
      <div class="wrap" role="img" aria-label="Live LED strip preview — tap a pixel to select its segment">
        ...
        ></canvas>
        ${i=this._status,"live"!==i&&"throttled"!==i?e`<span class="overlay">${this._status}</span>`:null}
      </div>
    `;var i}static{this.styles=[...a,t`
      .wrap {
        position: relative;
    ...
    `]}};i([s({type:Number})],b.prototype,"heightPx",void 0),i([s({type:Number})],b.prototype,"pixelCount",void 0),i([s({type:Array})],b.prototype,"segments",void 0),i([s({type:Number})],b.prototype,"selectedSegId",void 0),i([s({type:Array})],b.prototype,"highlightSegIds",void 0),i([r()],b.prototype,"_status",void 0),i([r()],b.prototype,"_hoverLed",void 0),b=i([l("wled-strip-preview")],b);let f=class extends o{constructor(){super(...arguments),this.controllerId="",this.heightPx=56,this.selectedSegId=-1,this.highlightSegIds=[],this._pixelCount=210,this._segments=[],this._status="connecting",this._throttledHold=!1,this._hold=new _(e=>{this._throttledHold=e})}willUpdate(e){(e.has("connection")||e.has("controllerId"))&&this.connection&&this.controllerId&&this._bootstrap()}onPoweredConnect(){this._bootstrap()}onPoweredDisconnect(){this._unsubLive?.(),this._unsubLive=void 0,this._hold.clear()}async _bootstrap(){if(this.connection&&this.controllerId){this._status="connecting",this._preview()?.setStatus(this._status);try{const e=(await d(this.connection)).find(e=>String(e.entry_id)===this.controllerId);this._pixelCount=Number(e?.pixel_count)||210;const t=await c(this.connection,this.controllerId);this._segments=t.segments??[]}catch{this._segments=[]}this._startLive()}}_startLive(){this.connection&&this.controllerId&&(this._unsubLive?.(),this._unsubLive=h(this.connection,this.controllerId,e=>{this._status=function(e){return!0===e.stale||"stale"===e.status?"stale":"drop"===e.status||(e.dropped??0)>0?"throttled":"live"}(e),"throttled"===this._status&&this._hold.ping(),this._preview()?.setStatus(this._status),"stale"!==this._status&&this._preview()?.setFrame(e)},{remote:this.remote.state.isRemote}),this.addUnsub(()=>this._unsubLive?.()))}pulseApply(){this._preview()?.pulseApply()}async refreshSegments(){if(this.connection&&this.controllerId)try{const e=await c(this.connection,this.controllerId);this._segments=e.segments??[]}catch{}}_preview(){return this.renderRoot.querySelector("wled-strip-preview")??void 0}_isStale(){return"stale"===this._status}_isThrottled(){return"throttled"===this._status}_onSegmentSelect(e){this.dispatchEvent(new CustomEvent("segment-select",{detail:e.detail,bubbles:!0,composed:!0}))}render(){return e`
      <div class="rail-preview">
        ...
        <div class="status-row">
          ${this._isStale()?e`<span class="status status-badge" role="status"
                >reconnecting</span
              >`:"live"===this._status||this._isThrottled()?this._throttledHold?e`<span class="status status-hint">throttled</span>`:null:e`<span class="status">${this._status}</span>`}
        </div>
      </div>
    ...
    `]}};i([s({attribute:!1})],f.prototype,"connection",void 0),i([s()],f.prototype,"controllerId",void 0),i([s({type:Number})],f.prototype,"heightPx",void 0),i([s({type:Number})],f.prototype,"selectedSegId",void 0),i([s({type:Array})],f.prototype,"highlightSegIds",void 0),i([r()],f.prototype,"_pixelCount",void 0),i([r()],f.prototype,"_segments",void 0),i([r()],f.prototype,"_status",void 0),i([r()],f.prototype,"_throttledHold",void 0),f=i([l("wled-studio-live-preview")],f);const x="wled-studio-panel",y="wled_studio.onboarded",$=[{id:"color",label:"Color",icon:"mdi:palette"},{id:"effects",label:"Effects",icon:"mdi:auto-fix"},{id:"scenes",label:"Scenes",icon:"mdi:palette-swatch"},{id:"paint",label:"Paint",icon:"mdi:brush"}],S=[{id:"layout",label:"Layout",icon:"mdi:vector-polygon"},{id:"devices",label:"Devices",icon:"mdi:devices"},{id:"audio",label:"Audio",icon:"mdi:music"},{id:"voice",label:"Voice",icon:"mdi:microphone-message"},{id:"schedules",label:"Schedules",icon:"mdi:clock-outline"},{id:"controller",label:"Controller",icon:"mdi:web"},{id:"settings",label:"Settings",icon:"mdi:cog"},{id:"firmware",label:"Firmware",icon:"mdi:chip"}];function k(e){return S.some(t=>t.id===e)}class I extends o{constructor(){super(...arguments),this._session=new u(this),this._nav=new v(this,{initial:"color",normalize:e=>"segments"===e?"color":e}),this._selection=new m(this),this._drawerOpen=!1,this._moreExpanded=!1,this._showOnboard=!1}get _view(){return this._nav.view}get _controllerId(){return this._session.controllerId}get _controllers(){return this._session.controllers}get _previewSegId(){return this._selection.selectedSegId}get _previewHighlightIds(){return this._selection.highlightSegIds}onPoweredConnect(){try{this._showOnboard=!localStorage.getItem(y)}catch{this._showOnboard=!1}k(this._view)&&(this._moreExpanded=!0),this._loadController()}onPoweredDisconnect(){this._unbindOnboardModal()}updated(e){super.updated(e),e.has("_showOnboard")&&(this._showOnboard?this._bindOnboardModal():this._unbindOnboardModal())}async _loadController(){this.hass?.connection&&await this._session.loadControllers(this.hass.connection)}_dismissOnboard(){try{localStorage.setItem(y,"1")}catch{}this._showOnboard=!1}_bindOnboardModal(){this._unbindOnboardModal(),this._onboardKeyHandler=e=>{if("Escape"===e.key)return e.preventDefault(),void this._dismissOnboard();if("Tab"!==e.key)return;const t=this.renderRoot.querySelector(".onboard-card");if(!t)return;const i=t.querySelectorAll('button:not([disabled]), [href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"])');if(!i.length)return;const s=i[0],r=i[i.length-1];e.shiftKey&&document.activeElement===s?(e.preventDefault(),r.focus()):e.shiftKey||document.activeElement!==r||(e.preventDefault(),s.focus())},document.addEventListener("keydown",this._onboardKeyHandler),this.scheduleRaf(()=>{this.renderRoot.querySelector(".onboard-primary")?.focus()})}_unbindOnboardModal(){this._onboardKeyHandler&&(document.removeEventListener("keydown",this._onboardKeyHandler),this._onboardKeyHandler=void 0)}_onControllerPick(e){this._session.setControllerId(e.target.value)}render(){const t=this.remote.state;return e`
      <div class="shell" role="application" aria-label="WLED Studio">
          ...
          <div class="more-section desktop-more">
            ...
            ${this._moreExpanded?e`
                  <nav class="more-nav" aria-label="More sections">
                    ${S.map(e=>this._navItem(e.id,e.label,e.icon))}
                  </nav>
                `:null}
          </div>
        ...
        <main class="stage">
          ...
          <nav class="primary-bar" aria-label="Primary sections">
            ${$.map(e=>this._primaryTab(e.id,e.label,e.icon))}
          </nav>
          <section
            class="content"
            aria-live="polite"
    ...
    `]}}i([r()],I.prototype,"_drawerOpen",void 0),i([r()],I.prototype,"_moreExpanded",void 0),i([r()],I.prototype,"_showOnboard",void 0),g(),p(x,I),console.info("[wled-studio] panel bundle loaded",{panel:x});
