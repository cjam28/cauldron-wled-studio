import{b as e,i as t,_ as i,n as s,d as a}from"./wled-studio-core.js";import{B as r,n as o,b as n,N as l,L as c}from"./geometry-preview.js";import{c as p}from"./wled-toast-host.js";const d=["Off","Normal","Vivid","Lazy"],h=["Off","Send","Receive"],u=["Linear","Square root","Logarithmic"],m=["Off","GEQ pulse","WaveSin","Sweep"];let f=class extends r{constructor(){super(...arguments),this.controllerId="",this._cfg={},this._info={},this._status="idle",this._busy=!1}onPoweredConnect(){this._load()}willUpdate(e){(e.has("connection")||e.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}async _load(){if(this.connection&&this.controllerId){this._status="loading";try{const e=(await o(this.connection,this.controllerId)).state,t=e?.AudioReactive??{};this._cfg=function(e){return{inputLevel:"number"==typeof e.inputLevel?e.inputLevel:128,squelch:"number"==typeof e.squelch?e.squelch:10,gain:"number"==typeof e.gain?e.gain:40,AGC:"number"==typeof e.AGC?e.AGC:2,sync:"number"==typeof e.sync?e.sync:0,port:"number"==typeof e.port?e.port:11988,freqDist:"number"==typeof e.freqDist?e.freqDist:1,limiterRise:"number"==typeof e.limiterRise?e.limiterRise:60,limiterFall:"number"==typeof e.limiterFall?e.limiterFall:800,PalAR:!0===e.PalAR}}(t),this._info=t,this._status="ready"}catch(e){this._status=e instanceof Error?e.message:"error"}}}async _patch(e){if(this.connection&&this.controllerId&&!this._busy){this._busy=!0,this._cfg={...this._cfg,...e};try{await n(this.connection,this.controllerId,e)}catch(e){p(this,e instanceof Error?e.message:String(e))}finally{this._busy=!1}}}_slider(t,i,s,a,r=""){const o=this._cfg[t]??s;return e`
      <label class="ctrl">
    ...
    `}static simulationLabels(){return m}static{this.styles=[...l,t`
      .ar h3 {
        margin: 0 0 6px;
        font-size: 1rem;
      }
    ...
    `]}};i([s({attribute:!1})],y.prototype,"connection",void 0),i([s()],y.prototype,"controllerId",void 0),i([a()],y.prototype,"_fft",void 0),i([a()],y.prototype,"_peak",void 0),i([a()],y.prototype,"_hasData",void 0),y=i([c("wled-view-audio")],y);export{y as WledViewAudio};
