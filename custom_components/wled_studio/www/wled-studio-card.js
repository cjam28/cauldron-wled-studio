...
`;class _t{constructor(t,e){this.host=t,this._hass=e,this._isRemote=!1,t.addController(this)}hostConnected(){this._refresh()}setHass(t){this._hass=t,this._refresh(),this.host.requestUpdate()}get state(){return{isRemote:this._isRemote,previewFps:this._isRemote?10:20,useBinaryPack:this._isRemote,disableBloom:this._isRemote}}_refresh(){if("undefined"==typeof location)return void(this._isRemote=!1);const t=location.hostname.endsWith(".ui.nabu.casa"),e=this._hass?.config?.external_url,s=!!e&&e.replace(/\/$/,"")===location.origin;this._isRemote=t||s}}const mt=[ft,gt];class vt extends ot{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new _t(this),this._visible=!0,this._inView=!0}static{this.styles=mt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(s=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(s)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}function bt(t,e){const s=()=>e();return t.addEventListener("ready",s),()=>t.removeEventListener("ready",s)}t([ht({attribute:!1})],vt.prototype,"hass",void 0);const yt=/^[0-9a-fA-F]+$/;function wt(t,e,s,i){let n,r=!1;const o=async()=>{n?.(),n=void 0,r||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const i=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),s=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:s,channels:4===e.channels?4:3,scale:s/t.length,count:t.length}}const s=e.leds;if(!Array.isArray(s)||0===s.length)return null;const i=[];let n=3;for(const t of s){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&yt.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;i.push(e.toLowerCase())}}if(0===i.length)return null;let r=i.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(r=t)}return{leds_hex:i,n:r,channels:n,scale:r/i.length,count:i.length}}(e);i&&s({...i,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:i?.remote??!1}))};o();const a=bt(t,()=>{o()});return()=>{r=!0,a(),n?.(),n=void 0}}async function xt(t){t.connected||await new Promise((e,s)=>{const i=window.setTimeout(()=>{t.removeEventListener("ready",n),s(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(i),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function $t(t){await xt(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,s=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${s}`)}}async function St(t,e){await xt(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function Et(t,e,s,i){await xt(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:s,full_response:i?.fullResponse??!1})).state??{}}function Ct(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function At(t){if(!Array.isArray(t))return[];const e=[];for(const s of t){if("string"==typeof s){const t=s.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(s)&&e.push([Number(s[0])||0,Number(s[1])||0,Number(s[2])||0,Number(s[3])||0])}return e}function kt(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}let It=class extends vt{constructor(){super(...arguments),this.heightPx=56,this.pixelCount=210,this.segments=[],this.selectedSegId=-1,this._status="waiting",this._hoverLed=-1,this._raf=0,this._onCanvasClick=t=>{const e=this._ledAtEvent(t);if(e<0)return;const s=this._segmentForLed(e);s<0||this.dispatchEvent(new CustomEvent("segment-select",{detail:{segmentId:s,ledIndex:e},bubbles:!0,composed:!0}))},this._onCanvasMove=t=>{const e=this._ledAtEvent(t);e!==this._hoverLed&&(this._hoverLed=e,this.requestUpdate(),this._lastPixels&&this._schedulePaint())},this._onCanvasLeave=()=>{this._hoverLed>=0&&(this._hoverLed=-1,this.requestUpdate(),this._lastPixels&&this._schedulePaint())}}setFrame(t){t&&(this._lastPixels=function(t,e){const s=new Uint8ClampedArray(4*e);for(let i=0;i<e;i++){const e=Math.min(t.count-1,Math.max(0,Math.round(i/t.scale))),n=t.leds_hex[e]??"000000",r=4*i;8===n.length?(s[r]=parseInt(n.slice(0,2),16),s[r+1]=parseInt(n.slice(2,4),16),s[r+2]=parseInt(n.slice(4,6),16),s[r+3]=parseInt(n.slice(6,8),16)):(s[r]=parseInt(n.slice(0,2),16),s[r+1]=parseInt(n.slice(2,4),16),s[r+2]=parseInt(n.slice(4,6),16),s[r+3]=255)}return s}(t,this.pixelCount),this._status="live",this.requestUpdate(),this.isPowered&&this._schedulePaint())}setStatus(t){this._status=t,this.requestUpdate()}onPoweredConnect(){this._lastPixels&&this._schedulePaint()}onPoweredDisconnect(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0}firstUpdated(){this._canvas=this.renderRoot.querySelector("canvas")??void 0,this._canvas&&(this._ctx=this._canvas.getContext("2d",{alpha:!1})??void 0,this._canvas.addEventListener("click",this._onCanvasClick),this._canvas.addEventListener("mousemove",this._onCanvasMove),this._canvas.addEventListener("mouseleave",this._onCanvasLeave),this.addUnsub(()=>{this._canvas?.removeEventListener("click",this._onCanvasClick),this._canvas?.removeEventListener("mousemove",this._onCanvasMove),this._canvas?.removeEventListener("mouseleave",this._onCanvasLeave)}))}_ledAtEvent(t){const e=this._canvas;if(!e)return-1;const s=e.getBoundingClientRect(),i=(t.clientX-s.left)/s.width;return Math.min(this.pixelCount-1,Math.max(0,Math.floor(i*this.pixelCount)))}_segmentForLed(t){for(const e of this.segments){const s=e.start??0,i=e.stop??e.len??this.pixelCount;if(t>=s&&t<i)return e.id}return 1===this.segments.length?this.segments[0].id:-1}_ledInSelectedSeg(t){if(this.selectedSegId<0)return!1;const e=this.segments.find(t=>t.id===this.selectedSegId);if(!e)return!1;const s=e.start??0,i=e.stop??e.len??this.pixelCount;return t>=s&&t<i}_schedulePaint(){this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0,this._paint()}))}_paint(){const t=this._ctx,e=this._canvas;if(!t||!e||!this._lastPixels)return;const s=e.width,i=e.height,n=this.pixelCount,r=s/n;t.fillStyle="#111",t.fillRect(0,0,s,i);for(let e=0;e<n;e++){const s=4*e,n=this._lastPixels[s],o=this._lastPixels[s+1],a=this._lastPixels[s+2],l=this._ledInSelectedSeg(e),c=e===this._hoverLed;t.fillStyle=`rgb(${n},${o},${a})`,t.shadowColor=`rgba(${n},${o},${a},0.85)`,t.shadowBlur=this.remote.state.disableBloom?0:l||c?10:6;const h=l?0:2,d=l?i:i-4;t.fillRect(e*r,h,Math.max(1,r-1),d),l&&(t.strokeStyle="rgba(255,255,255,0.9)",t.lineWidth=2,t.strokeRect(e*r+.5,.5,Math.max(1,r-2),i-1))}t.shadowBlur=0}render(){const t=Math.max(320,3*this.pixelCount);return q`
    ...
    `]}};function Pt(t){if(t instanceof Error)return t.message;if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t;if("string"==typeof e.message)return"string"==typeof e.code?`${e.code}: ${e.message}`:e.message;const s=e.error;if(s&&"object"==typeof s){const t=s;if("string"==typeof t.message)return"string"==typeof t.code?`${t.code}: ${t.message}`:t.message}if("string"==typeof e.code)return e.code}try{return JSON.stringify(t)}catch{return"Unknown error"}}t([ht({type:Number})],It.prototype,"heightPx",void 0),t([ht({type:Number})],It.prototype,"pixelCount",void 0),t([ht({type:Array})],It.prototype,"segments",void 0),t([ht({type:Number})],It.prototype,"selectedSegId",void 0),t([dt()],It.prototype,"_status",void 0),t([dt()],It.prototype,"_hoverLed",void 0),It=t([pt("wled-strip-preview")],It);const Rt={all:"All","1d":"1D","2d":"2D",solid:"Solid",sound:"Sound",palette:"Palette"};function Mt(t){return void 0!==t.Solid?t.Solid:0}const Nt="wled_studio.segment_snapshot",Ot="wled_studio.merge_for_effects",Tt=["start","stop","len","grp","spc","of","on","bri","col","fx","sx","ix","c1","c2","c3","o1","o2","o3","pal","n","rev","mi","sel","awm"];function Ut(t){try{const e=localStorage.getItem(t);if(!e)return{};const s=JSON.parse(e);return"object"==typeof s&&s?s:{}}catch{return{}}}function Lt(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function Dt(t){return Boolean(Ut(Ot)[t])}function Wt(t,e){const s=Ut(Ot);e?s[t]=!0:delete s[t],Lt(Ot,s)}function jt(t){return Ut(Nt)[t]??null}function Ht(t){return{seg:t.segments.map(t=>function(t){const e=t,s={id:t.id};for(const t of Tt){const i=e[t];void 0!==i&&(s[t]=i)}return s}(t))}}function zt(t,e){const s=t.find(t=>0===t.id);return s?[0]:t.length?[t[0].id]:[0]}function qt(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:At(t.col),awm:t.awm};return JSON.stringify(e)}function Bt(t,e,s){let i,n=null,r=0;const o=()=>{i&&clearTimeout(i),i=setTimeout(()=>{(async()=>{try{const i=((await St(t,e)).segments??[]).find(t=>t.id===r);if(!i||!n)return;const o=qt(n);if(o===qt(i))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(At(t.col))!==JSON.stringify(At(e.col))}(n,i)?s(i):s(i,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=function(t,e,s=100){let i,n,r;const o=()=>{if(i&&clearTimeout(i),n&&clearTimeout(n),i=n=void 0,r){const e=r;r=void 0,t(...e)}},a=(...t)=>{r=t,i&&clearTimeout(i),i=setTimeout(o,e),n||(n=setTimeout(o,s))};return a.cancel=()=>{i&&clearTimeout(i),n&&clearTimeout(n),i=n=void 0,r=void 0},a}((i,a)=>{n=a,r=a.id,Et(t,e,i,{fullResponse:!0}).then(t=>{const e=t.seg,s=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;s&&(n={...a,...s,id:a.id}),o()}).catch(t=>{s(a,`Failed to apply state to WLED: ${Pt(t)}`)})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),i&&clearTimeout(i)}}}var Ft,Vt,Gt,Jt,Kt,Zt={},Xt=[],Yt=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function Qt(t,e){for(var s in e)t[s]=e[s];return t}function te(t){var e=t.parentNode;e&&e.removeChild(t)}function ee(t,e,s){var i,n,r,o,a=arguments;if(e=Qt({},e),arguments.length>3)for(s=[s],i=3;i<arguments.length;i++)s.push(a[i]);if(null!=s&&(e.children=s),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return o=e.key,null!=(r=e.ref)&&delete e.ref,null!=o&&delete e.key,se(t,e,o,r)}function se(t,e,s,i){var n={type:t,props:e,key:s,ref:i,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return Ft.vnode&&Ft.vnode(n),n}function ie(t){return t.children}function ne(t,e){this.props=t,this.context=e}function re(t,e){if(null==e)return t.__p?re(t.__p,t.__p.__k.indexOf(t)+1):null;for(var s;e<t.__k.length;e++)if(null!=(s=t.__k[e])&&null!=s.__e)return s.__e;return"function"==typeof t.type?re(t):null}function oe(t){var e,s;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(s=t.__k[e])&&null!=s.__e){t.__e=t.__c.base=s.__e;break}return oe(t)}}function ae(t){(!t.__d&&(t.__d=!0)&&1===Vt.push(t)||Jt!==Ft.debounceRendering)&&(Jt=Ft.debounceRendering,(Ft.debounceRendering||Gt)(le))}function le(){var t,e,s,i,n,r,o,a;for(Vt.sort(function(t,e){return e.__v.__b-t.__v.__b});t=Vt.pop();)t.__d&&(s=void 0,i=void 0,r=(n=(e=t).__v).__e,o=e.__P,a=e.u,e.u=!1,o&&(s=[],i=fe(o,n,Qt({},n),e.__n,void 0!==o.ownerSVGElement,null,s,a,null==r?re(n):r),ge(s,n),i!=r&&oe(n)))}function ce(t,e,s,i,n,r,o,a,l){var c,h,d,u,p,f,g,_=s&&s.__k||Xt,m=_.length;if(a==Zt&&(a=null!=r?r[0]:m?re(s,0):null),c=0,e.__k=he(e.__k,function(s){if(null!=s){if(s.__p=e,s.__b=e.__b+1,null===(d=_[c])||d&&s.key==d.key&&s.type===d.type)_[c]=void 0;else for(h=0;h<m;h++){if((d=_[h])&&s.key==d.key&&s.type===d.type){_[h]=void 0;break}d=null}if(u=fe(t,s,d=d||Zt,i,n,r,o,null,a,l),(h=s.ref)&&d.ref!=h&&(g||(g=[])).push(h,s.__c||u,s),null!=u){if(null==f&&(f=u),null!=s.l)u=s.l,s.l=null;else if(r==d||u!=a||null==u.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(u);else{for(p=a,h=0;(p=p.nextSibling)&&h<m;h+=2)if(p==u)break t;t.insertBefore(u,a)}"option"==e.type&&(t.value="")}a=u.nextSibling,"function"==typeof e.type&&(e.l=u)}}return c++,s}),e.__e=f,null!=r&&"function"!=typeof e.type)for(c=r.length;c--;)null!=r[c]&&te(r[c]);for(c=m;c--;)null!=_[c]&&ve(_[c],_[c]);if(g)for(c=0;c<g.length;c++)me(g[c],g[++c],g[++c])}function he(t,e,s){if(null==s&&(s=[]),null==t||"boolean"==typeof t)e&&s.push(e(null));else if(Array.isArray(t))for(var i=0;i<t.length;i++)he(t[i],e,s);else s.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return se(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=se(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return s}function de(t,e,s){"-"===e[0]?t.setProperty(e,s):t[e]="number"==typeof s&&!1===Yt.test(e)?s+"px":null==s?"":s}function ue(t,e,s,i,n){var r,o,a,l,c;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(r=t.style,"string"==typeof s)r.cssText=s;else{if("string"==typeof i&&(r.cssText="",i=null),i)for(o in i)s&&o in s||de(r,o,"");if(s)for(a in s)i&&s[a]===i[a]||de(r,a,s[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),c=e.toLowerCase(),e=(c in t?c:e).slice(2),s?(i||t.addEventListener(e,pe,l),(t.t||(t.t={}))[e]=s):t.removeEventListener(e,pe,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==s?"":s:"function"!=typeof s&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==s||!1===s?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),s):null==s||!1===s?t.removeAttribute(e):t.setAttribute(e,s))}function pe(t){return this.t[t.type](Ft.event?Ft.event(t):t)}function fe(t,e,s,i,n,r,o,a,l,c){var h,d,u,p,f,g,_,m,v,b,y=e.type;if(void 0!==e.constructor)return null;(h=Ft.__b)&&h(e);try{t:if("function"==typeof y){if(m=e.props,v=(h=y.contextType)&&i[h.__c],b=h?v?v.props.value:h.__p:i,s.__c?_=(d=e.__c=s.__c).__p=d.__E:("prototype"in y&&y.prototype.render?e.__c=d=new y(m,b):(e.__c=d=new ne(m,b),d.constructor=y,d.render=be),v&&v.sub(d),d.props=m,d.state||(d.state={}),d.context=b,d.__n=i,u=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=y.getDerivedStateFromProps&&Qt(d.__s==d.state?d.__s=Qt({},d.__s):d.__s,y.getDerivedStateFromProps(m,d.__s)),u)null==y.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&o.push(d);else{if(null==y.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(m,b),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(m,d.__s,b)){for(d.props=m,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==s.__e?l:s.__e:null,e.__k=s.__k,h=0;h<e.__k.length;h++)e.__k[h]&&(e.__k[h].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(m,d.__s,b)}for(p=d.props,f=d.state,d.context=b,d.props=m,d.state=d.__s,(h=Ft.__r)&&h(e),d.__d=!1,d.__v=e,d.__P=t,h=d.render(d.props,d.state,d.context),e.__k=he(null!=h&&h.type==ie&&null==h.key?h.props.children:h),null!=d.getChildContext&&(i=Qt(Qt({},i),d.getChildContext())),u||null==d.getSnapshotBeforeUpdate||(g=d.getSnapshotBeforeUpdate(p,f)),ce(t,e,s,i,n,r,o,l,c),d.base=e.__e;h=d.__h.pop();)d.__s&&(d.state=d.__s),h.call(d);u||null==p||null==d.componentDidUpdate||d.componentDidUpdate(p,f,g),_&&(d.__E=d.__p=null)}else e.__e=_e(s.__e,e,s,i,n,r,o,c);(h=Ft.diffed)&&h(e)}catch(t){Ft.__e(t,e,s)}return e.__e}function ge(t,e){for(var s;s=t.pop();)try{s.componentDidMount()}catch(t){Ft.__e(t,s.__v)}Ft.__c&&Ft.__c(e)}function _e(t,e,s,i,n,r,o,a){var l,c,h,d,u=s.props,p=e.props;if(n="svg"===e.type||n,null==t&&null!=r)for(l=0;l<r.length;l++)if(null!=(c=r[l])&&(null===e.type?3===c.nodeType:c.localName===e.type)){t=c,r[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(p);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),r=null}return null===e.type?u!==p&&(null!=r&&(r[r.indexOf(t)]=null),t.data=p):e!==s&&(null!=r&&(r=Xt.slice.call(t.childNodes)),h=(u=s.props||Zt).dangerouslySetInnerHTML,d=p.dangerouslySetInnerHTML,a||(d||h)&&(d&&h&&d.__html==h.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,s,i,n){var r;for(r in s)r in e||ue(t,r,null,s[r],i);for(r in e)n&&"function"!=typeof e[r]||"value"===r||"checked"===r||s[r]===e[r]||ue(t,r,e[r],s[r],i)}(t,p,u,n,a),e.__k=e.props.children,d||ce(t,e,s,i,"foreignObject"!==e.type&&n,r,o,Zt,a),a||("value"in p&&void 0!==p.value&&p.value!==t.value&&(t.value=null==p.value?"":p.value),"checked"in p&&void 0!==p.checked&&p.checked!==t.checked&&(t.checked=p.checked))),t}function me(t,e,s){try{"function"==typeof t?t(e):t.current=e}catch(t){Ft.__e(t,s)}}function ve(t,e,s){var i,n,r;if(Ft.unmount&&Ft.unmount(t),(i=t.ref)&&me(i,null,e),s||"function"==typeof t.type||(s=null!=(n=t.__e)),t.__e=t.l=null,null!=(i=t.__c)){if(i.componentWillUnmount)try{i.componentWillUnmount()}catch(t){Ft.__e(t,e)}i.base=i.__P=null}if(i=t.__k)for(r=0;r<i.length;r++)i[r]&&ve(i[r],e,s);null!=n&&te(n)}function be(t,e,s){return this.constructor(t,s)}function ye(t,e,s){return e&&function(t,e){for(var s=0;s<e.length;s++){var i=e[s];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}(t.prototype,e),t}function we(){return we=Object.assign||function(t){for(var e=arguments,s=1;s<arguments.length;s++){var i=e[s];for(var n in i)Object.prototype.hasOwnProperty.call(i,n)&&(t[n]=i[n])}return t},we.apply(this,arguments)}Ft={},ne.prototype.setState=function(t,e){var s=this.__s!==this.state&&this.__s||(this.__s=Qt({},this.state));("function"!=typeof t||(t=t(s,this.props)))&&Qt(s,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),ae(this))},ne.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,ae(this))},ne.prototype.render=ie,Vt=[],Gt="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Jt=Ft.debounceRendering,Ft.__e=function(t,e,s){for(var i;e=e.__p;)if((i=e.__c)&&!i.__p)try{if(i.constructor&&null!=i.constructor.getDerivedStateFromError)i.setState(i.constructor.getDerivedStateFromError(t));else{if(null==i.componentDidCatch)continue;i.componentDidCatch(t)}return ae(i.__E=i)}catch(e){t=e}throw t},Kt=Zt;var xe="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",$e="[\\s|\\(]+("+xe+")[,|\\s]+("+xe+")[,|\\s]+("+xe+")\\s*\\)?",Se="[\\s|\\(]+("+xe+")[,|\\s]+("+xe+")[,|\\s]+("+xe+")[,|\\s]+("+xe+")\\s*\\)?",Ee=new RegExp("rgb"+$e),Ce=new RegExp("rgba"+Se),Ae=new RegExp("hsl"+$e),ke=new RegExp("hsla"+Se),Ie="^(?:#?|0x?)",Pe="([0-9a-fA-F]{1})",Re="([0-9a-fA-F]{2})",Me=new RegExp(Ie+Pe+Pe+Pe+"$"),Ne=new RegExp(Ie+Pe+Pe+Pe+Pe+"$"),Oe=new RegExp(Ie+Re+Re+Re+"$"),Te=new RegExp(Ie+Re+Re+Re+Re+"$"),Ue=Math.log,Le=Math.round,De=Math.floor;function We(t,e,s){return Math.min(Math.max(t,e),s)}function je(t,e){var s=t.indexOf("%")>-1,i=parseFloat(t);return s?e/100*i:i}function He(t){return parseInt(t,16)}function ze(t){return t.toString(16).padStart(2,"0")}var qe=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=we({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,s){var i;this[t]=we({},this[t],((i={})[e]=s,i))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,s=t.s/100,i=t.v/100,n=De(e),r=e-n,o=i*(1-s),a=i*(1-r*s),l=i*(1-(1-r)*s),c=n%6,h=[l,i,i,a,o,o][c],d=[o,o,l,i,i,a][c];return{r:We(255*[i,a,o,o,l,i][c],0,255),g:We(255*h,0,255),b:We(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,s=t.g/255,i=t.b/255,n=Math.max(e,s,i),r=Math.min(e,s,i),o=n-r,a=0,l=n,c=0===n?0:o/n;switch(n){case r:a=0;break;case e:a=(s-i)/o+(s<i?6:0);break;case s:a=(i-e)/o+2;break;case i:a=(e-s)/o+4}return{h:60*a%360,s:We(100*c,0,100),v:We(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,s=t.v/100,i=(2-e)*s,n=i<=1?i:2-i,r=n<1e-9?0:e*s/n;return{h:t.h,s:We(100*r,0,100),l:We(50*i,0,100)}},t.hslToHsv=function(t){var e=2*t.l,s=t.s*(e<=100?e:200-e)/100,i=e+s<1e-9?0:2*s/(e+s);return{h:t.h,s:We(100*i,0,100),v:We((e+s)/2,0,100)}},t.kelvinToRgb=function(t){var e,s,i,n=t/100;return n<66?(e=255,s=-155.25485562709179-.44596950469579133*(s=n-2)+104.49216199393888*Ue(s),i=n<20?0:.8274096064007395*(i=n-10)-254.76935184120902+115.67994401066147*Ue(i)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*Ue(e),s=325.4494125711974+.07943456536662342*(s=n-50)-28.0852963507957*Ue(s),i=255),{r:We(De(e),0,255),g:We(De(s),0,255),b:We(De(i),0,255)}},t.rgbToKelvin=function(e){for(var s,i=e.r,n=e.b,r=2e3,o=4e4;o-r>.4;){s=.5*(o+r);var a=t.kelvinToRgb(s);a.b/a.r>=n/i?o=s:r=s}return s},ye(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=we({},e,t),this.onChange){var s={h:!1,v:!1,s:!1,a:!1};for(var i in e)s[i]=t[i]!=e[i];this.$=t,(s.h||s.s||s.v||s.a)&&this.onChange(this,s)}else this.$=t}},{key:"hsva",get:function(){return we({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=we({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=we({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=we({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=we({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),s=e.r,i=e.g,n=e.b;return{r:Le(s),g:Le(i),b:Le(n)}},set:function(e){this.hsv=we({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return we({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),s=e.h,i=e.s,n=e.l;return{h:Le(s),s:Le(i),l:Le(n)}},set:function(e){this.hsv=we({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return we({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,s,i,n,r=1;if((e=Ee.exec(t))?(s=je(e[1],255),i=je(e[2],255),n=je(e[3],255)):(e=Ce.exec(t))&&(s=je(e[1],255),i=je(e[2],255),n=je(e[3],255),r=je(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:s,g:i,b:n,a:r}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+ze(t.r)+ze(t.g)+ze(t.b)},set:function(t){var e,s,i,n,r=255;if((e=Me.exec(t))?(s=17*He(e[1]),i=17*He(e[2]),n=17*He(e[3])):(e=Ne.exec(t))?(s=17*He(e[1]),i=17*He(e[2]),n=17*He(e[3]),r=17*He(e[4])):(e=Oe.exec(t))?(s=He(e[1]),i=He(e[2]),n=He(e[3])):(e=Te.exec(t))&&(s=He(e[1]),i=He(e[2]),n=He(e[3]),r=He(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:s,g:i,b:n,a:r/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+ze(t.r)+ze(t.g)+ze(t.b)+ze(De(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,s,i,n,r=1;if((e=Ae.exec(t))?(s=je(e[1],360),i=je(e[2],100),n=je(e[3],100)):(e=ke.exec(t))&&(s=je(e[1],360),i=je(e[2],100),n=je(e[3],100),r=je(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:s,s:i,l:n,a:r}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function Be(t){var e,s=t.width,i=t.sliderSize,n=t.borderWidth,r=t.handleRadius,o=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return i=null!=(e=i)?e:2*o+2*r,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:s-2*o-2*r,width:s,height:s,cx:s/2,cy:s/2,radius:s/2-n/2}:{handleStart:i/2,handleRange:s-i,radius:i/2,x:0,y:0,width:l?i:s,height:l?s:i}}function Fe(t,e){var s=Be(t),i=s.width,n=s.height,r=s.handleRange,o=s.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var s=e.hsva,i=e.rgb;switch(t.sliderType){case"red":return i.r/2.55;case"green":return i.g/2.55;case"blue":return i.b/2.55;case"alpha":return 100*s.a;case"kelvin":var n=t.minTemperature,r=t.maxTemperature-n,o=(e.kelvin-n)/r*100;return Math.max(0,Math.min(o,100));case"hue":return s.h/=3.6;case"saturation":return s.s;default:return s.v}}(t,e),c=a?i/2:n/2,h=o+l/100*r;return a&&(h=-1*h+r+2*o),{x:a?c:h,y:a?h:c}}var Ve,Ge=2*Math.PI,Je=function(t,e){return Math.sqrt(t*t+e*e)};function Ke(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function Ze(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function Xe(t,e,s){var i=t.wheelAngle,n=t.wheelDirection;return s&&"clockwise"===n?e=i+e:"clockwise"===n?e=360-i+e:s&&"anticlockwise"===n?e=i+180-e:"anticlockwise"===n&&(e=i-e),function(t,e){return(t%e+e)%e}(e,360)}function Ye(t,e,s){var i=Ze(t),n=i.cx,r=i.cy,o=Ke(t);e=n-e,s=r-s;var a=Xe(t,Math.atan2(-s,-e)*(360/Ge)),l=Math.min(Je(e,s),o);return{h:Math.round(a),s:Math.round(100/o*l)}}function Qe(t){var e=t.width,s=t.boxHeight;return{width:e,height:null!=s?s:e,radius:t.padding+t.handleRadius}}function ts(t,e,s){var i=Qe(t),n=i.width,r=i.height,o=i.radius,a=(e-o)/(n-2*o)*100,l=(s-o)/(r-2*o)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function es(t){Ve||(Ve=document.getElementsByTagName("base"));var e=window.navigator.userAgent,s=/^((?!chrome|android).)*safari/i.test(e),i=/iPhone|iPod|iPad/i.test(e),n=window.location;return(s||i)&&Ve.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function ss(t,e,s,i){for(var n=0;n<i.length;n++){var r=i[n].x-e,o=i[n].y-s;if(Math.sqrt(r*r+o*o)<t.handleRadius)return n}return null}function is(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function ns(t,e,s){return t+"-gradient("+e+", "+s.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function rs(t){return"string"==typeof t?t:t+"px"}var os=["mousemove","touchmove","mouseup","touchend"],as=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),s={onMouseDown:e,ontouchstart:e},i="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,r={overflow:"visible",display:i?"inline-block":"block"};return t.index>0&&(r[i?"marginLeft":"marginTop"]=n),ee(ie,null,t.children(this.uid,s,r))},e.prototype.handleEvent=function(t){var e=this,s=this.props.onInput,i=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,r=n.clientX-i.left,o=n.clientY-i.top;switch(t.type){case"mousedown":case"touchstart":!1!==s(r,o,0)&&os.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":s(r,o,1);break;case"mouseup":case"touchend":s(r,o,2),os.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(ne);function ls(t){var e=t.r,s=t.url,i=e,n=e;return ee("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+rs(t.x)+", "+rs(t.y)+")",willChange:"transform",top:rs(-e),left:rs(-e),width:rs(2*e),height:rs(2*e),position:"absolute",overflow:"visible"}},s&&ee("use",Object.assign({xlinkHref:es(s)},t.props)),!s&&ee("circle",{cx:i,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!s&&ee("circle",{cx:i,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function cs(t){var e=t.activeIndex,s=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,i=Be(t),n=i.width,r=i.height,o=i.radius,a=Fe(t,s),l=function(t,e){var s=e.hsv,i=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+i.g+","+i.b+")"],[100,"rgb(255,"+i.g+","+i.b+")"]];case"green":return[[0,"rgb("+i.r+",0,"+i.b+")"],[100,"rgb("+i.r+",255,"+i.b+")"]];case"blue":return[[0,"rgb("+i.r+","+i.g+",0)"],[100,"rgb("+i.r+","+i.g+",255)"]];case"alpha":return[[0,"rgba("+i.r+","+i.g+","+i.b+",0)"],[100,"rgb("+i.r+","+i.g+","+i.b+")"]];case"kelvin":for(var n=[],r=t.minTemperature,o=t.maxTemperature,a=o-r,l=r,c=0;l<o;l+=a/8,c+=1){var h=qe.kelvinToRgb(l),d=h.r,u=h.g,p=h.b;n.push([12.5*c,"rgb("+d+","+u+","+p+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var f=qe.hsvToHsl({h:s.h,s:0,v:s.v}),g=qe.hsvToHsl({h:s.h,s:100,v:s.v});return[[0,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"],[100,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"]];default:var _=qe.hsvToHsl({h:s.h,s:s.s,v:100});return[[0,"#000"],[100,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"]]}}(t,s);return ee(as,Object.assign({},t,{onInput:function(e,i,n){var r=function(t,e,s){var i,n=Be(t),r=n.handleRange,o=n.handleStart;i="horizontal"===t.layoutDirection?-1*s+r+o:e-o,i=Math.max(Math.min(i,r),0);var a=Math.round(100/r*i);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,i);t.parent.inputActive=!0,s[t.sliderType]=r,t.onInput(n,t.id)}}),function(e,i,c){return ee("div",Object.assign({},i,{className:"IroSlider",style:Object.assign({},{position:"relative",width:rs(n),height:rs(r),borderRadius:rs(o),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),ee("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:rs(o),background:ns("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},is(t))}),ee(ls,{isActive:!0,index:s.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function hs(t){var e=Qe(t),s=e.width,i=e.height,n=e.radius,r=t.colors,o=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,c=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],h=r.map(function(e){return function(t,e){var s=Qe(t),i=s.width,n=s.height,r=s.radius,o=e.hsv,a=r,l=i-2*r,c=n-2*r;return{x:a+o.s/100*l,y:a+(c-o.v/100*c)}}(t,e)});return ee(as,Object.assign({},t,{onInput:function(e,s,i){if(0===i){var n=ss(t,e,s,h);null!==n?o.setActiveColor(n):(o.inputActive=!0,l.hsv=ts(t,e,s),t.onInput(i,t.id))}else 1===i&&(o.inputActive=!0,l.hsv=ts(t,e,s));t.onInput(i,t.id)}}),function(e,o,a){return ee("div",Object.assign({},o,{className:"IroBox",style:Object.assign({},{width:rs(s),height:rs(i),position:"relative"},a)}),ee("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:rs(n)},is(t),{background:ns("linear","to bottom",c[1])+","+ns("linear","to right",c[0])})}),r.filter(function(t){return t!==l}).map(function(e){return ee(ls,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[e.index].x,y:h[e.index].y})}),ee(ls,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[l.index].x,y:h[l.index].y}))})}ls.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},cs.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function ds(t){var e=Ze(t).width,s=t.colors;t.borderWidth;var i=t.parent,n=t.color,r=n.hsv,o=s.map(function(e){return function(t,e){var s=e.hsv,i=Ze(t),n=i.cx,r=i.cy,o=Ke(t),a=(180+Xe(t,s.h,!0))*(Ge/360),l=s.s/100*o,c="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*c,y:r+l*Math.sin(a)*c}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return ee(as,Object.assign({},t,{onInput:function(e,s,r){if(0===r){if(!function(t,e,s){var i=Ze(t),n=i.cx,r=i.cy,o=t.width/2;return Je(n-e,r-s)<o}(t,e,s))return!1;var a=ss(t,e,s,o);null!==a?i.setActiveColor(a):(i.inputActive=!0,n.hsv=Ye(t,e,s),t.onInput(r,t.id))}else 1===r&&(i.inputActive=!0,n.hsv=Ye(t,e,s));t.onInput(r,t.id)}}),function(i,l,c){return ee("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:rs(e),height:rs(e),position:"relative"},c)}),ee("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),ee("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&ee("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-r.v/100})}),ee("div",{className:"IroWheelBorder",style:Object.assign({},a,is(t))}),s.filter(function(t){return t!==n}).map(function(e){return ee(ls,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[e.index].x,y:o[e.index].y})}),ee(ls,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:o[n.index].x,y:o[n.index].y}))})}var us=function(t){function e(e){var s=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return s.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var s=new qe(t,this.onColorChange.bind(this));this.colors.splice(e,0,s),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",s)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var s=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return s.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var s=this,i=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(i[t]||(i[t]=[])).push(e),s.deferredEvents[t]&&(s.deferredEvents[t].forEach(function(t){e.apply(null,t)}),s.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var s=this;(Array.isArray(t)?t:[t]).forEach(function(t){var i=s.events[t];i&&i.splice(i.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,s=[],i=arguments.length-1;i-- >0;)s[i]=arguments[i+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,s)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,s=[],i=arguments.length-1;i-- >0;)s[i]=arguments[i+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(s)),(n[t]||(n[t]=[])).push(s)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var s=this,i=e.layout;return Array.isArray(i)||(i=[{component:ds},{component:cs}],e.transparency&&i.push({component:cs,options:{sliderType:"alpha"}})),ee("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},i.map(function(t,i){var n=t.component,r=t.options;return ee(n,Object.assign({},e,r,{ref:void 0,onInput:s.emitInputEvent.bind(s),parent:s,index:i}))}))},e}(ne);us.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var ps,fs,gs,_s=(fs=function(t,e){var s,i=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(s.base),s.onMount(e)}return function(t,e,s){var i,n,r;Ft.__p&&Ft.__p(t,e),n=(i=s===Kt)?null:e.__k,t=ee(ie,null,[t]),r=[],fe(e,e.__k=t,n||Zt,Zt,void 0!==e.ownerSVGElement,n?null:Xt.slice.call(e.childNodes),r,!1,Zt,i),ge(r,t)}(ee(ps,Object.assign({},{ref:function(t){return s=t}},e)),i),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),s},fs.prototype=(ps=us).prototype,Object.assign(fs,ps),fs.__component=ps,fs);!function(t){var e;t.version="5.5.2",t.Color=qe,t.ColorPicker=_s,(e=t.ui||(t.ui={})).h=ee,e.ComponentBase=as,e.Handle=ls,e.Slider=cs,e.Wheel=ds,e.Box=hs}(gs||(gs={}));var ms=gs;let vs=class extends vt{constructor(){super(...arguments),this.rgb=[255,128,0],this.white=0,this.awm=0,this.showWhite=!0,this._suppress=!1}updated(){this._host&&!this._picker&&(this._picker=ms.ColorPicker(this._host,{width:140,color:{r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},borderWidth:1,borderColor:"var(--divider-color, #444)",layout:[{component:ms.ui.Wheel}]}),this._picker.on("color:change",t=>{this._suppress||this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:[t.rgb.r,t.rgb.g,t.rgb.b],white:this.white},bubbles:!0,composed:!0}))}),this._syncPicker())}willUpdate(){this._picker&&this._syncPicker()}_syncPicker(){this._picker&&(this._suppress=!0,this._picker.color.rgb={r:this.rgb[0],g:this.rgb[1],b:this.rgb[2]},this._suppress=!1)}_onWhite(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("color-change",{detail:{rgb:this.rgb,white:e},bubbles:!0,composed:!0}))}_onAwm(t){const e=Number(t.target.value);this.dispatchEvent(new CustomEvent("awm-change",{detail:{awm:e},bubbles:!0,composed:!0}))}render(){return q`
      <div class="wrap">
    ...
    `]}};t([ht({type:Array})],vs.prototype,"rgb",void 0),t([ht({type:Number})],vs.prototype,"white",void 0),t([ht({type:Number})],vs.prototype,"awm",void 0),t([ht({type:Boolean})],vs.prototype,"showWhite",void 0),t([ut(".wheel-host")],vs.prototype,"_host",void 0),vs=t([pt("wled-color-wheel-rgbw")],vs);function bs(t,e="strip",s,i=0){let n=String(t);return i&&(n=`${n}_p${i}`),s?.trim()&&(n=`${n}_${function(t){return(t||"").trim().replace(/[^\w.-]+/g,"_")||"unknown"}(s)}`),`${n}_${e}.webp`}function ys(t,e,s="strip",i,n,r){if(!t||e<0)return;const o=void 0!==r?function(t,e,s="strip",i){const n=e instanceof Set?e:new Set(e);if(!n.size)return;const r=[bs(t,s,i),bs(t,s)];for(const t of r)if(n.has(t))return t;const o=`${t}_`,a=`_${s}.webp`;for(const t of n)if(t.startsWith(o)&&t.endsWith(a))return t}(e,r,s,i):bs(e,s,i);return o?function(t,e){if(!t.startsWith("/"))return t;const s=e?.auth?.data?.access_token;if(!s)return t;const i=t.includes("?")?"&":"?";return`${t}${i}auth=${encodeURIComponent(s)}`}(function(t,e){return`/local/wled_studio/thumbs/${encodeURIComponent(t)}/${encodeURIComponent(e)}`}(t,o),n):void 0}const ws="wled_studio.recent_effects";function xs(t){try{const e=localStorage.getItem(t);if(!e)return{};const s=JSON.parse(e);return"object"==typeof s&&s?s:{}}catch{return{}}}function $s(t){return t?xs(ws)[t]??[]:[]}function Ss(t,e,s,i){if(!t)return[];if(e===(i.solidId??0))return $s(t);const n=xs(ws),r=(n[t]??[]).filter(t=>t.id!==e);return r.unshift({id:e,name:s}),n[t]=r.slice(0,10),function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(ws,n),n[t]}let Es=class extends vt{constructor(){super(...arguments),this.fxId=0,this.thumbUrl="",this.thumbUrlAnimated="",this.label="",this._hover=!1}render(){const t=this.thumbUrlAnimated||(this.thumbUrl.endsWith(".webp")?this.thumbUrl:""),e=this.thumbUrl||t,s=this._hover&&t?t:e;return q`
      <button
        class="tile"
        type="button"
    ...
    `]}};t([ht({type:Number})],Es.prototype,"fxId",void 0),t([ht()],Es.prototype,"thumbUrl",void 0),t([ht()],Es.prototype,"thumbUrlAnimated",void 0),t([ht()],Es.prototype,"label",void 0),t([dt()],Es.prototype,"_hover",void 0),Es=t([pt("wled-effect-tile")],Es);let Cs=class extends vt{constructor(){super(...arguments),this.effectsByName={},this.soundFlags=[],this.selectedFx=0,this.filter="",this.controllerId="",this.fwVer="",this.thumbBasenames=[],this.toggleOff=!0,this.showRecents=!0,this._category="all",this._recentEntries=[],this._recentVisible=6}onPoweredConnect(){this._loadRecents(),this._ro=new ResizeObserver(()=>this._measureRecents()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._loadRecents();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._recentRowEl&&(this._recentRowEl=e,this._ro?.observe(e),this._measureRecents())}_loadRecents(){this._recentEntries=$s(this.controllerId)}_measureRecents(){const t=this._recentRowEl;if(!t)return;const e=function(t,e=72,s=6,i=10){if(t<=0)return 1;const n=e+s;return Math.max(1,Math.min(i,Math.floor((t+s)/n)))}(t.clientWidth,76,6,10);e!==this._recentVisible&&(this._recentVisible=e)}_effectName(t){return Object.entries(this.effectsByName).find(([,e])=>e===t)?.[0]??`Effect ${t}`}render(){const t=this.filter.trim().toLowerCase(),e=Object.keys(this.effectsByName).sort((t,e)=>t.localeCompare(e)),s=Mt(this.effectsByName),i=e.filter(e=>!!function(t,e,s,i,n){if("all"===s)return!0;const r=i[e]??null,o=t.toLowerCase();return"solid"===s?e===Mt(n):"2d"===s?"2"===r||o.includes("2d"):"1d"===s?"2"!==r&&!o.includes("2d"):"sound"===s?"v"===r||"f"===r:"palette"!==s||o.includes("palette")||o.includes("colorloop")||o.includes("pride")||o.includes("cycle")}(e,this.effectsByName[e],this._category,this.soundFlags,this.effectsByName)&&!(t&&!e.toLowerCase().includes(t))),n=this.showRecents&&!t&&this._recentEntries.length>0,r=this._recentEntries.slice(0,this._recentVisible);return q`
      <div class="wrap">
        ...
        <div class="grid" role="listbox" aria-label="Effects">
          ${0===i.length?q`<p class="empty">No effects match this filter.</p>`:i.map(t=>{const e=this.effectsByName[t],i=this.soundFlags[e],n=e===this.selectedFx,r=ys(this.controllerId,e,"strip",this.fwVer,this.hass,this.thumbBasenames);return r?q`
                    <wled-effect-tile
    ...
    `]}};t([ht({type:Object})],Cs.prototype,"effectsByName",void 0),t([ht({type:Array})],Cs.prototype,"soundFlags",void 0),t([ht({type:Number})],Cs.prototype,"selectedFx",void 0),t([ht({type:String})],Cs.prototype,"filter",void 0),t([ht()],Cs.prototype,"controllerId",void 0),t([ht()],Cs.prototype,"fwVer",void 0),t([ht({type:Array})],Cs.prototype,"thumbBasenames",void 0),t([ht({type:Boolean})],Cs.prototype,"toggleOff",void 0),t([ht({type:Boolean})],Cs.prototype,"showRecents",void 0),t([dt()],Cs.prototype,"_category",void 0),t([dt()],Cs.prototype,"_recentEntries",void 0),t([dt()],Cs.prototype,"_recentVisible",void 0),Cs=t([pt("wled-effect-chips")],Cs);let As=class extends vt{constructor(){super(...arguments),this.controllerId="",this.segments=[],this.editIds=[],this.pixelCount=210,this._merged=!1,this._busy=!1,this._error=""}onPoweredConnect(){this._merged=Dt(this.controllerId)}willUpdate(t){t.has("controllerId")&&(this._merged=Dt(this.controllerId))}render(){const t=jt(this.controllerId),e=t&&this._merged?`${t.segments.length} segment layout saved`:null;return q`
    ...
    `]}};t([ht({attribute:!1})],As.prototype,"connection",void 0),t([ht()],As.prototype,"controllerId",void 0),t([ht({type:Array})],As.prototype,"segments",void 0),t([ht({type:Array})],As.prototype,"editIds",void 0),t([ht({type:Number})],As.prototype,"pixelCount",void 0),t([dt()],As.prototype,"_merged",void 0),t([dt()],As.prototype,"_busy",void 0),t([dt()],As.prototype,"_error",void 0),As=t([pt("wled-effect-merge-toggle")],As);let ks=class extends vt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return q`
      ...
      <div class="controls ${this.compact?"compact":""}">
        ...
        <div class="seg-bar" role="group" aria-label="Segments">
          ${this._segments.map(t=>q`
              ...
              >
                ${function(t,e){const s=t.id,i=e.find(t=>t.wled_segment_id===s||t.segment_index===s||t.entity_id.endsWith(`_segment_${s}`));return`${("string"==typeof t.n&&t.n.trim()?t.n.trim():"")||i?.name?.replace(/^.*\s—\s/,"")||`Seg ${s+1}`} (${t.start??"?"}–${t.stop??"?"})`}(t,this._snapshot?.segment_entities??[])}
              </button>
            `)}
        </div>
            `}
        ...
        <div class="sliders">
          ${Object.entries(Is).map(([e,s])=>{if(!n[e])return null;const i=t[e];return q`
              <label>
                ${s}
                <ha-slider
                  min="0"
    ...
    `]}};function Os(){return{type:`custom:${Ms}`,controller:"",height:56}}t([ht({attribute:!1})],Ns.prototype,"config",void 0),t([dt()],Ns.prototype,"_controllerId",void 0),t([dt()],Ns.prototype,"_masterEntity",void 0),t([dt()],Ns.prototype,"_pixelCount",void 0),t([dt()],Ns.prototype,"_previewStatus",void 0),t([dt()],Ns.prototype,"_hint",void 0),t([ut("wled-strip-preview")],Ns.prototype,"_preview",void 0),t([ut("wled-segment-controls")],Ns.prototype,"_segmentControls",void 0),t([dt()],Ns.prototype,"_selectedSegId",void 0),t([dt()],Ns.prototype,"_segments",void 0),Ns=Rs=t([pt(Ms)],Ns);const Ts=()=>({type:`custom:${Ms}`,controller:"Cloud",height:56});let Us=class extends ot{constructor(){super(...arguments),this._config=Ts()}setConfig(t){this._config={...Ts(),...t,type:t.type??`custom:${Ms}`}}render(){const t=this._config??Ts();return q`
      <div class="editor">
    ...
    `}_onController(t){const e=t.detail.value;this._fire({...this._config??Ts(),controller:e})}_onHeight(t){const e=Number(t.detail.value);this._fire({...this._config??Ts(),height:Number.isFinite(e)?e:56})}_fire(t){const e=new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0});this.dispatchEvent(e)}};t([ht({attribute:!1})],Us.prototype,"hass",void 0),t([dt()],Us.prototype,"_config",void 0),Us=t([pt("wled-studio-card-editor")],Us),customElements.get(Ms)||customElements.define(Ms,Ns),window.customCards=window.customCards||[],window.customCards.some(t=>t.type===Ms)||window.customCards.push({type:Ms,name:"WLED Studio",description:"Live LED strip preview and controls",preview:!0}),console.info("[wled-studio] lovelace bundle loaded",{card:Ms});export{Ms as CARD_TAG,Ns as WledStudioCard,Os as getStubConfig};
