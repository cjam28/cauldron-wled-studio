...
`];class vt extends rt{constructor(){super(...arguments),this.abort=new AbortController,this.rafIds=new Set,this.unsubs=new Set,this.remote=new _t(this),this._visible=!0,this._inView=!0}static{this.styles=mt}connectedCallback(){super.connectedCallback(),this._bindVisibility(),this._bindIntersection(),this.remote.setHass(this.hass),this.onPoweredConnect()}disconnectedCallback(){this.onPoweredDisconnect(),this._io?.disconnect(),this._io=void 0,this.abort.abort();for(const t of this.rafIds)cancelAnimationFrame(t);this.rafIds.clear();for(const t of this.unsubs)t();this.unsubs.clear(),super.disconnectedCallback()}updated(t){super.updated(t),t.has("hass")&&this.remote.setHass(this.hass)}get isPowered(){return this._visible&&this._inView}scheduleRaf(t){const e=requestAnimationFrame(i=>{this.rafIds.delete(e),this.isConnected&&!this.abort.signal.aborted&&t(i)});this.rafIds.add(e)}addUnsub(t){this.unsubs.add(t)}onPoweredConnect(){}onPoweredDisconnect(){}_bindVisibility(){document.addEventListener("visibilitychange",()=>{this._visible="visible"===document.visibilityState,this.requestUpdate()},{signal:this.abort.signal}),this._visible="visible"===document.visibilityState}_bindIntersection(){this._io=new IntersectionObserver(t=>{this._inView=t.some(t=>t.isIntersecting),this.requestUpdate()},{threshold:.01}),this._io.observe(this)}}t([ht({attribute:!1})],vt.prototype,"hass",void 0);const bt="0.11.5";function yt(t,e){const i=()=>e();return t.addEventListener("ready",i),()=>t.removeEventListener("ready",i)}const wt=/^[0-9a-fA-F]+$/;function xt(t,e,i,s){let n,o=!1;const r=async()=>{n?.(),n=void 0,o||(n=await t.subscribeMessage(t=>{const e=t.event?.data??("wled_studio_live_frame"===t.type?t.data:void 0);if(!e)return;const s=function(t){if(!t||"object"!=typeof t)return null;const e=t;if(Array.isArray(e.leds_hex)&&e.leds_hex.length>0){const t=e.leds_hex.map(t=>String(t).toLowerCase()),i=Number(e.n)>0?Number(e.n):t.length;return{leds_hex:t,n:i,channels:4===e.channels?4:3,scale:i/t.length,count:t.length}}const i=e.leds;if(!Array.isArray(i)||0===i.length)return null;const s=[];let n=3;for(const t of i){if("string"!=typeof t)continue;const e=t.trim().replace(/^#/,"");if(e&&e.length%2==0&&wt.test(e)){if(8===e.length)n=4;else if(6!==e.length)continue;s.push(e.toLowerCase())}}if(0===s.length)return null;let o=s.length;if(void 0!==e.n){const t=Number(e.n);Number.isFinite(t)&&t>0&&(o=t)}return{leds_hex:s,n:o,channels:n,scale:o/s.length,count:s.length}}(e);s&&i({...s,entry_id:e.entry_id,controller_id:e.controller_id,fps:e.fps})},{type:"wled_studio/subscribe_live",schema_version:1,controller_id:e,remote:s?.remote??!1}))};r();const a=yt(t,()=>{r()});return()=>{o=!0,a(),n?.(),n=void 0}}async function $t(t){t.connected||await new Promise((e,i)=>{const s=window.setTimeout(()=>{t.removeEventListener("ready",n),i(new Error("Home Assistant WebSocket not connected"))},15e3),n=()=>{t.connected&&(window.clearTimeout(s),t.removeEventListener("ready",n),e())};t.addEventListener("ready",n)})}async function St(t){await $t(t);try{return(await t.sendMessagePromise({type:"wled_studio/list_controllers",schema_version:1})).controllers??[]}catch(t){const e=t,i=e?.code?`${e.code}: ${e.message??"failed"}`:t instanceof Error?t.message:String(t);throw new Error(`wled_studio/list_controllers — ${i}`)}}function It(t,e,i=100){let s,n,o;const r=()=>{if(s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,o){const e=o;o=void 0,t(...e)}},a=(...t)=>{o=t,s&&clearTimeout(s),s=setTimeout(r,e),n||(n=setTimeout(r,i))};return a.cancel=()=>{s&&clearTimeout(s),n&&clearTimeout(n),s=n=void 0,o=void 0},a}async function kt(t,e){await $t(t);return await t.sendMessagePromise({type:"wled_studio/get_state",schema_version:1,controller_id:e})}async function Ct(t,e,i,s){await $t(t);return(await t.sendMessagePromise({type:"wled_studio/apply_state",schema_version:1,controller_id:e,state:i,full_response:s?.fullResponse??!1})).state??{}}async function Et(t,e,i){return(await t.sendMessagePromise({type:"wled_studio/effect_meta",schema_version:1,controller_id:e,effect_id:i})).meta??{sliders:{},colors_enabled:!0,palette_enabled:!0,flag:null,defaults:{}}}async function Pt(t,e){await $t(t);return(await t.sendMessagePromise({type:"wled_studio/get_palette_previews",schema_version:1,controller_id:e})).palette_previews??{}}function At(t){return!t||t.length<3?[255,255,255,0]:[t[0]??0,t[1]??0,t[2]??0,t[3]??0]}function Mt(t){if(!Array.isArray(t))return[];const e=[];for(const i of t){if("string"==typeof i){const t=i.replace("#","").trim();if(t.length>=6){e.push([parseInt(t.slice(0,2),16),parseInt(t.slice(2,4),16),parseInt(t.slice(4,6),16),t.length>=8?parseInt(t.slice(6,8),16):0]);continue}}Array.isArray(i)&&e.push([Number(i[0])||0,Number(i[1])||0,Number(i[2])||0,Number(i[3])||0])}return e}function Tt(t){const e=t.match(/_segment_(\d+)$/);return e?Number(e[1]):void 0}function Lt(t,e){for(const i of e){if(i.wled_segment_id===t)return i.entity_id;if(Tt(i.entity_id)===t)return i.entity_id;if(i.segment_index===t)return i.entity_id}}function Nt(t,e,i){const s=new Set(t),n=(i.length?i:t.map(t=>({id:t}))).map(t=>s.has(t.id)?{...e,id:t.id,sel:!0,on:void 0!==e.on?e.on:!1===t.on||t.on}:{id:t.id,sel:!1});return{seg:n}}async function Ot(t,e){return await $t(t),t.sendMessagePromise({...e,schema_version:1})}async function zt(t,e){return(await Ot(t,{type:"wled_studio/layout_list",controller_id:e})).layouts??[]}function Bt(t){if(!t)return 0;const e=t.attributes?.brightness_pct;if("number"==typeof e&&Number.isFinite(e))return Math.max(0,Math.min(100,Math.round(e)));const i=t.attributes?.brightness;return"number"==typeof i&&Number.isFinite(i)?Math.round(Math.max(0,Math.min(255,i))/255*100):"on"===t.state?100:0}function Rt(t){return Math.round(Math.max(0,Math.min(100,t))/100*255)}class Dt{constructor(t){this.host=t,this._selectedSegId=-1,this._highlightSegIds=[],this._segments=[],t.addController(this)}hostConnected(){}get selectedSegId(){return this._selectedSegId}get highlightSegIds(){return this._highlightSegIds}get segments(){return this._segments}selectSegment(t){this._selectedSegId!==t&&(this._selectedSegId=t,this.host.requestUpdate())}applyTargetsChanged(t){this._selectedSegId=t.segmentId,t.highlightIds?.length?this._highlightSegIds=[...t.highlightIds]:t.editIds?.length?this._highlightSegIds=[...t.editIds]:this._highlightSegIds=[t.segmentId],this.host.requestUpdate()}applySegmentChange(t){this._selectedSegId=t.segmentId,t.editIds?.length&&(this._highlightSegIds=[...t.editIds]),this.host.requestUpdate()}setSegments(t){this._segments=t,this.host.requestUpdate()}}function Ft(t){return(e,i)=>{const s=customElements.get(t);return s||(customElements.define(t,e),e)}}const Ut=.55,Wt=1,jt=1,Ht=0,qt=0,Vt=0,Gt=1,Xt=0,Yt=0,Jt=1,Kt=1;function Zt(t){return function(t,e){return t?{url:t,opacity:e?.opacity??Ut,brightness:e?.brightness??Wt,saturation:e?.saturation??jt,rotation:e?.rotation??Ht,offsetX:e?.offsetX??qt,offsetY:e?.offsetY??Vt,scale:e?.scale??Gt,cropX:e?.cropX??Xt,cropY:e?.cropY??Yt,cropW:e?.cropW??Jt,cropH:e?.cropH??Kt}:null}(t.background?.url??t.background_url,t.background??null)}function Qt(t,e=!1){return new Promise((i,s)=>{const n=new Image;n.onload=()=>i(n),n.onerror=()=>s(new Error(`Could not load image (${t})`)),function(t,e,i=!1){let s=e;if(i&&!s.includes("?")&&(s=`${s}?v=${Date.now()}`),t.removeAttribute("crossorigin"),s.startsWith("http://")||s.startsWith("https://"))try{new URL(s,window.location.href).origin!==window.location.origin&&(t.crossOrigin="anonymous")}catch{t.crossOrigin="anonymous"}t.src=s}(n,t,e)})}let te=class extends vt{constructor(){super(...arguments),this.controllerId="",this.layoutId="",this.fixtureId="",this.pixelCount=210,this.dotRadius=4,this.compact=!1,this.heightPx=200,this.externalLive=!1,this.paintMode=!1,this.paintLivePreview=!1,this.paintBrushSize=6,this.segments=[],this.selectedSegId=-1,this.highlightSegIds=[],this._positions=[],this._status="waiting",this._showDots=!1,this._closed=!1,this._bgLayer=null,this._bgImage=null,this._raf=0,this._hoverLed=-1,this._painting=!1,this._lastLivePaintMs=0,this._onCanvasClick=t=>{if(this.paintMode)return;const e=this._ledAtEvent(t);if(e<0)return;const i=this._segmentForLed(e);i<0||this.dispatchEvent(new CustomEvent("segment-select",{detail:{segmentId:i,ledIndex:e},bubbles:!0,composed:!0}))},this._onPaintPointerDown=t=>{if(!this.paintMode)return;this._painting=!0,t.target.setPointerCapture(t.pointerId);const e=this._ledAtEvent(t);this._emitPaintStroke(e)},this._onPaintPointerMove=t=>{if(!this.paintMode||!this._painting)return;const e=this._ledAtEvent(t);this._emitPaintStroke(e)},this._onPaintPointerUp=t=>{if(this.paintMode){this._painting=!1;try{t.target.releasePointerCapture(t.pointerId)}catch{}}},this._onPaintPointerLeave=()=>{this._painting=!1},this._onCanvasMove=t=>{const e=this._ledAtEvent(t);e!==this._hoverLed&&(this._hoverLed=e,this._schedPaint())},this._onCanvasLeave=()=>{this._hoverLed>=0&&(this._hoverLed=-1,this._schedPaint())}}setFrame(t){if(t&&(!this.paintMode||this.paintLivePreview)){if(this.paintMode&&this.paintLivePreview){const t=performance.now();if(t-this._lastLivePaintMs<50)return;this._lastLivePaintMs=t}this._pixels=function(t,e){const i=new Uint8ClampedArray(4*e);for(let s=0;s<e;s++){const e=Math.min(t.count-1,Math.max(0,Math.round(s/t.scale))),n=t.leds_hex[e]??"000000",o=4*s;8===n.length?(i[o]=parseInt(n.slice(0,2),16),i[o+1]=parseInt(n.slice(2,4),16),i[o+2]=parseInt(n.slice(4,6),16),i[o+3]=parseInt(n.slice(6,8),16)):(i[o]=parseInt(n.slice(0,2),16),i[o+1]=parseInt(n.slice(2,4),16),i[o+2]=parseInt(n.slice(4,6),16),i[o+3]=255)}return i}(t,this.pixelCount),this._status="live",this._schedPaint()}}setPaintPixels(t){this._paintPixels=t??void 0,this.paintMode&&(this._status=t?"paint":"ready"),this._schedPaint()}setStatus(t){this._status=t,this.requestUpdate()}async refresh(){await this._resolvePositions()}onPoweredConnect(){this._resolvePositions(),this._syncLiveSubscription()}onPoweredDisconnect(){this._raf&&cancelAnimationFrame(this._raf),this._raf=0,this._resizeObs?.disconnect(),this._unsubLive?.(),this._unsubLive=void 0}_wantsLiveStream(){return!this.externalLive||this.paintMode&&this.paintLivePreview}_syncLiveSubscription(){this._wantsLiveStream()?this._unsubLive||this._attachLiveStream():(this._unsubLive?.(),this._unsubLive=void 0)}updated(t){super.updated(t),(t.has("connection")||t.has("controllerId")||t.has("layoutId")||t.has("fixtureId"))&&(this._resolvePositions(),this._syncLiveSubscription()),(t.has("externalLive")||t.has("paintLivePreview")||t.has("paintMode"))&&this._syncLiveSubscription(),(t.has("selectedSegId")||t.has("highlightSegIds")||t.has("segments")||t.has("paintMode"))&&(this._schedPaint(),t.has("paintMode")&&this._canvas&&(this._canvas.style.cursor=this.paintMode?"crosshair":"pointer",this.paintMode&&queueMicrotask(()=>this._onResize())))}firstUpdated(){if(this._canvas=this.renderRoot.querySelector("canvas")??void 0,this._canvas){this._ctx=this._canvas.getContext("2d",{alpha:!0})??void 0,this._resizeObs=new ResizeObserver(()=>this._onResize()),this._resizeObs.observe(this._canvas);const t=this._canvas;t.style.touchAction="none",t.addEventListener("pointerdown",this._onPaintPointerDown),t.addEventListener("pointermove",this._onPaintPointerMove),t.addEventListener("pointerup",this._onPaintPointerUp),t.addEventListener("pointerleave",this._onPaintPointerLeave),t.addEventListener("click",this._onCanvasClick),t.addEventListener("mousemove",this._onCanvasMove),t.addEventListener("mouseleave",this._onCanvasLeave),this.addUnsub(()=>{t.removeEventListener("pointerdown",this._onPaintPointerDown),t.removeEventListener("pointermove",this._onPaintPointerMove),t.removeEventListener("pointerup",this._onPaintPointerUp),t.removeEventListener("pointerleave",this._onPaintPointerLeave),t.removeEventListener("click",this._onCanvasClick),t.removeEventListener("mousemove",this._onCanvasMove),t.removeEventListener("mouseleave",this._onCanvasLeave)})}this._onResize()}_emitPaintStroke(t){if(t<0)return;const e=Math.max(1,Math.floor(this.paintBrushSize/2)),i=[];for(let s=-e;s<=e;s++){const e=t+s;e>=0&&e<this.pixelCount&&i.push(e)}i.length&&this.dispatchEvent(new CustomEvent("paint-stroke",{detail:{led:t,leds:i},bubbles:!0,composed:!0}))}_segmentForLed(t){for(const e of this.segments){const i=e.start??0,s=e.stop??e.len??this.pixelCount;if(t>=i&&t<s)return e.id}return 1===this.segments.length?this.segments[0].id:-1}_ledInSegment(t,e){if(e<0)return!1;const i=this.segments.find(t=>t.id===e);if(!i)return!1;const s=i.start??0,n=i.stop??i.len??this.pixelCount;return t>=s&&t<n}_ledAtEvent(t){const e=this._hitTest(t.clientX,t.clientY);return e?.led??-1}_logicalCanvasSize(){const t=this._canvas;if(!t)return{w:0,h:0};const e=Math.min(2,window.devicePixelRatio||1);return{w:t.width/e,h:t.height/e}}_pointerToLogical(t,e){const i=this._canvas;if(!i)return null;const s=i.getBoundingClientRect();if(s.width<1||s.height<1)return null;const{w:n,h:o}=this._logicalCanvasSize();return[(t-s.left)/s.width*n,(e-s.top)/s.height*o]}_hitTest(t,e){if(!this._canvas||0===this._positions.length)return null;const i=this._pointerToLogical(t,e);if(!i)return null;const[s,n]=i,{w:o,h:r}=this._logicalCanvasSize(),a=this._layoutMap(o,r);if(!a)return null;const{toCanvas:l,hitR:c}=a;let h=null,d=c*c;for(const t of this._positions){const[e,i]=l(t.x,t.y),o=e-s,r=i-n,a=o*o+r*r;a<d&&(d=a,h=t)}return h}_positionExtents(){if(0===this._positions.length)return null;let t=1/0,e=-1/0,i=1/0,s=-1/0;for(const n of this._positions)n.x<t&&(t=n.x),n.x>e&&(e=n.x),n.y<i&&(i=n.y),n.y>s&&(s=n.y);return{minX:t,maxX:e,minY:i,maxY:s,rangeX:e-t||1,rangeY:s-i||1}}_applyLayoutAspectCss(){if(!this.paintMode)return void this.style.removeProperty("--wled-layout-aspect");const t=this._positionExtents();if(!t)return void this.style.removeProperty("--wled-layout-aspect");const e=Math.max(.35,Math.min(3.5,t.rangeX/t.rangeY));this.style.setProperty("--wled-layout-aspect",String(e)),queueMicrotask(()=>this._onResize())}_layoutMap(t,e){const i=this._positionExtents();if(!i)return null;const{minX:s,minY:n,rangeX:o,rangeY:r}=i,a=this.dotRadius,l=this.paintMode?2*a:3*a,c=(t-2*l)/o,h=(e-2*l)/r,d=Math.min(c,h),p=this.compact?Math.max(8,3*a):Math.max(3.5,1.75*a);return{toCanvas:(t,e)=>[l+(t-s)*d,l+(e-n)*d],hitR:Math.max(10,2.5*p),lineW:p}}_accentStroke(){return getComputedStyle(this).getPropertyValue("--wled-accent").trim()||"#03a9f4"}_surfaceFill(){return getComputedStyle(this).getPropertyValue("--wled-surface").trim()||"#1e1e1e"}_onResize(){const t=this._canvas;if(!t)return;const e=t.getBoundingClientRect();if(e.width<2||e.height<2)return;const i=Math.min(1200,Math.max(1,Math.floor(e.width))),s=Math.min(600,Math.max(1,Math.floor(e.height))),n=Math.min(2,window.devicePixelRatio||1),o=Math.floor(i*n),r=Math.floor(s*n);if(t.width!==o||t.height!==r){t.width=o,t.height=r;const e=this._ctx;e&&e.setTransform(n,0,0,n,0,0),this._schedPaint()}}async _resolvePositions(){if(this.connection&&this.controllerId&&this.fixtureId)try{if(this.layoutId){const t=await async function(t,e,i){return(await Ot(t,{type:"wled_studio/layout_get",controller_id:e,layout_id:i})).layout??null}(this.connection,this.controllerId,this.layoutId);if(t){this._bgLayer=Zt(t),this._loadBackgroundImage();const e=t.fixtures??[],i=this.fixtureId?e.find(t=>String(t.id??"")===this.fixtureId):e[0];this._closed=Boolean(i?.closed??!1)}}this._positions=await async function(t,e,i,s){return(await Ot(t,{type:"wled_studio/layout_resolve_positions",controller_id:e,fixture_id:i,layout_id:s})).positions??[]}(this.connection,this.controllerId,this.fixtureId,this.layoutId||void 0),this._applyLayoutAspectCss(),queueMicrotask(()=>this._onResize()),this._schedPaint()}catch{this._positions=[],this._applyLayoutAspectCss()}}_loadBackgroundImage(){const t=this._bgLayer?.url;t?Qt(t).then(t=>{this._bgImage=t,this._schedPaint()},()=>{this._bgImage=null}):this._bgImage=null}_attachLiveStream(){this.connection&&this.controllerId&&!this._unsubLive&&(this._unsubLive=xt(this.connection,this.controllerId,t=>{this.setFrame(t)}),this.addUnsub(()=>{this._unsubLive?.(),this._unsubLive=void 0}))}_schedPaint(){this._raf||(this._raf=requestAnimationFrame(()=>{this._raf=0,this._paint()}))}_rgbForLed(t,e){if(!t)return[80,80,80];const i=4*e;return[t[i],t[i+1],t[i+2]]}_paint(){const t=this._ctx,e=this._canvas;if(!t||!e)return;const{w:i,h:s}=this._logicalCanvasSize();if(i<1||s<1)return;t.clearRect(0,0,i,s),t.fillStyle=this._surfaceFill(),t.fillRect(0,0,i,s),this._bgImage?.complete&&this._bgLayer&&function(t,e,i,s,n){const o=n.opacity??Ut,r=n.brightness??1,a=n.saturation??1,l=(n.rotation??0)*Math.PI/180,c=(n.offsetX??0)*e,h=(n.offsetY??0)*i,d=n.scale??1,p=n.cropX??0,u=n.cropY??0,g=n.cropW??1,f=n.cropH??1,_=s.naturalWidth*g,m=s.naturalHeight*f,v=s.naturalWidth*p,b=s.naturalHeight*u,y=Math.max(e/_,i/m)*d,w=_*y,x=m*y;t.save(),t.globalAlpha=o,t.filter=`brightness(${r}) saturate(${a})`,t.translate(e/2+c,i/2+h),t.rotate(l),t.drawImage(s,v,b,_,m,-w/2,-x/2,w,x),t.restore()}(t,i,s,this._bgImage,this._bgLayer);const n=this.paintMode&&this._paintPixels&&!this.paintLivePreview?this._paintPixels:this._pixels,o=[...this._positions].sort((t,e)=>t.led-e.led),r=this.dotRadius,a=this._layoutMap(i,s);if(o.length>0&&a){const{toCanvas:e,lineW:i}=a,s=this.remote.state.disableBloom;if(!this._showDots){t.lineCap="round",t.lineJoin="round",t.lineWidth=i;const r=(o,r)=>{const[a,l]=e(o.x,o.y),[c,h]=e(r.x,r.y),[d,p,u]=this._rgbForLed(n,o.led);!s&&(d>10||p>10||u>10)?(t.shadowColor=`rgba(${d},${p},${u},0.55)`,t.shadowBlur=i*(this.compact?2:1.5)):t.shadowBlur=0,t.strokeStyle=`rgb(${d},${p},${u})`,t.beginPath(),t.moveTo(a,l),t.lineTo(c,h),t.stroke()};for(let t=0;t<o.length-1;t++)r(o[t],o[t+1]);this._closed&&o.length>=2&&r(o[o.length-1],o[0]),t.shadowBlur=0}if(this._showDots){for(const{x:i,y:a,led:l}of o){const[o,c]=e(i,a),[h,d,p]=this._rgbForLed(n,l);!s&&(h>10||d>10||p>10)?(t.shadowColor=`rgba(${h},${d},${p},0.7)`,t.shadowBlur=2.5*r):t.shadowBlur=0,t.beginPath(),t.arc(o,c,r,0,2*Math.PI),t.fillStyle=`rgb(${h},${d},${p})`,t.fill()}t.shadowBlur=0}this.paintMode?this._hoverLed>=0&&this._paintBrushHover(t,o,e):this._paintSegmentSelection(t,o,e,i)}else{const e=this.pixelCount,o=(i-8)/e,a=s/2;for(let i=0;i<e;i++){let e=80,s=80,l=80;if(n){const t=4*i;e=n[t],s=n[t+1],l=n[t+2]}t.beginPath(),t.arc(4+i*o+o/2,a,r,0,2*Math.PI),t.fillStyle=`rgb(${e},${s},${l})`,t.fill()}}}_paintBrushHover(t,e,i){const s=e.find(t=>t.led===this._hoverLed);if(!s)return;const[n,o]=i(s.x,s.y),r=Math.max(8,2.5*this.dotRadius);t.save(),t.strokeStyle="rgba(255, 255, 255, 0.9)",t.lineWidth=2,t.beginPath(),t.arc(n,o,r,0,2*Math.PI),t.stroke(),t.strokeStyle=this._accentStroke(),t.lineWidth=1.5,t.beginPath(),t.moveTo(n-r-4,o),t.lineTo(n+r+4,o),t.moveTo(n,o-r-4),t.lineTo(n,o+r+4),t.stroke(),t.restore()}_highlightIds(){if(this.highlightSegIds.length)return[...new Set(this.highlightSegIds)];if(this.selectedSegId>=0)return[this.selectedSegId];if(this._hoverLed>=0){const t=this._segmentForLed(this._hoverLed);return t>=0?[t]:[]}return[]}_paintSegmentSelection(t,e,i,s){const n=this._highlightIds();if(!n.length||0===this.segments.length)return;const o=this._accentStroke(),r=Math.max(1.25,Math.min(2.5,.45*s));t.save(),t.lineCap="round",t.lineJoin="round",t.shadowBlur=0;for(const s of n){const n=e.filter(t=>this._ledInSegment(t.led,s)).sort((t,e)=>t.led-e.led);if(n.length<2)continue;const[a,l]=i(n[0].x,n[0].y);t.beginPath(),t.moveTo(a,l);for(let e=1;e<n.length;e++){const[s,o]=i(n[e].x,n[e].y);t.lineTo(s,o)}t.strokeStyle="rgba(0, 0, 0, 0.55)",t.lineWidth=r+1.5,t.stroke(),t.strokeStyle=o,t.lineWidth=r,t.stroke()}t.restore()}render(){const t=this.paintMode?"Paint on layout — drag along the fixture path":this.compact?"Live layout preview — tap the strip to select a segment":"LED geometry preview — positions mapped from fixture layout",e=!this.paintMode&&"live"!==this._status&&"paint"!==this._status;return j`
    ...
    `]}};t([ht({attribute:!1})],te.prototype,"connection",void 0),t([ht()],te.prototype,"controllerId",void 0),t([ht()],te.prototype,"layoutId",void 0),t([ht()],te.prototype,"fixtureId",void 0),t([ht({type:Number})],te.prototype,"pixelCount",void 0),t([ht({type:Number})],te.prototype,"dotRadius",void 0),t([ht({type:Boolean,reflect:!0})],te.prototype,"compact",void 0),t([ht({type:Number})],te.prototype,"heightPx",void 0),t([ht({type:Boolean})],te.prototype,"externalLive",void 0),t([ht({type:Boolean,reflect:!0})],te.prototype,"paintMode",void 0),t([ht({type:Boolean})],te.prototype,"paintLivePreview",void 0),t([ht({type:Number})],te.prototype,"paintBrushSize",void 0),t([ht({type:Array})],te.prototype,"segments",void 0),t([ht({type:Number})],te.prototype,"selectedSegId",void 0),t([ht({type:Array})],te.prototype,"highlightSegIds",void 0),t([dt()],te.prototype,"_positions",void 0),t([dt()],te.prototype,"_status",void 0),t([dt()],te.prototype,"_showDots",void 0),t([dt()],te.prototype,"_closed",void 0),te=t([Ft("wled-geometry-preview")],te);const ee="wled-toast";function ie(t,e){const i=e.trim();i&&t.dispatchEvent(new CustomEvent(ee,{detail:{message:i},bubbles:!0,composed:!0}))}class se extends Error{constructor(t,e){super("Scene conflict"),this.name="SceneConflictError",this.remote=t,this.etag=e}}async function ne(t,e){return await $t(t),t.sendMessagePromise({...e,schema_version:1})}async function oe(t,e){return(await ne(t,{type:"wled_studio/scene_list",controller_id:e})).scenes??[]}async function re(t,e,i,s){try{return(await ne(t,{type:"wled_studio/scene_capture",controller_id:e,name:i,scene_id:s?.sceneId,layout_id:s?.layoutId,transition_ms:s?.transitionMs??2500})).scene??{id:"",controller_id:e,name:i,wled_state:{}}}catch(t){const e=t;if("conflict"===e?.code&&e.data?.scene)throw new se(e.data.scene,String(e.data.etag??e.message??""));throw t}}function ae(t,e){const i=new Set(t);return i.has(e)?i.delete(e):i.add(e),[...i].sort((t,e)=>t-e)}function le(t,e){const i=t.id,s=e.find(t=>t.wled_segment_id===i||t.segment_index===i||t.entity_id.endsWith(`_segment_${i}`));return`${("string"==typeof t.n&&t.n.trim()?t.n.trim():"")||s?.name?.replace(/^.*\s—\s/,"")||`Seg ${i+1}`} (${t.start??"?"}–${t.stop??"?"})`}const ce="wled_studio.effect_defaults",he="wled_studio.effect_library";function de(t){return Number.isFinite(t)?Math.min(255,Math.max(0,Math.round(t))):null}function pe(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function ue(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function ge(t,e){if(!t)return null;const i=function(t){return pe(ce)[t]??{}}(t)[String(e)];return i??null}function fe(t){return t?pe(he)[t]??[]:[]}function _e(t){if(t instanceof Error)return t.message;if("string"==typeof t)return t;if(t&&"object"==typeof t){const e=t;if("string"==typeof e.message)return"string"==typeof e.code?`${e.code}: ${e.message}`:e.message;const i=e.error;if(i&&"object"==typeof i){const t=i;if("string"==typeof t.message)return"string"==typeof t.code?`${t.code}: ${t.message}`:t.message}if("string"==typeof e.code)return e.code}try{return JSON.stringify(t)}catch{return"Unknown error"}}const me={all:"All","1d":"1D","2d":"2D",solid:"Solid",sound:"Music",palette:"Palette"};function ve(t){return void 0!==t.Solid?t.Solid:0}const be=/\b(dj|sound|music|audio|beat|freq|grav|jugg|ripple|water|pixel|rock|streak|popcorn|balls|fireworks|matrix|stream|peak|level|radio|sync|reactive|volume|puddle|ripple|noisem|noisep|noisemove|pixels|juggle|sinelon|phased|blurz|djlight)\b/i;function ye(t,e,i,s,n){if("all"===i)return!0;const o=s[e]??null,r=t.toLowerCase();return"solid"===i?e===ve(n):"2d"===i?"2"===o||r.includes("2d"):"1d"===i?"2"!==o&&!r.includes("2d"):"sound"===i?function(t,e,i){const s=i[e]??null;return"v"===s||"f"===s||be.test(t)}(t,e,s):"palette"!==i||(r.includes("palette")||r.includes("colorloop")||r.includes("pride")||r.includes("cycle"))}const we="wled_studio.segment_snapshot",xe="wled_studio.merge_for_effects",$e=["start","stop","len","grp","spc","of","on","bri","col","fx","sx","ix","c1","c2","c3","o1","o2","o3","pal","n","rev","mi","sel","awm"];function Se(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function Ie(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function ke(t){if(!t)return!1;const e=Se(xe);return!(t in e)||Boolean(e[t])}function Ce(t){if(!t)return!1;const e=Se(xe);return t in e&&Boolean(e[t])}function Ee(t,e){const i=t.find(t=>0===t.id);if(!i||e<=0)return!1;return(i.stop??0)-(i.start??0)>=.9*e}function Pe(t,e){const i=Se(xe);e?i[t]=!0:delete i[t],Ie(xe,i)}function Ae(t){return Se(we)[t]??null}function Me(t,e,i){const s={savedAt:Date.now(),segments:e.map(t=>({...t})),pixelCount:i},n=Se(we);return n[t]=s,Ie(we,n),s}function Te(t){return{seg:t.segments.map(t=>function(t){const e=t,i={id:t.id};for(const t of $e){const s=e[t];void 0!==s&&(i[t]=s)}return i}(t))}}function Le(t,e,i){const s=t.length?[...t].sort((t,e)=>t.id-e.id):[{id:0,start:0,stop:e,on:!0}],n=i?.length?new Set(i):null,o=n?s.filter(t=>n.has(t.id)):s,r=o.filter(t=>(t.stop??0)>(t.start??0)),a=r.length?r:o.length?o:s,l=Math.min(...a.map(t=>t.start??0)),c=Math.max(...a.map(t=>t.stop??e)),h=a[0],d={id:0,start:l,stop:c,on:!1!==h.on,sel:!0,bri:h.bri??255,fx:h.fx??0,n:"Merged (effects)"};void 0!==h.col&&(d.col=h.col),void 0!==h.pal&&(d.pal=h.pal);const p=[d];for(const t of s){if(0===t.id)continue;const e=t.stop??t.start??0;p.push({id:t.id,start:e,stop:e,on:!1,sel:!1})}return{seg:p}}function Ne(t,e){const i=t.find(t=>0===t.id);return i?[0]:t.length?[t[0].id]:[0]}function Oe(t){const e={id:t.id,on:t.on,bri:t.bri,fx:t.fx,sx:t.sx,ix:t.ix,c1:t.c1,c2:t.c2,c3:t.c3,o1:t.o1,o2:t.o2,o3:t.o3,pal:t.pal,col:Mt(t.col),awm:t.awm};return JSON.stringify(e)}function ze(t,e,i){let s,n=null,o=0;const r=()=>{s&&clearTimeout(s),s=setTimeout(()=>{(async()=>{try{const s=((await kt(t,e)).segments??[]).find(t=>t.id===o);if(!s||!n)return;const r=Oe(n);if(r===Oe(s))return;!function(t,e){return t.fx!==e.fx||JSON.stringify(Mt(t.col))!==JSON.stringify(Mt(e.col))}(n,s)?i(s):i(s,"WLED applied a different color or effect than requested")}catch{}})()},500)},a=It((s,a)=>{n=a,o=a.id,Ct(t,e,s,{fullResponse:!0}).then(t=>{const e=t.seg,i=Array.isArray(e)?e.find(t=>t.id===a.id):void 0;i&&(n={...a,...i,id:a.id}),r()}).catch(t=>{i(a,`Failed to apply state to WLED: ${_e(t)}`)})},50,100);return{push(t,e){a(t,e)},cancel(){a.cancel(),s&&clearTimeout(s)}}}var Be,Re,De,Fe,Ue,We={},je=[],He=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|^--/i;function qe(t,e){for(var i in e)t[i]=e[i];return t}function Ve(t){var e=t.parentNode;e&&e.removeChild(t)}function Ge(t,e,i){var s,n,o,r,a=arguments;if(e=qe({},e),arguments.length>3)for(i=[i],s=3;s<arguments.length;s++)i.push(a[s]);if(null!=i&&(e.children=i),null!=t&&null!=t.defaultProps)for(n in t.defaultProps)void 0===e[n]&&(e[n]=t.defaultProps[n]);return r=e.key,null!=(o=e.ref)&&delete e.ref,null!=r&&delete e.key,Xe(t,e,r,o)}function Xe(t,e,i,s){var n={type:t,props:e,key:i,ref:s,__k:null,__p:null,__b:0,__e:null,l:null,__c:null,constructor:void 0};return Be.vnode&&Be.vnode(n),n}function Ye(t){return t.children}function Je(t,e){this.props=t,this.context=e}function Ke(t,e){if(null==e)return t.__p?Ke(t.__p,t.__p.__k.indexOf(t)+1):null;for(var i;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e)return i.__e;return"function"==typeof t.type?Ke(t):null}function Ze(t){var e,i;if(null!=(t=t.__p)&&null!=t.__c){for(t.__e=t.__c.base=null,e=0;e<t.__k.length;e++)if(null!=(i=t.__k[e])&&null!=i.__e){t.__e=t.__c.base=i.__e;break}return Ze(t)}}function Qe(t){(!t.__d&&(t.__d=!0)&&1===Re.push(t)||Fe!==Be.debounceRendering)&&(Fe=Be.debounceRendering,(Be.debounceRendering||De)(ti))}function ti(){var t,e,i,s,n,o,r,a;for(Re.sort(function(t,e){return e.__v.__b-t.__v.__b});t=Re.pop();)t.__d&&(i=void 0,s=void 0,o=(n=(e=t).__v).__e,r=e.__P,a=e.u,e.u=!1,r&&(i=[],s=ri(r,n,qe({},n),e.__n,void 0!==r.ownerSVGElement,null,i,a,null==o?Ke(n):o),ai(i,n),s!=o&&Ze(n)))}function ei(t,e,i,s,n,o,r,a,l){var c,h,d,p,u,g,f,_=i&&i.__k||je,m=_.length;if(a==We&&(a=null!=o?o[0]:m?Ke(i,0):null),c=0,e.__k=ii(e.__k,function(i){if(null!=i){if(i.__p=e,i.__b=e.__b+1,null===(d=_[c])||d&&i.key==d.key&&i.type===d.type)_[c]=void 0;else for(h=0;h<m;h++){if((d=_[h])&&i.key==d.key&&i.type===d.type){_[h]=void 0;break}d=null}if(p=ri(t,i,d=d||We,s,n,o,r,null,a,l),(h=i.ref)&&d.ref!=h&&(f||(f=[])).push(h,i.__c||p,i),null!=p){if(null==g&&(g=p),null!=i.l)p=i.l,i.l=null;else if(o==d||p!=a||null==p.parentNode){t:if(null==a||a.parentNode!==t)t.appendChild(p);else{for(u=a,h=0;(u=u.nextSibling)&&h<m;h+=2)if(u==p)break t;t.insertBefore(p,a)}"option"==e.type&&(t.value="")}a=p.nextSibling,"function"==typeof e.type&&(e.l=p)}}return c++,i}),e.__e=g,null!=o&&"function"!=typeof e.type)for(c=o.length;c--;)null!=o[c]&&Ve(o[c]);for(c=m;c--;)null!=_[c]&&hi(_[c],_[c]);if(f)for(c=0;c<f.length;c++)ci(f[c],f[++c],f[++c])}function ii(t,e,i){if(null==i&&(i=[]),null==t||"boolean"==typeof t)e&&i.push(e(null));else if(Array.isArray(t))for(var s=0;s<t.length;s++)ii(t[s],e,i);else i.push(e?e(function(t){if(null==t||"boolean"==typeof t)return null;if("string"==typeof t||"number"==typeof t)return Xe(null,t,null,null);if(null!=t.__e||null!=t.__c){var e=Xe(t.type,t.props,t.key,null);return e.__e=t.__e,e}return t}(t)):t);return i}function si(t,e,i){"-"===e[0]?t.setProperty(e,i):t[e]="number"==typeof i&&!1===He.test(e)?i+"px":null==i?"":i}function ni(t,e,i,s,n){var o,r,a,l,c;if("key"===(e=n?"className"===e?"class":e:"class"===e?"className":e)||"children"===e);else if("style"===e)if(o=t.style,"string"==typeof i)o.cssText=i;else{if("string"==typeof s&&(o.cssText="",s=null),s)for(r in s)i&&r in i||si(o,r,"");if(i)for(a in i)s&&i[a]===s[a]||si(o,a,i[a])}else"o"===e[0]&&"n"===e[1]?(l=e!==(e=e.replace(/Capture$/,"")),c=e.toLowerCase(),e=(c in t?c:e).slice(2),i?(s||t.addEventListener(e,oi,l),(t.t||(t.t={}))[e]=i):t.removeEventListener(e,oi,l)):"list"!==e&&"tagName"!==e&&"form"!==e&&!n&&e in t?t[e]=null==i?"":i:"function"!=typeof i&&"dangerouslySetInnerHTML"!==e&&(e!==(e=e.replace(/^xlink:?/,""))?null==i||!1===i?t.removeAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase()):t.setAttributeNS("http://www.w3.org/1999/xlink",e.toLowerCase(),i):null==i||!1===i?t.removeAttribute(e):t.setAttribute(e,i))}function oi(t){return this.t[t.type](Be.event?Be.event(t):t)}function ri(t,e,i,s,n,o,r,a,l,c){var h,d,p,u,g,f,_,m,v,b,y=e.type;if(void 0!==e.constructor)return null;(h=Be.__b)&&h(e);try{t:if("function"==typeof y){if(m=e.props,v=(h=y.contextType)&&s[h.__c],b=h?v?v.props.value:h.__p:s,i.__c?_=(d=e.__c=i.__c).__p=d.__E:("prototype"in y&&y.prototype.render?e.__c=d=new y(m,b):(e.__c=d=new Je(m,b),d.constructor=y,d.render=di),v&&v.sub(d),d.props=m,d.state||(d.state={}),d.context=b,d.__n=s,p=d.__d=!0,d.__h=[]),null==d.__s&&(d.__s=d.state),null!=y.getDerivedStateFromProps&&qe(d.__s==d.state?d.__s=qe({},d.__s):d.__s,y.getDerivedStateFromProps(m,d.__s)),p)null==y.getDerivedStateFromProps&&null!=d.componentWillMount&&d.componentWillMount(),null!=d.componentDidMount&&r.push(d);else{if(null==y.getDerivedStateFromProps&&null==a&&null!=d.componentWillReceiveProps&&d.componentWillReceiveProps(m,b),!a&&null!=d.shouldComponentUpdate&&!1===d.shouldComponentUpdate(m,d.__s,b)){for(d.props=m,d.state=d.__s,d.__d=!1,d.__v=e,e.__e=null!=l?l!==i.__e?l:i.__e:null,e.__k=i.__k,h=0;h<e.__k.length;h++)e.__k[h]&&(e.__k[h].__p=e);break t}null!=d.componentWillUpdate&&d.componentWillUpdate(m,d.__s,b)}for(u=d.props,g=d.state,d.context=b,d.props=m,d.state=d.__s,(h=Be.__r)&&h(e),d.__d=!1,d.__v=e,d.__P=t,h=d.render(d.props,d.state,d.context),e.__k=ii(null!=h&&h.type==Ye&&null==h.key?h.props.children:h),null!=d.getChildContext&&(s=qe(qe({},s),d.getChildContext())),p||null==d.getSnapshotBeforeUpdate||(f=d.getSnapshotBeforeUpdate(u,g)),ei(t,e,i,s,n,o,r,l,c),d.base=e.__e;h=d.__h.pop();)d.__s&&(d.state=d.__s),h.call(d);p||null==u||null==d.componentDidUpdate||d.componentDidUpdate(u,g,f),_&&(d.__E=d.__p=null)}else e.__e=li(i.__e,e,i,s,n,o,r,c);(h=Be.diffed)&&h(e)}catch(t){Be.__e(t,e,i)}return e.__e}function ai(t,e){for(var i;i=t.pop();)try{i.componentDidMount()}catch(t){Be.__e(t,i.__v)}Be.__c&&Be.__c(e)}function li(t,e,i,s,n,o,r,a){var l,c,h,d,p=i.props,u=e.props;if(n="svg"===e.type||n,null==t&&null!=o)for(l=0;l<o.length;l++)if(null!=(c=o[l])&&(null===e.type?3===c.nodeType:c.localName===e.type)){t=c,o[l]=null;break}if(null==t){if(null===e.type)return document.createTextNode(u);t=n?document.createElementNS("http://www.w3.org/2000/svg",e.type):document.createElement(e.type),o=null}return null===e.type?p!==u&&(null!=o&&(o[o.indexOf(t)]=null),t.data=u):e!==i&&(null!=o&&(o=je.slice.call(t.childNodes)),h=(p=i.props||We).dangerouslySetInnerHTML,d=u.dangerouslySetInnerHTML,a||(d||h)&&(d&&h&&d.__html==h.__html||(t.innerHTML=d&&d.__html||"")),function(t,e,i,s,n){var o;for(o in i)o in e||ni(t,o,null,i[o],s);for(o in e)n&&"function"!=typeof e[o]||"value"===o||"checked"===o||i[o]===e[o]||ni(t,o,e[o],i[o],s)}(t,u,p,n,a),e.__k=e.props.children,d||ei(t,e,i,s,"foreignObject"!==e.type&&n,o,r,We,a),a||("value"in u&&void 0!==u.value&&u.value!==t.value&&(t.value=null==u.value?"":u.value),"checked"in u&&void 0!==u.checked&&u.checked!==t.checked&&(t.checked=u.checked))),t}function ci(t,e,i){try{"function"==typeof t?t(e):t.current=e}catch(t){Be.__e(t,i)}}function hi(t,e,i){var s,n,o;if(Be.unmount&&Be.unmount(t),(s=t.ref)&&ci(s,null,e),i||"function"==typeof t.type||(i=null!=(n=t.__e)),t.__e=t.l=null,null!=(s=t.__c)){if(s.componentWillUnmount)try{s.componentWillUnmount()}catch(t){Be.__e(t,e)}s.base=s.__P=null}if(s=t.__k)for(o=0;o<s.length;o++)s[o]&&hi(s[o],e,i);null!=n&&Ve(n)}function di(t,e,i){return this.constructor(t,i)}function pi(t,e,i){return e&&function(t,e){for(var i=0;i<e.length;i++){var s=e[i];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(t,s.key,s)}}(t.prototype,e),t}function ui(){return ui=Object.assign||function(t){for(var e=arguments,i=1;i<arguments.length;i++){var s=e[i];for(var n in s)Object.prototype.hasOwnProperty.call(s,n)&&(t[n]=s[n])}return t},ui.apply(this,arguments)}Be={},Je.prototype.setState=function(t,e){var i=this.__s!==this.state&&this.__s||(this.__s=qe({},this.state));("function"!=typeof t||(t=t(i,this.props)))&&qe(i,t),null!=t&&this.__v&&(this.u=!1,e&&this.__h.push(e),Qe(this))},Je.prototype.forceUpdate=function(t){this.__v&&(t&&this.__h.push(t),this.u=!0,Qe(this))},Je.prototype.render=Ye,Re=[],De="function"==typeof Promise?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Fe=Be.debounceRendering,Be.__e=function(t,e,i){for(var s;e=e.__p;)if((s=e.__c)&&!s.__p)try{if(s.constructor&&null!=s.constructor.getDerivedStateFromError)s.setState(s.constructor.getDerivedStateFromError(t));else{if(null==s.componentDidCatch)continue;s.componentDidCatch(t)}return Qe(s.__E=s)}catch(e){t=e}throw t},Ue=We;var gi="(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)",fi="[\\s|\\(]+("+gi+")[,|\\s]+("+gi+")[,|\\s]+("+gi+")\\s*\\)?",_i="[\\s|\\(]+("+gi+")[,|\\s]+("+gi+")[,|\\s]+("+gi+")[,|\\s]+("+gi+")\\s*\\)?",mi=new RegExp("rgb"+fi),vi=new RegExp("rgba"+_i),bi=new RegExp("hsl"+fi),yi=new RegExp("hsla"+_i),wi="^(?:#?|0x?)",xi="([0-9a-fA-F]{1})",$i="([0-9a-fA-F]{2})",Si=new RegExp(wi+xi+xi+xi+"$"),Ii=new RegExp(wi+xi+xi+xi+xi+"$"),ki=new RegExp(wi+$i+$i+$i+"$"),Ci=new RegExp(wi+$i+$i+$i+$i+"$"),Ei=Math.log,Pi=Math.round,Ai=Math.floor;function Mi(t,e,i){return Math.min(Math.max(t,e),i)}function Ti(t,e){var i=t.indexOf("%")>-1,s=parseFloat(t);return i?e/100*s:s}function Li(t){return parseInt(t,16)}function Ni(t){return t.toString(16).padStart(2,"0")}var Oi=function(){function t(t,e){this.$={h:0,s:0,v:0,a:1},t&&this.set(t),this.onChange=e,this.initialValue=ui({},this.$)}var e=t.prototype;return e.set=function(e){if("string"==typeof e)/^(?:#?|0x?)[0-9a-fA-F]{3,8}$/.test(e)?this.hexString=e:/^rgba?/.test(e)?this.rgbString=e:/^hsla?/.test(e)&&(this.hslString=e);else{if("object"!=typeof e)throw new Error("Invalid color value");e instanceof t?this.hsva=e.hsva:"r"in e&&"g"in e&&"b"in e?this.rgb=e:"h"in e&&"s"in e&&"v"in e?this.hsv=e:"h"in e&&"s"in e&&"l"in e?this.hsl=e:"kelvin"in e&&(this.kelvin=e.kelvin)}},e.setChannel=function(t,e,i){var s;this[t]=ui({},this[t],((s={})[e]=i,s))},e.reset=function(){this.hsva=this.initialValue},e.clone=function(){return new t(this)},e.unbind=function(){this.onChange=void 0},t.hsvToRgb=function(t){var e=t.h/60,i=t.s/100,s=t.v/100,n=Ai(e),o=e-n,r=s*(1-i),a=s*(1-o*i),l=s*(1-(1-o)*i),c=n%6,h=[l,s,s,a,r,r][c],d=[r,r,l,s,s,a][c];return{r:Mi(255*[s,a,r,r,l,s][c],0,255),g:Mi(255*h,0,255),b:Mi(255*d,0,255)}},t.rgbToHsv=function(t){var e=t.r/255,i=t.g/255,s=t.b/255,n=Math.max(e,i,s),o=Math.min(e,i,s),r=n-o,a=0,l=n,c=0===n?0:r/n;switch(n){case o:a=0;break;case e:a=(i-s)/r+(i<s?6:0);break;case i:a=(s-e)/r+2;break;case s:a=(e-i)/r+4}return{h:60*a%360,s:Mi(100*c,0,100),v:Mi(100*l,0,100)}},t.hsvToHsl=function(t){var e=t.s/100,i=t.v/100,s=(2-e)*i,n=s<=1?s:2-s,o=n<1e-9?0:e*i/n;return{h:t.h,s:Mi(100*o,0,100),l:Mi(50*s,0,100)}},t.hslToHsv=function(t){var e=2*t.l,i=t.s*(e<=100?e:200-e)/100,s=e+i<1e-9?0:2*i/(e+i);return{h:t.h,s:Mi(100*s,0,100),v:Mi((e+i)/2,0,100)}},t.kelvinToRgb=function(t){var e,i,s,n=t/100;return n<66?(e=255,i=-155.25485562709179-.44596950469579133*(i=n-2)+104.49216199393888*Ei(i),s=n<20?0:.8274096064007395*(s=n-10)-254.76935184120902+115.67994401066147*Ei(s)):(e=351.97690566805693+.114206453784165*(e=n-55)-40.25366309332127*Ei(e),i=325.4494125711974+.07943456536662342*(i=n-50)-28.0852963507957*Ei(i),s=255),{r:Mi(Ai(e),0,255),g:Mi(Ai(i),0,255),b:Mi(Ai(s),0,255)}},t.rgbToKelvin=function(e){for(var i,s=e.r,n=e.b,o=2e3,r=4e4;r-o>.4;){i=.5*(r+o);var a=t.kelvinToRgb(i);a.b/a.r>=n/s?r=i:o=i}return i},pi(t,[{key:"hsv",get:function(){var t=this.$;return{h:t.h,s:t.s,v:t.v}},set:function(t){var e=this.$;if(t=ui({},e,t),this.onChange){var i={h:!1,v:!1,s:!1,a:!1};for(var s in e)i[s]=t[s]!=e[s];this.$=t,(i.h||i.s||i.v||i.a)&&this.onChange(this,i)}else this.$=t}},{key:"hsva",get:function(){return ui({},this.$)},set:function(t){this.hsv=t}},{key:"hue",get:function(){return this.$.h},set:function(t){this.hsv={h:t}}},{key:"saturation",get:function(){return this.$.s},set:function(t){this.hsv={s:t}}},{key:"value",get:function(){return this.$.v},set:function(t){this.hsv={v:t}}},{key:"alpha",get:function(){return this.$.a},set:function(t){this.hsv=ui({},this.hsv,{a:t})}},{key:"kelvin",get:function(){return t.rgbToKelvin(this.rgb)},set:function(e){this.rgb=t.kelvinToRgb(e)}},{key:"red",get:function(){return this.rgb.r},set:function(t){this.rgb=ui({},this.rgb,{r:t})}},{key:"green",get:function(){return this.rgb.g},set:function(t){this.rgb=ui({},this.rgb,{g:t})}},{key:"blue",get:function(){return this.rgb.b},set:function(t){this.rgb=ui({},this.rgb,{b:t})}},{key:"rgb",get:function(){var e=t.hsvToRgb(this.$),i=e.r,s=e.g,n=e.b;return{r:Pi(i),g:Pi(s),b:Pi(n)}},set:function(e){this.hsv=ui({},t.rgbToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"rgba",get:function(){return ui({},this.rgb,{a:this.alpha})},set:function(t){this.rgb=t}},{key:"hsl",get:function(){var e=t.hsvToHsl(this.$),i=e.h,s=e.s,n=e.l;return{h:Pi(i),s:Pi(s),l:Pi(n)}},set:function(e){this.hsv=ui({},t.hslToHsv(e),{a:void 0===e.a?1:e.a})}},{key:"hsla",get:function(){return ui({},this.hsl,{a:this.alpha})},set:function(t){this.hsl=t}},{key:"rgbString",get:function(){var t=this.rgb;return"rgb("+t.r+", "+t.g+", "+t.b+")"},set:function(t){var e,i,s,n,o=1;if((e=mi.exec(t))?(i=Ti(e[1],255),s=Ti(e[2],255),n=Ti(e[3],255)):(e=vi.exec(t))&&(i=Ti(e[1],255),s=Ti(e[2],255),n=Ti(e[3],255),o=Ti(e[4],1)),!e)throw new Error("Invalid rgb string");this.rgb={r:i,g:s,b:n,a:o}}},{key:"rgbaString",get:function(){var t=this.rgba;return"rgba("+t.r+", "+t.g+", "+t.b+", "+t.a+")"},set:function(t){this.rgbString=t}},{key:"hexString",get:function(){var t=this.rgb;return"#"+Ni(t.r)+Ni(t.g)+Ni(t.b)},set:function(t){var e,i,s,n,o=255;if((e=Si.exec(t))?(i=17*Li(e[1]),s=17*Li(e[2]),n=17*Li(e[3])):(e=Ii.exec(t))?(i=17*Li(e[1]),s=17*Li(e[2]),n=17*Li(e[3]),o=17*Li(e[4])):(e=ki.exec(t))?(i=Li(e[1]),s=Li(e[2]),n=Li(e[3])):(e=Ci.exec(t))&&(i=Li(e[1]),s=Li(e[2]),n=Li(e[3]),o=Li(e[4])),!e)throw new Error("Invalid hex string");this.rgb={r:i,g:s,b:n,a:o/255}}},{key:"hex8String",get:function(){var t=this.rgba;return"#"+Ni(t.r)+Ni(t.g)+Ni(t.b)+Ni(Ai(255*t.a))},set:function(t){this.hexString=t}},{key:"hslString",get:function(){var t=this.hsl;return"hsl("+t.h+", "+t.s+"%, "+t.l+"%)"},set:function(t){var e,i,s,n,o=1;if((e=bi.exec(t))?(i=Ti(e[1],360),s=Ti(e[2],100),n=Ti(e[3],100)):(e=yi.exec(t))&&(i=Ti(e[1],360),s=Ti(e[2],100),n=Ti(e[3],100),o=Ti(e[4],1)),!e)throw new Error("Invalid hsl string");this.hsl={h:i,s:s,l:n,a:o}}},{key:"hslaString",get:function(){var t=this.hsla;return"hsla("+t.h+", "+t.s+"%, "+t.l+"%, "+t.a+")"},set:function(t){this.hslString=t}}]),t}();function zi(t){var e,i=t.width,s=t.sliderSize,n=t.borderWidth,o=t.handleRadius,r=t.padding,a=t.sliderShape,l="horizontal"===t.layoutDirection;return s=null!=(e=s)?e:2*r+2*o,"circle"===a?{handleStart:t.padding+t.handleRadius,handleRange:i-2*r-2*o,width:i,height:i,cx:i/2,cy:i/2,radius:i/2-n/2}:{handleStart:s/2,handleRange:i-s,radius:s/2,x:0,y:0,width:l?s:i,height:l?i:s}}function Bi(t,e){var i=zi(t),s=i.width,n=i.height,o=i.handleRange,r=i.handleStart,a="horizontal"===t.layoutDirection,l=function(t,e){var i=e.hsva,s=e.rgb;switch(t.sliderType){case"red":return s.r/2.55;case"green":return s.g/2.55;case"blue":return s.b/2.55;case"alpha":return 100*i.a;case"kelvin":var n=t.minTemperature,o=t.maxTemperature-n,r=(e.kelvin-n)/o*100;return Math.max(0,Math.min(r,100));case"hue":return i.h/=3.6;case"saturation":return i.s;default:return i.v}}(t,e),c=a?s/2:n/2,h=r+l/100*o;return a&&(h=-1*h+o+2*r),{x:a?c:h,y:a?h:c}}var Ri,Di=2*Math.PI,Fi=function(t,e){return Math.sqrt(t*t+e*e)};function Ui(t){return t.width/2-t.padding-t.handleRadius-t.borderWidth}function Wi(t){var e=t.width/2;return{width:t.width,radius:e-t.borderWidth,cx:e,cy:e}}function ji(t,e,i){var s=t.wheelAngle,n=t.wheelDirection;return i&&"clockwise"===n?e=s+e:"clockwise"===n?e=360-s+e:i&&"anticlockwise"===n?e=s+180-e:"anticlockwise"===n&&(e=s-e),function(t,e){return(t%e+e)%e}(e,360)}function Hi(t,e,i){var s=Wi(t),n=s.cx,o=s.cy,r=Ui(t);e=n-e,i=o-i;var a=ji(t,Math.atan2(-i,-e)*(360/Di)),l=Math.min(Fi(e,i),r);return{h:Math.round(a),s:Math.round(100/r*l)}}function qi(t){var e=t.width,i=t.boxHeight;return{width:e,height:null!=i?i:e,radius:t.padding+t.handleRadius}}function Vi(t,e,i){var s=qi(t),n=s.width,o=s.height,r=s.radius,a=(e-r)/(n-2*r)*100,l=(i-r)/(o-2*r)*100;return{s:Math.max(0,Math.min(a,100)),v:Math.max(0,Math.min(100-l,100))}}function Gi(t){Ri||(Ri=document.getElementsByTagName("base"));var e=window.navigator.userAgent,i=/^((?!chrome|android).)*safari/i.test(e),s=/iPhone|iPod|iPad/i.test(e),n=window.location;return(i||s)&&Ri.length>0?n.protocol+"//"+n.host+n.pathname+n.search+t:t}function Xi(t,e,i,s){for(var n=0;n<s.length;n++){var o=s[n].x-e,r=s[n].y-i;if(Math.sqrt(o*o+r*r)<t.handleRadius)return n}return null}function Yi(t){return{boxSizing:"border-box",border:t.borderWidth+"px solid "+t.borderColor}}function Ji(t,e,i){return t+"-gradient("+e+", "+i.map(function(t){var e=t[0];return t[1]+" "+e+"%"}).join(",")+")"}function Ki(t){return"string"==typeof t?t:t+"px"}var Zi=["mousemove","touchmove","mouseup","touchend"],Qi=function(t){function e(e){t.call(this,e),this.uid=(Math.random()+1).toString(36).substring(5)}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.render=function(t){var e=this.handleEvent.bind(this),i={onMouseDown:e,ontouchstart:e},s="horizontal"===t.layoutDirection,n=null===t.margin?t.sliderMargin:t.margin,o={overflow:"visible",display:s?"inline-block":"block"};return t.index>0&&(o[s?"marginLeft":"marginTop"]=n),Ge(Ye,null,t.children(this.uid,i,o))},e.prototype.handleEvent=function(t){var e=this,i=this.props.onInput,s=this.base.getBoundingClientRect();t.preventDefault();var n=t.touches?t.changedTouches[0]:t,o=n.clientX-s.left,r=n.clientY-s.top;switch(t.type){case"mousedown":case"touchstart":!1!==i(o,r,0)&&Zi.forEach(function(t){document.addEventListener(t,e,{passive:!1})});break;case"mousemove":case"touchmove":i(o,r,1);break;case"mouseup":case"touchend":i(o,r,2),Zi.forEach(function(t){document.removeEventListener(t,e,{passive:!1})})}},e}(Je);function ts(t){var e=t.r,i=t.url,s=e,n=e;return Ge("svg",{className:"IroHandle IroHandle--"+t.index+" "+(t.isActive?"IroHandle--isActive":""),style:{"-webkit-tap-highlight-color":"rgba(0, 0, 0, 0);",transform:"translate("+Ki(t.x)+", "+Ki(t.y)+")",willChange:"transform",top:Ki(-e),left:Ki(-e),width:Ki(2*e),height:Ki(2*e),position:"absolute",overflow:"visible"}},i&&Ge("use",Object.assign({xlinkHref:Gi(i)},t.props)),!i&&Ge("circle",{cx:s,cy:n,r:e,fill:"none","stroke-width":2,stroke:"#000"}),!i&&Ge("circle",{cx:s,cy:n,r:e-2,fill:t.fill,"stroke-width":2,stroke:"#fff"}))}function es(t){var e=t.activeIndex,i=void 0!==e&&e<t.colors.length?t.colors[e]:t.color,s=zi(t),n=s.width,o=s.height,r=s.radius,a=Bi(t,i),l=function(t,e){var i=e.hsv,s=e.rgb;switch(t.sliderType){case"red":return[[0,"rgb(0,"+s.g+","+s.b+")"],[100,"rgb(255,"+s.g+","+s.b+")"]];case"green":return[[0,"rgb("+s.r+",0,"+s.b+")"],[100,"rgb("+s.r+",255,"+s.b+")"]];case"blue":return[[0,"rgb("+s.r+","+s.g+",0)"],[100,"rgb("+s.r+","+s.g+",255)"]];case"alpha":return[[0,"rgba("+s.r+","+s.g+","+s.b+",0)"],[100,"rgb("+s.r+","+s.g+","+s.b+")"]];case"kelvin":for(var n=[],o=t.minTemperature,r=t.maxTemperature,a=r-o,l=o,c=0;l<r;l+=a/8,c+=1){var h=Oi.kelvinToRgb(l),d=h.r,p=h.g,u=h.b;n.push([12.5*c,"rgb("+d+","+p+","+u+")"])}return n;case"hue":return[[0,"#f00"],[16.666,"#ff0"],[33.333,"#0f0"],[50,"#0ff"],[66.666,"#00f"],[83.333,"#f0f"],[100,"#f00"]];case"saturation":var g=Oi.hsvToHsl({h:i.h,s:0,v:i.v}),f=Oi.hsvToHsl({h:i.h,s:100,v:i.v});return[[0,"hsl("+g.h+","+g.s+"%,"+g.l+"%)"],[100,"hsl("+f.h+","+f.s+"%,"+f.l+"%)"]];default:var _=Oi.hsvToHsl({h:i.h,s:i.s,v:100});return[[0,"#000"],[100,"hsl("+_.h+","+_.s+"%,"+_.l+"%)"]]}}(t,i);return Ge(Qi,Object.assign({},t,{onInput:function(e,s,n){var o=function(t,e,i){var s,n=zi(t),o=n.handleRange,r=n.handleStart;s="horizontal"===t.layoutDirection?-1*i+o+r:e-r,s=Math.max(Math.min(s,o),0);var a=Math.round(100/o*s);switch(t.sliderType){case"kelvin":var l=t.minTemperature;return l+(t.maxTemperature-l)*(a/100);case"alpha":return a/100;case"hue":return 3.6*a;case"red":case"blue":case"green":return 2.55*a;default:return a}}(t,e,s);t.parent.inputActive=!0,i[t.sliderType]=o,t.onInput(n,t.id)}}),function(e,s,c){return Ge("div",Object.assign({},s,{className:"IroSlider",style:Object.assign({},{position:"relative",width:Ki(n),height:Ki(o),borderRadius:Ki(r),background:"conic-gradient(#ccc 25%, #fff 0 50%, #ccc 0 75%, #fff 0)",backgroundSize:"8px 8px"},c)}),Ge("div",{className:"IroSliderGradient",style:Object.assign({},{position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:Ki(r),background:Ji("linear","horizontal"===t.layoutDirection?"to top":"to right",l)},Yi(t))}),Ge(ts,{isActive:!0,index:i.index,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:a.x,y:a.y}))})}function is(t){var e=qi(t),i=e.width,s=e.height,n=e.radius,o=t.colors,r=t.parent,a=t.activeIndex,l=void 0!==a&&a<t.colors.length?t.colors[a]:t.color,c=[[[0,"#fff"],[100,"hsl("+l.hue+",100%,50%)"]],[[0,"rgba(0,0,0,0)"],[100,"#000"]]],h=o.map(function(e){return function(t,e){var i=qi(t),s=i.width,n=i.height,o=i.radius,r=e.hsv,a=o,l=s-2*o,c=n-2*o;return{x:a+r.s/100*l,y:a+(c-r.v/100*c)}}(t,e)});return Ge(Qi,Object.assign({},t,{onInput:function(e,i,s){if(0===s){var n=Xi(t,e,i,h);null!==n?r.setActiveColor(n):(r.inputActive=!0,l.hsv=Vi(t,e,i),t.onInput(s,t.id))}else 1===s&&(r.inputActive=!0,l.hsv=Vi(t,e,i));t.onInput(s,t.id)}}),function(e,r,a){return Ge("div",Object.assign({},r,{className:"IroBox",style:Object.assign({},{width:Ki(i),height:Ki(s),position:"relative"},a)}),Ge("div",{className:"IroBox",style:Object.assign({},{width:"100%",height:"100%",borderRadius:Ki(n)},Yi(t),{background:Ji("linear","to bottom",c[1])+","+Ji("linear","to right",c[0])})}),o.filter(function(t){return t!==l}).map(function(e){return Ge(ts,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[e.index].x,y:h[e.index].y})}),Ge(ts,{isActive:!0,index:l.index,fill:l.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:h[l.index].x,y:h[l.index].y}))})}ts.defaultProps={fill:"none",x:0,y:0,r:8,url:null,props:{x:0,y:0}},es.defaultProps=Object.assign({},{sliderShape:"bar",sliderType:"value",minTemperature:2200,maxTemperature:11e3});function ss(t){var e=Wi(t).width,i=t.colors;t.borderWidth;var s=t.parent,n=t.color,o=n.hsv,r=i.map(function(e){return function(t,e){var i=e.hsv,s=Wi(t),n=s.cx,o=s.cy,r=Ui(t),a=(180+ji(t,i.h,!0))*(Di/360),l=i.s/100*r,c="clockwise"===t.wheelDirection?-1:1;return{x:n+l*Math.cos(a)*c,y:o+l*Math.sin(a)*c}}(t,e)}),a={position:"absolute",top:0,left:0,width:"100%",height:"100%",borderRadius:"50%",boxSizing:"border-box"};return Ge(Qi,Object.assign({},t,{onInput:function(e,i,o){if(0===o){if(!function(t,e,i){var s=Wi(t),n=s.cx,o=s.cy,r=t.width/2;return Fi(n-e,o-i)<r}(t,e,i))return!1;var a=Xi(t,e,i,r);null!==a?s.setActiveColor(a):(s.inputActive=!0,n.hsv=Hi(t,e,i),t.onInput(o,t.id))}else 1===o&&(s.inputActive=!0,n.hsv=Hi(t,e,i));t.onInput(o,t.id)}}),function(s,l,c){return Ge("div",Object.assign({},l,{className:"IroWheel",style:Object.assign({},{width:Ki(e),height:Ki(e),position:"relative"},c)}),Ge("div",{className:"IroWheelHue",style:Object.assign({},a,{transform:"rotateZ("+(t.wheelAngle+90)+"deg)",background:"clockwise"===t.wheelDirection?"conic-gradient(red, yellow, lime, aqua, blue, magenta, red)":"conic-gradient(red, magenta, blue, aqua, lime, yellow, red)"})}),Ge("div",{className:"IroWheelSaturation",style:Object.assign({},a,{background:"radial-gradient(circle closest-side, #fff, transparent)"})}),t.wheelLightness&&Ge("div",{className:"IroWheelLightness",style:Object.assign({},a,{background:"#000",opacity:1-o.v/100})}),Ge("div",{className:"IroWheelBorder",style:Object.assign({},a,Yi(t))}),i.filter(function(t){return t!==n}).map(function(e){return Ge(ts,{isActive:!1,index:e.index,fill:e.hslString,r:t.handleRadius,url:t.handleSvg,props:t.handleProps,x:r[e.index].x,y:r[e.index].y})}),Ge(ts,{isActive:!0,index:n.index,fill:n.hslString,r:t.activeHandleRadius||t.handleRadius,url:t.handleSvg,props:t.handleProps,x:r[n.index].x,y:r[n.index].y}))})}var ns=function(t){function e(e){var i=this;t.call(this,e),this.colors=[],this.inputActive=!1,this.events={},this.activeEvents={},this.deferredEvents={},this.id=e.id,(e.colors.length>0?e.colors:[e.color]).forEach(function(t){return i.addColor(t)}),this.setActiveColor(0),this.state=Object.assign({},e,{color:this.color,colors:this.colors,layout:e.layout})}return t&&(e.__proto__=t),e.prototype=Object.create(t&&t.prototype),e.prototype.constructor=e,e.prototype.addColor=function(t,e){void 0===e&&(e=this.colors.length);var i=new Oi(t,this.onColorChange.bind(this));this.colors.splice(e,0,i),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),this.deferredEmit("color:init",i)},e.prototype.removeColor=function(t){var e=this.colors.splice(t,1)[0];e.unbind(),this.colors.forEach(function(t,e){return t.index=e}),this.state&&this.setState({colors:this.colors}),e.index===this.color.index&&this.setActiveColor(0),this.emit("color:remove",e)},e.prototype.setActiveColor=function(t){this.color=this.colors[t],this.state&&this.setState({color:this.color}),this.emit("color:setActive",this.color)},e.prototype.setColors=function(t,e){var i=this;void 0===e&&(e=0),this.colors.forEach(function(t){return t.unbind()}),this.colors=[],t.forEach(function(t){return i.addColor(t)}),this.setActiveColor(e),this.emit("color:setAll",this.colors)},e.prototype.on=function(t,e){var i=this,s=this.events;(Array.isArray(t)?t:[t]).forEach(function(t){(s[t]||(s[t]=[])).push(e),i.deferredEvents[t]&&(i.deferredEvents[t].forEach(function(t){e.apply(null,t)}),i.deferredEvents[t]=[])})},e.prototype.off=function(t,e){var i=this;(Array.isArray(t)?t:[t]).forEach(function(t){var s=i.events[t];s&&s.splice(s.indexOf(e),1)})},e.prototype.emit=function(t){for(var e=this,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.activeEvents;!!n.hasOwnProperty(t)&&n[t]||(n[t]=!0,(this.events[t]||[]).forEach(function(t){return t.apply(e,i)}),n[t]=!1)},e.prototype.deferredEmit=function(t){for(var e,i=[],s=arguments.length-1;s-- >0;)i[s]=arguments[s+1];var n=this.deferredEvents;(e=this).emit.apply(e,[t].concat(i)),(n[t]||(n[t]=[])).push(i)},e.prototype.setOptions=function(t){this.setState(t)},e.prototype.resize=function(t){this.setOptions({width:t})},e.prototype.reset=function(){this.colors.forEach(function(t){return t.reset()}),this.setState({colors:this.colors})},e.prototype.onMount=function(t){this.el=t,this.deferredEmit("mount",this)},e.prototype.onColorChange=function(t,e){this.setState({color:this.color}),this.inputActive&&(this.inputActive=!1,this.emit("input:change",t,e)),this.emit("color:change",t,e)},e.prototype.emitInputEvent=function(t,e){0===t?this.emit("input:start",this.color,e):1===t?this.emit("input:move",this.color,e):2===t&&this.emit("input:end",this.color,e)},e.prototype.render=function(t,e){var i=this,s=e.layout;return Array.isArray(s)||(s=[{component:ss},{component:es}],e.transparency&&s.push({component:es,options:{sliderType:"alpha"}})),Ge("div",{class:"IroColorPicker",id:e.id,style:{display:e.display}},s.map(function(t,s){var n=t.component,o=t.options;return Ge(n,Object.assign({},e,o,{ref:void 0,onInput:i.emitInputEvent.bind(i),parent:i,index:s}))}))},e}(Je);ns.defaultProps=Object.assign({},{width:300,height:300,color:"#fff",colors:[],padding:6,layoutDirection:"vertical",borderColor:"#fff",borderWidth:0,handleRadius:8,activeHandleRadius:null,handleSvg:null,handleProps:{x:0,y:0},wheelLightness:!0,wheelAngle:0,wheelDirection:"anticlockwise",sliderSize:null,sliderMargin:12,boxHeight:null},{colors:[],display:"block",id:null,layout:"default",margin:null});var os,rs,as,ls=(rs=function(t,e){var i,s=document.createElement("div");function n(){var e=t instanceof Element?t:document.querySelector(t);e.appendChild(i.base),i.onMount(e)}return function(t,e,i){var s,n,o;Be.__p&&Be.__p(t,e),n=(s=i===Ue)?null:e.__k,t=Ge(Ye,null,[t]),o=[],ri(e,e.__k=t,n||We,We,void 0!==e.ownerSVGElement,n?null:je.slice.call(e.childNodes),o,!1,We,s),ai(o,t)}(Ge(os,Object.assign({},{ref:function(t){return i=t}},e)),s),"loading"!==document.readyState?n():document.addEventListener("DOMContentLoaded",n),i},rs.prototype=(os=ns).prototype,Object.assign(rs,os),rs.__component=os,rs);!function(t){var e;t.version="5.5.2",t.Color=Oi,t.ColorPicker=ls,(e=t.ui||(t.ui={})).h=Ge,e.ComponentBase=Qi,e.Handle=ts,e.Slider=es,e.Wheel=ss,e.Box=is}(as||(as={}));var cs=as;const hs="wled_studio.color_swatches";function ds(t){return t.trim()||"_default"}function ps(){try{const t=localStorage.getItem(hs);if(!t)return{};const e=JSON.parse(t);return e&&"object"==typeof e?e:{}}catch{return{}}}function us(t){const e=ps()[ds(t)];return Array.isArray(e)?[...e]:[]}function gs(t,e){const i=ps();var s;i[ds(t)]=e.slice(0,32),s=i,localStorage.setItem(hs,JSON.stringify(s))}function fs(t,e){return`${t[0]},${t[1]},${t[2]},${e}`}function _s(t,e){const i="#"+[t[0],t[1],t[2]].map(t=>Math.max(0,Math.min(255,t)).toString(16).padStart(2,"0")).join("");return e>0?`${i} +W`:i.toUpperCase()}let ms=class extends vt{constructor(){super(...arguments),this.controllerId="",this.rgb=[255,128,0],this.white=0,this._swatches=[],this._saving=!1,this._saveName="",this._editingId=null,this._editName="",this._pressTimer=null,this._pressSwatch=null,this._suppressChipClick=!1}onPoweredConnect(){this._reload()}updated(t){super.updated(t),t.has("controllerId")&&this._reload()}_reload(){this._swatches=us(this.controllerId)}_currentKey(){return fs(this.rgb,this.white)}_swatchCss(t){const[e,i,s]=t.rgb;return t.white>0?`linear-gradient(135deg, rgb(${e},${i},${s}) 55%, rgba(255,255,255,0.95) 55%)`:`rgb(${e},${i},${s})`}_apply(t){this.dispatchEvent(new CustomEvent("swatch-select",{detail:{rgb:[...t.rgb],white:t.white},bubbles:!0,composed:!0}))}_openSave(){this._saveName=_s(this.rgb,this.white),this._saving=!0,this._editingId=null}_confirmSave(){!function(t,e){const i=us(t),s=fs(e.rgb,e.white),n=i.find(t=>fs(t.rgb,t.white)===s);if(n)return n.name=e.name.trim()||n.name,gs(t,i),n;const o={id:`sw_${Date.now().toString(36)}_${Math.random().toString(36).slice(2,7)}`,name:e.name.trim()||_s(e.rgb,e.white),rgb:[...e.rgb],white:e.white};i.unshift(o),gs(t,i)}(this.controllerId,{name:this._saveName,rgb:this.rgb,white:this.white}),this._saving=!1,this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_cancelSave(){this._saving=!1}_startEdit(t,e){e.stopPropagation(),this._editingId=t.id,this._editName=t.name,this._saving=!1}_confirmEdit(){this._editingId&&(!function(t,e,i){const s=us(t),n=s.findIndex(t=>t.id===e);if(n<0)return null;const o=s[n],r={...o,...i,rgb:i.rgb?[...i.rgb]:o.rgb};void 0!==i.name&&(r.name=i.name.trim()||_s(r.rgb,r.white)),s[n]=r,gs(t,s)}(this.controllerId,this._editingId,{name:this._editName}),this._editingId=null,this._reload())}_cancelEdit(){this._editingId=null}_delete(t,e){e?.stopPropagation(),function(t,e){const i=us(t).filter(t=>t.id!==e);gs(t,i)}(this.controllerId,t),this._editingId===t&&(this._editingId=null),this._reload(),this.dispatchEvent(new CustomEvent("swatches-changed",{bubbles:!0,composed:!0}))}_clearPressTimer(){null!==this._pressTimer&&(clearTimeout(this._pressTimer),this._pressTimer=null),this._pressSwatch=null}_confirmDelete(t){confirm(`Delete swatch "${t.name}"?`)&&this._delete(t.id),this._suppressChipClick=!1}_onChipTouchStart(t){this._clearPressTimer(),this._pressSwatch=t,this._pressTimer=setTimeout(()=>{this._pressTimer=null,this._suppressChipClick=!0,this._confirmDelete(t)},500)}_onChipTouchEnd(){this._clearPressTimer()}_onChipTouchMove(t){if(!this._pressSwatch||1!==t.touches.length)return;const e=t.touches[0],i=t.currentTarget.getBoundingClientRect();(e.clientX<i.left-12||e.clientX>i.right+12||e.clientY<i.top-12||e.clientY>i.bottom+12)&&this._clearPressTimer()}_onChipClick(t,e){if(this._suppressChipClick)return this._suppressChipClick=!1,e.preventDefault(),void e.stopPropagation();this._apply(t)}render(){const t=this._currentKey();return j`
        ...
        ${0!==this._swatches.length||this._saving?j`
              <div class="grid" role="list">
                ${this._swatches.map(e=>j`
                    <div
                      class="chip-wrap ${fs(e.rgb,e.white)===t?"active":""}"
                      role="listitem"
                    >
                      <button
                        type="button"
    ...
    `]}};t([ht({type:Array,hasChanged:(t,e)=>!t||!e||!function(t,e){return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]}(t,e)})],vs.prototype,"rgb",void 0),t([ht({type:Number})],vs.prototype,"white",void 0),t([ht({type:Number})],vs.prototype,"awm",void 0),t([ht({type:Boolean})],vs.prototype,"showWhite",void 0),t([ht()],vs.prototype,"controllerId",void 0),t([pt(".wheel-host")],vs.prototype,"_host",void 0),vs=t([Ft("wled-color-wheel-rgbw")],vs);function bs(t,e="strip",i,s=0){let n=String(t);return s&&(n=`${n}_p${s}`),i?.trim()&&(n=`${n}_${function(t){return(t||"").trim().replace(/[^\w.-]+/g,"_")||"unknown"}(i)}`),`${n}_${e}.webp`}function ys(t,e,i="strip",s,n=0){const o=e instanceof Set?e:new Set(e);if(!o.size)return;const r=[bs(t,i,s,n),bs(t,i,s),bs(t,i,void 0,n),bs(t,i)];for(const t of r)if(o.has(t))return t;const a=n?`${t}_p${n}_`:`${t}_`,l=`_${i}.webp`;for(const t of o)if(t.startsWith(a)&&t.endsWith(l))return t;return n?ys(t,o,i,s,0):void 0}function ws(t,e,i="strip",s,n,o,r=0){if(!t||e<0)return;const a=void 0!==o?ys(e,o,i,s,r):bs(e,i,s,r);return a?function(t,e){if(!t.startsWith("/"))return t;const i=e?.auth?.data?.access_token;if(!i)return t;const s=t.includes("?")?"&":"?";return`${t}${s}auth=${encodeURIComponent(i)}`}(function(t,e){return`/local/wled_studio/thumbs/${encodeURIComponent(t)}/${encodeURIComponent(e)}`}(t,a),n):void 0}const xs="wled_studio.recent_effects",$s="wled_studio.recent_scenes";function Ss(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function Is(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}function ks(t){return t?Ss(xs)[t]??[]:[]}function Cs(t,e=72,i=6,s=10){if(t<=0)return 1;const n=e+i;return Math.max(1,Math.min(s,Math.floor((t+i)/n)))}const Es="wled_studio.pinned_effects";function Ps(t){try{const e=localStorage.getItem(t);if(!e)return{};const i=JSON.parse(e);return"object"==typeof i&&i?i:{}}catch{return{}}}function As(t,e,i){if(!t)return[];const s=Ps(Es),n=s[t]??[],o=n.findIndex(t=>t.id===e);return o>=0?n.splice(o,1):n.unshift({id:e,name:i}),s[t]=n,function(t,e){try{localStorage.setItem(t,JSON.stringify(e))}catch{}}(Es,s),s[t]}let Ms=class extends vt{constructor(){super(...arguments),this.fxId=0,this.thumbUrl="",this.thumbUrlAnimated="",this.label="",this.listboxOption=!1,this.selected=!1,this._hover=!1}render(){const t=this.thumbUrlAnimated||(this.thumbUrl.endsWith(".webp")?this.thumbUrl:""),e=this.thumbUrl||t,i=this._hover&&t?t:e,s=this.label||`Effect ${this.fxId}`;return j`
      <button
        class="tile"
        type="button"
        aria-label=${s}
    ...
    `]}};t([ht({type:Number})],Ms.prototype,"fxId",void 0),t([ht()],Ms.prototype,"thumbUrl",void 0),t([ht()],Ms.prototype,"thumbUrlAnimated",void 0),t([ht()],Ms.prototype,"label",void 0),t([ht({type:Boolean,attribute:"listbox-option"})],Ms.prototype,"listboxOption",void 0),t([ht({type:Boolean})],Ms.prototype,"selected",void 0),t([dt()],Ms.prototype,"_hover",void 0),Ms=t([Ft("wled-effect-tile")],Ms);let Ts=class extends vt{constructor(){super(...arguments),this.effectsByName={},this.soundFlags=[],this.selectedFx=0,this.filter="",this.controllerId="",this.fwVer="",this.thumbBasenames=[],this.toggleOff=!0,this.showRecents=!0,this.tileGrid=!1,this.scrollPane=!1,this.selectedPalette=0,this.paletteAware=!1,this._category="all",this._recentEntries=[],this._pinnedEntries=[],this._recentVisible=6}onPoweredConnect(){this._loadRecents(),this._ro=new ResizeObserver(()=>this._measureRecents()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._loadRecents();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._recentRowEl&&(this._recentRowEl=e,this._ro?.observe(e),this._measureRecents())}_loadRecents(){var t;this._recentEntries=ks(this.controllerId),this._pinnedEntries=(t=this.controllerId)?Ps(Es)[t]??[]:[],this.soundFlags.length&&!this.soundFlags.some(t=>"v"===t||"f"===t)&&console.debug(`[wled-studio] sound_flags for ${this.controllerId} contain no v/f entries — Music filter will rely on name heuristics`)}_togglePin(t,e){e.stopPropagation(),this.controllerId&&(this._pinnedEntries=As(this.controllerId,t,this._effectName(t)))}_measureRecents(){const t=this._recentRowEl;if(!t)return;const e=Cs(t.clientWidth,76,6,10);e!==this._recentVisible&&(this._recentVisible=e)}_effectName(t){return Object.entries(this.effectsByName).find(([,e])=>e===t)?.[0]??`Effect ${t}`}render(){const t=this.filter.trim().toLowerCase(),e=Object.keys(this.effectsByName).sort((t,e)=>t.localeCompare(e)),i=ve(this.effectsByName),s=e.filter(e=>!!ye(e,this.effectsByName[e],this._category,this.soundFlags,this.effectsByName)&&!(t&&!e.toLowerCase().includes(t))),n=this.showRecents&&!t&&this._recentEntries.length>0,o=this._recentEntries.slice(0,this._recentVisible),r=!t&&this._pinnedEntries.length>0;return j`
      ...
      >
        ...
        <div class="grid" role="listbox" aria-label="Effects">
          ${0===s.length?j`<p class="empty">No effects match this filter.</p>`:s.map(t=>{const e=this.effectsByName[t],s=this.soundFlags[e],n=e===this.selectedFx,o=ws(this.controllerId,e,"strip",this.fwVer,this.hass,this.thumbBasenames,this.paletteAware?this.selectedPalette:0),r=t+("v"===s?" ♪":"")+("f"===s?" ♫":"")+("2"===s?" 2D":"");return o?j`
                    <wled-effect-tile
    ...
    `]}};t([ht({type:Object})],Ts.prototype,"effectsByName",void 0),t([ht({type:Array})],Ts.prototype,"soundFlags",void 0),t([ht({type:Number})],Ts.prototype,"selectedFx",void 0),t([ht({type:String})],Ts.prototype,"filter",void 0),t([ht()],Ts.prototype,"controllerId",void 0),t([ht()],Ts.prototype,"fwVer",void 0),t([ht({type:Array})],Ts.prototype,"thumbBasenames",void 0),t([ht({type:Boolean})],Ts.prototype,"toggleOff",void 0),t([ht({type:Boolean})],Ts.prototype,"showRecents",void 0),t([ht({type:Boolean,attribute:"tile-grid"})],Ts.prototype,"tileGrid",void 0),t([ht({type:Boolean,attribute:"scroll-pane"})],Ts.prototype,"scrollPane",void 0),t([ht({type:Number})],Ts.prototype,"selectedPalette",void 0),t([ht({type:Boolean,attribute:"palette-aware"})],Ts.prototype,"paletteAware",void 0),t([dt()],Ts.prototype,"_category",void 0),t([dt()],Ts.prototype,"_recentEntries",void 0),t([dt()],Ts.prototype,"_pinnedEntries",void 0),t([dt()],Ts.prototype,"_recentVisible",void 0),Ts=t([Ft("wled-effect-chips")],Ts);let Ls=class extends vt{constructor(){super(...arguments),this.controllerId="",this.segments=[],this.editIds=[],this.pixelCount=210,this.compact=!1,this._merged=!1,this._busy=!1,this._error=""}onPoweredConnect(){this._merged=ke(this.controllerId)}willUpdate(t){t.has("controllerId")&&(this._merged=ke(this.controllerId))}render(){const t=Ae(this.controllerId),e=t&&this._merged?`${t.segments.length} segment layout saved`:null;return j`
    ...
    `}async _onToggle(t){const e=t.target.checked;if(this.connection&&this.controllerId){this._busy=!0,this._error="";try{if(e){const t=await kt(this.connection,this.controllerId),e=t.segments??this.segments,i=t.info?.leds,s=Number(i?.count)||this.pixelCount;Me(this.controllerId,e,s);const n=Le(e,s,this.editIds.length?this.editIds:void 0);await Ct(this.connection,this.controllerId,n,{fullResponse:!0}),Pe(this.controllerId,!0),this._merged=!0}else{const t=Ae(this.controllerId);if(!t)throw new Error("No saved segment layout to restore");await Ct(this.connection,this.controllerId,Te(t),{fullResponse:!0}),Pe(this.controllerId,!1),function(t){const e=Se(we);delete e[t],Ie(we,e)}(this.controllerId),this._merged=!1}this.dispatchEvent(new CustomEvent("merge-changed",{detail:{merged:this._merged},bubbles:!0,composed:!0})),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(e){this._error=e instanceof Error?e.message:String(e),t.target.checked=this._merged}finally{this._busy=!1}}}static{this.styles=[...mt,r`
      .merge-row {
        display: flex;
        gap: 10px;
        align-items: flex-start;
    ...
    `]}};t([ht({type:Object})],zs.prototype,"palettesByName",void 0),t([ht({type:Object})],zs.prototype,"palettePreviews",void 0),t([ht({type:Number})],zs.prototype,"selectedPal",void 0),t([ht()],zs.prototype,"filter",void 0),t([ht()],zs.prototype,"deviceHost",void 0),t([ht({type:Boolean})],zs.prototype,"compact",void 0),t([ht({type:Boolean,attribute:"collapsible"})],zs.prototype,"collapsible",void 0),t([dt()],zs.prototype,"_open",void 0),t([dt()],zs.prototype,"_localFilter",void 0),t([dt()],zs.prototype,"_editorOpen",void 0),zs=t([Ft("wled-palette-chips")],zs);let Bs=class extends vt{constructor(){super(...arguments),this.presets=[]}render(){const t=this.presets.filter(t=>t.ql),e=this.presets.filter(t=>!t.ql||t.name);return j`
    ...
    `]}};t([ht({type:Array})],Bs.prototype,"presets",void 0),Bs=t([Ft("wled-preset-bar")],Bs);const Rs=["For each","Bar","Arc","Corner"],Ds=["Replace","Add","Subtract","Multiply","Lighten","Darken"],Fs=["Off","GEQ pulse","WaveSin","Sweep"];let Us=class extends vt{constructor(){super(...arguments),this.compact=!1}_emit(t){this.dispatchEvent(new CustomEvent("segment-patch",{detail:t,bubbles:!0,composed:!0}))}_num(t,e,i,s){const n=this.segment;if(!n)return null;const o=n[t]??i;return j`
      <label class="cell">
    ...
    `}render(){if(!this.segment)return null;const t=this.meta,e=[];for(const i of["o1","o2","o3"])if(t?.sliders?.[i]){const s="string"==typeof t.defaults?.[i]&&t.defaults[i].trim()?t.defaults[i]:i.toUpperCase();e.push({key:i,label:s})}return j`
      <details class="adv" ?open=${!this.compact}>
        ...
        ${e.length?j`
            ...
            `:null}
        <div class="grid">
          ${this._select("si","Sound simulation",Fs)}
          ${this._select("m12","1D-in-2D mode",Rs)}
          ${this._select("bm","Blend mode",Ds)}
        </div>
      </details>
    `}static{this.styles=[...mt,r`
      .adv {
    ...
    `]}};t([ht({attribute:!1})],Us.prototype,"segment",void 0),t([ht({attribute:!1})],Us.prototype,"meta",void 0),t([ht({type:Boolean})],Us.prototype,"compact",void 0),Us=t([Ft("wled-segment-advanced")],Us);let Ws=class extends vt{constructor(){super(...arguments),this.width="100%",this.height="1rem",this.roundedFull=!1}render(){return j`
      <div
    ...
    `}render(){if(this._loading)return this._renderSkeleton();if(this._error)return j`<p class="err">${this._error}</p>`;const t=this._activeSeg();if(!t)return j`<p class="muted">No segments on this controller.</p>`;const e=this._cols(t),i=e[this._colorSlot]??e[0],s=this._meta,n=s?.sliders??{},o=!1!==s?.colors_enabled?3:1,r=this._snapshot?.rgbwm??0;return j`
      <div class="controls ${this.compact?"compact":""}">
          ...
          ${this._segments.map(t=>j`
              ...
              >
                ${this.compact?null:j`
                    ...
                    `}
                <span class="seg-label">${le(t,this._snapshot?.segment_entities??[])}</span>
              </button>
            `)}
        </div>
            `}
        ...
        <div class="sliders">
          ${Object.entries(js).map(([e,i])=>{if(!n[e])return null;const s=t[e];return j`
              <label>
                ${i}
                <ha-slider
                  min="0"
    ...
    `}async _confirmSaveScene(){if(this.connection&&this.controllerId&&this._saveSceneName.trim())try{await re(this.connection,this.controllerId,this._saveSceneName.trim()),this._saveSceneOpen=!1,ie(this,`Scene "${this._saveSceneName.trim()}" saved`)}catch(t){ie(this,t instanceof Error?t.message:String(t))}}get segments(){return this._segments}static{this.styles=[...mt,r`
      .controls {
        display: flex;
        flex-direction: column;
        gap: 10px;
    ...
    `]}};t([ht({attribute:!1})],Hs.prototype,"connection",void 0),t([ht({attribute:!1})],Hs.prototype,"hass",void 0),t([ht()],Hs.prototype,"controllerId",void 0),t([ht({type:Boolean})],Hs.prototype,"compact",void 0),t([ht({type:Boolean})],Hs.prototype,"wholeMode",void 0),t([ht({type:Boolean,attribute:"hide-segment-brightness"})],Hs.prototype,"hideSegmentBrightness",void 0),t([ht({type:Number})],Hs.prototype,"selectedSegId",void 0),t([ht()],Hs.prototype,"masterEntity",void 0),t([dt()],Hs.prototype,"_loading",void 0),t([dt()],Hs.prototype,"_error",void 0),t([dt()],Hs.prototype,"_segId",void 0),t([dt()],Hs.prototype,"_editIds",void 0),t([dt()],Hs.prototype,"_segments",void 0),t([dt()],Hs.prototype,"_snapshot",void 0),t([dt()],Hs.prototype,"_meta",void 0),t([dt()],Hs.prototype,"_effectFilter",void 0),t([dt()],Hs.prototype,"_presets",void 0),t([dt()],Hs.prototype,"_colorSlot",void 0),t([dt()],Hs.prototype,"_mergeActive",void 0),t([dt()],Hs.prototype,"_saveSceneOpen",void 0),t([dt()],Hs.prototype,"_saveSceneName",void 0),Hs=t([Ft("wled-segment-controls")],Hs);let qs=class extends vt{constructor(){super(...arguments),this.segments=[],this.selectedIds=[],this.segmentEntities=[],this.hint="Tap segments to toggle",this._dragSegId=null}render(){return this.segments.length?j`
      <div class="block">
        ...
        <div class="bar" role="group" aria-label="Segments">
          ${this.segments.map(t=>j`
              ...
              >
                ...
                <span class="btn-label">${le(t,this.segmentEntities)}</span>
              </button>
            `)}
        </div>
      </div>
    ...
    `]}};t([ht({type:Array})],qs.prototype,"segments",void 0),t([ht({type:Array})],qs.prototype,"selectedIds",void 0),t([ht({type:Array})],qs.prototype,"segmentEntities",void 0),t([ht()],qs.prototype,"hint",void 0),t([dt()],qs.prototype,"_dragSegId",void 0),qs=t([Ft("wled-segment-bar")],qs);const Vs={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let Gs=class extends vt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this._segments=[],this._editIds=[],this._focusSegId=0,this._filter="",this._status="Loading effects…",this._mergeActive=!1,this._library=[],this._saveCopyOpen=!1,this._saveCopyName="",this._saveSceneOpen=!1,this._saveSceneName="",this._needsMergeApply=!1}onPoweredConnect(){this._mergeActive=ke(this.controllerId),this._library=fe(this.controllerId),this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}async _refreshPalettePreviews(){if(this.connection&&this.controllerId&&this._snapshot)try{const t=await Pt(this.connection,this.controllerId);this._snapshot={...this._snapshot,palette_previews:t}}catch{}}_onPaletteCatalogChanged(){this._refreshPalettePreviews()}async _load(){if(this.connection&&this.controllerId){this._status="Loading effects…";try{if(this._snapshot=await kt(this.connection,this.controllerId),this._segments=[...this._snapshot.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length){const t=this._segments.map(t=>t.id),e=this._editIds.filter(e=>t.includes(e));this._editIds=e.length?e:t,t.includes(this._focusSegId)||(this._focusSegId=this._segments[0].id)}const t=this._pixelCount();this._mergeActive=ke(this.controllerId);const e=Ee(this._segments,t);this._needsMergeApply=this._mergeActive&&this._segments.length>1&&!e,Ce(this.controllerId)&&e&&(this._editIds=Ne(this._segments),this._focusSegId=this._editIds[0]??0),await this._refreshMeta(),this._status="",this._emitTargetsChanged()}catch{this._status="Could not load device state."}}}get highlightSegmentIds(){return this._targetIds()}_emitTargetsChanged(){this.dispatchEvent(new CustomEvent("segment-targets-changed",{detail:{segmentId:this._focusSegId,editIds:[...this._editIds],mergeActive:this._mergeActive,highlightIds:this.highlightSegmentIds},bubbles:!0,composed:!0}))}async confirmMergeApply(){await this._applyMergeOnDevice(this._pixelCount()),this._needsMergeApply=!1,await this._load()}async _applyMergeOnDevice(t){if(!this.connection||!this.controllerId||!this._snapshot)return;Me(this.controllerId,this._segments,t);const e=Le(this._segments,t,this._editIds.length?this._editIds:void 0);await Ct(this.connection,this.controllerId,e,{fullResponse:!0}),Pe(this.controllerId,!0),this._snapshot=await kt(this.connection,this.controllerId),this._segments=[...this._snapshot.segments??[]].sort((t,e)=>t.id-e.id)}_activeSeg(){return this._segments.find(t=>t.id===this._focusSegId)??this._segments[0]}async _refreshMeta(){const t=this._activeSeg();this.connection&&this.controllerId&&t&&(this._meta=await Et(this.connection,this.controllerId,t.fx??0))}selectSegmentFromPreview(t){if(this._mergeActive)return this._focusSegId=0,this._refreshMeta(),void this._emitTargetsChanged();this._editIds.includes(t)||(this._editIds=[...this._editIds,t].sort((t,e)=>t-e)),this._focusSegId=t,this._refreshMeta(),this._emitTargetsChanged()}_onSegToggle(t){if(this._mergeActive)return;let e=ae(this._editIds,t.detail.id);e.length||(e=[t.detail.id]),this._editIds=e,this._focusSegId=t.detail.id,this._refreshMeta(),this._emitTargetsChanged()}_pixelCount(){const t=this._snapshot?.info?.leds;return Number(t?.count)||210}_targetIds(){if(this._mergeActive){const t=Ne(this._segments);return t.length?t:[0]}return this._editIds.length?this._editIds:[this._focusSegId]}_onMergeChanged(){this._mergeActive=ke(this.controllerId),this._load(),this._emitTargetsChanged()}_effectName(t){return Object.entries(this._snapshot?.effects_by_name??{}).find(([,e])=>e===t)?.[0]??`Effect ${t}`}_sliderValuesFromSeg(){const t=this._activeSeg();return t?function(t){const e={};for(const i of["sx","ix","c1","c2","c3","o1","o2","o3"]){const s=t[i];"number"==typeof s&&(e[i]=s)}return e}(t):{}}_saveAsDefault(){const t=this._activeSeg();t&&this.controllerId&&(!function(t,e,i){if(!t)return;const s=pe(ce),n={...s[t]??{}};n[String(e)]={...i},s[t]=n,ue(ce,s)}(this.controllerId,t.fx??0,this._sliderValuesFromSeg()),ie(this,`Saved default options for ${this._effectName(t.fx??0)}`))}_openSaveCopy(){const t=this._activeSeg();t&&(this._saveCopyName=`${this._effectName(t.fx??0)} copy`,this._saveCopyOpen=!0)}_confirmSaveCopy(){const t=this._activeSeg();t&&this.controllerId&&this._saveCopyName.trim()&&(!function(t,e){const i={...e,id:`fx-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,savedAt:Date.now()},s=pe(he),n=[i,...s[t]??[]];s[t]=n.slice(0,48),ue(he,s)}(this.controllerId,{name:this._saveCopyName.trim(),effectId:t.fx??0,effectName:this._effectName(t.fx??0),pinned:!0,...this._sliderValuesFromSeg()}),this._library=fe(this.controllerId),this._saveCopyOpen=!1,ie(this,`Saved "${this._saveCopyName.trim()}" to library`))}_openSaveScene(){const t=this._activeSeg();t&&(this._saveSceneName=`${this._effectName(t.fx??0)} scene`,this._saveSceneOpen=!0)}async _confirmSaveScene(){if(this.connection&&this.controllerId&&this._saveSceneName.trim())try{await re(this.connection,this.controllerId,this._saveSceneName.trim()),this._saveSceneOpen=!1,ie(this,`Scene "${this._saveSceneName.trim()}" saved`)}catch(t){ie(this,t instanceof Error?t.message:String(t))}}async _applyLibraryEntry(t){if(!this.connection||!this._snapshot)return;const e=this._targetIds(),i={fx:t.effectId,on:!0};for(const e of["sx","ix","c1","c2","c3","o1","o2","o3"]){const s=t[e];"number"==typeof s&&(i[e]=s)}const s=Nt(e,i,this._segments);await Ct(this.connection,this.controllerId,s),await this._load(),ie(this,`Applied ${t.name}`)}_isLoading(){return"Loading effects…"===this._status}_renderSkeleton(){return j`
              ...
              <div class="merge-prompt">
                ...
                <div class="merge-prompt-row">
                  ...
                  <button
                    type="button"
                    class="ghost"
                    @click=${()=>{Pe(this.controllerId,!1),this._mergeActive=!1,this._needsMergeApply=!1,this._emitTargetsChanged()}}
                  >
              ...
              <div class="effects-workspace ${r?"compact":""}">
                ...
                <div class="effects-tuning">
                  ...
                  <div class="sliders ${r?"compact":""}">
                    ${Object.entries(Vs).map(([t,i])=>{if(!n[t])return null;const s=e[t];return j`
                        <label>
                          ${i}
                          <ha-slider
                            min="0"
    ...
    `}async _onFx(t,e){if(!this.connection||!this._snapshot)return;const i=this._targetIds(),s=Nt(i,{fx:t,on:!0},this._segments);try{await Ct(this.connection,this.controllerId,s);for(const e of i){const i=this._segments.findIndex(t=>t.id===e);if(i>=0){const e=[...this._segments];e[i]={...e[i],fx:t,on:!0},this._segments=e}}this._focusSegId=i[0],await this._refreshMeta();const n=Object.entries(this._snapshot.effects_by_name).find(([,e])=>e===t)?.[0]??(e?"Solid":`#${t}`),o=ge(this.controllerId,t);if(o&&Object.keys(o).length){const t=Nt(i,o,this._segments);await Ct(this.connection,this.controllerId,t)}ie(this,e?`Solid on ${i.length} segment(s)`:`Applied ${n}`),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(t){ie(this,`Apply failed: ${t.message||"error"}`)}}_slider(t,e){const i=de(Number(e.target.value));null!==i&&this._segPatch({[t]:i})}async _segPatch(t){if(!this.connection||!this._snapshot)return;const e=this._targetIds(),i=Nt(e,t,this._segments);try{await Ct(this.connection,this.controllerId,i)}catch(t){return void ie(this,`Apply failed: ${t.message||"error"}`)}const s=[...this._segments];for(const i of e){const e=s.findIndex(t=>t.id===i);e>=0&&(s[e]={...s[e],...t})}this._segments=s}static{this.styles=[...mt,r`
      .wrap {
        max-width: 100%;
      }
      :host {
    ...
    `]}};function Xs(t,e){return Math.max(0,Math.min(255,Math.round(t*e)))}function Ys(t,e,i){return`rgb(${t}, ${e}, ${i})`}function Js(t){return function(t){if(!t.length)return"linear-gradient(135deg, var(--wled-surface-elevated), var(--wled-surface))";if(1===t.length){const e=t[0];return`linear-gradient(135deg, ${e}, color-mix(in srgb, ${e} 55%, rgb(0 0 0)))`}const e=t.map((e,i)=>`${e} ${Math.round(i/(t.length-1)*100)}%`).join(", ");return`linear-gradient(135deg, ${e})`}(function(t){const e=t??{};if(!1===e.on)return["rgb(26, 26, 26)","rgb(13, 13, 13)"];const i="number"==typeof e.bri&&Number.isFinite(e.bri)?Math.max(0,Math.min(255,e.bri)):128,s=(Array.isArray(e.seg)?e.seg:[])[0]??{};if(!1===s.on)return["rgb(26, 26, 26)","rgb(13, 13, 13)"];const n=("number"==typeof s.bri&&Number.isFinite(s.bri)?Math.max(0,Math.min(255,s.bri)):i)/255,o=[];if(Array.isArray(s.col))for(const t of s.col.slice(0,3)){const[e,i,s]=At(t);o.push(Ys(Xs(e,n),Xs(i,n),Xs(s,n)))}if(!o.length){const t=Xs(255,n),e=Xs(220,n);o.push(Ys(t,e,Math.min(255,e-20)))}return o}(t.wled_state))}function Ks(t){return Boolean(t.scene_thumb_url?.trim())}t([ht({attribute:!1})],Gs.prototype,"connection",void 0),t([ht()],Gs.prototype,"controllerId",void 0),t([ht({type:Boolean,reflect:!0})],Gs.prototype,"compact",void 0),t([dt()],Gs.prototype,"_snapshot",void 0),t([dt()],Gs.prototype,"_segments",void 0),t([dt()],Gs.prototype,"_editIds",void 0),t([dt()],Gs.prototype,"_focusSegId",void 0),t([dt()],Gs.prototype,"_filter",void 0),t([dt()],Gs.prototype,"_status",void 0),t([dt()],Gs.prototype,"_meta",void 0),t([dt()],Gs.prototype,"_mergeActive",void 0),t([dt()],Gs.prototype,"_library",void 0),t([dt()],Gs.prototype,"_saveCopyOpen",void 0),t([dt()],Gs.prototype,"_saveCopyName",void 0),t([dt()],Gs.prototype,"_saveSceneOpen",void 0),t([dt()],Gs.prototype,"_saveSceneName",void 0),t([dt()],Gs.prototype,"_needsMergeApply",void 0),Gs=t([Ft("wled-view-effects")],Gs);let Zs=class extends vt{constructor(){super(...arguments),this.controllerId="",this.scenes=[],this.disabled=!1,this._recents=[],this._visibleCount=6}onPoweredConnect(){this._reload(),this._ro=new ResizeObserver(()=>this._measure()),this.addUnsub(()=>this._ro?.disconnect())}updated(t){t.has("controllerId")&&this._reload();const e=this.renderRoot.querySelector(".recent-row");e&&e!==this._rowEl&&(this._rowEl=e,this._ro?.observe(e),this._measure())}reload(){this._reload()}_reload(){var t;this._recents=(t=this.controllerId)?Ss($s)[t]??[]:[]}_measure(){const t=this._rowEl;if(!t)return;const e=Cs(t.clientWidth,104,8,8);e!==this._visibleCount&&(this._visibleCount=e)}_sceneFor(t){return this.scenes.find(e=>e.id===t)}render(){const t=this._recents.filter(t=>this.scenes.some(e=>e.id===t.id)).slice(0,this._visibleCount);return t.length?j`
      <div class="block">
        <span class="label">Recent scenes</span>
        <div class="recent-row" role="group" aria-label="Recent scenes">
          ${t.map(t=>{const e=this._sceneFor(t.id),i=e?.name??t.name,s=e?Js(e):"linear-gradient(135deg, var(--wled-surface-elevated), var(--wled-surface))",n=e&&Ks(e)?e.scene_thumb_url.trim():"";return j`
              <button
                type="button"
                class="chip"
    ...
    `]}};t([ht()],Zs.prototype,"controllerId",void 0),t([ht({type:Array})],Zs.prototype,"scenes",void 0),t([ht({type:Boolean})],Zs.prototype,"disabled",void 0),t([dt()],Zs.prototype,"_recents",void 0),t([dt()],Zs.prototype,"_visibleCount",void 0),Zs=t([Ft("wled-recent-scenes-row")],Zs);let Qs=class extends vt{constructor(){super(...arguments),this.controllerId="",this.compact=!1,this._scenes=[],this._status="Loading scenes…",this._busy=!1,this._captureName="",this._segments=[],this._applySegIds=[]}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load()}onPoweredDisconnect(){this._applyAbort?.abort(),this._applyAbort=void 0}async _load(){if(this.connection&&this.controllerId){this._status="Loading scenes…";try{const[t,e]=await Promise.all([oe(this.connection,this.controllerId),kt(this.connection,this.controllerId)]);if(this._scenes=t,this._snapshot=e,this._segments=[...e.segments??[]].sort((t,e)=>t.id-e.id),this._segments.length&&!this._applySegIds.length)this._applySegIds=this._segments.map(t=>t.id);else{const t=new Set(this._segments.map(t=>t.id));this._applySegIds=this._applySegIds.filter(e=>t.has(e)),!this._applySegIds.length&&this._segments.length&&(this._applySegIds=this._segments.map(t=>t.id))}this._status=0===this._scenes.length?"No scenes yet — capture the current look or use starter scenes after reload.":""}catch{this._status="Could not load scenes."}}}selectSegmentFromPreview(t){this._toggleApplySeg(t)}_toggleApplySeg(t){let e=ae(this._applySegIds,t);e.length||(e=[t]),this._applySegIds=e}_isLoading(){return"Loading scenes…"===this._status}_renderSkeleton(){return j`
    ...
    `}_sceneTile(t){const e=t.transition_ms??2500,i=Js(t),s=Ks(t)?t.scene_thumb_url.trim():"";return j`
    ...
    `}_recentScenesRow(){return this.renderRoot.querySelector("wled-recent-scenes-row")??null}async _apply(t){if(this.connection){this._busy=!0,this._applyAbort?.abort(),this._applyAbort=new AbortController;try{const e=this._segments.length>0&&this._applySegIds.length===this._segments.length;await async function(t,e,i,s){await $t(t);const n={type:"wled_studio/scene_apply",schema_version:1,controller_id:e,scene_id:i,transition_ms:s?.transitionMs,segment_ids:s?.segmentIds?.length?s.segmentIds:void 0};return s?.signal?new Promise((e,i)=>{const o=()=>i(new DOMException("Aborted","AbortError"));s.signal?.aborted?o():(s.signal?.addEventListener("abort",o,{once:!0}),t.sendMessagePromise(n).then(t=>{s.signal?.removeEventListener("abort",o),e(t.state??{})}).catch(t=>{s.signal?.removeEventListener("abort",o),i(t)}))}):(await t.sendMessagePromise(n)).state??{}}(this.connection,this.controllerId,t.id,{signal:this._applyAbort.signal,segmentIds:e?void 0:[...this._applySegIds]}),function(t,e,i){if(!t)return[];const s=Ss($s),n=(s[t]??[]).filter(t=>t.id!==e);n.unshift({id:e,name:i}),s[t]=n.slice(0,10),Is($s,s),s[t]}(this.controllerId,t.id,t.name),this._recentScenesRow()?.reload(),await this._load(),ie(this,`Applied ${t.name}`),this.dispatchEvent(new CustomEvent("wled-preview-refresh",{bubbles:!0,composed:!0}))}catch(t){if("AbortError"!==t.name){ie(this,`Apply failed: ${t.message||t.message||"error"}`)}}finally{this._busy=!1}}}async _capture(){if(!this.connection)return;const t=this._captureName.trim();if(t){this._busy=!0;try{const e=await re(this.connection,this.controllerId,t);this._captureName="",ie(this,`Saved ${e.name}`),await this._load()}catch(e){ie(this,e instanceof se?`"${t}" was changed on another device — reload and save again.`:`Save failed: ${e.message||"error"}`)}finally{this._busy=!1}}}async _delete(t){if(this.connection&&confirm(`Delete scene "${t.name}"?`)){this._busy=!0;try{await async function(t,e,i){await ne(t,{type:"wled_studio/scene_delete",controller_id:e,scene_id:i})}(this.connection,this.controllerId,t.id),ie(this,`Deleted ${t.name}`),await this._load()}catch{ie(this,"Delete failed")}finally{this._busy=!1}}}_dismissConflict(){this._conflict=void 0,this._load()}async _overwriteConflict(){if(!this.connection||!this._conflict)return;const t=this._scenes.find(t=>t.id===this._conflict?.id);if(t){this._busy=!0;try{await async function(t,e,i,s){try{return(await ne(t,{type:"wled_studio/scene_save",controller_id:e,scene:i,if_match_etag:s?.ifMatchEtag})).scene??i}catch(t){const e=t;if("conflict"===e?.code&&e.data?.scene)throw new se(e.data.scene,String(e.data.etag??e.message??""));throw t}}(this.connection,this.controllerId,t,{ifMatchEtag:this._conflict.etag}),this._conflict=void 0,ie(this,"Scene overwritten"),await this._load()}catch(t){t instanceof se?this._conflict=t.remote:ie(this,`Overwrite failed: ${t.message||"error"}`)}finally{this._busy=!1}}}static{this.styles=[...mt,r`
      .wrap {
        max-width: 960px;
      }
      .wrap.compact {
    ...
    `]}};function tn(t=0,e=[255,51,102,0]){return{on:!0,bri:255,fx:t,pal:0,col:e,sx:128,ix:128,c1:128,c2:128,c3:128,o1:!1,o2:!1,o3:!1}}function en(t="off"){return{mode:t,on:"off"!==t,bri:"off"===t?0:128,fx:0,pal:0,col:"custom"===t?[72,72,72,0]:[0,0,0,0],sx:128,ix:128,c1:128,c2:128,c3:128,o1:!1,o2:!1,o3:!1}}function sn(t,e){const i=e.Solid??0;return t.fx===i?"color":"effect"}async function nn(t,e){await $t(t);try{return await t.sendMessagePromise({...e,schema_version:1})}catch(t){throw new Error(_e(t))}}async function on(t,e,i,s){const n=function(t){let e="";for(let i=0;i<t.length;i+=32768){const s=t.subarray(i,i+32768);e+=String.fromCharCode(...s)}return btoa(e)}(i),o=s?.brush,r=s?.fill,a=o?sn(o,s?.effectsByName??{}):"color";await nn(t,{type:"wled_studio/paint_frame",controller_id:e,data:n,rgbw:s?.rgbw??!0,paint_mode:a,...s?.touched?.length?{touched:s.touched}:{},...o?{brush:o}:{},...r?{fill:r}:{},..."effect"===a&&o?{effect_id:o.fx}:{}})}async function rn(t,e,i=!0){await nn(t,{type:"wled_studio/paint_stop",controller_id:e,commit:i})}function an(t,e,i){const s=i?4:3,n=new Uint8ClampedArray(4*e);for(let o=0;o<e;o++){const e=o*s,r=4*o;n[r]=t[e]??0,n[r+1]=t[e+1]??0,n[r+2]=t[e+2]??0,n[r+3]=i?t[e+3]??0:255}return n}t([ht({attribute:!1})],Qs.prototype,"connection",void 0),t([ht()],Qs.prototype,"controllerId",void 0),t([ht({type:Boolean})],Qs.prototype,"compact",void 0),t([dt()],Qs.prototype,"_scenes",void 0),t([dt()],Qs.prototype,"_status",void 0),t([dt()],Qs.prototype,"_busy",void 0),t([dt()],Qs.prototype,"_conflict",void 0),t([dt()],Qs.prototype,"_captureName",void 0),t([dt()],Qs.prototype,"_segments",void 0),t([dt()],Qs.prototype,"_applySegIds",void 0),t([dt()],Qs.prototype,"_snapshot",void 0),Qs=t([Ft("wled-view-scenes")],Qs);const ln={sx:"Speed",ix:"Intensity",c1:"Custom 1",c2:"Custom 2",c3:"Custom 3",o1:"Option 1",o2:"Option 2",o3:"Option 3"};let cn=class extends vt{constructor(){super(...arguments),this.controllerId="",this.heading="Brush",this.showOnToggle=!1,this._loadingEffects=!0,this._error="",this._effectFilter=""}onPoweredConnect(){this._load()}willUpdate(t){(t.has("connection")||t.has("controllerId"))&&this.connection&&this.controllerId&&this._load(),t.has("settings")&&void 0!==this.settings?.fx&&this._refreshMeta()}async _load(){if(this.connection&&this.controllerId){this._loadingEffects=!0,this._error="";try{this._snapshot=await kt(this.connection,this.controllerId),await this._refreshMeta()}catch(t){this._error=_e(t)}finally{this._loadingEffects=!1}}}async _refreshMeta(){this.connection&&this.controllerId&&this.settings&&(this._meta=await Et(this.connection,this.controllerId,this.settings.fx))}_emit(t){const e={...this.settings,...t};this.dispatchEvent(new CustomEvent("settings-change",{detail:e,bubbles:!0,composed:!0}))}_onColor(t){const{rgb:e,white:i}=t.detail,s={col:[e[0],e[1],e[2],i]};"Fill look"!==this.heading&&(s.fx=ve(this._snapshot?.effects_by_name??{})),this._emit(s)}async _onEffectSelect(t){this._emit({fx:t.detail.effectId}),await this._refreshMeta()}_slider(t,e){const i=e.target.value;if(t.startsWith("o"))return void this._emit({[t]:Number(i)>0});const s=de(Number(i));null!==s&&this._emit({[t]:s})}render(){if(!this.settings)return null;const t=At(this.settings.col),e=this._meta,i=e?.sliders??{},s=this._snapshot?.rgbwm??0;return j`
      <div class="block">
        ...
        ${this._loadingEffects?j`<p class="muted">Loading effects…</p>`:j`
              ...
              <div class="sliders">
                ${Object.entries(ln).map(([t,e])=>{if(!i[t])return null;const s=this.settings[t];return"boolean"==typeof s?j`
                      <label class="row">
                        <input
                          type="checkbox"
                          .checked=${s}
    ...
    `]}};t([ht({attribute:!1})],cn.prototype,"connection",void 0),t([ht({attribute:!1})],cn.prototype,"hass",void 0),t([ht()],cn.prototype,"controllerId",void 0),t([ht()],cn.prototype,"heading",void 0),t([ht({attribute:!1})],cn.prototype,"settings",void 0),t([ht({type:Boolean})],cn.prototype,"showOnToggle",void 0),t([dt()],cn.prototype,"_loadingEffects",void 0),t([dt()],cn.prototype,"_error",void 0),t([dt()],cn.prototype,"_snapshot",void 0),t([dt()],cn.prototype,"_meta",void 0),t([dt()],cn.prototype,"_effectFilter",void 0),cn=t([Ft("wled-paint-settings")],cn);let hn=class extends vt{constructor(){super(...arguments),this.controllerId="",this.embedMode=!1,this.embedLayoutId="",this.embedFixtureId="",this.embedPixelCount=0,this._pixelCount=210,this._rgbw=!0,this._active=!1,this._brush=tn(),this._fill=en("off"),this._brushSize=6,this._status="",this._warn="",this._effectsByName={},this._layouts=[],this._layoutId="",this._fixtureId="",this._buffer=null,this._previewPixels=null,this._touched=new Set,this._flushInFlight=!1,this._flushQueued=!1,this._flushColor=function(t,e){let i,s,n=0;const o=(...o)=>{s=o;const r=Date.now(),a=r-n;if(a>=e)return n=r,i&&(clearTimeout(i),i=void 0),void t(...o);i||(i=setTimeout(()=>{i=void 0,n=Date.now(),s&&t(...s)},e-a))};return o.cancel=()=>{i&&clearTimeout(i),i=void 0,s=void 0},o}(()=>{this._flushNow()},20),this._flushEffect=It(()=>{this._flushNow()},60,180)}_previewEl(){return this.embedMode?this._externalPreview:this._internalPreview}get brushSize(){return this._brushSize}get paintLivePreview(){return this._brushIsEffect()}get paintExternalLive(){return!this._brushIsEffect()}bindExternalPreview(t){this._externalPreview=t,t&&this._active&&t.setStatus("live paint"),t&&this._previewPixels?this._syncPreviewPixels():t&&t.refresh()}handleExternalPaintStroke(t){this._onPaintStroke(t)}_emitPaintConfig(){this.dispatchEvent(new CustomEvent("paint-config-change",{bubbles:!0,composed:!0}))}_brushIsEffect(){return"effect"===sn(this._brush,this._effectsByName)}updated(t){(t.has("_fill")||t.has("_brush")||t.has("_buffer")||t.has("_layoutId"))&&(this._applyFillToBuffer(),this._brushIsEffect()?this._previewEl()?.setPaintPixels(null):this._syncPreviewPixels()),(t.has("_brush")||t.has("_brushSize"))&&(this.requestUpdate(),this._emitPaintConfig()),this.embedMode&&(t.has("embedLayoutId")||t.has("embedFixtureId")||t.has("embedPixelCount"))&&(this.embedLayoutId&&(this._layoutId=this.embedLayoutId),this.embedFixtureId&&(this._fixtureId=this.embedFixtureId),this.embedPixelCount>0&&(this._pixelCount=this.embedPixelCount),this._previewEl()?.refresh())}async onPoweredConnect(){if(this.connection&&this.controllerId)try{const[t,e]=await Promise.all([kt(this.connection,this.controllerId),zt(this.connection,this.controllerId)]),i=t.info?.leds;i?.count&&(this._pixelCount=i.count),"boolean"==typeof i?.rgbw&&(this._rgbw=i.rgbw),this._effectsByName=t.effects_by_name??{};const s=t.segments?.[0];if(s){const t=s.col?.[0],e=Array.isArray(t)&&t.length>=3?[t[0],t[1],t[2],t[3]??0]:void 0;this._brush=tn(s.fx??0,e)}this._layouts=e,this.embedMode&&this.embedLayoutId?(this._layoutId=this.embedLayoutId,this._fixtureId=this.embedFixtureId||"fixture-0",this.embedPixelCount>0&&(this._pixelCount=this.embedPixelCount)):this._applyLayout(e[0]),this._allocBuffer(),this._status=this.embedMode?this._layoutId?"Drag on the strip preview to paint":"Create a layout in Studio → Layout first":e.length?"Drag on the layout to paint":"Create a layout in the Layout tab first"}catch(t){this._status=_e(t)}}_applyLayout(t){if(!t)return this._layoutId="",void(this._fixtureId="");this._layoutId=t.id;const e=t.fixtures[0];this._fixtureId=e?String(e.id??"fixture-0"):"fixture-0",t.pixel_count&&(this._pixelCount=t.pixel_count),this._previewEl()?.refresh()}_onLayoutPick(t){const e=t.target.value,i=this._layouts.find(t=>t.id===e);this._applyLayout(i),this._allocBuffer()}async onPoweredDisconnect(){if(this._flushColor.cancel(),this._flushEffect.cancel(),this._active&&this.connection&&this.controllerId)try{await rn(this.connection,this.controllerId,!1)}catch{}this._active=!1,this._touched.clear()}async _ensureSession(){if(this._active||!this.connection||!this.controllerId)return this._active;try{const t=await async function(t,e){return nn(t,{type:"wled_studio/paint_start",controller_id:e})}(this.connection,this.controllerId);return this._active=!0,this._touched.clear(),this._warn=t.wifi_sleep_warning??"",t.pixel_count&&(this._pixelCount=t.pixel_count),"boolean"==typeof t.rgbw&&(this._rgbw=t.rgbw),this._allocBuffer(),this._previewEl()?.setStatus("live paint"),this._status="Live paint",!0}catch(t){return this._status=_e(t),!1}}_allocBuffer(){const t=this._rgbw?4:3;this._buffer=new Uint8Array(this._pixelCount*t),this._previewPixels=null,this._applyFillToBuffer(),this._syncPreviewPixels()}_syncPreviewPixels(t){const e=this._previewEl();if(!this._buffer||!e)return;if(!this._previewPixels||this._previewPixels.length!==4*this._pixelCount)this._previewPixels=an(this._buffer,this._pixelCount,this._rgbw);else if(t?.length){const e=this._rgbw?4:3,i=this._previewPixels;for(const s of t){const t=s*e,n=4*s;i[n]=this._buffer[t]??0,i[n+1]=this._buffer[t+1]??0,i[n+2]=this._buffer[t+2]??0,i[n+3]=this._rgbw?this._buffer[t+3]??0:255}}else this._previewPixels=an(this._buffer,this._pixelCount,this._rgbw);e.setPaintPixels(this._previewPixels)}_brushRgb(){const t=Math.max(0,Math.min(255,this._brush.bri))/255;return[Math.round(this._brush.col[0]*t),Math.round(this._brush.col[1]*t),Math.round(this._brush.col[2]*t)]}async cancelLiveIfActive(){if(!this._active||!this.connection||!this.controllerId)return!1;this._flushColor.cancel(),this._flushEffect.cancel();try{await rn(this.connection,this.controllerId,!1),this._status="Live paint ended — layout segments restored",this._previewEl()?.setStatus("ready")}catch(t){return this._status=_e(t),!1}return this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels(),this.dispatchEvent(new CustomEvent("wled-paint-ended",{bubbles:!0,composed:!0})),this._emitPaintConfig(),!0}_writeLed(t,e){if(!this._buffer)return;const i=t*(this._rgbw?4:3);this._buffer[i]=e[0],this._buffer[i+1]=e[1],this._buffer[i+2]=e[2],this._rgbw&&(this._buffer[i+3]=0)}_applyFillToBuffer(){if(!this._buffer)return;const t="off"===this._fill.mode?[0,0,0]:"custom"===this._fill.mode?[this._fill.col[0],this._fill.col[1],this._fill.col[2]]:[40,40,40];for(let e=0;e<this._pixelCount;e++)this._touched.has(e)||this._writeLed(e,t)}_scheduleFlush(){this._brushIsEffect()?this._flushEffect():this._flushColor()}_strokeLeds(t){if(!this._buffer||!t.length)return;if(this._brushIsEffect()){for(const e of t)this._touched.add(e);this._previewEl()?.setPaintPixels(null)}else{const e=this._brushRgb();for(const i of t)this._writeLed(i,e),this._touched.add(i);this._syncPreviewPixels(t)}this._scheduleFlush()}async _onPaintStroke(t){await this._ensureSession()&&this._strokeLeds(t.detail.leds)}async _flushNow(){if(this._active&&this.connection&&this._buffer)if(this._flushInFlight)this._flushQueued=!0;else{this._flushInFlight=!0;try{await on(this.connection,this.controllerId,this._buffer,{rgbw:this._rgbw,touched:[...this._touched],brush:this._brush,fill:this._fill,effectsByName:this._effectsByName});const t=this._brushIsEffect()?"effect (device preview)":"color";this._status=`Live paint · ${this._touched.size} LEDs · ${t} · fill: ${this._fill.mode}`}catch(t){this._status=_e(t)}finally{this._flushInFlight=!1,this._flushQueued&&(this._flushQueued=!1,this._flushNow())}}}_onBrushChange(t){this._brush=t.detail,this._emitPaintConfig(),this._active&&this._scheduleFlush()}_onFillChange(t){this._fill={...t.detail,mode:this._fill.mode},this._applyFillToBuffer(),this._syncPreviewPixels(),this._active&&this._scheduleFlush()}_onFillModeChange(t){this._fill=en(t),this._applyFillToBuffer(),this._syncPreviewPixels(),this._active&&this._flushNow()}async _commit(){if(this.connection&&this._active){this._flushColor.cancel(),this._flushEffect.cancel(),await this._flushNow();try{await rn(this.connection,this.controllerId,!0),this._status="Committed to WLED",this._previewEl()?.setStatus("committed")}catch(t){this._status=_e(t)}this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels()}}async _cancel(){if(this.connection&&this._active){this._flushColor.cancel(),this._flushEffect.cancel();try{await rn(this.connection,this.controllerId,!1),this._status="Live mode released",this._previewEl()?.setStatus("ready")}catch(t){this._status=_e(t)}this._active=!1,this._touched.clear(),this._applyFillToBuffer(),this._syncPreviewPixels()}}render(){const t=Boolean(this._layoutId),e=this.embedMode;return j`
    ...
    `]}};t([ht({attribute:!1})],hn.prototype,"connection",void 0),t([ht({attribute:!1})],hn.prototype,"hass",void 0),t([ht()],hn.prototype,"controllerId",void 0),t([ht({type:Boolean,attribute:"embed-mode"})],hn.prototype,"embedMode",void 0),t([ht()],hn.prototype,"embedLayoutId",void 0),t([ht()],hn.prototype,"embedFixtureId",void 0),t([ht({type:Number})],hn.prototype,"embedPixelCount",void 0),t([dt()],hn.prototype,"_pixelCount",void 0),t([dt()],hn.prototype,"_rgbw",void 0),t([dt()],hn.prototype,"_active",void 0),t([dt()],hn.prototype,"_brush",void 0),t([dt()],hn.prototype,"_fill",void 0),t([dt()],hn.prototype,"_brushSize",void 0),t([dt()],hn.prototype,"_status",void 0),t([dt()],hn.prototype,"_warn",void 0),t([dt()],hn.prototype,"_effectsByName",void 0),t([dt()],hn.prototype,"_layouts",void 0),t([dt()],hn.prototype,"_layoutId",void 0),t([dt()],hn.prototype,"_fixtureId",void 0),t([pt("wled-geometry-preview")],hn.prototype,"_internalPreview",void 0),hn=t([Ft("wled-view-paint")],hn);let dn=class extends vt{constructor(){super(...arguments),this._toasts=[],this._nextId=0,this._timers=new Map,this._onToast=t=>{const e=t.detail;if(!e?.message)return;const i=++this._nextId;this._toasts=[...this._toasts,{id:i,message:e.message}];const s=this._toastDurationMs(),n=window.setTimeout(()=>this._dismiss(i),s);this._timers.set(i,n)}}onPoweredConnect(){this.getRootNode().addEventListener(ee,this._onToast,{signal:this.abort.signal})}onPoweredDisconnect(){for(const t of this._timers.values())window.clearTimeout(t);this._timers.clear()}_toastDurationMs(){const t=getComputedStyle(this).getPropertyValue("--m-toast").trim(),e=Number.parseInt(t,10);return Number.isFinite(e)&&e>0?e:4e3}_dismiss(t){const e=this._timers.get(t);void 0!==e&&(window.clearTimeout(e),this._timers.delete(t)),this._toasts=this._toasts.filter(e=>e.id!==t)}render(){return this._toasts.length?j`
    ...
    `]}}function fn(){return{type:`custom:${pn}`,controller:"",height:200,show_segments:!1}}t([ht({attribute:!1})],gn.prototype,"config",void 0),t([dt()],gn.prototype,"_controllerId",void 0),t([dt()],gn.prototype,"_masterEntity",void 0),t([dt()],gn.prototype,"_pixelCount",void 0),t([dt()],gn.prototype,"_previewStatus",void 0),t([dt()],gn.prototype,"_hint",void 0),t([dt()],gn.prototype,"_layoutId",void 0),t([dt()],gn.prototype,"_fixtureId",void 0),t([dt()],gn.prototype,"_cardTab",void 0),t([pt("wled-geometry-preview")],gn.prototype,"_preview",void 0),t([pt("wled-segment-controls")],gn.prototype,"_segmentControls",void 0),t([pt("wled-view-effects")],gn.prototype,"_effectsView",void 0),t([pt("wled-view-paint")],gn.prototype,"_paintPanel",void 0),t([dt()],gn.prototype,"_globalBriPct",void 0),t([dt()],gn.prototype,"_lastNonZeroBri",void 0);const _n=[{key:"show_effects",label:"Show Effects tab"},{key:"show_scenes",label:"Show Scenes tab"},{key:"show_segments",label:"Show Segments tab (legacy)"},{key:"show_paint",label:"Show Paint tab"}];let mn=class extends rt{constructor(){super(...arguments),this._config=fn()}setConfig(t){this._config={...fn(),...t,type:t.type??`custom:${pn}`}}render(){const t=this._config;return j`
      <div class="editor">
  ...
  `}};t([ht({attribute:!1})],mn.prototype,"hass",void 0),t([dt()],mn.prototype,"_config",void 0),mn=t([Ft("wled-studio-card-editor")],mn),function(){const t=window.__WLED_STUDIO_BUILD__;t&&t!==bt&&(window.__WLED_STUDIO_STALE__=!0),window.__WLED_STUDIO_BUILD__=bt}(),function(t,e){const i=customElements.get(t);i||customElements.define(t,e)}(pn,gn),window.customCards=window.customCards||[],window.customCards.some(t=>t.type===pn)||window.customCards.push({type:pn,name:"WLED Studio",description:"Live LED strip preview and controls",preview:!0}),console.info("[wled-studio] lovelace bundle loaded",{card:pn});export{pn as CARD_TAG,gn as WledStudioCard,fn as getStubConfig};
